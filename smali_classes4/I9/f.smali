...
# direct methods
.method public constructor <init>(Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/MiviInfo4EntityJsonAdapter;LG9/b;)V
    .locals 1
    ...
    iput-object p1, p0, LI9/f;->a:Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/MiviInfo4EntityJsonAdapter;

    iput-object p2, p0, LI9/f;->b:LG9/b;
...
.method public final fromJson(LP8/q;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, LP8/q;->p()Ljava/lang/Object;
    ...
    :cond_1
    iget-object p0, p0, LI9/f;->a:Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/MiviInfo4EntityJsonAdapter;

    invoke-virtual {p0, p1}, LP8/l;->fromJsonValue(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0}, LXe/k;->V([Ljava/lang/Object;)Ljava/util/Set;

    move-result-object p0

    invoke-static {p1, p0}, LXe/G;->M(Ljava/util/Map;Ljava/util/Set;)Ljava/util/Map;
...
.method public final toJson(LP8/v;Ljava/lang/Object;)V
    ...
    invoke-static {v0}, LXe/G;->S(Ljava/util/Map;)Ljava/util/LinkedHashMap;
    ...
    :cond_4
    iget-object p0, p0, LI9/f;->b:LG9/b;

    invoke-virtual {p0, p1, v0}, LG9/b;->toJson(LP8/v;Ljava/lang/Object;)V
