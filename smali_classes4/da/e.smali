...
# direct methods
.method public varargs constructor <init>(Ljava/lang/String;LAb/a$a;LAb/a$a;Z[Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lda/c;-><init>(Ljava/lang/String;LAb/a$a;)V

    new-instance p2, Ljava/util/HashSet;

    invoke-direct {p2}, Ljava/util/HashSet;-><init>()V

    iput-object p2, p0, Lda/e;->f:Ljava/util/HashSet;

    iput-boolean p4, p0, Lda/e;->g:Z

    new-instance p4, Lca/f;

    invoke-direct {p4, p3}, Lca/f;-><init>(LAb/a$a;)V

    iput-object p4, p0, Lda/e;->e:Lca/f;
...
.method public final a()Lda/b;
    ...
    iget-object p0, p0, Lda/c;->c:Ljava/lang/String;
    ...
    invoke-direct {v0, p0}, Lda/b;-><init>(Ljava/lang/Exception;)V

    return-object v0

    :cond_0
    invoke-static {}, Lda/c;->b()Lca/a$b;

    move-result-object v1

    iget-object v3, p0, Lda/c;->c:Ljava/lang/String;

    invoke-virtual {v1, v3}, Lca/a$b;->a(Ljava/lang/String;)Lca/a$a;
    ...
    iget-object v3, p0, Lda/c;->a:Ljava/lang/String;
    ...
    invoke-virtual {v3, v4}, LP5/Z;->J2(Lda/f;)V

    iget-object v3, v1, Lca/a$a;->d:LP5/g;

    invoke-static {v3}, LP5/h;->H2(LP5/g;)Z
    ...
    iget-object v7, v3, LP5/Z;->T:Ljava/lang/Object;
    ...
    invoke-virtual {v3}, LP5/Z;->c2()I

    move-result v8

    iput v8, v3, LP5/Z;->K:I

    iput-boolean v0, v3, LP5/Z;->x:Z

    iget-object v0, v3, LP5/Z;->w:Landroid/hardware/camera2/CameraCaptureSession;

    iget v8, v3, LP5/Z;->o0:I

    const-string v9, "cancelSession"

    invoke-static {v0, v8, v9}, LP5/Z;->m2(Landroid/hardware/camera2/CameraCaptureSession;ILjava/lang/String;)Z
    ...
    iget-object v6, v3, LP5/Z;->w:Landroid/hardware/camera2/CameraCaptureSession;
    ...
    iput-object v4, v3, LP5/Z;->w:Landroid/hardware/camera2/CameraCaptureSession;
    ...
    invoke-virtual {v3, v0, v4, v2}, LP5/Z;->h2(Ljava/lang/Exception;Ljava/lang/String;Z)V
    ...
    :cond_5
    :goto_5
    iget-object v0, v1, Lca/a$a;->e:LP5/Z;

    iget-object v0, v0, LP5/Z;->v:Lx9/b;

    iget-object p0, p0, Lda/e;->e:Lca/f;
    ...
    iget-object v0, v0, Lx9/b;->a:Landroid/hardware/camera2/CameraDevice;

    invoke-virtual {p0, v0}, Lca/f;->onOpened(Landroid/hardware/camera2/CameraDevice;)V

    invoke-static {}, Lda/b;->a()Lda/b;
    ...
    invoke-virtual {v1}, Lca/a$b;->b()Ljava/util/Set;
    ...
    iget-object v4, v3, Lca/a$a;->e:LP5/Z;

    const-wide/16 v5, 0xa

    if-eqz v4, :cond_9

    iget-object v4, p0, Lda/e;->f:Ljava/util/HashSet;

    iget-object v7, v3, Lca/a$a;->g:Ljava/lang/String;
    ...
    iget-object v3, v3, Lca/a$a;->g:Ljava/lang/String;

    iget-object v4, p0, Lda/c;->c:Ljava/lang/String;
    ...
    iget-object v1, p0, Lda/e;->f:Ljava/util/HashSet;
    ...
    invoke-static {v1}, Lca/d;->b([Ljava/lang/String;)V

    invoke-static {}, Lca/d;->d()Lca/d;

    move-result-object v1

    iget-object v1, v1, Lca/d;->a:Landroid/os/Handler;
    ...
    :cond_9
    iget-boolean v4, v3, Lca/a$a;->a:Z

    if-eqz v4, :cond_a

    iget-object v1, p0, Lda/c;->a:Ljava/lang/String;

    iget-object v2, v3, Lca/a$a;->g:Ljava/lang/String;
    ...
    :cond_a
    iget-boolean v4, v3, Lca/a$a;->b:Z
    ...
    iget-object v1, v3, Lca/a$a;->g:Ljava/lang/String;
    ...
    iget-object v3, v3, Lca/a$b;->a:Landroid/hardware/camera2/CameraManager;

    invoke-static {}, Lca/d;->d()Lca/d;

    move-result-object v4

    iget-object v4, v4, Lca/d;->a:Landroid/os/Handler;

    iget-object v5, p0, Lda/c;->a:Ljava/lang/String;
    ...
    iget-object v7, p0, Lda/c;->c:Ljava/lang/String;
    ...
    iget-object v5, p0, Lda/c;->c:Ljava/lang/String;

    iget-object v6, p0, Lda/e;->e:Lca/f;
    ...
    invoke-virtual {v3, v4}, Lca/a$b;->a(Ljava/lang/String;)Lca/a$a;

    move-result-object v3

    iput-boolean v0, v3, Lca/a$a;->a:Z
    ...
    :goto_7
    iget-object v4, p0, Lda/c;->a:Ljava/lang/String;
    ...
    iget-object v6, p0, Lda/c;->c:Ljava/lang/String;
    ...
    invoke-direct {p0, v3}, Lda/b;-><init>(Ljava/lang/Exception;)V
    ...
    invoke-direct {p0, v0}, Lda/b;-><init>(Ljava/lang/Exception;)V
