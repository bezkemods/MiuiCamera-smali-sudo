...
# direct methods
.method public constructor <init>(Lob/i;Ljava/lang/String;)V
    .locals 1

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lob/b;->a:Lob/b$a;

    invoke-static {}, Ljava/util/concurrent/Executors;->newSingleThreadExecutor()Ljava/util/concurrent/ExecutorService;

    move-result-object p1

    iput-object p1, p0, Lob/d;->c:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object p1, p0, Lob/d;->b:Ljava/util/concurrent/LinkedBlockingQueue;
    ...
    iput-object p1, p0, Lob/d;->e:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {p1, v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object p1, p0, Lob/d;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {p2, p0, p1}, Lob/d$a;-><init>(Lob/d;Ljava/net/InetAddress;)V

    iput-object p2, p0, Lob/d;->d:Lob/d$a;
    ...
    invoke-virtual {p0, p1}, Lob/d;->d(Ljava/lang/String;)V
...
.method public final d(Ljava/lang/String;)V
    ...
    invoke-interface {p0, p1}, Lob/b$a;->a(Ljava/lang/String;)V
...
.method public final e(Ljava/io/FileInputStream;Ljava/lang/String;IJ)V
    ...
    iget-object v3, p0, Lob/d;->d:Lob/d$a;
    ...
    invoke-virtual/range {v3 .. v8}, Lob/d$a;->d(Ljava/io/FileInputStream;Ljava/lang/String;IJ)V
    :try_end_0
...
.method public final f(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;I)V
    ...
    invoke-virtual/range {v2 .. v7}, Lob/d;->e(Ljava/io/FileInputStream;Ljava/lang/String;IJ)V
