...
# direct methods
.method public constructor <init>(Lob/d;Ljava/net/InetAddress;)V
    .locals 0

    iput-object p1, p0, Lob/d$a;->i:Lob/d;

    invoke-direct {p0}, Ljava/lang/Thread;-><init>()V

    const/4 p1, 0x0

    iput-boolean p1, p0, Lob/d$a;->h:Z

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lob/d$a;->b:Ljava/lang/Object;

    iput-object p2, p0, Lob/d$a;->e:Ljava/net/InetAddress;

    const/16 p1, 0x1388

    iput p1, p0, Lob/d$a;->a:I
...
.method public final a()V
    ...
    :try_start_0
    iget-object v0, p0, Lob/d$a;->b:Ljava/lang/Object;
    ...
    :try_start_1
    iput-boolean v1, p0, Lob/d$a;->h:Z

    iget-object v1, p0, Lob/d$a;->d:Ljava/net/Socket;
    ...
    iput-object v2, p0, Lob/d$a;->d:Ljava/net/Socket;
    ...
    :cond_0
    :goto_0
    iget-object v1, p0, Lob/d$a;->c:Ljava/io/BufferedReader;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Ljava/io/BufferedReader;->close()V

    iput-object v2, p0, Lob/d$a;->c:Ljava/io/BufferedReader;

    :cond_1
    iget-object v1, p0, Lob/d$a;->f:Ljava/io/OutputStream;
    ...
    iput-object v2, p0, Lob/d$a;->f:Ljava/io/OutputStream;

    :cond_2
    iget-object v1, p0, Lob/d$a;->i:Lob/d;
    ...
    invoke-virtual {p0, v0}, Lob/d;->d(Ljava/lang/String;)V
...
.method public final b(I)V
    ...
    :cond_0
    sget-boolean p1, Lob/t;->a:Z

    const-string p1, "handleRevSuccess"

    invoke-static {v2, v1, p1}, Landroid/util/Log;->println(ILjava/lang/String;Ljava/lang/String;)I

    iget-object p1, p0, Lob/d$a;->i:Lob/d;

    iget-object v0, p1, Lob/d;->c:Ljava/util/concurrent/ExecutorService;
    ...
    iget-object p1, p1, Lob/d;->c:Ljava/util/concurrent/ExecutorService;
    ...
    iget-object p0, p0, Lob/d$a;->d:Ljava/net/Socket;
...
.method public final c(Ljava/io/BufferedReader;)V
    ...
    iget-object v3, p0, Lob/d$a;->b:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v5, p0, Lob/d$a;->d:Ljava/net/Socket;
    ...
    invoke-virtual {v5, p1}, Lob/d;->d(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p1}, Lob/d;->d(Ljava/lang/String;)V

    const/4 p1, -0x1

    :goto_1
    invoke-virtual {p0, p1}, Lob/d$a;->b(I)V
...
.method public final d(Ljava/io/FileInputStream;Ljava/lang/String;IJ)V
    ...
    iget-object v3, v0, Lob/d$a;->i:Lob/d;

    iget-object v4, v3, Lob/d;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v3, v3, Lob/d;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v9, v0, Lob/d$a;->g:Ljava/io/BufferedOutputStream;

    invoke-static {v4}, Lob/b;->b(I)[B
    ...
    iget-object v10, v0, Lob/d$a;->g:Ljava/io/BufferedOutputStream;

    array-length v11, v9

    invoke-static {v11}, Lob/b;->b(I)[B
    ...
    iget-object v4, v0, Lob/d$a;->g:Ljava/io/BufferedOutputStream;

    long-to-int v9, v1

    invoke-static {v9}, Lob/b;->b(I)[B
    ...
    iget-object v15, v0, Lob/d$a;->g:Ljava/io/BufferedOutputStream;
    ...
    invoke-static {v13, v14}, Lob/b;->a(J)Ljava/lang/String;
    ...
    invoke-static/range {p4 .. p5}, Lob/b;->a(J)Ljava/lang/String;
    ...
    iget-object v1, v0, Lob/d$a;->g:Ljava/io/BufferedOutputStream;

    invoke-virtual {v1}, Ljava/io/BufferedOutputStream;->flush()V

    iget-object v0, v0, Lob/d$a;->f:Ljava/io/OutputStream;
...
.method public final run()V
    ...
    iput-boolean v0, p0, Lob/d$a;->h:Z
    ...
    iget-object v2, p0, Lob/d$a;->e:Ljava/net/InetAddress;

    iget v3, p0, Lob/d$a;->a:I

    invoke-direct {v1, v2, v3}, Ljava/net/Socket;-><init>(Ljava/net/InetAddress;I)V

    iput-object v1, p0, Lob/d$a;->d:Ljava/net/Socket;
    ...
    iget-object v3, p0, Lob/d$a;->d:Ljava/net/Socket;
    ...
    iput-object v1, p0, Lob/d$a;->c:Ljava/io/BufferedReader;
    ...
    iput-object v1, p0, Lob/d$a;->f:Ljava/io/OutputStream;

    new-instance v1, Ljava/io/BufferedOutputStream;

    iget-object v2, p0, Lob/d$a;->f:Ljava/io/OutputStream;

    invoke-direct {v1, v2}, Ljava/io/BufferedOutputStream;-><init>(Ljava/io/OutputStream;)V

    iput-object v1, p0, Lob/d$a;->g:Ljava/io/BufferedOutputStream;
    ...
    invoke-virtual {v1, v0}, Lob/d;->d(Ljava/lang/String;)V

    :goto_0
    iget-object v0, p0, Lob/d$a;->i:Lob/d;

    iget-object v0, v0, Lob/d;->c:Ljava/util/concurrent/ExecutorService;
    ...
    iget-boolean v0, p0, Lob/d$a;->h:Z

    if-nez v0, :cond_1

    :try_start_3
    iget-object v0, p0, Lob/d$a;->d:Ljava/net/Socket;
    ...
    iget-object v0, p0, Lob/d$a;->c:Ljava/io/BufferedReader;

    invoke-virtual {p0, v0}, Lob/d$a;->c(Ljava/io/BufferedReader;)V
    :try_end_3
    ...
    iget-object v2, p0, Lob/d$a;->i:Lob/d;

    invoke-virtual {v0}, Ljava/lang/Throwable;->getMessage()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v2, v0}, Lob/d;->d(Ljava/lang/String;)V
