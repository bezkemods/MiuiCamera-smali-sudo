...
.method public final C(Lv9/h;)V
    ...
    invoke-static {v0, v1}, LA/m2;->i(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-boolean v1, v1, Lv9/b$a;->i:Z
    ...
    iget-object v5, v4, Lv9/b$a;->d:Landroid/media/Image;

    invoke-static {v5}, LP9/l;->m(Landroid/media/Image;)Z
    ...
    :cond_2
    iget-object v6, v4, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    if-nez v1, :cond_3

    iget v7, p1, Lv9/h;->d:I

    invoke-virtual {p0, v6, v5, v3, v7}, LP9/A;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    iget-object v8, v4, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v8}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getRequest()Landroid/hardware/camera2/CaptureRequest;

    move-result-object v8

    sget-object v9, Ld6/s;->u:Ld6/J;

    const v10, 0xbabe

    invoke-static {v8, v9, v10}, Ld6/K;->i(Landroid/hardware/camera2/CaptureRequest;Ld6/J;I)Ljava/lang/Object;
    ...
    :goto_2
    iget v8, p1, Lv9/h;->d:I

    invoke-virtual {p0, v6, v5, v7, v8}, LP9/A;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V

    :goto_3
    iget-object v4, v4, Lv9/b$a;->e:Landroid/media/Image;

    iget-object v5, p0, LP9/l;->j:LP9/r$e;

    invoke-static {v4, v5}, LP9/b;->E(Landroid/media/Image;LP9/r$e;)V
...
.method public final K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-static {v0, v1, v2, v4}, LA/N;->j(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :cond_0
    new-instance p1, LP9/y;

    invoke-direct {p1, p0}, LP9/y;-><init>(LP9/A;)V
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, LP9/b;->w:Landroid/media/ImageReader;

    new-instance v2, LP9/v;

    invoke-direct {v2, p0, p1}, LP9/v;-><init>(LP9/A;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    new-instance v2, LP9/w;

    invoke-direct {v2, p0}, LP9/w;-><init>(LP9/A;)V
    ...
    invoke-direct {v1, p0}, LP9/x;-><init>(LP9/A;)V
