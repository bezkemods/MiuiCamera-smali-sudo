...
.method public constructor <init>(LP9/r;)V
    ...
    iput-object p1, p0, LP9/r$e;->a:LP9/r;
...
.method public final a(LP9/b;)Z
    ...
    iget-object v2, v0, Lv9/b;->r:LP9/l;
...
.method public final b(IJ)V
    ...
    invoke-virtual {p0, p2, p3}, LP9/r;->u(J)LP9/o;
    ...
    invoke-virtual {v1, p2}, LL3/l;->m(Ljava/lang/String;)V

    iget-object p0, p0, LP9/r;->h:Lcom/android/camera/b$a;

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object p2, v0, LP9/o;->x:LP9/u;

    if-eqz p2, :cond_2

    invoke-interface {p2, v0, p1}, LP9/u;->a(LP9/o;I)V
    ...
    invoke-interface {p0, v0, p1}, LP9/u;->a(LP9/o;I)V
...
.method public final c(Landroid/media/Image;IZ)V
    ...
    invoke-static {v2, v3, v1}, LA/M;->g(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v12, v0, LP9/r$e;->a:LP9/r;

    const/4 v2, 0x2

    if-ne v1, v2, :cond_0

    invoke-static/range {p1 .. p1}, Lr9/e;->h(Landroid/media/Image;)[B

    move-result-object v0

    if-eqz v0, :cond_1b

    iget-object v1, v12, LP9/r;->F:LP9/r$f;

    invoke-virtual {v1, v0, v8}, LP9/r$f;->onJpegAvailable([BLjava/lang/String;)V

    goto/16 :goto_7

    :cond_0
    invoke-virtual {v12, v6, v7}, LP9/r;->u(J)LP9/o;
    ...
    iget-object v4, v13, LP9/o;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    :goto_0
    iget v15, v13, LP9/o;->A:I

    iget-object v14, v12, LP9/r;->F:LP9/r$f;
    ...
    invoke-static {v15}, Lr9/c;->c(I)Z

    move-result v5

    if-nez v5, :cond_a

    invoke-static {v15}, Lr9/c;->b(I)Z
    ...
    iget-object v0, v0, LP9/r$e;->a:LP9/r;
    ...
    :try_start_0
    invoke-virtual {v12, v6, v7, v0}, LP9/r;->z(JLcom/xiaomi/camera/imagecodec/ReprocessData;)V
    :try_end_0
    ...
    invoke-virtual {v14, v0, v8}, LP9/r$f;->onError(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v10, v1, v1}, Lr9/e;->k(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;

    move-result-object v0

    iget-object v1, v12, LP9/r;->C:LP9/r$c;

    invoke-virtual {v1, v10}, LP9/r$c;->b(Landroid/media/Image;)V
    ...
    iput-object v13, v3, Ll4/b$a;->b:LP9/o;

    iget-object v0, v12, LP9/r;->s:LJa/a;

    iput-object v0, v3, Ll4/b$a;->p:LJa/a;
    ...
    iget-object v1, v1, LP9/p;->I:Landroid/util/Size;
    ...
    iget-object v1, v12, LP9/r;->i:Ll4/j;
    ...
    invoke-static {v15}, Lr9/c;->d(I)Z

    move-result v0

    if-eqz v0, :cond_9

    iget-object v0, v12, LP9/r;->v:Ljava/util/HashMap;
    ...
    iget-object v0, v3, LP9/p;->j:Landroid/util/Size;
    ...
    iget-object v0, v12, LP9/r;->D:LP9/r$d;
    ...
    iget-object v2, v13, LP9/o;->r:LP9/p;

    iget-boolean v2, v2, LP9/p;->a:Z
    ...
    invoke-virtual/range {v1 .. v7}, LP9/r$e;->e(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLP9/o;J)V
    ...
    iget-object v1, v12, LP9/r;->u:Ljava/util/HashMap;
    ...
    iput-object v1, v12, LP9/r;->u:Ljava/util/HashMap;
    ...
    iget-object v1, v12, LP9/r;->t:Ljava/util/HashMap;
    ...
    iput-object v1, v12, LP9/r;->t:Ljava/util/HashMap;
    ...
    iget v2, v13, LP9/o;->R:I

    iget v3, v13, LP9/o;->S:I

    iget-object v4, v13, LP9/o;->T:Landroid/graphics/Rect;

    iget v5, v13, LP9/o;->U:F

    invoke-static {v1, v2, v3, v4, v5}, LP9/r;->i(Landroid/graphics/Rect;IILandroid/graphics/Rect;F)V
    ...
    iget-object v0, v12, LP9/r;->t:Ljava/util/HashMap;
    ...
    :goto_4
    iget-object v0, v12, LP9/r;->u:Ljava/util/HashMap;
    ...
    invoke-static {v0, v1, v2, v2}, Lr9/e;->k(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;

    move-result-object v0

    iget-object v2, v12, LP9/r;->C:LP9/r$c;

    invoke-virtual {v2, v1}, LP9/r$c;->b(Landroid/media/Image;)V

    invoke-virtual {v12, v6, v7, v0}, LP9/r;->r(JLandroid/media/Image;)V
    ...
    invoke-virtual {v12, v6, v7, v1}, LP9/r;->r(JLandroid/media/Image;)V
...
.method public final d(Landroid/media/Image;)V
    ...
    iget-object p0, p0, LP9/r;->C:LP9/r$c;

    invoke-virtual {p0, p1}, LP9/r$c;->b(Landroid/media/Image;)V

    return-void
.end method

.method public final e(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLP9/o;J)V
    .locals 8
    ...
    invoke-static {p2, p1}, Lr9/e;->g(Landroid/media/Image;Z)[B
    ...
    invoke-static {v1, v2, p3, p2}, LA/W;->a(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-virtual {p4, v0, p1}, LP9/o;->a(I[B)V

    const-string p2, "JPEG"

    invoke-virtual {p4, p2}, LP9/o;->g(Ljava/lang/String;)Z

    move-result p2

    if-nez p2, :cond_2

    sget-boolean p2, Lj6/b;->B:Z
    ...
    iget-object v1, p0, LP9/r;->i:Ll4/j;
    ...
    invoke-virtual/range {v1 .. v6}, Ll4/j;->p(LP9/o;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;Ljava/util/function/IntFunction;)V

    iget-object p1, p4, LP9/o;->K:Landroid/media/Image;

    invoke-static {p0, p1}, LP9/r;->b(LP9/r;Landroid/media/Image;)V

    invoke-static {p0, p4}, LP9/r;->d(LP9/r;LP9/o;)Z

    move-result p1

    if-eqz p1, :cond_3

    iget-object p1, p0, LP9/r;->h:Lcom/android/camera/b$a;

    if-eqz p1, :cond_3

    invoke-virtual {p1, p4}, Lcom/android/camera/b$a;->a(LP9/o;)V

    :cond_3
    const-string p1, "[2] onImageProcessed: parallelTaskHashMap remove "

    invoke-static {p5, p6, p1}, LV1/A;->c(JLjava/lang/String;)Ljava/lang/String;
    ...
    iget p1, p0, LP9/r;->y:I

    add-int/lit8 p1, p1, 0x1

    iput p1, p0, LP9/r;->y:I

    invoke-virtual {p0, p5, p6}, LP9/r;->y(J)LP9/o;

    move-result-object p1

    iget p2, p0, LP9/r;->y:I

    invoke-static {p0, p1, p2}, LP9/r;->e(LP9/r;LP9/o;I)Z

    move-result p1

    if-eqz p1, :cond_4

    invoke-static {p0}, LP9/r;->c(LP9/r;)V

    iput v0, p0, LP9/r;->y:I
