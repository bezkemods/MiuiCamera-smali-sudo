...
.method public constructor <init>(LP9/r;)V
    ...
    iput-object p1, p0, LP9/r$c;->a:LP9/r;
...
.method public final a(Lv9/b;)V
    ...
    iget-wide v9, v1, Lv9/b;->d:J

    iget-object v3, v1, Lv9/b;->f:Ljava/util/ArrayList;

    iget v2, v1, Lv9/b;->a:I
    ...
    iget-object v8, v0, LP9/r$c;->a:LP9/r;

    if-eq v6, v2, :cond_0

    if-ne v5, v2, :cond_5

    iget-boolean v11, v8, LP9/r;->r:Z

    if-eqz v11, :cond_5

    :cond_0
    iget-object v11, v1, Lv9/b;->i:Lv9/b$a;

    if-eqz v11, :cond_10

    invoke-virtual {v8, v9, v10}, LP9/r;->u(J)LP9/o;

    move-result-object v12

    iget-object v13, v11, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v9, v10, v15, v6}, LA/l2;->c(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iput-wide v13, v12, LP9/o;->e:J

    invoke-virtual {v8, v9, v10}, LP9/r;->y(J)LP9/o;

    invoke-static {v8, v13, v14, v12}, LP9/r;->f(LP9/r;JLP9/o;)V

    :cond_1
    if-ne v5, v2, :cond_4

    iget-boolean v5, v8, LP9/r;->r:Z

    if-eqz v5, :cond_4

    iget-boolean v5, v1, Lv9/b;->m:Z

    if-eqz v5, :cond_3

    iget-object v5, v1, Lv9/b;->g:Ljava/util/ArrayList;
    ...
    iget-object v5, v2, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iget-object v2, v2, Lv9/b$a;->d:Landroid/media/Image;
    ...
    iput-object v5, v6, LP9/o;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iget-object v5, v6, LP9/o;->r:LP9/p;

    iget-boolean v5, v5, LP9/p;->S:Z
    ...
    iget-boolean v7, v1, Lv9/b;->s:Z

    iget-object v8, v6, LP9/o;->L:Lv9/d;
    ...
    invoke-direct/range {v2 .. v8}, Lv9/h;-><init>(Ljava/util/ArrayList;ZJZLv9/d;)V

    iget v2, v1, Lv9/b;->x:I

    iput v2, v0, Lv9/h;->f:I

    iget-object v1, v1, Lv9/b;->r:LP9/l;

    sget-boolean v2, Lj6/b;->B:Z

    if-nez v2, :cond_7

    iget-object v2, v1, LP9/l;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {v1, v0}, LP9/l;->e(Lv9/h;)I

    goto/16 :goto_2

    :cond_8
    iget-object v1, v8, LP9/r;->E:LP9/r$e;

    invoke-virtual {v1, v4, v9, v10}, LP9/r$e;->b(IJ)V
    ...
    invoke-virtual {v1, v2, v4, v4}, LP9/r$e;->c(Landroid/media/Image;IZ)V
    ...
    invoke-static {v9, v10, v1}, LV1/A;->c(JLjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v6, v3, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v9, LP5/M;->a:Ljava/util/List;
    ...
    :cond_c
    sget-object v11, Ld6/I;->J1:Ld6/J;

    const v12, 0xbabe

    invoke-static {v8, v11, v12}, Ld6/K;->j(Landroid/hardware/camera2/CaptureResult;Ld6/J;I)Ljava/lang/Object;
    ...
    invoke-static {v11, v8}, LA/W;->e(Ljava/lang/String;Ljava/lang/Integer;)Ljava/lang/String;
    ...
    invoke-static {v10, v8}, LA/O;->b(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    iput-object v6, v2, LP9/o;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iget-object v2, v1, Lv9/b;->r:LP9/l;
    ...
    invoke-static {v5, v3, v6, v9}, Lr9/e;->k(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    invoke-virtual {v9}, LV0/c;->a()LV0/h;

    move-result-object v9

    invoke-direct {v6, v5, v4, v8, v9}, Lv9/c;-><init>(Landroid/media/Image;IZLV0/h;)V

    invoke-virtual {v2, v6}, LP9/l;->d(Lv9/c;)V
    ...
    :cond_d
    invoke-virtual {v0, v3}, LP9/r$c;->b(Landroid/media/Image;)V

    goto :goto_2

    :cond_e
    invoke-virtual {v0, v1, v5}, LP9/r$c;->c(Lv9/b;Ljava/lang/String;)V
...
.method public final c(Lv9/b;Ljava/lang/String;)V
    .locals 17
    .param p1    # Lv9/b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual/range {p1 .. p1}, Lv9/b;->a()Lv9/h;
    ...
    invoke-static {v4, v2, v0}, LA/Q;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v7, v3, Lv9/h;->a:Ljava/util/ArrayList;
    ...
    iget-wide v11, v1, Lv9/b;->d:J

    iget v13, v1, Lv9/b;->a:I

    iget-object v15, v0, LP9/r$c;->a:LP9/r;
    ...
    iget-boolean v14, v1, Lv9/b;->s:Z

    if-nez v14, :cond_5

    iget-boolean v14, v10, Lv9/b$a;->a:Z

    if-eqz v14, :cond_4

    iget-object v8, v10, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {v15, v5, v6}, LP9/r;->u(J)LP9/o;
    ...
    invoke-static {v15, v1, v13}, LP9/r;->a(LP9/r;Lv9/b;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v5

    iput-object v5, v8, LP9/o;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual/range {p1 .. p1}, Lv9/b;->b()Z

    move-result v5

    if-eqz v5, :cond_7

    invoke-virtual {v15, v11, v12}, LP9/r;->u(J)LP9/o;
    ...
    iput-object v6, v5, LP9/o;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v15, v2, v0}, LP9/r;->h(LP9/r;Lv9/b$a;LP9/r$c;)V
    ...
    :cond_a
    iget-object v0, v1, Lv9/b;->r:LP9/l;

    iget-boolean v1, v1, Lv9/b;->s:Z

    if-eqz v1, :cond_b

    iget-boolean v1, v3, Lv9/h;->b:Z

    if-eqz v1, :cond_b

    iget-object v1, v0, LP9/l;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v1}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    :cond_b
    iget-object v1, v15, LP9/r;->b:LP9/l;
    ...
    invoke-static {v4, v2, v1}, LA/Q;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput v1, v3, Lv9/h;->d:I

    :cond_f
    if-eqz v0, :cond_10

    invoke-virtual {v0, v3}, LP9/l;->e(Lv9/h;)I
