...
# instance fields
.field public final A:LP9/r$a;

.field public final B:LP9/r$b;

.field public final C:LP9/r$c;

.field public final D:LP9/r$d;

.field public final E:LP9/r$e;

.field public final F:LP9/r$f;

.field public a:I

.field public b:LP9/l;
...
.method public constructor <init>(Lcom/android/camera/b$a;)V
    ...
    iput v0, p0, LP9/r;->a:I

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, LP9/r;->c:Ljava/util/HashMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, LP9/r;->d:Ljava/util/ArrayList;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, LP9/r;->e:Landroid/util/SparseArray;

    const/4 v0, 0x0

    iput-object v0, p0, LP9/r;->f:Landroid/os/HandlerThread;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, LP9/r;->j:Ljava/lang/Object;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, LP9/r;->k:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, LP9/r;->l:Ljava/util/HashMap;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, LP9/r;->m:Ljava/lang/Object;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, LP9/r;->n:Ljava/lang/Object;

    new-instance v0, LP9/r$g;

    invoke-direct {v0, p0}, LP9/r$g;-><init>(LP9/r;)V

    iput-object v0, p0, LP9/r;->o:LP9/r$g;

    const/4 v0, -0x1

    iput v0, p0, LP9/r;->p:I

    iput v0, p0, LP9/r;->q:I

    const/4 v1, 0x1

    iput v1, p0, LP9/r;->x:I

    const/4 v1, 0x0

    iput v1, p0, LP9/r;->y:I

    iput v0, p0, LP9/r;->z:I

    new-instance v0, LP9/r$a;

    invoke-direct {v0, p0}, LP9/r$a;-><init>(LP9/r;)V

    iput-object v0, p0, LP9/r;->A:LP9/r$a;

    new-instance v0, LP9/r$b;

    invoke-direct {v0, p0}, LP9/r$b;-><init>(LP9/r;)V

    iput-object v0, p0, LP9/r;->B:LP9/r$b;

    new-instance v0, LP9/r$c;

    invoke-direct {v0, p0}, LP9/r$c;-><init>(LP9/r;)V

    iput-object v0, p0, LP9/r;->C:LP9/r$c;

    new-instance v0, LP9/r$d;

    invoke-direct {v0, p0}, LP9/r$d;-><init>(LP9/r;)V

    iput-object v0, p0, LP9/r;->D:LP9/r$d;

    new-instance v0, LP9/r$e;

    invoke-direct {v0, p0}, LP9/r$e;-><init>(LP9/r;)V

    iput-object v0, p0, LP9/r;->E:LP9/r$e;

    new-instance v0, LP9/r$f;

    invoke-direct {v0, p0}, LP9/r$f;-><init>(LP9/r;)V

    iput-object v0, p0, LP9/r;->F:LP9/r$f;
    ...
    iget-object v0, p0, LP9/r;->f:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, LP9/r;->f:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, LP9/r;->g:Landroid/os/Handler;

    iput-object p1, p0, LP9/r;->h:Lcom/android/camera/b$a;
    ...
    invoke-direct {p1, p0, v0}, LJa/a;-><init>(Ljava/lang/Object;I)V

    iput-object p1, p0, LP9/r;->s:LJa/a;

    :cond_1
    return-void
.end method

.method public static a(LP9/r;Lv9/b;I)Lcom/xiaomi/protocol/ICustomCaptureResult;
    .locals 5
    ...
    :cond_0
    iget-object p1, p1, Lv9/b;->f:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    check-cast p2, Lv9/b$a;

    iget-object p2, p2, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v3, Ld6/I;->G1:Ld6/J;

    const v4, 0xbabe

    invoke-static {v2, v3, v4}, Ld6/K;->j(Landroid/hardware/camera2/CaptureResult;Ld6/J;I)Ljava/lang/Object;
    ...
    invoke-static {p2, v2}, LA/W;->e(Ljava/lang/String;Ljava/lang/Integer;)Ljava/lang/String;
    ...
    invoke-direct {v2, v0}, LP9/q;-><init>(Z)V
    ...
    :cond_5
    iget-object p0, p2, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    :goto_2
    return-object p0
.end method

.method public static b(LP9/r;Landroid/media/Image;)V
    .locals 0
...
.method public static c(LP9/r;)V
    .locals 0

    invoke-virtual {p0}, LP9/r;->q()V
...
.method public static d(LP9/r;LP9/o;)Z
    .locals 2
    ...
    invoke-static {v0}, Lr9/c;->a(I)Z

    move-result v0

    if-nez v0, :cond_1

    iget p1, p1, LP9/o;->A:I
...
.method public static e(LP9/r;LP9/o;I)Z
    .locals 1
...
.method public static f(LP9/r;JLP9/o;)V
    .locals 4

    const-string v0, "putParallelTaskData : data for "

    iget-object v1, p0, LP9/r;->m:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, LP9/r;->k:Ljava/util/HashMap;
    ...
    :cond_0
    :goto_0
    iget-object p0, p0, LP9/r;->k:Ljava/util/HashMap;
...
.method public static g(LP9/r;LP9/o;Landroid/media/Image;Ljava/lang/String;IZ)V
    .locals 21
    ...
    invoke-static {v2, v1, v15, v15}, Lr9/e;->k(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;

    move-result-object v2

    iget-object v3, v7, LP9/r;->C:LP9/r$c;

    invoke-virtual {v3, v1}, LP9/r$c;->b(Landroid/media/Image;)V
    ...
    iget-object v11, v7, LP9/r;->B:LP9/r$b;
    ...
    invoke-virtual {v10}, L炤炨炪烩炪炮烩炣炢炱炮炤炢烩炤炨炪炪炨炩烩炄炨炪炪炨炩;->G2()Z
    ...
    invoke-virtual/range {v1 .. v6}, LP9/r;->j(LP9/o;Landroid/media/Image;Ljava/lang/String;IZ)V

    iget v1, v0, LP9/o;->A:I

    invoke-static {v1}, Lr9/c;->d(I)Z
    ...
    iget v10, v0, LP9/o;->A:I

    iget-object v2, v0, LP9/o;->a0:Ljava/lang/String;

    iget-object v3, v0, LP9/o;->P:Ljava/lang/Object;

    move-object/from16 v17, v3

    check-cast v17, LP9/l;
    ...
    invoke-direct/range {v9 .. v17}, Lv9/b;-><init>(IIIJLjava/lang/String;ZLP9/l;)V

    iget v2, v0, LP9/o;->k0:I

    iput v2, v1, Lv9/b;->x:I

    iput-object v8, v1, Lv9/b;->q:LP9/r$b;

    sget-object v2, LP9/n$e;->a:LP9/n;

    invoke-virtual {v2, v1}, LP9/n;->g(Lv9/b;)V

    invoke-virtual {v7, v0, v4}, LP9/r;->m(LP9/o;Z)V

    iget-object v1, v0, LP9/o;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v5, Ld6/s;->O1:Ld6/J;

    invoke-static {v0, v5, v3}, Ld6/K;->f(Landroid/hardware/camera2/impl/CameraMetadataNative;Ld6/J;Ljava/lang/Integer;)V
    ...
    invoke-static {v5, v3, v8}, Ld6/K;->a(Ljava/lang/Exception;Ljava/lang/Object;I)V

    goto :goto_3

    :goto_4
    invoke-virtual {v2, v1, v3}, LP9/n;->e(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V

    iget-object v0, v7, LP9/r;->v:Ljava/util/HashMap;
    ...
    :goto_5
    iget-object v0, v0, LP9/r$i;->a:Lcom/xiaomi/camera/imagecodec/ReprocessData;
    ...
    invoke-virtual {v2, v0, v1, v15, v3}, LP9/n;->d(Landroid/media/Image;IIZ)V
    ...
    iget-object v10, v0, LP9/o;->r:LP9/p;
    ...
    iput-object v11, v4, LP9/p;->j:Landroid/util/Size;

    new-instance v4, Lv9/b;

    iget v10, v0, LP9/o;->A:I

    iget-object v15, v0, LP9/o;->a0:Ljava/lang/String;

    iget-object v9, v0, LP9/o;->P:Ljava/lang/Object;
    ...
    iget v9, v0, LP9/o;->k0:I

    iput v9, v4, Lv9/b;->x:I

    iput-object v8, v4, Lv9/b;->q:LP9/r$b;

    sget-object v8, LP9/n$e;->a:LP9/n;

    invoke-virtual {v8, v4}, LP9/n;->g(Lv9/b;)V

    invoke-virtual {v7, v0, v5}, LP9/r;->m(LP9/o;Z)V

    iget-object v4, v0, LP9/o;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v7, Ld6/s;->O1:Ld6/J;

    invoke-static {v0, v7, v3}, Ld6/K;->f(Landroid/hardware/camera2/impl/CameraMetadataNative;Ld6/J;Ljava/lang/Integer;)V
    ...
    invoke-static {v7, v3, v9}, Ld6/K;->a(Ljava/lang/Exception;Ljava/lang/Object;I)V

    :goto_7
    invoke-virtual {v8, v4, v5}, LP9/n;->e(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V

    const/4 v3, 0x0

    invoke-virtual {v8, v1, v3, v5, v5}, LP9/n;->d(Landroid/media/Image;IIZ)V
    ...
    :cond_d
    iget-object v1, v7, LP9/r;->v:Ljava/util/HashMap;
    ...
    check-cast v1, LP9/r$i;

    iget-object v1, v1, LP9/r$i;->a:Lcom/xiaomi/camera/imagecodec/ReprocessData;
    ...
    :goto_9
    iget-object v1, v0, LP9/o;->P:Ljava/lang/Object;
    ...
    invoke-direct {v1, v9, v2, v3, v4}, Lv9/c;-><init>(Landroid/media/Image;IZLV0/h;)V

    iget-object v0, v0, LP9/o;->P:Ljava/lang/Object;

    check-cast v0, LP9/l;

    invoke-virtual {v0, v1}, LP9/l;->d(Lv9/c;)V
    ...
    invoke-virtual {v7, v1, v2, v9}, LP9/r;->r(JLandroid/media/Image;)V
...
.method public static h(LP9/r;Lv9/b$a;LP9/r$c;)V
    .locals 2
    ...
    iget-object p0, p1, Lv9/b$a;->d:Landroid/media/Image;

    iget-boolean v0, p1, Lv9/b$a;->j:Z

    invoke-static {p0, v0, p2}, LP9/r;->x(Landroid/media/Image;ZLP9/r$c;)V

    iget-object p0, p1, Lv9/b$a;->e:Landroid/media/Image;

    iget-boolean v0, p1, Lv9/b$a;->k:Z

    invoke-static {p0, v0, p2}, LP9/r;->x(Landroid/media/Image;ZLP9/r$c;)V

    iget-object p0, p1, Lv9/b$a;->g:Landroid/media/Image;

    iget-boolean v0, p1, Lv9/b$a;->l:Z

    invoke-static {p0, v0, p2}, LP9/r;->x(Landroid/media/Image;ZLP9/r$c;)V

    iget-object p0, p1, Lv9/b$a;->r:Ljava/util/ArrayList;
    ...
    iget-object v0, p1, Lv9/e;->a:Landroid/media/Image;

    iget-boolean p1, p1, Lv9/e;->d:Z

    invoke-static {v0, p1, p2}, LP9/r;->x(Landroid/media/Image;ZLP9/r$c;)V
...
.method public static i(Landroid/graphics/Rect;IILandroid/graphics/Rect;F)V
    ...
    :cond_9
    invoke-static {p3, p4}, LCh/j;->g(Landroid/graphics/Rect;F)Landroid/graphics/Rect;
...
.method public static x(Landroid/media/Image;ZLP9/r$c;)V
    .locals 0
    ...
    invoke-virtual {p2, p0}, LP9/r$c;->b(Landroid/media/Image;)V
...
.method public final A()V
    ...
    iget-object v2, p0, LP9/r;->m:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-object v3, p0, LP9/r;->k:Ljava/util/HashMap;
    ...
    iget-object v1, p0, LP9/r;->j:Ljava/lang/Object;

    monitor-enter v1

    :try_start_1
    iget-object v2, p0, LP9/r;->j:Ljava/lang/Object;
    ...
    iget-object v0, p0, LP9/r;->h:Lcom/android/camera/b$a;
    ...
    :cond_3
    :goto_1
    invoke-virtual {p0}, LP9/r;->s()V

    invoke-virtual {p0}, LP9/r;->o()V

    iget-object v0, p0, LP9/r;->t:Ljava/util/HashMap;
    ...
    iput-object v1, p0, LP9/r;->t:Ljava/util/HashMap;

    :cond_4
    iget-object v0, p0, LP9/r;->u:Ljava/util/HashMap;

    if-eqz v0, :cond_5

    invoke-virtual {v0}, Ljava/util/HashMap;->clear()V

    iput-object v1, p0, LP9/r;->u:Ljava/util/HashMap;

    :cond_5
    iget-object v0, p0, LP9/r;->v:Ljava/util/HashMap;

    if-eqz v0, :cond_6

    invoke-virtual {v0}, Ljava/util/HashMap;->clear()V

    iput-object v1, p0, LP9/r;->v:Ljava/util/HashMap;
    ...
    iget-object v0, p0, LP9/n;->a:Landroid/os/HandlerThread;
    ...
    iget-object v0, p0, LP9/n;->b:LP9/n$a;
...
.method public final j(LP9/o;Landroid/media/Image;Ljava/lang/String;IZ)V
    .locals 13
    ...
    iget-object v1, v6, LP9/r;->v:Ljava/util/HashMap;
    ...
    iput-object v1, v6, LP9/r;->v:Ljava/util/HashMap;
    ...
    new-instance v12, LP9/r$i;

    invoke-direct {v12}, LP9/r$i;-><init>()V
    ...
    invoke-virtual/range {v0 .. v5}, LP9/r;->t(LP9/o;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;

    move-result-object v0

    iput-boolean v11, v12, LP9/r$i;->b:Z
    ...
    iget-object v1, v7, LP9/o;->K:Landroid/media/Image;
    ...
    :cond_2
    iput-object v8, v7, LP9/o;->K:Landroid/media/Image;

    iput-boolean v11, v12, LP9/r$i;->c:Z

    :goto_0
    iput-object v0, v12, LP9/r$i;->a:Lcom/xiaomi/camera/imagecodec/ReprocessData;

    iget-object v0, v6, LP9/r;->v:Ljava/util/HashMap;
    ...
    iget-object v0, v7, LP9/o;->K:Landroid/media/Image;
    ...
    iput-boolean v11, v1, LP9/r$i;->c:Z

    :goto_1
    iget-boolean v0, v1, LP9/r$i;->b:Z

    if-eqz v0, :cond_9

    iget-boolean v0, v1, LP9/r$i;->c:Z

    if-eqz v0, :cond_9

    if-eqz p5, :cond_8

    iget v0, v7, LP9/o;->A:I

    const/16 v1, 0xc

    if-eq v1, v0, :cond_7

    invoke-static {v0}, Lr9/c;->b(I)Z
...
.method public final k()Z
    ...
    iget-object v0, p0, LP9/r;->j:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget v1, p0, LP9/r;->x:I
    ...
    :cond_0
    iget-object v1, p0, LP9/r;->e:Landroid/util/SparseArray;
...
.method public final l()V
    ...
    iget-object v0, p0, LP9/r;->m:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, LP9/r;->k:Ljava/util/HashMap;
...
.method public final m(LP9/o;Z)V
    .locals 4
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
    ...
    iget-object v2, p1, LP9/o;->r:LP9/p;

    iget-object v2, v2, LP9/p;->j:Landroid/util/Size;
    ...
    iget-object v0, p1, LP9/o;->P:Ljava/lang/Object;

    check-cast v0, LP9/l;

    invoke-virtual {v0}, LP9/l;->j()Lv9/j;
    ...
    iget-object v0, v0, Lv9/j;->b:Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {v0, p2}, LP9/l;->c(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;

    move-result-object v0

    iget-object p0, p0, LP9/r;->A:LP9/r$a;
    ...
    iput-object p0, v0, Lv9/j;->a:Lcom/xiaomi/engine/TaskSession;

    iput-object p2, v0, Lv9/j;->b:Lcom/xiaomi/engine/BufferFormat;

    iget-object p0, p1, LP9/o;->P:Ljava/lang/Object;

    check-cast p0, LP9/l;

    invoke-virtual {p0, v0}, LP9/l;->u(Lv9/j;)V
...
.method public final n(Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    invoke-static {v1}, LY5/d;->d(Landroid/util/SparseArray;)Ljava/util/ArrayList;
    ...
    iget-boolean v4, v3, LY5/e;->c:Z

    if-eqz v4, :cond_0

    iget-object v3, v3, LY5/e;->e:Landroid/media/ImageReader;

    if-eqz v3, :cond_0

    iget-object v4, p0, LP9/r;->d:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, LP9/r;->e:Landroid/util/SparseArray;
    ...
    iget-object v4, v4, LY5/e;->f:Lcom/xiaomi/protocol/IImageReaderParameterSets;
    ...
    iget-object v4, v3, LY5/e;->f:Lcom/xiaomi/protocol/IImageReaderParameterSets;
    ...
    iput v7, v6, LP9/r$h;->a:I

    iput v4, v6, LP9/r$h;->b:I

    iget-object v4, p0, LP9/r;->g:Landroid/os/Handler;
    ...
    iput-object v5, v4, LY5/e;->e:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, LP9/r;->e:Landroid/util/SparseArray;
...
.method public final o()V
    ...
    :goto_0
    iget-object v3, p0, LP9/r;->e:Landroid/util/SparseArray;
    ...
    :cond_2
    iget-object v1, p0, LP9/r;->d:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, LP9/r;->s:LJa/a;
...
.method public final r(JLandroid/media/Image;)V
    ...
    iget-object v2, p0, LP9/r;->v:Ljava/util/HashMap;
    ...
    iget-object v5, v2, LP9/r$i;->a:Lcom/xiaomi/camera/imagecodec/ReprocessData;

    invoke-virtual {v5, p3}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setMainImage(Landroid/media/Image;)Ljava/util/ArrayList;

    iget-object p3, v2, LP9/r$i;->a:Lcom/xiaomi/camera/imagecodec/ReprocessData;

    invoke-virtual {p0, p1, p2, p3}, LP9/r;->z(JLcom/xiaomi/camera/imagecodec/ReprocessData;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object p0, p0, LP9/r;->v:Ljava/util/HashMap;
    ...
    :try_start_1
    iget-object v2, p0, LP9/r;->F:LP9/r$f;
    ...
    invoke-virtual {v2, p3, v1}, LP9/r$f;->onError(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public final s()V
    ...
    iget-object v3, p0, LP9/r;->j:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    iget-object v4, p0, LP9/r;->c:Ljava/util/HashMap;
    ...
    iget-object v0, p0, LP9/r;->c:Ljava/util/HashMap;
    ...
    iget-object v1, p0, LP9/r;->f:Landroid/os/HandlerThread;
    ...
    iput-object v0, p0, LP9/r;->g:Landroid/os/Handler;
    ...
    :goto_3
    iget-object v2, p0, LP9/r;->f:Landroid/os/HandlerThread;
...
.method public final t(LP9/o;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    .locals 15
    ...
    iget-boolean v9, v3, LP9/p;->G:Z

    iget-object v4, v3, LP9/p;->I:Landroid/util/Size;
    ...
    iget-object v13, v0, LP9/r;->F:LP9/r$f;

    iget v12, v3, LP9/p;->J:I
    ...
    iget-boolean v2, v1, LP9/o;->J:Z

    const/4 v4, 0x1

    if-eqz v2, :cond_0

    iget-object v2, v1, LP9/o;->K:Landroid/media/Image;
    ...
    iget-object v0, v1, LP9/o;->W:Ljava/lang/String;
...
.method public final v()Z
    ...
    iget-object v0, p0, LP9/r;->k:Ljava/util/HashMap;
...
.method public final y(J)LP9/o;
    ...
    iget-object p0, p0, LP9/r;->h:Lcom/android/camera/b$a;
    ...
    invoke-static {p0, p2}, LN9/f;->a(II)V
...
.method public final z(JLcom/xiaomi/camera/imagecodec/ReprocessData;)V
    ...
    iget-object v0, p0, LP9/r;->n:Ljava/lang/Object;
