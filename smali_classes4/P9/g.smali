...
.method public constructor <init>(LP9/r$e;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {p0, p1, p2}, LP9/b;-><init>(LP9/r$e;Lcom/xiaomi/engine/BufferFormat;)V
...
# virtual methods
.method public final C(Lv9/h;)V
    .locals 10

    iget-object v0, p1, Lv9/h;->a:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-boolean v1, p1, Lv9/h;->b:Z

    if-eqz v1, :cond_1

    iget-object v1, p0, LP9/b;->r:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v1}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    :cond_1
    iget-object v1, p1, Lv9/h;->g:Lv9/d;

    invoke-virtual {v1}, Lv9/d;->d()I
    ...
    iget-object v4, v1, Lv9/b$a;->d:Landroid/media/Image;

    iget-object v6, v1, Lv9/b$a;->e:Landroid/media/Image;

    invoke-static {v4}, LP9/l;->m(Landroid/media/Image;)Z

    move-result v7

    invoke-static {v6}, LP9/l;->m(Landroid/media/Image;)Z
    ...
    :cond_4
    iget-object v1, v1, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget v7, p1, Lv9/h;->d:I

    invoke-virtual {p0, v1, v4, v2, v7}, LP9/g;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    iget v4, p1, Lv9/h;->d:I

    invoke-virtual {p0, v1, v6, v5, v4}, LP9/g;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public final K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-static {v1, v2, v3, v5}, LA/N;->j(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p2, v0}, LA/S;->h(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    :cond_2
    new-instance p1, LP9/g$a;

    invoke-direct {p1, p0}, LP9/g$a;-><init>(LP9/g;)V
    ...
    iget-object p1, p0, LP9/b;->A:Ljava/lang/Object;
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;
    ...
    invoke-direct {v2, p0}, LP9/d;-><init>(LP9/g;)V

    iget-object v3, p0, LP9/b;->t:Landroid/os/Handler;

    invoke-virtual {v1, v2, v3}, Landroid/media/ImageReader;->setOnImageAvailableListener(Landroid/media/ImageReader$OnImageAvailableListener;Landroid/os/Handler;)V

    new-instance v1, Landroid/hardware/camera2/params/OutputConfiguration;

    iget-object v2, p0, LP9/b;->w:Landroid/media/ImageReader;
    ...
    invoke-direct {v2, p0}, LP9/e;-><init>(LP9/g;)V

    iget-object v4, p0, LP9/b;->t:Landroid/os/Handler;
    ...
    iget-object v2, p0, LP9/b;->x:Landroid/media/ImageReader;
    ...
    invoke-static {v2, p1, v1, v5, v6}, LA/l2;->b(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iput-object p1, p0, LP9/b;->y:Landroid/media/ImageReader;

    new-instance v1, LP9/f;

    invoke-direct {v1, p0}, LP9/f;-><init>(LP9/g;)V
    ...
    iget-object p0, p0, LP9/b;->y:Landroid/media/ImageReader;
...
.method public final l()Z
    ...
    iget-object v0, p0, LP9/l;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, LP9/l;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, LP9/l;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {v1, p0}, LP9/r$e;->a(LP9/b;)Z
