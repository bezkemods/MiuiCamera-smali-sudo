...
.field public static final b:LCc/c;
...
.method static constructor <clinit>()V
    ...
    const-string v3, "raphaelin"

    const-string v4, "hercules"

    invoke-static {v0, v1, v2, v3, v4}, LCc/b;->a(LCc/c;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v4, "chopin"

    invoke-static {v0, v1, v2, v3, v4}, LCc/b;->a(LCc/c;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "odin"

    const-string v2, "enuma"

    const-string v3, "elish"

    const-string v4, "nabu"
    ...
    const-string v3, "pissarropro"

    const-string v4, "pissarroin"
    ...
    const-string v3, "psyche"

    const-string v4, "ingres"

    invoke-static {v0, v1, v2, v3, v4}, LCc/b;->a(LCc/c;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "poussin"

    const-string v2, "cupid"

    const-string v3, "munch"
    ...
    const-string v4, "xaga"

    invoke-static {v0, v1, v2, v3, v4}, LCc/b;->a(LCc/c;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "xagapro"

    const-string v2, "xagain"

    const-string v3, "xagaproin"
    ...
    const-string v1, "ditingp"

    const-string v2, "dagu"

    const-string v3, "ziyi"
    ...
    const-string v3, "rubypro"

    const-string v4, "rubyplus"
    ...
    const-string v3, "yudi"

    const-string v4, "zircon"

    invoke-static {v0, v1, v2, v3, v4}, LCc/b;->a(LCc/c;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "garnet_OLD"

    const-string v2, "houji"

    const-string v3, "shennong"

    const-string v4, "vermeer"
    ...
    const-string v4, "ruyi"

    invoke-static {v0, v1, v2, v3, v4}, LCc/b;->a(LCc/c;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-string v1, "chenfeng"

    const-string v2, "peridot"

    const-string v3, "goku"

    const-string v4, "rothko"
