...
.method public constructor <init>(LZ8/e;)V
    ...
    iput-boolean v0, p0, LY8/h;->c:Z

    iput-boolean v0, p0, LY8/h;->d:Z

    iput-object p1, p0, LY8/h;->a:LZ8/e;

    iget-object v1, p1, LZ8/e;->b:LNf/j;

    const-string v2, "aivs.env"

    invoke-virtual {v1, v2, v0}, LNf/j;->b(Ljava/lang/String;I)I
    ...
    :goto_0
    iput-object v1, p0, LY8/h;->b:Ljava/lang/String;
    ...
    iget-object v2, p1, LZ8/e;->b:LNf/j;

    const-string v3, "connection.connect_timeout"

    invoke-virtual {v2, v3, v0}, LNf/j;->b(Ljava/lang/String;I)I
    ...
    iput-object v1, p0, La9/c;->f:Lokhttp3/OkHttpClient;

    const-class v1, LY8/g;

    invoke-virtual {p1, v1}, LZ8/e;->a(Ljava/lang/Class;)LY8/b;
    ...
    invoke-virtual {p1, v3}, LY8/g;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v5, Lg9/a;->a:LJ6/t;

    invoke-virtual {v5, v4}, LJ6/t;->l(Ljava/lang/String;)LJ6/l;
    ...
    invoke-virtual {v4, v2}, LW6/s;->A(Ljava/lang/String;)LJ6/l;
    ...
    :cond_3
    invoke-virtual {p1, v3}, LY8/g;->b(Ljava/lang/String;)V
    :try_end_0
...
.method public final e(Ljava/lang/String;)Z
    ...
    iget-object v0, p0, LY8/h;->a:LZ8/e;

    iget-object v1, v0, LZ8/e;->l:Landroid/content/Context;

    invoke-static {v1}, Lcom/xiaomi/ai/android/utils/NetworkUtils;->b(Landroid/content/Context;)Lf9/E3;

    move-result-object v1

    sget-object v2, Lf9/E3;->c:Lf9/E3;
    ...
    iget-object v2, v0, LZ8/e;->b:LNf/j;

    const-string v5, "track.max_track_times"

    invoke-virtual {v2, v5, v4}, LNf/j;->b(Ljava/lang/String;I)I
    ...
    iget-object p1, v0, LZ8/e;->b:LNf/j;

    invoke-virtual {p1, v5, v4}, LNf/j;->b(Ljava/lang/String;I)I
    ...
    invoke-virtual {v0, v5, v4}, LNf/j;->b(Ljava/lang/String;I)I
    ...
    iget-object v1, p0, La9/c;->f:Lokhttp3/OkHttpClient;

    invoke-virtual {v1, v0}, Lokhttp3/OkHttpClient;->newCall(Lokhttp3/Request;)Lokhttp3/Call;

    move-result-object v0

    new-instance v1, La9/c$a;

    invoke-direct {v1, p0, p1}, La9/c$a;-><init>(La9/c;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, p1, v1}, LY8/h;->c(Ljava/lang/String;Ljava/lang/String;LW6/a;)Z

    move-result p1

    if-eqz p1, :cond_5

    iput-boolean v2, p0, LY8/h;->d:Z
