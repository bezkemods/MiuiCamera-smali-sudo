...
.field public final f:La9/a$e;

.field public final synthetic g:La9/a;


# direct methods
.method public constructor <init>(La9/a;La9/a$e;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, La9/a$d;->g:La9/a;

    const/4 p1, 0x1

    iput-boolean p1, p0, La9/a$d;->c:Z

    const/4 p1, 0x0

    iput-boolean p1, p0, La9/a$d;->d:Z

    iput-boolean p1, p0, La9/a$d;->e:Z

    iput-object p2, p0, La9/a$d;->f:La9/a$e;
    ...
    iput-object p1, p0, La9/a$d;->a:Ljava/io/PipedInputStream;

    :try_start_0
    new-instance p1, Ljava/io/PipedOutputStream;

    iget-object p2, p0, La9/a$d;->a:Ljava/io/PipedInputStream;

    invoke-direct {p1, p2}, Ljava/io/PipedOutputStream;-><init>(Ljava/io/PipedInputStream;)V

    iput-object p1, p0, La9/a$d;->b:Ljava/io/PipedOutputStream;
    :try_end_0
...
.method public final a(II[B)I
    ...
    :goto_0
    iget-boolean v2, p0, La9/a$d;->c:Z
    ...
    :try_start_0
    iget-object v2, p0, La9/a$d;->a:Ljava/io/PipedInputStream;
    ...
    iget-boolean v3, p0, La9/a$d;->c:Z
    ...
    invoke-static {v0, p0}, Lk9/a;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-boolean p0, p0, La9/a$d;->c:Z
...
.method public final b([BZ)V
    ...
    :try_start_0
    iget-object v1, p0, La9/a$d;->b:Ljava/io/PipedOutputStream;
    :try_end_0
    ...
    :cond_0
    :goto_0
    iget-object p1, p0, La9/a$d;->b:Ljava/io/PipedOutputStream;
    ...
    invoke-static {p2, p1}, Lk9/a;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final c()V
    ...
    iget-object v1, p0, La9/a$d;->g:La9/a;

    iget-object v1, v1, La9/a;->c:Landroid/media/MediaCodec;
    ...
    iget-object v2, p0, La9/a$d;->g:La9/a;

    iget-object v2, v2, La9/a;->c:Landroid/media/MediaCodec;
    ...
    iget-object v4, p0, La9/a$d;->f:La9/a$e;

    :try_start_0
    iget-object v4, v4, La9/a$e;->b:Ljava/util/concurrent/LinkedBlockingQueue;
    ...
    iget-object v0, p0, La9/a$d;->f:La9/a$e;

    new-array v1, v5, [B

    :try_start_1
    iget-object v0, v0, La9/a$e;->b:Ljava/util/concurrent/LinkedBlockingQueue;
    ...
    :goto_1
    iput-boolean v5, p0, La9/a$d;->c:Z
...
.method public final d([BZ)V
    ...
    :goto_0
    iget-boolean v0, p0, La9/a$d;->c:Z

    if-eqz v0, :cond_4

    iget-object v0, p0, La9/a$d;->g:La9/a;

    iget-object v0, v0, La9/a;->c:Landroid/media/MediaCodec;
    ...
    :goto_1
    iget-object p0, p0, La9/a$d;->g:La9/a;

    iget-object v3, p0, La9/a;->c:Landroid/media/MediaCodec;
...
.method public final run()V
    ...
    new-instance v4, La9/a$b;

    invoke-direct {v4}, La9/a$b;-><init>()V

    :goto_0
    iget-boolean v5, p0, La9/a$d;->c:Z

    if-eqz v5, :cond_5

    iget-boolean v5, p0, La9/a$d;->e:Z

    const/4 v6, 0x1

    if-nez v5, :cond_3

    invoke-virtual {p0, v1, v2, v3}, La9/a$d;->a(II[B)I
    ...
    :goto_1
    iput-boolean v6, p0, La9/a$d;->e:Z
    ...
    :cond_0
    invoke-virtual {v4, v3}, La9/a$b;->b([B)Z
    ...
    invoke-static {v5, v7}, Lk9/a;->d(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_1

    :cond_1
    iget v5, v4, La9/a$b;->h:I
    ...
    invoke-virtual {p0, v2, v5, v7}, La9/a$d;->a(II[B)I
    ...
    :cond_2
    invoke-virtual {p0, v7, v1}, La9/a$d;->d([BZ)V

    goto :goto_2

    :cond_3
    iget-boolean v5, p0, La9/a$d;->d:Z

    if-nez v5, :cond_4

    invoke-virtual {p0, v0, v6}, La9/a$d;->d([BZ)V

    const-string v5, "MediaPlayerImpl"

    const-string v7, "StreamDecodeTask: put end flag"

    invoke-static {v5, v7}, Lk9/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    iput-boolean v6, p0, La9/a$d;->d:Z

    :cond_4
    :goto_2
    invoke-virtual {p0}, La9/a$d;->c()V
    :try_end_0
    ...
    :cond_5
    :try_start_1
    iget-object v2, p0, La9/a$d;->b:Ljava/io/PipedOutputStream;
    ...
    iput-object v0, p0, La9/a$d;->b:Ljava/io/PipedOutputStream;
    ...
    iput-object v0, p0, La9/a$d;->a:Ljava/io/PipedInputStream;
    :try_end_1
    ...
    iget-object v2, v0, La9/a;->e:Ljava/lang/Object;
    ...
    :goto_15
    :try_start_d
    iget-object v3, p0, La9/a$d;->b:Ljava/io/PipedOutputStream;
    ...
    :cond_f
    :goto_16
    iget-object v3, p0, La9/a$d;->a:Ljava/io/PipedInputStream;
    ...
    iget-object v0, v0, La9/a;->e:Ljava/lang/Object;

    monitor-enter v0

    :try_start_e
    iget-object v3, p0, La9/a$d;->g:La9/a;

    iget-object v3, v3, La9/a;->c:Landroid/media/MediaCodec;
    ...
    invoke-static {v4, v3}, Lk9/a;->d(Ljava/lang/String;Ljava/lang/String;)V
