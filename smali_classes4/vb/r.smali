...
.method public final a(Lcom/android/camera/module/video/v;)V
    ...
    iget-object p0, p0, Lvb/r;->a:Lvb/n;

    invoke-virtual {p0, p1}, Lvb/n;->e(Lcom/android/camera/module/video/v;)V
...
.method public final b(Lvb/p$b;)V
    ...
    invoke-direct {v0, p0, p1}, Lsd/a;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public final d(Landroid/view/Surface;)V
    ...
    iget-object p0, p0, Lvb/n;->f:Lvb/k;
...
.method public final g()Landroid/media/AudioParaManger$TuneListener;
    .locals 0

    iget-object p0, p0, Lvb/r;->a:Lvb/n;

    iget-object p0, p0, Lvb/n;->r:Lvb/n$a;
...
.method public final j(Lvb/q;)V
    ...
    invoke-virtual {p0, p1}, Lvb/n;->b(Lvb/q;)V
...
.method public final k()Ljava/lang/String;
    ...
    iget-object p0, p0, Lvb/n;->u:Ljava/lang/String;
...
.method public final o()V
    ...
    iget-object p0, p0, Lvb/k;->g:Lxb/b;
...
.method public final prepare()V
    ...
    invoke-direct {v2, p0}, Lvb/o;-><init>(Lvb/n;)V

    iput-object v2, p0, Lvb/n;->q:Lvb/o;
    ...
    iget-boolean v3, p0, Lvb/n;->w:Z

    if-eqz v3, :cond_0

    iget-object v3, p0, Lvb/a;->e:Lvb/q;

    iget v3, v3, Lvb/q;->g:I

    invoke-static {v3}, Lvb/w;->f(I)Ljava/lang/String;

    move-result-object v3

    iget-object v4, p0, Lvb/a;->e:Lvb/q;

    iget-object v4, v4, Lvb/q;->k:Landroid/util/Size;

    invoke-virtual {v4}, Landroid/util/Size;->getWidth()I

    move-result v4

    iget-object v6, p0, Lvb/a;->e:Lvb/q;

    iget-object v6, v6, Lvb/q;->k:Landroid/util/Size;
    ...
    new-instance v6, Lyb/h;

    const-string v7, "VideoCodecEncoder-Depth"

    invoke-direct {v6, v7}, Lyb/c;-><init>(Ljava/lang/String;)V

    iput-object v6, p0, Lvb/n;->i:Lyb/h;
    ...
    iget-object v8, p0, Lvb/a;->e:Lvb/q;

    iget v8, v8, Lvb/q;->j:I
    ...
    iget-object v12, p0, Lvb/n;->i:Lyb/h;

    iget-object v13, p0, Lvb/n;->q:Lvb/o;

    iput-object v13, v12, Lyb/c;->r:Lyb/c$b;

    invoke-virtual {v12, v4}, Lyb/h;->o(Landroid/media/MediaFormat;)V
    ...
    iget-object v12, p0, Lvb/a;->e:Lvb/q;

    iget-object v12, v12, Lvb/q;->k:Landroid/util/Size;
    ...
    invoke-direct {v4, v12}, Lyb/c;-><init>(Ljava/lang/String;)V

    iput-object v4, p0, Lvb/n;->j:Lyb/h;

    invoke-virtual {v3, v6, v7}, Landroid/media/MediaFormat;->setInteger(Ljava/lang/String;I)V

    iget-object v4, p0, Lvb/a;->e:Lvb/q;

    iget v4, v4, Lvb/q;->j:I
    ...
    iget-object v4, p0, Lvb/n;->j:Lyb/h;

    iget-object v6, p0, Lvb/n;->q:Lvb/o;

    iput-object v6, v4, Lyb/c;->r:Lyb/c$b;

    invoke-virtual {v4, v3}, Lyb/h;->o(Landroid/media/MediaFormat;)V

    :cond_0
    iget-object v3, p0, Lvb/n;->f:Lvb/k;

    if-eqz v3, :cond_1

    invoke-virtual {v3}, Lvb/k;->j()V
    ...
    iget-object v4, p0, Lvb/n;->t:Ljava/lang/String;
    ...
    iget-object v4, p0, Lvb/n;->v:Ljava/text/SimpleDateFormat;
    ...
    iput-object v3, p0, Lvb/n;->u:Ljava/lang/String;

    new-instance v3, Landroid/media/MediaMuxer;

    iget-object v4, p0, Lvb/n;->u:Ljava/lang/String;

    iget-object v6, p0, Lvb/a;->e:Lvb/q;

    iget v6, v6, Lvb/q;->l:I

    invoke-direct {v3, v4, v6}, Landroid/media/MediaMuxer;-><init>(Ljava/lang/String;I)V

    iput-object v3, p0, Lvb/n;->g:Landroid/media/MediaMuxer;
    ...
    iget-object v3, p0, Lvb/n;->g:Landroid/media/MediaMuxer;

    iget-object v4, p0, Lvb/a;->e:Lvb/q;

    iget v4, v4, Lvb/q;->q:I
    ...
    iget-boolean v4, v3, Lvb/q;->a:Z

    if-eqz v4, :cond_4

    iget-boolean v4, v3, Lvb/q;->v:Z

    if-eqz v4, :cond_4

    iget v3, v3, Lvb/q;->e:I
    ...
    invoke-static {v0, v1, v3, p0}, LA/W;->a(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public final release()V
    ...
    invoke-virtual {v3}, Lvb/k;->l()V

    :cond_0
    const/4 v3, 0x0

    iput-object v3, p0, Lvb/n;->f:Lvb/k;
    ...
    iget-object v4, p0, Lvb/n;->i:Lyb/h;

    if-eqz v4, :cond_2

    invoke-virtual {v4}, Lyb/c;->j()V

    :cond_2
    iput-object v3, p0, Lvb/n;->i:Lyb/h;
    ...
    :cond_3
    iput-object v3, p0, Lvb/n;->j:Lyb/h;
...
.method public final start()V
    ...
    iput-wide v2, p0, Lvb/n;->x:J

    const/4 v2, 0x1

    iput-boolean v2, p0, Lvb/n;->p:Z

    const/4 v2, 0x0

    iput-boolean v2, p0, Lvb/n;->y:Z
    ...
    iget-object v3, p0, Lvb/n;->i:Lyb/h;

    invoke-virtual {v3}, Lyb/h;->l()V

    iget-object p0, p0, Lvb/n;->j:Lyb/h;
...
.method public final stop()V
    ...
    invoke-virtual {p0, v2}, Lvb/n;->e(Lcom/android/camera/module/video/v;)V
