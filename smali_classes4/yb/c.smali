...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lyb/c;->a:Ljava/lang/String;
    ...
    iput-wide v1, p0, Lyb/c;->g:J

    iput-wide v1, p0, Lyb/c;->h:J

    iput-boolean v0, p0, Lyb/c;->i:Z

    iput-boolean v0, p0, Lyb/c;->j:Z

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Lyb/c;->k:Ljava/lang/Object;

    iput-wide v1, p0, Lyb/c;->m:J

    iput-wide v1, p0, Lyb/c;->n:J

    const-wide/16 v3, -0x1

    iput-wide v3, p0, Lyb/c;->o:J

    iput-wide v1, p0, Lyb/c;->p:J

    iput-wide v1, p0, Lyb/c;->q:J
    ...
    iput-object v0, p0, Lyb/c;->u:Ljava/lang/Integer;

    iput-object p1, p0, Lyb/c;->b:Ljava/lang/String;

    return-void
.end method

.method public static a(Lyb/c;Landroid/media/MediaCodec;ILandroid/media/MediaCodec$BufferInfo;)V
    .locals 2
    ...
    iget-object p1, p0, Lyb/c;->a:Ljava/lang/String;

    new-instance p2, Ljava/lang/StringBuilder;

    invoke-direct {p2}, Ljava/lang/StringBuilder;-><init>()V

    iget-object p3, p0, Lyb/c;->b:Ljava/lang/String;
    ...
    iget-object p1, p0, Lyb/c;->k:Ljava/lang/Object;
    ...
    :try_start_1
    iput-boolean p2, p0, Lyb/c;->j:Z

    iget-object p2, p0, Lyb/c;->k:Ljava/lang/Object;
    ...
    iput-wide v0, p0, Lyb/c;->h:J

    invoke-virtual {p0, p1, p2, p3}, Lyb/c;->e(Landroid/media/MediaCodec;ILandroid/media/MediaCodec$BufferInfo;)V
    :try_end_2
    ...
    :goto_0
    iget-object p2, p0, Lyb/c;->a:Ljava/lang/String;
    ...
    iget-object p0, p0, Lyb/c;->r:Lyb/c$b;

    if-eqz p0, :cond_1

    invoke-interface {p0}, Lyb/c$b;->b()V
...
.method public final b()Z
    ...
    iget-object v3, p0, Lyb/c;->b:Ljava/lang/String;
    ...
    iget-wide v3, p0, Lyb/c;->h:J

    invoke-virtual {v2, v3, v4}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string v3, ",diffTime = "

    invoke-static {v0, v1, v3, v2}, LA/m2;->c(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lyb/c;->a:Ljava/lang/String;
...
.method public final f(Landroid/media/MediaFormat;I)V
    ...
    iput-object p1, p0, Lyb/c;->d:Landroid/media/MediaFormat;
    ...
    :goto_0
    iget-object v4, p0, Lyb/c;->d:Landroid/media/MediaFormat;
    ...
    :cond_3
    iget-object v4, p0, Lyb/c;->u:Ljava/lang/Integer;
    ...
    iget-object v6, p0, Lyb/c;->b:Ljava/lang/String;
    ...
    iput-object v4, p0, Lyb/c;->s:Landroid/os/HandlerThread;

    invoke-virtual {v4}, Ljava/lang/Thread;->start()V

    new-instance v2, Landroid/os/Handler;

    iget-object v4, p0, Lyb/c;->s:Landroid/os/HandlerThread;
    ...
    iput-object v2, p0, Lyb/c;->t:Landroid/os/Handler;

    iget-object v2, p0, Lyb/c;->d:Landroid/media/MediaFormat;
    ...
    invoke-virtual {p0, p1}, Lyb/c;->c(Landroid/media/MediaFormat;)Landroid/media/MediaCodec;

    move-result-object v2

    iput-object v2, p0, Lyb/c;->c:Landroid/media/MediaCodec;

    const-string v2, " mMediaCodec =  "

    invoke-static {v6, v2}, LA3/H2;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget-object v4, p0, Lyb/c;->c:Landroid/media/MediaCodec;
    ...
    iget-object v5, p0, Lyb/c;->a:Ljava/lang/String;

    invoke-static {v5, v2, v4}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v2, p0, Lyb/c;->c:Landroid/media/MediaCodec;

    new-instance v4, Lyb/b;

    invoke-direct {v4, p0}, Lyb/b;-><init>(Lyb/c;)V

    iget-object v7, p0, Lyb/c;->t:Landroid/os/Handler;
    ...
    invoke-virtual {p0}, Lyb/c;->g()Landroid/view/Surface;

    iget-object p1, p0, Lyb/c;->r:Lyb/c$b;
    ...
    invoke-interface {p1, p0}, Lyb/c$b;->g(Landroid/media/MediaFormat;)V

    :cond_5
    const-string p0, " init End >> "

    invoke-static {v6, p0}, LA3/H2;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final h()Z
    ...
    iget-object p0, p0, Lyb/c;->d:Landroid/media/MediaFormat;
...
.method public final i(JJLjava/util/function/IntFunction;)V
    ...
    iget-object v5, p0, Lyb/c;->c:Landroid/media/MediaCodec;

    invoke-virtual {v5, v0}, Landroid/media/MediaCodec;->setParameters(Landroid/os/Bundle;)V

    :cond_0
    iput-wide p1, p0, Lyb/c;->m:J

    const-wide/16 p1, 0x0

    iput-wide p1, p0, Lyb/c;->q:J

    iput-object p5, p0, Lyb/c;->l:Ljava/util/function/IntFunction;
    ...
    iget-object p1, p0, Lyb/c;->t:Landroid/os/Handler;

    new-instance p2, Lyb/c$a;

    move-object v0, p0

    check-cast v0, Lyb/e;

    invoke-direct {p2, v0}, Lyb/c$a;-><init>(Lyb/e;)V

    invoke-virtual {p1, p2, p5, p3, p4}, Landroid/os/Handler;->postDelayed(Ljava/lang/Runnable;Ljava/lang/Object;J)Z

    :cond_1
    iput-boolean v3, p0, Lyb/c;->f:Z
...
.method public j()V
    ...
    iget-object v0, p0, Lyb/c;->k:Ljava/lang/Object;
    ...
    iget-object v1, p0, Lyb/c;->a:Ljava/lang/String;

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v4, p0, Lyb/c;->b:Ljava/lang/String;
    ...
    iput-object v1, p0, Lyb/c;->c:Landroid/media/MediaCodec;

    const-wide/16 v3, 0x0

    iput-wide v3, p0, Lyb/c;->m:J

    iput-wide v3, p0, Lyb/c;->g:J

    const-wide/16 v3, -0x1

    iput-wide v3, p0, Lyb/c;->o:J

    iget-object v1, p0, Lyb/c;->s:Landroid/os/HandlerThread;
    ...
    iget-object p0, p0, Lyb/c;->b:Ljava/lang/String;
...
.method public k(J)V
    ...
    iget-wide v5, p0, Lyb/c;->m:J

    sub-long v5, p1, v5

    iput-wide v5, p0, Lyb/c;->q:J

    iget-wide v7, p0, Lyb/c;->p:J

    add-long/2addr v7, v5

    iput-wide v7, p0, Lyb/c;->p:J
    ...
    iget-object p1, p0, Lyb/c;->c:Landroid/media/MediaCodec;

    invoke-virtual {p1, v0}, Landroid/media/MediaCodec;->setParameters(Landroid/os/Bundle;)V

    :cond_0
    iput-boolean v2, p0, Lyb/c;->f:Z
...
.method public m(J)V
    ...
    iget-wide v2, p0, Lyb/c;->p:J

    invoke-static {p1, p2, v2, v3, v1}, LA/Q;->d(JJLjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-wide v5, p0, Lyb/c;->p:J

    sub-long v5, p1, v5

    iput-wide v5, p0, Lyb/c;->o:J
    ...
    iget-object v6, p0, Lyb/c;->c:Landroid/media/MediaCodec;

    invoke-virtual {v6, v5}, Landroid/media/MediaCodec;->setParameters(Landroid/os/Bundle;)V

    iget-object v5, p0, Lyb/c;->k:Ljava/lang/Object;

    monitor-enter v5

    :goto_0
    :try_start_0
    iget-boolean v6, p0, Lyb/c;->i:Z

    if-nez v6, :cond_4

    iget-boolean v6, p0, Lyb/c;->j:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :try_start_1
    iget-object v6, p0, Lyb/c;->a:Ljava/lang/String;

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v8, p0, Lyb/c;->b:Ljava/lang/String;
    ...
    iget-object v6, p0, Lyb/c;->k:Ljava/lang/Object;

    invoke-virtual {v6, v8, v9}, Ljava/lang/Object;->wait(J)V

    invoke-virtual {p0}, Lyb/c;->b()Z
    ...
    :goto_1
    :try_start_2
    iget-object v7, p0, Lyb/c;->a:Ljava/lang/String;

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v9, p0, Lyb/c;->b:Ljava/lang/String;
...
.method public final n()V
    ...
    iget-object v1, p0, Lyb/c;->e:Landroid/view/Surface;

    if-eqz v1, :cond_1

    iget-boolean v1, p0, Lyb/c;->j:Z
    ...
    :goto_1
    :try_start_2
    iget-object v3, p0, Lyb/c;->a:Ljava/lang/String;

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v5, p0, Lyb/c;->b:Ljava/lang/String;
    ...
    :cond_2
    :goto_2
    iget-object v1, p0, Lyb/c;->r:Lyb/c$b;

    if-eqz v1, :cond_3

    invoke-interface {v1, p0}, Lyb/c$b;->c(Lyb/c;)V

    :cond_3
    const/4 v1, 0x1

    iput-boolean v1, p0, Lyb/c;->i:Z

    iget-object v1, p0, Lyb/c;->k:Ljava/lang/Object;
