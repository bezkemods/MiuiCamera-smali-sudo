...
.method public constructor <init>(Lxb/b;)V
    ...
    iput-object p1, p0, Lxb/d;->c:Lxb/b;
    ...
    iput-wide v0, p0, Lxb/d;->a:J

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Lxb/d;->b:J
...
.method public final a(ILandroid/media/AudioTimestamp;Ljava/nio/ByteBuffer;I)V
    ...
    iget-wide v7, v1, Lxb/d;->a:J

    cmp-long v0, v10, v7

    if-lez v0, :cond_2

    iget-object v0, v1, Lxb/d;->c:Lxb/b;
    ...
    iget-object v8, v0, Lxb/b;->e:Landroid/media/AudioFormat;
    ...
    iget-object v0, v0, Lxb/b;->e:Landroid/media/AudioFormat;
    ...
    invoke-static {v7, v0}, LA/O;->b(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    iget-wide v5, v1, Lxb/d;->a:J

    sub-long/2addr v10, v5

    iget-object v0, v1, Lxb/d;->c:Lxb/b;

    iget-object v0, v0, Lxb/b;->a:Landroid/media/AudioRecord;
    ...
    iget-object v0, v0, Lxb/b;->m:Lwb/a;

    iget-wide v5, v1, Lxb/d;->b:J

    iput-wide v5, v0, Lwb/a;->d:J

    new-instance v5, Ljava/lang/StringBuilder;

    const-string v6, "start startTimeUs = "

    invoke-direct {v5, v6}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-wide v6, v0, Lwb/a;->d:J
    ...
    iget-object v5, v0, Lxb/b;->m:Lwb/a;

    iget-wide v7, v5, Lwb/a;->d:J
    ...
    :cond_5
    :try_start_0
    iget-object v0, v5, Lwb/a;->c:Ljava/nio/ByteBuffer;

    invoke-virtual {v0}, Ljava/nio/ByteBuffer;->clear()Ljava/nio/Buffer;

    iget-object v0, v5, Lwb/a;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v7, v5, Lwb/a;->b:Ljava/nio/ByteBuffer;
    ...
    iput-object v7, v5, Lwb/a;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v7, v5, Lwb/a;->c:Ljava/nio/ByteBuffer;

    invoke-virtual {v7, v3}, Ljava/nio/ByteBuffer;->put(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;

    add-int/2addr v0, v4

    iget-object v4, v5, Lwb/a;->c:Ljava/nio/ByteBuffer;
    ...
    iget-object v8, v5, Lwb/a;->c:Ljava/nio/ByteBuffer;
    ...
    iget-object v3, v5, Lwb/a;->c:Ljava/nio/ByteBuffer;
    ...
    iget-object v11, v5, Lwb/a;->c:Ljava/nio/ByteBuffer;
    ...
    :cond_8
    iget-wide v10, v5, Lwb/a;->e:J

    const-wide/16 v12, 0x400

    add-long/2addr v10, v12

    iput-wide v10, v5, Lwb/a;->e:J

    iget-wide v12, v5, Lwb/a;->d:J

    const-wide/32 v14, 0xf4240

    mul-long/2addr v10, v14

    iget v0, v5, Lwb/a;->a:I
    ...
    iget-object v0, v5, Lwb/a;->g:Lxb/b$a;
    ...
    iget-object v7, v0, Lxb/b$a;->a:Lxb/b;

    iget-boolean v7, v7, Lxb/b;->d:Z

    if-nez v7, :cond_a

    new-instance v7, Lyb/f;
    ...
    invoke-direct/range {v10 .. v15}, Lyb/f;-><init>(Ljava/nio/ByteBuffer;IJLandroid/media/MediaCodec$BufferInfo;)V

    iget-object v0, v0, Lxb/b$a;->a:Lxb/b;

    iget-object v10, v0, Lxb/b;->p:LL2/k;

    if-eqz v10, :cond_9

    iget-object v0, v10, LL2/k;->b:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v8, v7}, LLa/c;->a(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    :cond_d
    iget-object v3, v5, Lwb/a;->b:Ljava/nio/ByteBuffer;
    ...
    iput-object v3, v5, Lwb/a;->b:Ljava/nio/ByteBuffer;
    ...
    iget-wide v4, v1, Lxb/d;->a:J

    cmp-long v0, v2, v4

    if-lez v0, :cond_10

    iput-wide v2, v1, Lxb/d;->a:J
...
.method public final run()V
    ...
    iget-object v0, p0, Lxb/d;->c:Lxb/b;

    iget v0, v0, Lxb/b;->g:I

    invoke-static {v0}, Ljava/nio/ByteBuffer;->allocateDirect(I)Ljava/nio/ByteBuffer;

    move-result-object v0

    iget-object v1, p0, Lxb/d;->c:Lxb/b;

    invoke-static {v1}, Lxb/b;->b(Lxb/b;)V

    const-wide/16 v3, -0x1

    iput-wide v3, p0, Lxb/d;->b:J

    :goto_0
    iget-object v1, p0, Lxb/d;->c:Lxb/b;

    iget-boolean v1, v1, Lxb/b;->c:Z

    if-eqz v1, :cond_2

    iget-object v1, p0, Lxb/d;->c:Lxb/b;

    iget-object v1, v1, Lxb/b;->j:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v3, p0, Lxb/d;->c:Lxb/b;

    iget-object v4, v3, Lxb/b;->a:Landroid/media/AudioRecord;

    if-eqz v4, :cond_1

    iget v3, v3, Lxb/b;->g:I

    invoke-virtual {v4, v0, v3}, Landroid/media/AudioRecord;->read(Ljava/nio/ByteBuffer;I)I

    move-result v3

    iget-object v4, p0, Lxb/d;->c:Lxb/b;

    iget-object v5, v4, Lxb/b;->a:Landroid/media/AudioRecord;

    iget-object v6, v4, Lxb/b;->k:Landroid/media/AudioTimestamp;

    iget v4, v4, Lxb/b;->n:I
    ...
    iget-object v5, p0, Lxb/d;->c:Lxb/b;

    iget-object v5, v5, Lxb/b;->k:Landroid/media/AudioTimestamp;

    invoke-virtual {p0, v4, v5, v0, v3}, Lxb/d;->a(ILandroid/media/AudioTimestamp;Ljava/nio/ByteBuffer;I)V
    ...
    invoke-static {v4, v5, v3}, Lxb/b;->a(Lxb/b;Ljava/lang/String;I)V
    ...
    :cond_2
    :try_start_1
    iget-object p0, p0, Lxb/d;->c:Lxb/b;
