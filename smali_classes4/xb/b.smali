...
.method public constructor <init>()V
    ...
    iput-object v2, v1, Lxb/a;->a:Ljava/util/concurrent/ArrayBlockingQueue;

    iput-object v1, p0, Lxb/b;->i:Lxb/a;

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, Lxb/b;->j:Ljava/lang/Object;

    new-instance v1, Landroid/media/AudioTimestamp;

    invoke-direct {v1}, Landroid/media/AudioTimestamp;-><init>()V

    iput-object v1, p0, Lxb/b;->k:Landroid/media/AudioTimestamp;

    iput-boolean v0, p0, Lxb/b;->l:Z

    iput v0, p0, Lxb/b;->n:I

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lxb/b;->q:J

    return-void
.end method

.method public static a(Lxb/b;Ljava/lang/String;I)V
    .locals 4
    ...
    invoke-static {p2, p1, v0}, LA/P;->c(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-wide p1, p0, Lxb/b;->q:J

    :cond_0
    return-void
.end method

.method public static b(Lxb/b;)V
    .locals 5
    ...
    iget-object v3, p0, Lxb/b;->a:Landroid/media/AudioRecord;
    ...
    iget-object v1, p0, Lxb/b;->j:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Lxb/b;->a:Landroid/media/AudioRecord;
    ...
    iget-object p0, p0, Lxb/b;->a:Landroid/media/AudioRecord;
...
.method public final c()V
    ...
    iget-object v0, p0, Lxb/b;->b:Ljava/lang/Thread;

    if-nez v0, :cond_2

    iget-boolean v0, p0, Lxb/b;->l:Z
    ...
    iget-object v5, p0, Lxb/b;->a:Landroid/media/AudioRecord;
    ...
    :goto_3
    iget-object v0, p0, Lxb/b;->a:Landroid/media/AudioRecord;
    ...
    invoke-direct {v0, p0}, Lxb/d;-><init>(Lxb/b;)V

    iput-object v0, p0, Lxb/b;->b:Ljava/lang/Thread;
    ...
    invoke-direct {v0, p0}, Lxb/c;-><init>(Lxb/b;)V
...
.method public final d(Landroid/media/AudioFormat;IIII)V
    ...
    iput-object p1, p0, Lxb/b;->e:Landroid/media/AudioFormat;

    iput p2, p0, Lxb/b;->g:I

    iput p3, p0, Lxb/b;->f:I

    iput p4, p0, Lxb/b;->h:I

    iput p5, p0, Lxb/b;->n:I
    ...
    iput-boolean p3, p0, Lxb/b;->l:Z

    new-instance p3, Lwb/a;
    ...
    iput-object p4, p3, Lwb/a;->c:Ljava/nio/ByteBuffer;

    const-wide/16 v0, -0x1

    iput-wide v0, p3, Lwb/a;->d:J

    const-wide/16 v0, 0x0

    iput-wide v0, p3, Lwb/a;->e:J

    iput-boolean p5, p3, Lwb/a;->f:Z

    iput p1, p3, Lwb/a;->a:I

    iput-object p4, p3, Lwb/a;->b:Ljava/nio/ByteBuffer;
    ...
    iput-object p1, p3, Lwb/a;->c:Ljava/nio/ByteBuffer;

    iput-object p3, p0, Lxb/b;->m:Lwb/a;

    new-instance p1, Lxb/b$a;

    invoke-direct {p1, p0}, Lxb/b$a;-><init>(Lxb/b;)V

    iput-object p1, p3, Lwb/a;->g:Lxb/b$a;

    goto :goto_0

    :cond_0
    iput-boolean p5, p0, Lxb/b;->l:Z
    ...
    invoke-static {p2, p1, p3}, LMf/f;->g(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-boolean p2, p0, Lxb/b;->l:Z
    ...
    iget-object p2, p0, Lxb/b;->e:Landroid/media/AudioFormat;
    ...
    iput-object p1, p0, Lxb/b;->a:Landroid/media/AudioRecord;
    :try_end_0
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_0 .. :try_end_0} :catch_0

    invoke-virtual {p0}, Lxb/b;->c()V
...
.method public final e()V
    ...
    iput-boolean v2, p0, Lxb/b;->c:Z

    iget-object v0, p0, Lxb/b;->j:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lxb/b;->a:Landroid/media/AudioRecord;
    ...
    iput-object v1, p0, Lxb/b;->a:Landroid/media/AudioRecord;

    iget-object v3, p0, Lxb/b;->i:Lxb/a;

    invoke-virtual {v3}, Lxb/a;->a()V

    monitor-exit v0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v0, p0, Lxb/b;->m:Lwb/a;

    if-eqz v0, :cond_3

    iput-object v1, v0, Lwb/a;->b:Ljava/nio/ByteBuffer;

    iput-object v1, v0, Lwb/a;->c:Ljava/nio/ByteBuffer;

    iput-object v1, v0, Lwb/a;->g:Lxb/b$a;

    const-wide/16 v3, -0x1

    iput-wide v3, v0, Lwb/a;->d:J

    const-wide/16 v3, 0x0

    iput-wide v3, v0, Lwb/a;->e:J

    :cond_3
    iput-object v1, p0, Lxb/b;->m:Lwb/a;

    iput-object v1, p0, Lxb/b;->b:Ljava/lang/Thread;

    iput-boolean v2, p0, Lxb/b;->l:Z
...
.method public final f()V
    ...
    iget-object v1, p0, Lxb/b;->i:Lxb/a;

    invoke-virtual {v1}, Lxb/a;->a()V

    iget-object v1, p0, Lxb/b;->b:Ljava/lang/Thread;
    ...
    :cond_0
    iget-object p0, p0, Lxb/b;->b:Ljava/lang/Thread;
...
.method public final g()V
    ...
    :try_start_1
    iget-object v3, p0, Lxb/b;->m:Lwb/a;

    iget-object v4, v3, Lwb/a;->b:Ljava/nio/ByteBuffer;
    ...
    :cond_1
    iput-object v1, v3, Lwb/a;->b:Ljava/nio/ByteBuffer;

    iget-object v4, v3, Lwb/a;->c:Ljava/nio/ByteBuffer;
