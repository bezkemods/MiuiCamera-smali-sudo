...
.method private addMetaData()V
    ...
    invoke-static {v2}, Lrj/c;->a(Ljava/io/File;)Lrj/c;

    move-result-object v2

    iget-object v3, v2, Lrj/c;->a:Ljava/util/Map;
...
.method private notifyTaskFinish()V
    ...
    iget-object v1, p0, Lcom/miui/extravideo/interpolation/VideoInterpolatorAsyncImp;->mEncodeListener:Lcom/miui/extravideo/interpolation/EncodeListener;

    if-eqz v1, :cond_0

    invoke-interface {v1}, Lcom/miui/extravideo/interpolation/EncodeListener;->onEncodeFinish()V
    ...
    invoke-interface {v1}, Lcom/miui/extravideo/interpolation/EncodeListener;->onError()V
