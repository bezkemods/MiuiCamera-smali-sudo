...
.method public constructor <init>(LP8/y;)V
    ...
    iput-object v4, p0, Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/SupportSizeObjectJsonAdapter;->a:LP8/q$a;
    ...
    invoke-static {v6, v5}, LP8/B;->d(Ljava/lang/Class;[Ljava/lang/reflect/Type;)LQ8/c$b;

    move-result-object v5

    sget-object v8, LXe/y;->a:LXe/y;

    invoke-virtual {p1, v5, v8, v0}, LP8/y;->b(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)LP8/l;

    move-result-object v0

    iput-object v0, p0, Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/SupportSizeObjectJsonAdapter;->b:LP8/l;
    ...
    invoke-static {v6, v0}, LP8/B;->d(Ljava/lang/Class;[Ljava/lang/reflect/Type;)LQ8/c$b;

    move-result-object v0

    invoke-virtual {p1, v0, v8, v1}, LP8/y;->b(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)LP8/l;

    move-result-object v0

    iput-object v0, p0, Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/SupportSizeObjectJsonAdapter;->c:LP8/l;
    ...
    invoke-virtual {p1, v0, v8, v2}, LP8/y;->b(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)LP8/l;

    move-result-object v0

    iput-object v0, p0, Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/SupportSizeObjectJsonAdapter;->d:LP8/l;
    ...
    invoke-virtual {p1, v0, v8, v3}, LP8/y;->b(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)LP8/l;

    move-result-object p1

    iput-object p1, p0, Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/SupportSizeObjectJsonAdapter;->e:LP8/l;
...
.method public final fromJson(LP8/q;)Ljava/lang/Object;
    ...
    iget-object v4, p0, Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/SupportSizeObjectJsonAdapter;->a:LP8/q$a;
    ...
    :cond_0
    iget-object v3, p0, Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/SupportSizeObjectJsonAdapter;->e:LP8/l;
    ...
    :cond_1
    iget-object v2, p0, Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/SupportSizeObjectJsonAdapter;->d:LP8/l;
    ...
    :cond_2
    iget-object v1, p0, Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/SupportSizeObjectJsonAdapter;->c:LP8/l;
    ...
    :cond_3
    iget-object v0, p0, Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/SupportSizeObjectJsonAdapter;->b:LP8/l;
...
.method public final toJson(LP8/v;Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/SupportSizeObjectJsonAdapter;->c:LP8/l;
    ...
    iget-object v0, p0, Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/SupportSizeObjectJsonAdapter;->d:LP8/l;
    ...
    iget-object p0, p0, Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/SupportSizeObjectJsonAdapter;->e:LP8/l;
