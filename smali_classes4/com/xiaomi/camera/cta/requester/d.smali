...
.method public static final b(Landroidx/fragment/app/FragmentActivity;Lcom/xiaomi/camera/cta/requester/CtaViewModel;Landroid/content/Intent;Lcom/xiaomi/camera/cta/requester/e$a;)V
    ...
    invoke-direct/range {v2 .. v7}, LQ9/a;-><init>(Lkotlin/jvm/internal/C;Landroidx/fragment/app/FragmentActivity;Lcom/xiaomi/camera/cta/requester/CTARequester$startCTAForResult$observer$1;Lcom/xiaomi/camera/cta/requester/e$a;Lcom/xiaomi/camera/cta/requester/CtaViewModel;)V
    ...
    iget-object p0, p1, Lcom/xiaomi/camera/cta/requester/CtaViewModel;->b:LHg/A;

    invoke-virtual {p0}, LHg/A;->getValue()Ljava/lang/Object;

    move-result-object p0

    const-string p3, "startCTAForResult state:"

    invoke-static {p0, p3}, LA/m2;->e(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
...
.method public static final c(Landroidx/fragment/app/FragmentActivity;Lcom/xiaomi/camera/cta/requester/a;)V
    ...
    iget-object v1, v1, Lcom/xiaomi/camera/cta/requester/b;->a:LR9/b;

    invoke-interface {v1, p0, v0}, LR9/b;->f(Landroidx/fragment/app/FragmentActivity;Z)Landroid/content/Intent;
    ...
    invoke-virtual {p1, v1}, LA/w1;->a(Lcom/xiaomi/camera/cta/requester/c$a;)V
    ...
    invoke-direct {v1, p1, v2}, LCg/f;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v2, p0, v0, v1, v3}, Lcom/xiaomi/camera/cta/requester/e;-><init>(Landroidx/fragment/app/FragmentActivity;Landroid/content/Intent;LCg/f;Laf/e;)V

    const/4 p0, 0x3

    invoke-static {p1, v3, v2, p0}, LEg/f;->b(LEg/F;Laf/f;Llf/p;I)LEg/C0;
