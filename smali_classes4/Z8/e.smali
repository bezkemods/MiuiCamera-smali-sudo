...
# instance fields
.field public b:LNf/j;

.field public c:LZ8/g;

.field public d:LZ8/f;

.field public e:LZ8/b;

.field public f:Li9/a;

.field public g:Ljava/util/HashMap;

.field public h:LP5/Y;

.field public i:LZ8/k;
...
.field public m:LZ8/h;

.field public n:Lf9/E4;

.field public o:LZ8/j;


# virtual methods
.method public final a(Ljava/lang/Class;)LY8/b;
    .locals 0
    ...
    iget-object p0, p0, LZ8/e;->g:Ljava/util/HashMap;
...
.method public final b(IZ)V
    ...
    iget-object v0, v1, LZ8/e;->f:Li9/a;
    ...
    iget-object v0, v1, LZ8/e;->o:LZ8/j;

    invoke-virtual {v0, v4}, LZ8/j;->b(Z)V
    ...
    iput v0, v5, LU8/a;->a:I

    iput-object v1, v5, LW8/a;->l:LZ8/e;

    const-string v0, "DAA-TOKEN-V1"

    iput-object v0, v5, LW8/a;->m:Ljava/lang/String;

    new-instance v0, Lokhttp3/OkHttpClient;

    invoke-direct {v0}, Lokhttp3/OkHttpClient;-><init>()V

    iput-object v0, v5, LW8/a;->n:Lokhttp3/OkHttpClient;

    iget-object v0, v1, LZ8/e;->l:Landroid/content/Context;
    ...
    invoke-static {v7, v0}, Lk9/a;->d(Ljava/lang/String;Ljava/lang/String;)V

    :goto_0
    const-string v0, "MD5"

    invoke-static {v0, v9}, LP9/B;->b(Ljava/lang/String;[B)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v5, LW8/a;->e:Ljava/lang/String;
    ...
    iput-object v0, v5, LW8/a;->f:Ljava/lang/String;

    iget-object v0, v1, LZ8/e;->n:Lf9/E4;

    iget-object v0, v0, Lf9/E4;->a:Lfc/a;
    ...
    iput-object v0, v5, LW8/a;->g:Ljava/lang/String;

    iget-object v0, v1, LZ8/e;->b:LNf/j;

    const-string v7, "aivs.env"

    const/4 v8, -0x1

    invoke-virtual {v0, v7, v8}, LNf/j;->b(Ljava/lang/String;I)I
    ...
    invoke-virtual {v0, v8}, LNf/j;->c(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    iput-object v8, v5, LW8/a;->h:Ljava/lang/String;
    ...
    iput-object v8, v5, LW8/a;->i:Ljava/lang/String;
    ...
    iput-object v8, v5, LW8/a;->j:Ljava/lang/String;
    ...
    iget v6, v5, LU8/a;->a:I

    iget-object v8, v1, LZ8/e;->l:Landroid/content/Context;
    ...
    iput-object v0, v5, LW8/a;->k:Ljava/lang/String;
    ...
    invoke-virtual {v0, v6}, LNf/j;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v6, v1, LZ8/e;->n:Lf9/E4;

    iget-object v8, v1, LZ8/e;->e:LZ8/b;

    invoke-direct {v0, v2, v6, v5, v8}, Li9/a;-><init>(LNf/j;Lf9/E4;LW8/a;LWg/b;)V
    ...
    iput-object v6, v0, Li9/d;->k:Lokhttp3/OkHttpClient;

    iget-object v6, v0, Li9/a;->a:LNf/j;

    const-string v8, "connection.enable_lite_crypt"

    const/4 v10, 0x0

    invoke-virtual {v6, v8, v10}, LNf/j;->a(Ljava/lang/String;Z)Z
    ...
    :cond_5
    iget-object v6, v0, Li9/a;->c:LWg/b;

    const-string v12, "wss_expire_at"

    invoke-virtual {v6, v12}, LWg/b;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-boolean v10, v0, Li9/d;->j:Z

    const-string v6, "checkWssMode:not in wss mode"

    :goto_3
    invoke-static {v8, v6}, Lk9/a;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v6, v12}, LWg/b;->i(Ljava/lang/String;)V
    ...
    iget-object v14, v2, LNf/j;->a:Ljava/lang/Object;
    ...
    invoke-virtual {v2, v10}, LNf/j;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_8
    invoke-virtual {v2, v7, v4}, LNf/j;->b(Ljava/lang/String;I)I
    ...
    :cond_b
    invoke-virtual {v2, v13, v4}, LNf/j;->a(Ljava/lang/String;Z)Z
    ...
    :goto_5
    invoke-direct {v6, v0, v2}, Lm9/d;-><init>(Li9/a;Ljava/lang/String;)V

    :goto_6
    iput-object v6, v0, Li9/a;->f:Lm9/d;
    ...
    iget-object v7, v1, LZ8/e;->e:LZ8/b;

    invoke-direct {v0, v2, v6, v5, v7}, Li9/a;-><init>(LNf/j;Lf9/E4;LW8/a;LWg/b;)V
    ...
    :goto_8
    iput-object v0, v5, LU8/a;->b:Li9/a;

    iput-object v0, v1, LZ8/e;->f:Li9/a;
    ...
    iget-object v2, v1, LZ8/e;->o:LZ8/j;

    iget-object v5, v2, LZ8/j;->c:LZ8/e;

    iget-object v5, v5, LZ8/e;->b:LNf/j;

    invoke-virtual {v5, v3, v4}, LNf/j;->a(Ljava/lang/String;Z)Z

    move-result v3

    if-eqz v3, :cond_14

    iget-object v2, v2, LZ8/j;->b:Landroid/os/Handler;
    ...
    iget-object v1, v1, LZ8/j;->d:Lc9/a;

    iput-object v1, v0, Li9/a;->h:Lc9/a;
    ...
    invoke-static {v6, v0}, Lk9/a;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final c()I
    ...
    invoke-virtual {v2, v0, v3}, LNf/j;->b(Ljava/lang/String;I)I
    ...
    invoke-virtual {v2, v4, v5}, LNf/j;->b(Ljava/lang/String;I)I
    ...
    :cond_0
    iget-object v4, v1, LZ8/e;->l:Landroid/content/Context;

    const-string v5, "aivs_cloud_control"

    const-string v9, "link_mode"

    invoke-static {v4, v5, v9}, Ld9/b;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, v1, LZ8/e;->e:LZ8/b;

    invoke-virtual {v4, v9}, LZ8/b;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7, v5}, Lk9/a;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v6, v8}, LNf/j;->e(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v2, v6, v3}, LNf/j;->e(Ljava/lang/String;Z)V
    ...
    :cond_5
    iget-object v0, v1, LZ8/e;->e:LZ8/b;

    const-string v5, "xmd_ws_expire_at"

    invoke-virtual {v0, v5}, LZ8/b;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7, v0}, Lk9/a;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v5}, LZ8/b;->i(Ljava/lang/String;)V
...
.method public final d()V
    ...
    iget-object v0, p0, LZ8/e;->n:Lf9/E4;

    if-eqz v0, :cond_0

    iget-object v0, v0, Lf9/E4;->f:Lfc/a;
    ...
    iget-object p0, p0, LZ8/e;->n:Lf9/E4;

    iget-object p0, p0, Lf9/E4;->f:Lfc/a;
    ...
    invoke-static {v0, p0}, Lk9/a;->c(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public final e(LY8/b;)V
    .locals 1
