...
# direct methods
.method public static b(LZ8/d;J)V
    .locals 5
    ...
    :cond_0
    iget-object v2, p0, LZ8/d;->i:Ljava/util/concurrent/ScheduledFuture;
    ...
    sget-object v3, Lh9/b;->a:Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    :goto_0
    :try_start_0
    invoke-static {v0, p1, p2}, Lh9/b;->a(Ljava/lang/Runnable;J)Ljava/util/concurrent/ScheduledFuture;

    move-result-object p1

    iput-object p1, p0, LZ8/d;->i:Ljava/util/concurrent/ScheduledFuture;
    :try_end_0
...
.method public static c(LZ8/d;I)J
    .locals 6

    const-string v0, "cloud_config_last_request_time"

    invoke-virtual {p0, v0}, LZ8/d;->a(Ljava/lang/String;)J
    ...
    invoke-static {p1, v1}, Lk9/a;->b(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p0, p0, LZ8/d;->b:Landroid/content/Context;

    const-string p1, "aivs_cloud_control"

    invoke-static {p0, p1, v0}, Ld9/b;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    :goto_1
    return-wide v4
.end method

.method public static d(LZ8/d;)V
    .locals 6
    ...
    iget-object v2, p0, LZ8/d;->b:Landroid/content/Context;
    ...
    iget-object v3, p0, LZ8/d;->a:LZ8/e;
    ...
    invoke-virtual {v3, v5, v4}, LNf/j;->b(Ljava/lang/String;I)I
    ...
    iget-object v5, p0, LZ8/d;->d:Ljava/lang/String;
    ...
    iget-object v5, p0, LZ8/d;->e:Ljava/lang/String;

    invoke-virtual {v3, v4, v5}, Lokhttp3/HttpUrl$Builder;->addQueryParameter(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;

    const-string v4, "uid"

    iget-object v5, p0, LZ8/d;->f:Ljava/lang/String;
    ...
    :try_start_0
    iget-object v5, p0, LZ8/d;->g:Lokhttp3/OkHttpClient;
    ...
    invoke-static {v1, v5}, LJ6/t;->b(Ljava/lang/Object;Ljava/lang/String;)V

    iget-object v5, v2, LJ6/t;->b:La7/o;

    invoke-virtual {v5, v3}, La7/o;->k(Ljava/lang/reflect/Type;)LJ6/i;
    ...
    :try_start_1
    iget-object v5, v2, LJ6/t;->a:Lz6/d;

    invoke-virtual {v5, v1}, Lz6/d;->e(Ljava/lang/String;)Lz6/i;

    move-result-object v1

    invoke-virtual {v2, v3, v1}, LJ6/t;->d(LJ6/i;Lz6/i;)Ljava/lang/Object;

    move-result-object v1
    :try_end_1
    .catch Lz6/j; {:try_start_1 .. :try_end_1} :catch_2
    ...
    :goto_2
    invoke-static {v1}, LJ6/k;->g(Ljava/io/IOException;)LJ6/k;
    ...
    iget-object p0, p0, LZ8/d;->c:LZ8/c;
...
.method public final a(Ljava/lang/String;)J
    ...
    invoke-static {p0, v0, p1}, Ld9/b;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, p1, v3}, LA/N;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p1, p0}, Lk9/a;->c(Ljava/lang/String;Ljava/lang/String;)V
