...
.method static constructor <clinit>()V
    ...
    new-instance v8, Lz8/d$b;

    invoke-direct {v8}, Lz8/d$b;-><init>()V
    ...
    sput-object v0, Lz8/d;->a:Ljava/util/concurrent/ThreadPoolExecutor;

    new-instance v0, Ljava/util/LinkedHashSet;

    invoke-direct {v0}, Ljava/util/LinkedHashSet;-><init>()V

    sput-object v0, Lz8/d;->b:Ljava/util/LinkedHashSet;

    return-void
.end method

.method public static final a(Lz8/d$a;)Lvj/v;
    .locals 6

    iget-object v0, p0, Lz8/d$a;->g:Lokhttp3/OkHttpClient$Builder;
    ...
    iget-object v3, p0, Lz8/d$a;->b:Ljava/lang/Integer;
    ...
    invoke-direct {v2, v1}, LF8/c;-><init>(Ljava/util/Map;)V
    ...
    iget-object v1, v1, Lz8/d$a$a;->a:Ljava/io/File;
    ...
    :cond_4
    iget-object v1, p0, Lz8/d$a;->j:Ljava/util/List;
    ...
    :cond_5
    sget-object v1, LG8/a;->a:Lokhttp3/logging/HttpLoggingInterceptor$Logger;
    ...
    sget-object v1, Lz8/d;->a:Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    invoke-direct {v4, v2}, Lwj/g;-><init>(Lio/reactivex/Scheduler;)V

    invoke-direct {v3, v4}, LA8/a;-><init>(Lwj/g;)V

    new-instance v2, Lvj/v$b;

    invoke-direct {v2}, Lvj/v$b;-><init>()V

    iget-object v4, p0, Lz8/d$a;->i:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object v1, v2, Lvj/v$b;->f:Ljava/util/concurrent/ExecutorService;

    iget-object v1, v2, Lvj/v$b;->e:Ljava/util/ArrayList;
    ...
    invoke-direct {v3, v1}, Lxj/a;-><init>(Lcom/google/gson/Gson;)V

    move-object v1, v3

    :cond_7
    iget-object v3, v2, Lvj/v$b;->d:Ljava/util/ArrayList;

    invoke-virtual {v3, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object p0, p0, Lz8/d$a;->a:Ljava/lang/String;

    invoke-virtual {v2, p0}, Lvj/v$b;->a(Ljava/lang/String;)V
    ...
    iput-object p0, v2, Lvj/v$b;->b:Lokhttp3/Call$Factory;

    invoke-virtual {v2}, Lvj/v$b;->b()Lvj/v;
