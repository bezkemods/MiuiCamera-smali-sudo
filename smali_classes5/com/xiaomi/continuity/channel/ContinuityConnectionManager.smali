...
.field private mService:Ljc/f;


# direct methods
.method private constructor <init>(Ljc/f;Landroid/content/Context;)V
    .locals 1
    ...
    iput-object p1, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mService:Ljc/f;
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->addServiceListener(Ljc/b;)V

    return-void
.end method

.method public static synthetic access$002(Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;Ljc/f;)Ljc/f;
    .locals 0
...
.method private checkApiFeatureStatusChanged()Z
    ...
    invoke-static {p0, v0}, Ljc/i;->b(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;
    ...
    invoke-static {p0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->getSystemService(Landroid/content/Context;)Ljc/f;
    ...
    invoke-direct {v2, v1, p0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;-><init>(Ljc/f;Landroid/content/Context;)V
...
.method private declared-synchronized getService()Ljc/f;
    .locals 4

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mService:Ljc/f;
    ...
    invoke-static {v0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->getSystemService(Landroid/content/Context;)Ljc/f;

    move-result-object v0

    iput-object v0, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mService:Ljc/f;
    ...
    invoke-static {v1, v3, v2, v0}, Lmc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static getSystemService(Landroid/content/Context;)Ljc/f;
    .locals 9

    invoke-static {p0}, Ljc/d;->a(Landroid/content/Context;)Ljc/d;
    ...
    :try_start_0
    iget-object v5, p0, Ljc/d;->b:Ljc/e;

    new-instance v6, Ljc/c;

    invoke-direct {v6}, Ljava/lang/Object;-><init>()V

    invoke-virtual {v5, v6}, Lkc/d;->g(Ljc/c;)Lkc/d$a;
    ...
    iget-object v5, p0, Ljc/d;->d:Ljava/util/ArrayList;

    monitor-enter v5

    :try_start_1
    iget-object v3, p0, Ljc/d;->d:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Ljc/d;->d:Ljava/util/ArrayList;
    ...
    :cond_3
    new-instance p0, Ljc/f$a$a;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object v4, p0, Ljc/f$a$a;->a:Landroid/os/IBinder;
    ...
    invoke-static {v0, v2, v1, p0}, Lmc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
# virtual methods
.method public addServiceListener(Ljc/b;)V
    .locals 0
...
.method public confirmChannel(IILcom/xiaomi/continuity/channel/ChannelConfirmOptions;)I
    ...
    invoke-direct {p0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->getService()Ljc/f;
    ...
    invoke-interface {v0, p1, p2, p3}, Ljc/f;->i0(IILcom/xiaomi/continuity/channel/ChannelConfirmOptions;)V
    ...
    invoke-interface {v0, p1, p2, p0}, Ljc/f;->U(IILjava/lang/String;)V

    goto :goto_0

    :cond_1
    invoke-interface {v0, p1, p2}, Ljc/f;->Q(II)V
    ...
    invoke-static {v1, p2, p0, p1}, Lmc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    ...
    invoke-static {v1, p0, p2, p1}, Lmc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public createChannel(Lcom/xiaomi/continuity/netbus/LinkAddress;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ChannelInnerListener;Ljava/util/concurrent/Executor;)I
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0, p5}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->addServiceListener(Ljc/b;)V
    ...
    invoke-interface/range {v1 .. v6}, Ljc/f;->u(Ljava/lang/String;Lcom/xiaomi/continuity/netbus/LinkAddress;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$c;)I
    ...
    invoke-interface/range {v1 .. v6}, Ljc/f;->z(Ljava/lang/String;Lcom/xiaomi/continuity/netbus/LinkAddress;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptions;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$c;)I
    ...
    invoke-static {p3, p1, p4, p2}, Lmc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 3
    invoke-virtual {p0, p5}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->removeServiceListener(Ljc/b;)V
...
.method public createChannel(Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ChannelInnerListener;Ljava/util/concurrent/Executor;)I
    ...
    invoke-interface/range {v1 .. v6}, Ljc/f;->a(Ljava/lang/String;Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$b;)I
    ...
    invoke-interface/range {v1 .. v6}, Ljc/f;->F(Ljava/lang/String;Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptions;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$b;)I
...
.method public destroyChannel(I)I
    ...
    :try_start_0
    invoke-interface {p0, p1}, Ljc/f;->D(I)V
    ...
    invoke-static {v1, v3, p0, p1}, Lmc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v1, p0, v2, p1}, Lmc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public getApiFeature()Ljava/lang/String;
    ...
    :try_start_0
    invoke-interface {v0}, Ljc/f;->i()Ljava/lang/String;
...
.method public getChannelInfoExt(II)Landroid/os/Bundle;
    ...
    :try_start_0
    invoke-interface {p0, p1, p2}, Ljc/f;->f0(II)Landroid/os/Bundle;
    ...
    invoke-static {p2, p0, v0, p1}, Lmc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public notifyChannelServerConnected(Lcom/xiaomi/continuity/ServiceName;I)V
    ...
    invoke-static {p0, v3}, Ljc/i;->b(Ljava/lang/String;Ljava/lang/String;)Z

    move-result p0

    if-eqz p0, :cond_1

    invoke-interface {v0, p1, p2}, Ljc/f;->k(Lcom/xiaomi/continuity/ServiceName;I)V
    ...
    invoke-static {v2, p2, p0, p1}, Lmc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v2, p0, p2, p1}, Lmc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public notifyChannelServerCreateFailed(I)V
    ...
    :try_start_0
    invoke-interface {p0, p1, v1}, Ljc/f;->b0(II)V
    ...
    invoke-static {v0, v2, p0, p1}, Lmc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v0, p0, v1, p1}, Lmc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public notifyChannelServerCreated(II)V
    ...
    :try_start_0
    invoke-interface {p0, p1, p2}, Ljc/f;->b0(II)V
    ...
    invoke-static {v2, v0, p0, p1}, Lmc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v2, v0, p2, v1}, Lmc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public registerChannelListener(Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ServerChannelOptions;Lcom/xiaomi/continuity/channel/ChannelInnerListener;Ljava/util/concurrent/Executor;)I
    ...
    invoke-virtual {p0, v1}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->addServiceListener(Ljc/b;)V
    ...
    invoke-interface {v0, p3, p1, p2, v1}, Ljc/f;->N(Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ServerChannelOptions;Lcom/xiaomi/continuity/channel/a;)I
    ...
    invoke-virtual {p0, v1}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->removeServiceListener(Ljc/b;)V
    ...
    invoke-static {p2, p0, p3, p1}, Lmc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public removeServiceListener(Ljc/b;)V
    .locals 0
...
.method public send(I[BLandroid/os/Bundle;Lcom/xiaomi/continuity/channel/SendResultCallback;Ljava/util/concurrent/Executor;)I
    ...
    invoke-interface {p0, p1, p2, p3, v3}, Ljc/f;->w(I[BLandroid/os/Bundle;Lcom/xiaomi/continuity/channel/f;)I
...
.method public unbindService()V
    ...
    invoke-static {v0}, Ljc/d;->a(Landroid/content/Context;)Ljc/d;

    move-result-object v0

    const-string v1, "continuity_connection"

    iget-object v2, v0, Ljc/d;->d:Ljava/util/ArrayList;

    monitor-enter v2

    :try_start_0
    iget-object v3, v0, Ljc/d;->d:Ljava/util/ArrayList;
    ...
    :cond_0
    :goto_0
    iget-object v1, v0, Ljc/d;->d:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Ljc/d;->b:Ljc/e;

    iput-boolean v3, v0, Lkc/d;->m:Z

    iget-object v1, v0, Lkc/d;->h:Landroid/os/Handler;

    new-instance v3, LA/W2;

    const/16 v4, 0x1a

    invoke-direct {v3, v0, v4}, LA/W2;-><init>(Ljava/lang/Object;I)V
...
.method public unregisterChannelListener(Lcom/xiaomi/continuity/ServiceName;)I
    ...
    invoke-virtual {p0, v3}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->removeServiceListener(Ljc/b;)V
    ...
    invoke-interface {p0, p1}, Ljc/f;->n0(Lcom/xiaomi/continuity/ServiceName;)I
    ...
    invoke-static {p0, v4, p1, v3}, Lmc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
