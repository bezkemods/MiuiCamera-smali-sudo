...
.method private static dumpImage(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;LP9/o;Ljava/lang/String;)V
    .locals 2
    ...
    iget-object p1, p1, LP9/o;->W:Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2}, Lr9/e;->d(Landroid/media/Image;Ljava/lang/String;Ljava/lang/String;)Z

    :cond_0
    return-void
.end method

.method private getParallelTaskData(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;ZLjava/lang/String;)LP9/o;
    .locals 11
    ...
    invoke-static {v0, v1, v2, p2}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->getParallelTaskData(Ljava/lang/String;JZ)LP9/o;
    ...
    invoke-virtual {v0, v1, v3}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->readParallelTaskDataFromSmallJpeg(Landroid/content/Context;Ljava/lang/String;)LP9/o;
    ...
    invoke-static {p0}, Ll4/C;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p0, v0, LP9/o;->h:Landroid/hardware/camera2/TotalCaptureResult;

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getPictureName()Ljava/lang/String;

    move-result-object p0

    iput-object p0, v0, LP9/o;->W:Ljava/lang/String;

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getFrameNumber()J

    move-result-wide v5

    iput-wide v5, v0, LP9/o;->b0:J

    new-instance p0, LP9/p;

    invoke-direct {p0}, LP9/p;-><init>()V

    new-instance p2, Lv9/f;

    invoke-direct {p2}, Lv9/f;-><init>()V

    iput-object p2, p0, LP9/p;->M:Lv9/f;

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getOutputSize()Landroid/util/Size;

    move-result-object p1

    iput-object p1, p0, LP9/p;->I:Landroid/util/Size;

    iput-object p0, v0, LP9/o;->r:LP9/p;

    iput-boolean v1, v0, LP9/o;->m0:Z
...
.method private initReprocessProxy(LP9/o;ZLjava/lang/String;)V
    .locals 2
    ...
    invoke-static {p3, p0}, Landroidx/concurrent/futures/a;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p3, p1}, Landroidx/concurrent/futures/a;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private lambda$startReprocessLoop$1()V
    ...
    invoke-static {v6, v7}, Lo0/b;->H(ILjava/lang/String;)V
    ...
    :goto_2
    invoke-direct {p0, v3, v5, v4}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->getParallelTaskData(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;ZLjava/lang/String;)LP9/o;
    ...
    iput v7, v5, LP9/o;->v0:I

    invoke-virtual {v3, v5}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->setParallelTaskData(LP9/o;)V
    ...
    sget-boolean v7, Lr9/e;->d:Z

    if-eqz v7, :cond_8

    const-string v7, "algo_done"

    invoke-static {v3, v5, v7}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->dumpImage(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;LP9/o;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v5, v6, v4}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->initReprocessProxy(LP9/o;ZLjava/lang/String;)V
