...
.method private createParallelTaskData(Landroid/content/Context;Lorg/json/JSONObject;)LP9/o;
    .locals 3

    :try_start_0
    const-class v0, LP9/o;
...
.method private dataToJsonRecursiveCallCheck(Ljava/util/ArrayList;Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-static {v4, p1}, LA3/H2;->f(ILjava/util/ArrayList;)Ljava/lang/Object;
...
.method private generateJpegWithXmp([BLcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter$ParallelItem;)[B
    ...
    :try_start_0
    iget-object v6, v3, Lhb/b;->a:Ljava/util/HashMap;
    ...
    invoke-virtual {v1, v4, v5, v6}, Li/l;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :cond_0
    :goto_0
    invoke-static {v3, p1, v1}, Lk6/b;->e(Ljava/io/ByteArrayInputStream;Ljava/io/ByteArrayOutputStream;Lh/d;)V
    ...
    :try_start_a
    iget-object p2, p1, Lhb/b;->a:Ljava/util/HashMap;
...
.method private getThumbnailPath(Landroid/content/Context;Ljava/lang/String;)Ljava/nio/file/Path;
    ...
    invoke-static {p2}, Lo0/b;->G(Ljava/lang/String;)Lm0/b;
...
.method private parallelTaskDataToBytes(LP9/o;)[B
    .locals 8
...
.method private stringToParallelTaskData(Landroid/content/Context;Ljava/lang/String;)LP9/o;
    .locals 6
    ...
    invoke-direct {p0, p1, p2}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->createParallelTaskData(Landroid/content/Context;Lorg/json/JSONObject;)LP9/o;
...
.method private valueToString(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    invoke-static {v0, p1, v2, p0}, LA/N;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v4, v5, v3, v2}, LA/P;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v3, v0, v2, p0}, LA/N;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p1, v0, p2, v2}, LA/P;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public combineParallelTaskDataToSmallJpeg([BLjava/lang/String;J)[B
    ...
    invoke-static {p2, p3, p4, v1}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->getParallelTaskData(Ljava/lang/String;JZ)LP9/o;

    move-result-object p2

    if-eqz p2, :cond_5

    iget-boolean p3, p2, LP9/o;->m0:Z
    ...
    :cond_1
    invoke-virtual {p0, p2, v1}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->convertTaskDataItem(LP9/o;Z)Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter$ParallelItem;
...
.method public convertTaskDataItem(LP9/o;Z)Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter$ParallelItem;
    .locals 12
    ...
    :cond_0
    iget-object v4, p1, LP9/o;->W:Ljava/lang/String;

    iget-wide v8, p1, LP9/o;->b0:J
    ...
    invoke-static {v10, p2}, LA/O;->b(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->parallelTaskDataToBytes(LP9/o;)[B
    ...
    invoke-static {v10, p1}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter$ParallelItem;->e(Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter$ParallelItem;Li/l;)V
    ...
    invoke-virtual {p1, v3, v6, v11}, Li/l;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
...
.method public getCacheSizeInfo()Ljava/lang/String;
    ...
    invoke-static {p0, v0, v1, v2, v3}, LA/X;->g(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public readParallelTaskDataFromSmallJpeg(Landroid/content/Context;Ljava/lang/String;)LP9/o;
    .locals 7

    const-string v0, "read parallel task data from small jpeg, pictureName: "

    invoke-static {v0, p2}, LA/N2;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v2, v6, p2}, LA/P;->f(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v6, p2, Lk6/b$b;->a:Ljava/lang/String;

    filled-new-array {p2}, [Lk6/b$b;

    move-result-object v6

    invoke-static {v0, v6}, Lk6/b;->a(Ljava/io/FileInputStream;[Lk6/b$b;)V

    iget-object p2, p2, Lk6/b$b;->d:[B
    :try_end_1
    ...
    invoke-direct {p0, p1, p2}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->stringToParallelTaskData(Landroid/content/Context;Ljava/lang/String;)LP9/o;
