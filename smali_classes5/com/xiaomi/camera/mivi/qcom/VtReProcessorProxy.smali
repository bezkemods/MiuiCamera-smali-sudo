...
.method private execute(Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getParallelTaskData()LP9/o;
    ...
    invoke-static {v8, v9, v7}, LA/M;->g(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {v8, v10}, Lr9/a;->a(Landroid/hardware/camera2/CaptureResult;Ljava/lang/String;)Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v9, v2, LP9/o;->r:LP9/p;

    iget-boolean v9, v9, LP9/p;->A:Z

    if-eqz v9, :cond_4

    const-string v9, "process[2]: setRotateOrientationToZero true"

    invoke-static {v1, v9}, Landroidx/concurrent/futures/a;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v10, v2, LP9/o;->r:LP9/p;

    iget-boolean v10, v10, LP9/p;->Z:Z

    if-eqz v10, :cond_6

    const-string v10, "process[3]: setOrientation "

    invoke-static {v1, v10}, LA3/H2;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-object v12, v2, LP9/o;->r:LP9/p;

    iget v12, v12, LP9/p;->w:I
