...
.method public static synthetic a(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;LP9/o;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->lambda$getParallelTaskSize$0(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;LP9/o;)V
...
.method private doJpeg(LP9/o;Landroid/media/Image;I)V
    .locals 9
    ...
    invoke-static {v1, v2, p3}, LA/M;->g(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->generateReprocessData(LP9/o;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
...
.method private generateReprocessData(LP9/o;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    .locals 18
    ...
    invoke-static {v2, v4}, Lr9/a;->a(Landroid/hardware/camera2/CaptureResult;Ljava/lang/String;)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v7

    iget-boolean v8, v13, LP9/p;->G:Z

    iget-object v2, v13, LP9/p;->I:Landroid/util/Size;
    ...
    iget-object v4, v1, LP9/o;->K:Landroid/media/Image;
    ...
    :cond_1
    iget-boolean v2, v13, LP9/p;->Z:Z

    if-eqz v2, :cond_2

    iget v2, v13, LP9/p;->w:I

    invoke-virtual {v14, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setOrientation(I)V

    :cond_2
    iget-byte v2, v13, LP9/p;->a0:B

    invoke-virtual {v14, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setSiqeType(B)V

    iget-object v2, v13, LP9/p;->j:Landroid/util/Size;

    invoke-virtual {v2}, Landroid/util/Size;->getWidth()I

    move-result v2

    iget-object v3, v13, LP9/p;->j:Landroid/util/Size;
...
.method private handTimeoutTask(J)V
    ...
    invoke-static {p1, p2, v1, v2}, LA/l2;->c(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method private handleDataBeanIfReady(Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;Z)V
    ...
    invoke-virtual {p2, v0}, LL3/l;->c(Ljava/lang/String;)J

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;->getTimestamp()J

    move-result-wide v0

    invoke-virtual {p0, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->getParallelTaskData(J)LP9/o;
    ...
    :cond_1
    iget-wide v0, p2, LP9/o;->b0:J

    iget-object v2, p2, LP9/o;->W:Ljava/lang/String;

    iget-wide v3, p2, LP9/o;->e:J
    ...
    invoke-static {v0}, Lr9/e;->h(Landroid/media/Image;)[B
    ...
    invoke-virtual {p2, v1, v0}, LP9/o;->a(I[B)V
    ...
    invoke-static {v1, v2, v3}, LA/M;->g(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iput-object v0, p2, LP9/o;->K:Landroid/media/Image;
    ...
    invoke-direct {p0, v2, p2, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->postCvWaterMark(Landroid/media/Image;LP9/o;I)V
    ...
    invoke-direct {p0, p2, v1, v2}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->doJpeg(LP9/o;Landroid/media/Image;I)V
...
.method private handleRawImageData([BLjava/lang/String;)V
    ...
    invoke-virtual {p0, p2, p1}, LP9/o;->a(I[B)V
    ...
    invoke-static {p0, p1}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->notifyFinish(LP9/o;Ljava/lang/String;)V
...
.method private static synthetic lambda$getParallelTaskSize$0(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;LP9/o;)V
    .locals 0

    invoke-virtual {p2}, LP9/o;->c()I
...
.method private postCvWaterMark(Landroid/media/Image;LP9/o;I)V
    .locals 4
    ...
    invoke-static {p1, v2}, Lr9/e;->g(Landroid/media/Image;Z)[B

    move-result-object v2

    const-string v3, ""

    invoke-static {p3, v3}, Landroidx/concurrent/futures/a;->e(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, v3, p1}, LA/W;->a(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {p1, p2, p3}, LA/M;->g(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
...
.method public getParallelTaskData(J)LP9/o;
    .locals 3
...
.method public getParallelTaskSize()Ljava/lang/String;
    ...
    invoke-direct {v4, v1, v5}, LI2/C;-><init>(Ljava/lang/Object;I)V
...
.method public putParallelTaskData(JLP9/o;)V
    .locals 5
