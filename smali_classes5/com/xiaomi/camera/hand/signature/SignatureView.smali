...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v4, LDa/c;->SignatureView:[I

    invoke-virtual {p1, p2, v4}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, LDa/c;->SignatureView_sv_hint_text_size:I
    ...
    sget p2, LDa/c;->SignatureView_sv_hint_text_color:I
    ...
    sget p2, LDa/c;->SignatureView_sv_hint_text:I
    ...
    invoke-static {p1}, LA3/s2;->n(Landroid/content/Context;)Z
    ...
    invoke-static {p2, v1}, LA3/s2;->g(Landroid/content/Context;I)I
    ...
    iput-object v1, p1, LFa/b;->a:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p1, LFa/b;->b:Ljava/util/ArrayList;

    new-instance v1, LEa/a;

    const/4 v2, 0x0

    invoke-direct {v1, v2, v2}, LEa/a;-><init>(FF)V

    iput-object v1, p1, LFa/b;->f:LEa/a;
    ...
    iput-object v2, v1, LFa/a;->a:LEa/a;

    new-instance v2, LEa/a;

    invoke-direct {v2}, LEa/a;-><init>()V

    iput-object v2, v1, LFa/a;->b:LEa/a;

    new-instance v2, LEa/a;

    invoke-direct {v2}, LEa/a;-><init>()V

    iput-object v2, v1, LFa/a;->c:LEa/a;

    new-instance v2, LEa/a;

    invoke-direct {v2}, LEa/a;-><init>()V

    iput-object v2, v1, LFa/a;->d:LEa/a;

    iput-object v1, p1, LFa/b;->g:LFa/a;

    iput v0, p1, LFa/b;->j:I
    ...
    :cond_1
    iput-object p2, p1, LFa/b;->c:Landroid/graphics/Paint;

    invoke-virtual {p2}, Landroid/graphics/Paint;->getStrokeWidth()F

    move-result p2

    iput p2, p1, LFa/b;->d:F

    new-instance p2, Landroid/graphics/RectF;

    invoke-direct {p2}, Landroid/graphics/RectF;-><init>()V

    iput-object p2, p1, LFa/b;->k:Landroid/graphics/RectF;

    iput-object p1, p0, Lcom/xiaomi/camera/hand/signature/SignatureView;->d:LFa/b;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p2

    iput-object p2, p1, LFa/b;->h:Landroid/content/Context;

    invoke-virtual {p0}, Landroid/view/View;->getResources()Landroid/content/res/Resources;

    move-result-object p1

    sget p2, LDa/b;->signature_dialog_signature_view_height:I
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/xiaomi/camera/hand/signature/SignatureView;->p:LDa/e;

    if-eqz v0, :cond_3

    invoke-interface {v0}, LDa/e;->b()V
    ...
    iget-object p1, p0, Lcom/xiaomi/camera/hand/signature/SignatureView;->d:LFa/b;

    iget-object p1, p1, LFa/b;->b:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Lcom/xiaomi/camera/hand/signature/SignatureView;->p:LDa/e;

    if-eqz p1, :cond_5

    invoke-interface {p1}, LDa/e;->a()V
    ...
    invoke-virtual {p1, p0}, LFa/b;->a(Landroid/graphics/Canvas;)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v1, v0, Lcom/xiaomi/camera/hand/signature/SignatureView;->d:LFa/b;
    ...
    iput v7, v5, LEa/b;->a:F

    iput v8, v5, LEa/b;->b:F

    iput-wide v9, v5, LEa/b;->c:J

    iget-object v11, v1, LFa/b;->a:Ljava/util/ArrayList;

    invoke-virtual {v11, v5}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v12, v1, LFa/b;->b:Ljava/util/ArrayList;

    iget-object v13, v1, LFa/b;->g:LFa/a;
    ...
    iget-object v2, v1, LFa/b;->f:LEa/a;

    iget-wide v3, v2, LEa/a;->d:J
    ...
    invoke-direct {v3, v4, v8}, LEa/a;-><init>(FF)V

    iput-wide v9, v3, LEa/a;->d:J

    iget v5, v2, LEa/a;->a:F

    sub-float/2addr v4, v5

    float-to-double v4, v4

    iget v2, v2, LEa/a;->b:F
    ...
    iput-wide v8, v1, LFa/b;->i:D

    iget v2, v1, LFa/b;->d:F
    ...
    iput v2, v3, LEa/a;->c:F

    invoke-virtual {v13}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget v2, v3, LEa/a;->a:F

    iget v6, v3, LEa/a;->b:F

    iget v7, v3, LEa/a;->c:F

    iget-object v8, v13, LFa/a;->a:LEa/a;

    iget-object v9, v13, LFa/a;->c:LEa/a;

    invoke-virtual {v8}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget v10, v9, LEa/a;->a:F

    iget v11, v9, LEa/a;->b:F

    iget v15, v9, LEa/a;->c:F

    invoke-virtual {v8, v10, v11, v15}, LEa/a;->a(FFF)V

    iget-object v8, v13, LFa/a;->b:LEa/a;

    iget-object v10, v13, LFa/a;->d:LEa/a;

    invoke-virtual {v8}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget v11, v10, LEa/a;->a:F

    iget v15, v10, LEa/a;->b:F

    iget v14, v10, LEa/a;->c:F

    invoke-virtual {v8, v11, v15, v14}, LEa/a;->a(FFF)V

    iget v8, v10, LEa/a;->a:F

    invoke-static {v8, v2}, LFa/a;->a(FF)F

    move-result v8

    iget v11, v10, LEa/a;->b:F

    invoke-static {v11, v6}, LFa/a;->a(FF)F

    move-result v11

    iget v14, v10, LEa/a;->c:F

    invoke-static {v14, v7}, LFa/a;->a(FF)F

    move-result v14

    invoke-virtual {v9, v8, v11, v14}, LEa/a;->a(FFF)V

    invoke-virtual {v10, v2, v6, v7}, LEa/a;->a(FFF)V
    ...
    invoke-virtual {v13, v6, v7}, LFa/a;->b(D)LEa/a;
    ...
    :cond_2
    iput-object v3, v1, LFa/b;->f:LEa/a;
    ...
    iget v8, v4, LEa/b;->a:F

    iget v9, v6, LEa/b;->a:F

    cmpl-float v8, v8, v9

    if-nez v8, :cond_5

    iget v8, v4, LEa/b;->b:F

    iget v9, v6, LEa/b;->b:F
    ...
    :cond_5
    :goto_2
    iget v7, v4, LEa/b;->a:F

    iget v8, v6, LEa/b;->a:F
    ...
    iget v4, v4, LEa/b;->b:F

    iget v6, v6, LEa/b;->b:F
    ...
    iget-object v11, v1, LFa/b;->h:Landroid/content/Context;

    const/4 v14, 0x7

    invoke-static {v11, v14}, LA3/s2;->g(Landroid/content/Context;I)I

    move-result v11

    int-to-float v11, v11

    iget-object v14, v1, LFa/b;->f:LEa/a;

    iget v14, v14, LEa/a;->c:F

    iget v15, v1, LFa/b;->d:F
    ...
    :goto_6
    iget-object v3, v1, LFa/b;->f:LEa/a;

    iget v3, v3, LEa/a;->c:F
    ...
    iget-object v4, v6, LFa/a;->a:LEa/a;

    iget-object v8, v6, LFa/a;->c:LEa/a;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget v9, v8, LEa/a;->a:F

    iget v10, v8, LEa/a;->b:F

    iget v12, v8, LEa/a;->c:F

    invoke-virtual {v4, v9, v10, v12}, LEa/a;->a(FFF)V

    iget-object v4, v6, LFa/a;->b:LEa/a;

    iget-object v9, v6, LFa/a;->d:LEa/a;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget v10, v9, LEa/a;->a:F

    iget v12, v9, LEa/a;->b:F

    iget v13, v9, LEa/a;->c:F

    invoke-virtual {v4, v10, v12, v13}, LEa/a;->a(FFF)V

    iget v4, v9, LEa/a;->a:F

    invoke-static {v4, v7}, LFa/a;->a(FF)F

    move-result v4

    iget v10, v9, LEa/a;->b:F

    invoke-static {v10, v5}, LFa/a;->a(FF)F

    move-result v10

    invoke-virtual {v8, v4, v10, v3}, LEa/a;->a(FFF)V

    invoke-virtual {v9, v7, v5, v3}, LEa/a;->a(FFF)V
    ...
    invoke-virtual {v6, v7, v8}, LFa/a;->b(D)LEa/a;
    ...
    :cond_f
    invoke-virtual {v1, v2}, LFa/b;->a(Landroid/graphics/Canvas;)V

    iget-object v1, v1, LFa/b;->b:Ljava/util/ArrayList;
    ...
    iput v4, v1, LFa/b;->j:I

    invoke-virtual {v11}, Ljava/util/ArrayList;->clear()V

    new-instance v2, LEa/a;

    iget v4, v1, LFa/b;->d:F

    invoke-direct {v2, v3, v8, v4}, LEa/a;-><init>(FFF)V

    iput-wide v9, v2, LEa/a;->d:J

    iput-object v2, v1, LFa/b;->e:LEa/a;

    iput-object v2, v1, LFa/b;->f:LEa/a;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget v3, v2, LEa/a;->a:F

    iget v4, v2, LEa/a;->b:F

    iget v2, v2, LEa/a;->c:F

    iget-object v5, v6, LFa/a;->a:LEa/a;

    invoke-virtual {v5, v3, v4, v2}, LEa/a;->a(FFF)V

    invoke-static {v3, v3}, LFa/a;->a(FF)F

    move-result v5

    invoke-static {v4, v4}, LFa/a;->a(FF)F

    move-result v7

    invoke-static {v2, v2}, LFa/a;->a(FF)F

    move-result v8

    iget-object v9, v6, LFa/a;->c:LEa/a;

    invoke-virtual {v9, v5, v7, v8}, LEa/a;->a(FFF)V

    invoke-static {v3, v5}, LFa/a;->a(FF)F
    ...
    invoke-static {v2, v8}, LFa/a;->a(FF)F

    move-result v8

    iget-object v9, v6, LFa/a;->b:LEa/a;

    invoke-virtual {v9, v5, v7, v8}, LEa/a;->a(FFF)V

    iget-object v5, v6, LFa/a;->d:LEa/a;

    invoke-virtual {v5, v3, v4, v2}, LEa/a;->a(FFF)V

    const-wide/16 v2, 0x0

    iput-wide v2, v1, LFa/b;->i:D
...
.method public setPenSize(F)V
    ...
    :cond_1
    iput-object p0, p1, LFa/b;->c:Landroid/graphics/Paint;

    invoke-virtual {p0}, Landroid/graphics/Paint;->getStrokeWidth()F

    move-result p0

    iput p0, p1, LFa/b;->d:F

    return-void
.end method

.method public setSignatureStateListener(LDa/e;)V
    .locals 0

    iput-object p1, p0, Lcom/xiaomi/camera/hand/signature/SignatureView;->p:LDa/e;
