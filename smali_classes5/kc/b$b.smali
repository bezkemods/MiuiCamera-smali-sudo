...
# direct methods
.method public constructor <init>(Lkc/b;Ljava/util/concurrent/CompletionStage;Ljava/util/function/BiFunction;)V
    .locals 1
    ...
    iput-object v0, p0, Lkc/b$b;->g:Ljava/lang/Object;

    invoke-static {p2}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    iput-object p2, p0, Lkc/b$b;->h:Ljava/util/concurrent/CompletionStage;

    invoke-static {p3}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    iput-object p3, p0, Lkc/b$b;->i:Ljava/util/function/BiFunction;

    invoke-virtual {p1, p0}, Lkc/b;->whenComplete(Ljava/util/function/BiConsumer;)Ljava/util/concurrent/CompletableFuture;
...
.method public final h(Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    :cond_0
    iget-object p2, p0, Lkc/b$b;->h:Ljava/util/concurrent/CompletionStage;

    if-eqz p2, :cond_1

    iput-object p1, p0, Lkc/b$b;->g:Ljava/lang/Object;

    iget-object p1, p0, Lkc/b$b;->h:Ljava/util/concurrent/CompletionStage;

    new-instance p2, Lh2/d;

    const/4 v0, 0x1

    invoke-direct {p2, p0, v0}, Lh2/d;-><init>(Ljava/lang/Object;I)V
    ...
    :cond_1
    :try_start_0
    iget-object p2, p0, Lkc/b$b;->i:Ljava/util/function/BiFunction;

    iget-object v0, p0, Lkc/b$b;->g:Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lkc/b;->completeExceptionally(Ljava/lang/Throwable;)Z
