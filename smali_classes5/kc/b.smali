...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkc/b;->e:Landroidx/profileinstaller/b;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lkc/b;->a:Ljava/lang/Object;

    sget-object v0, Lkc/b;->e:Landroidx/profileinstaller/b;

    iput-object v0, p0, Lkc/b;->c:Ljava/util/concurrent/Executor;

    sget-object v0, Lkc/b;->f:Landroid/os/Handler;
    ...
    sput-object v0, Lkc/b;->f:Landroid/os/Handler;

    :cond_0
    sget-object v0, Lkc/b;->f:Landroid/os/Handler;

    iput-object v0, p0, Lkc/b;->d:Landroid/os/Handler;
...
.method public static b(Ljava/util/function/BiConsumer;Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-static {p1, p2}, LA/m2;->e(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, p0, p1, p2}, Lmc/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public c(Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lkc/b;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lkc/b;->b:Ljava/util/function/BiConsumer;

    const/4 v2, 0x0

    iput-object v2, p0, Lkc/b;->b:Ljava/util/function/BiConsumer;
    ...
    iget-object p0, p0, Lkc/b;->c:Ljava/util/concurrent/Executor;

    sget-object v0, Lkc/b;->e:Landroidx/profileinstaller/b;

    if-ne p0, v0, :cond_0

    invoke-static {v1, p1, p2}, Lkc/b;->b(Ljava/util/function/BiConsumer;Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, v2, p2, v1, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/l;-><init>(ILjava/io/Serializable;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public cancel(Z)Z
    ...
    invoke-virtual {p0, v1, v0}, Lkc/b;->c(Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method public final complete(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1, v1}, Lkc/b;->c(Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method public final completeExceptionally(Ljava/lang/Throwable;)Z
    ...
    invoke-virtual {p0, v1, p1}, Lkc/b;->c(Ljava/lang/Object;Ljava/lang/Throwable;)V
...
.method public final e(Ljava/util/function/Function;)Lkc/b$a;
    .locals 2
    ...
    invoke-direct {v1, p0, p1, v0}, Lkc/b$a;-><init>(Lkc/b;Ljava/util/function/Function;Ljava/util/concurrent/Executor;)V

    return-object v1
.end method

.method public final f(Ljava/util/function/Function;)Lkc/b$c;
    .locals 2

    sget-object v0, Lkc/b;->e:Landroidx/profileinstaller/b;

    new-instance v1, Lkc/b$c;

    invoke-direct {v1, p0, p1, v0}, Lkc/b$c;-><init>(Lkc/b;Ljava/util/function/Function;Ljava/util/concurrent/Executor;)V
...
.method public final g(Ljava/util/function/BiConsumer;Ljava/util/concurrent/Executor;)V
    ...
    iget-object v2, p0, Lkc/b;->c:Ljava/util/concurrent/Executor;
    ...
    :cond_0
    iput-object p2, p0, Lkc/b;->c:Ljava/util/concurrent/Executor;
    ...
    invoke-direct {p2, v1, p1}, Lkc/a;-><init>(Ljava/util/function/BiConsumer;Ljava/util/function/BiConsumer;)V

    move-object p1, p2

    :goto_0
    iput-object p1, p0, Lkc/b;->b:Ljava/util/function/BiConsumer;
    ...
    sget-object v1, Lkc/b;->e:Landroidx/profileinstaller/b;

    if-ne p0, v1, :cond_3

    invoke-static {p1, p2, v0}, Lkc/b;->b(Ljava/util/function/BiConsumer;Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v1, v2, v0, p1, p2}, Lcom/android/camera2/compat/theme/custom/mm/top/l;-><init>(ILjava/io/Serializable;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public bridge synthetic orTimeout(JLjava/util/concurrent/TimeUnit;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lkc/b;->d(JLjava/util/concurrent/TimeUnit;)V
...
.method public bridge synthetic thenApply(Ljava/util/function/Function;)Ljava/util/concurrent/CompletableFuture;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lkc/b;->e(Ljava/util/function/Function;)Lkc/b$a;
...
.method public thenApplyAsync(Ljava/util/function/Function;Ljava/util/concurrent/Executor;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-direct {v0, p0, p1, p2}, Lkc/b$a;-><init>(Lkc/b;Ljava/util/function/Function;Ljava/util/concurrent/Executor;)V
...
.method public thenCombine(Ljava/util/concurrent/CompletionStage;Ljava/util/function/BiFunction;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-direct {v0, p0, p1, p2}, Lkc/b$b;-><init>(Lkc/b;Ljava/util/concurrent/CompletionStage;Ljava/util/function/BiFunction;)V
...
.method public bridge synthetic thenCompose(Ljava/util/function/Function;)Ljava/util/concurrent/CompletableFuture;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lkc/b;->f(Ljava/util/function/Function;)Lkc/b$c;
...
.method public thenComposeAsync(Ljava/util/function/Function;Ljava/util/concurrent/Executor;)Ljava/util/concurrent/CompletableFuture;
    ...
    .line 1
    new-instance v0, Lkc/b$c;

    invoke-direct {v0, p0, p1, p2}, Lkc/b$c;-><init>(Lkc/b;Ljava/util/function/Function;Ljava/util/concurrent/Executor;)V
...
.method public whenComplete(Ljava/util/function/BiConsumer;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-virtual {p0, p1, v0}, Lkc/b;->g(Ljava/util/function/BiConsumer;Ljava/util/concurrent/Executor;)V
...
.method public bridge synthetic whenCompleteAsync(Ljava/util/function/BiConsumer;Ljava/util/concurrent/Executor;)Ljava/util/concurrent/CompletableFuture;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Lkc/b;->g(Ljava/util/function/BiConsumer;Ljava/util/concurrent/Executor;)V
