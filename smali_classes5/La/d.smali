...
.method public constructor <init>(Landroid/media/MediaFormat;Landroid/opengl/EGLContext;JJLjava/util/concurrent/LinkedBlockingQueue;Ljava/util/concurrent/ArrayBlockingQueue;)V
    ...
    invoke-direct/range {v0 .. v6}, LLa/c;-><init>(Landroid/media/MediaFormat;JJLjava/util/concurrent/LinkedBlockingQueue;)V

    const/high16 p1, 0x7f800000    # Float.POSITIVE_INFINITY

    iput p1, p0, LLa/d;->G:F
    ...
    iput-object p2, p0, LLa/d;->C:Landroid/opengl/EGLContext;
    ...
    iput p1, p0, LLa/d;->z:I

    iput-object p8, p0, LLa/d;->E:Ljava/util/concurrent/ArrayBlockingQueue;

    iget-object p1, p0, LLa/c;->b:Landroid/media/MediaFormat;

    invoke-virtual {p0, p1}, LLa/d;->y(Landroid/media/MediaFormat;)V

    const/4 p1, 0x1

    iput-boolean p1, p0, LLa/c;->o:Z
...
.method public final A()V
    ...
    iget-object v6, p0, LLa/d;->F:Landroid/view/Surface;

    iget v7, p0, LLa/d;->y:I

    iget v8, p0, LLa/d;->z:I

    const-string v4, "CircularVideoEncoderWM"

    iget-object v5, p0, LLa/d;->C:Landroid/opengl/EGLContext;

    const/4 v9, 0x0

    move-object v3, v0

    invoke-direct/range {v3 .. v9}, LMa/b;-><init>(Ljava/lang/String;Landroid/opengl/EGLContext;Landroid/view/Surface;IIZ)V

    iput-object v0, p0, LLa/d;->B:LMa/b;

    iget v1, p0, LLa/d;->G:F
    ...
    iget-object p0, p0, LLa/d;->B:LMa/b;
...
.method public final C(Ljava/util/ArrayList;)V
    ...
    invoke-static {p1, v0}, LA/m2;->i(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-direct {v0, p0, v2}, LA3/x1;-><init>(Ljava/lang/Object;I)V
...
.method public final declared-synchronized D()V
    ...
    iget-object v0, p0, LLa/d;->A:LMa/b;
    ...
    iput-object v1, p0, LLa/d;->A:LMa/b;
    ...
    iput-object v1, p0, LLa/d;->B:LMa/b;
...
.method public E(Landroid/util/Size;)V
    ...
    iput-object p1, p0, LLa/d;->J:Landroid/util/Size;

    const-string p0, "updateCodecSize X size = "

    invoke-static {p0, p1}, LA/w3;->j(Ljava/lang/String;Landroid/util/Size;)Ljava/lang/String;
...
.method public declared-synchronized f()V
    ...
    iget-object v0, p0, LLa/c;->q:Ljava/util/concurrent/LinkedBlockingQueue;
...
.method public declared-synchronized g()V
    ...
    :cond_0
    iget-object v0, p0, LLa/c;->m:LLa/c$a;

    invoke-virtual {v0}, LLa/c$a;->a()V
    ...
    invoke-virtual {p0}, LLa/d;->z()V

    :cond_2
    invoke-virtual {p0}, LLa/d;->A()V

    const-wide/16 v0, 0x0

    iput-wide v0, p0, LLa/c;->p:J

    iput-wide v0, p0, LLa/d;->H:J

    iput-wide v0, p0, LLa/d;->I:J

    iput-boolean v2, p0, LLa/c;->r:Z

    iput-boolean v2, p0, LLa/c;->s:Z
...
.method public declared-synchronized h()V
    ...
    invoke-virtual {p0, v1}, LLa/d;->C(Ljava/util/ArrayList;)V
...
.method public u(Z)V
    ...
    invoke-super {p0, p1}, LLa/c;->u(Z)V
...
.method public w()V
    ...
    iget-object v3, p0, LLa/c;->b:Landroid/media/MediaFormat;
    ...
    invoke-virtual {p0}, LLa/d;->x()Landroid/view/Surface;

    move-result-object v2

    iput-object v2, p0, LLa/d;->D:Landroid/view/Surface;

    iget-object v2, p0, LLa/d;->F:Landroid/view/Surface;

    if-eqz v2, :cond_0

    iget-object v3, p0, LLa/c;->k:Landroid/media/MediaCodec;
    ...
    iget-object p0, p0, LLa/d;->F:Landroid/view/Surface;
...
.method public x()Landroid/view/Surface;
    ...
    iget-object p0, p0, LLa/c;->k:Landroid/media/MediaCodec;
...
.method public final z()V
    ...
    iget-object v6, p0, LLa/d;->D:Landroid/view/Surface;
    ...
    iput-object v0, p0, LLa/d;->A:LMa/b;
    ...
    iget-object p0, p0, LLa/d;->A:LMa/b;
