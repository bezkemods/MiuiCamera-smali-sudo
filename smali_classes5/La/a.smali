...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, LLa/a;->G:Z

    const/4 v0, 0x1

    sput-boolean v0, LLa/a;->H:Z
...
.method public constructor <init>(Landroid/media/MediaFormat;JJLjava/util/concurrent/LinkedBlockingQueue;)V
    ...
    invoke-direct/range {p0 .. p6}, LLa/c;-><init>(Landroid/media/MediaFormat;JJLjava/util/concurrent/LinkedBlockingQueue;)V
    ...
    iput-object p2, p0, LLa/a;->F:Landroid/media/AudioFormat;

    iget-object p2, p0, LLa/c;->b:Landroid/media/MediaFormat;
    ...
    iget-object p3, p0, LLa/c;->b:Landroid/media/MediaFormat;
    ...
    iget-object p4, p0, LLa/c;->b:Landroid/media/MediaFormat;
    ...
    invoke-static {p2, p3}, Lvb/w;->h(II)Z
    ...
    iget-object p3, p0, LLa/a;->F:Landroid/media/AudioFormat;
    ...
    iget-object p2, p0, LLa/a;->F:Landroid/media/AudioFormat;

    invoke-virtual {p0, p2}, LLa/a;->w(Landroid/media/AudioFormat;)V

    iget-object p2, p0, LLa/c;->b:Landroid/media/MediaFormat;

    const-string p3, "max-input-size"

    iget p4, p0, LLa/a;->C:I
    ...
    iget-object p3, p0, LLa/a;->D:Lxb/b;

    iget-object p3, p3, Lxb/b;->a:Landroid/media/AudioRecord;
    ...
    iget-boolean p1, p0, LLa/a;->E:Z

    if-nez p1, :cond_6

    :try_start_0
    iget-object p1, p0, LLa/c;->b:Landroid/media/MediaFormat;
    ...
    iput-object p1, p0, LLa/c;->k:Landroid/media/MediaCodec;
    :try_end_0
...
.method public final f()V
    ...
    :cond_0
    invoke-super {p0}, LLa/c;->f()V

    const/4 v0, 0x0

    :try_start_0
    iget-object v1, p0, LLa/a;->D:Lxb/b;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Lxb/b;->e()V
    :try_end_0
...
.method public final g()V
    ...
    :cond_2
    iget-object v2, p0, LLa/c;->m:LLa/c$a;

    invoke-virtual {v2}, LLa/c$a;->a()V

    iget-boolean v2, p0, LLa/a;->E:Z

    const/4 v3, 0x1

    if-nez v2, :cond_3

    iget-object v2, p0, LLa/c;->k:Landroid/media/MediaCodec;
    ...
    iget-object v5, p0, LLa/c;->h:LNa/b;

    invoke-virtual {v5}, LNa/b;->a()V

    iget-object v5, v5, LNa/b;->d:Landroid/os/Looper;
    ...
    iput-boolean v1, p0, LLa/c;->s:Z

    invoke-virtual {p0}, LLa/c;->t()V

    :try_start_0
    iget-object v2, p0, LLa/a;->D:Lxb/b;

    if-nez v2, :cond_4

    iget-object v2, p0, LLa/a;->F:Landroid/media/AudioFormat;

    invoke-virtual {p0, v2}, LLa/a;->w(Landroid/media/AudioFormat;)V
    ...
    :try_start_1
    iput-boolean v3, p0, LLa/c;->r:Z

    const-string v2, "audio/mp4a-latm"

    iget v4, p0, LLa/a;->z:I
    ...
    iput-object v2, p0, LLa/c;->l:Landroid/media/MediaFormat;

    const-string v4, "csd-0"

    iget v5, p0, LLa/a;->z:I

    iget v6, p0, LLa/a;->A:I

    invoke-static {v5, v6}, Lvb/w;->a(II)Ljava/nio/ByteBuffer;

    move-result-object v5

    invoke-virtual {v2, v4, v5}, Landroid/media/MediaFormat;->setByteBuffer(Ljava/lang/String;Ljava/nio/ByteBuffer;)V

    iget-object v2, p0, LLa/c;->l:Landroid/media/MediaFormat;

    const-string v4, "bitrate"

    iget v5, p0, LLa/a;->y:I

    invoke-virtual {v2, v4, v5}, Landroid/media/MediaFormat;->setInteger(Ljava/lang/String;I)V

    invoke-virtual {p0}, Ljava/lang/Object;->notifyAll()V

    iget-object v2, p0, LLa/c;->f:Ljava/util/ArrayList;

    new-instance v4, LA3/B;

    const/4 v5, 0x5

    invoke-direct {v4, p0, v5}, LA3/B;-><init>(Ljava/lang/Object;I)V
    ...
    :cond_5
    :goto_1
    iput-boolean v3, p0, LLa/c;->n:Z

    const-wide/16 v2, 0x0

    iput-wide v2, p0, LLa/c;->p:J
...
.method public final h()V
    ...
    :cond_3
    :try_start_0
    iget-object v0, p0, LLa/a;->D:Lxb/b;
    ...
    iput-object v0, p0, LLa/a;->D:Lxb/b;
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v3, p0, LLa/c;->f:Ljava/util/ArrayList;

    monitor-enter v3

    :try_start_1
    iget-object v4, p0, LLa/c;->f:Ljava/util/ArrayList;

    invoke-virtual {v2, v4}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    iget-object p0, p0, LLa/c;->f:Ljava/util/ArrayList;
    ...
    check-cast v0, LLa/c$d;

    :try_start_2
    invoke-virtual {v0}, LLa/c$d;->d()V
    :try_end_2
...
.method public final onInputBufferAvailable(Landroid/media/MediaCodec;I)V
    ...
    :try_start_0
    iget-object v0, v0, Lxb/a;->a:Ljava/util/concurrent/ArrayBlockingQueue;
    ...
    iget-object v4, v0, Lyb/f;->a:Ljava/nio/ByteBuffer;
    ...
    iget p1, p0, LLa/a;->B:I

    div-int p1, v8, p1

    iget-wide v9, v0, Lyb/f;->c:J

    iget-boolean p1, p0, LLa/c;->n:Z
...
.method public final w(Landroid/media/AudioFormat;)V
    ...
    iget v4, p0, LLa/a;->y:I

    const/4 v5, 0x1

    move-object v1, p1

    invoke-virtual/range {v0 .. v5}, Lxb/b;->d(Landroid/media/AudioFormat;IIII)V

    iget-object p1, p0, LLa/a;->D:Lxb/b;

    iget-object p1, p1, Lxb/b;->a:Landroid/media/AudioRecord;
    ...
    iput-object v0, p1, Lxb/b;->p:LL2/k;

    :cond_0
    return-void

    :cond_1
    iget-object p0, p0, LLa/a;->D:Lxb/b;
