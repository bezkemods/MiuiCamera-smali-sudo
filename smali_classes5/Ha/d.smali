...
.field public d0:LHa/c;

.field public final e:D

.field public e0:LHa/b;
...
# direct methods
.method public constructor <init>(IIZIIIILandroid/os/Handler;LHa/i$c;)V
    .locals 23
    ...
    iput-object v9, v0, LHa/d;->y:Ljava/util/ArrayList;

    new-instance v9, Ljava/util/ArrayList;

    invoke-direct {v9}, Ljava/util/ArrayList;-><init>()V

    iput-object v9, v0, LHa/d;->V:Ljava/util/ArrayList;

    new-instance v9, Ljava/util/ArrayList;

    invoke-direct {v9}, Ljava/util/ArrayList;-><init>()V

    iput-object v9, v0, LHa/d;->W:Ljava/util/ArrayList;

    const/16 v9, 0x10

    new-array v9, v9, [F

    iput-object v9, v0, LHa/d;->g0:[F
    ...
    iput-object v9, v0, LHa/d;->h0:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v7, v0, LHa/d;->a:Ljava/lang/String;

    const/16 v9, 0x200

    iput v9, v0, LHa/d;->b:I

    iput v9, v0, LHa/d;->c:I

    const/16 v11, 0x20

    iput v11, v0, LHa/d;->d:I

    const-wide/high16 v11, 0x3fd0000000000000L    # 0.25

    iput-wide v11, v0, LHa/d;->e:D
    ...
    iget-object v9, v0, LHa/d;->a:Ljava/lang/String;
    ...
    iput-object v7, v0, LHa/d;->f:Landroid/media/MediaCodec;
    ...
    :cond_1
    iget-object v7, v0, LHa/d;->f:Landroid/media/MediaCodec;

    invoke-virtual {v7}, Landroid/media/MediaCodec;->release()V

    iput-object v14, v0, LHa/d;->f:Landroid/media/MediaCodec;
    ...
    :catch_0
    sget-object v7, LHa/f;->i0:Landroid/media/MediaCodecList;
    ...
    iget v8, v0, LHa/d;->b:I

    if-gt v1, v8, :cond_8

    iget v8, v0, LHa/d;->c:I
    ...
    :cond_9
    sget-object v7, LHa/a;->i0:Landroid/media/MediaCodecList;
    ...
    :goto_b
    iput v4, v0, LHa/d;->j:I

    move-object/from16 v9, p9

    iput-object v9, v0, LHa/d;->h:LHa/i$c;
    ...
    iput-object v9, v0, LHa/d;->i:Landroid/os/Handler;
    ...
    :goto_10
    iput-boolean v4, v0, LHa/d;->Y:Z

    iput v1, v0, LHa/d;->k:I

    iput v2, v0, LHa/d;->l:I

    iput-boolean v8, v0, LHa/d;->r:Z

    if-eqz v8, :cond_19

    iget v9, v0, LHa/d;->b:I

    iget v3, v0, LHa/d;->c:I
    ...
    iput v1, v0, LHa/d;->m:I

    iput v2, v0, LHa/d;->n:I

    const/4 v3, 0x1

    iput v3, v0, LHa/d;->o:I

    iput v3, v0, LHa/d;->p:I

    goto :goto_13

    :cond_1e
    iput v9, v0, LHa/d;->m:I

    iput v3, v0, LHa/d;->n:I

    iput v11, v0, LHa/d;->o:I

    iput v7, v0, LHa/d;->p:I

    :goto_13
    iget v3, v0, LHa/d;->o:I

    iget v5, v0, LHa/d;->p:I

    mul-int/2addr v3, v5

    iput v3, v0, LHa/d;->q:I
    ...
    :goto_17
    iput-object v12, v0, LHa/d;->g:Landroid/media/MediaFormat;

    new-instance v1, Landroid/graphics/Rect;

    iget v2, v0, LHa/d;->m:I

    iget v3, v0, LHa/d;->n:I

    const/4 v4, 0x0

    invoke-direct {v1, v4, v4, v2, v3}, Landroid/graphics/Rect;-><init>(IIII)V

    iput-object v1, v0, LHa/d;->w:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, v0, LHa/d;->u:Landroid/graphics/Rect;
...
.method public final a([B)V
    ...
    iget-object v0, p0, LHa/d;->y:Ljava/util/ArrayList;
    ...
    :goto_0
    :try_start_0
    iget-boolean v1, p0, LHa/d;->t:Z

    if-nez v1, :cond_0

    iget-object v1, p0, LHa/d;->y:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, LHa/d;->V:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_3
    iget-object v0, p0, LHa/d;->V:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, LHa/d;->i:Landroid/os/Handler;
...
.method public final b()V
    ...
    iget v1, p0, LHa/d;->m:I

    iget v2, p0, LHa/d;->n:I
    ...
    iget-object v9, p0, LHa/d;->u:Landroid/graphics/Rect;

    invoke-virtual {v9, v5, v6, v7, v8}, Landroid/graphics/Rect;->set(IIII)V

    :try_start_0
    iget-object v5, p0, LHa/d;->e0:LHa/b;

    iget v6, p0, LHa/d;->f0:I

    sget-object v7, LHa/h;->h:[F

    invoke-virtual {v5, v6, v7, v9}, LHa/b;->a(I[FLandroid/graphics/Rect;)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0

    iget-object v5, p0, LHa/d;->d0:LHa/c;

    iget v6, p0, LHa/d;->s:I

    add-int/lit8 v7, v6, 0x1

    iput v7, p0, LHa/d;->s:I
    ...
    iget-object v8, v5, LHa/c;->a:Landroid/opengl/EGLDisplay;

    iget-object v5, v5, LHa/c;->c:Landroid/opengl/EGLSurface;
    ...
    iget-object v6, v5, LHa/c;->a:Landroid/opengl/EGLDisplay;
    ...
    iget-object p0, p0, LHa/d;->h0:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final c()V
    ...
    :cond_0
    :goto_0
    iget-boolean v1, v0, LHa/d;->t:Z

    const/4 v3, 0x0

    if-nez v1, :cond_2

    iget-object v1, v0, LHa/d;->x:Ljava/nio/ByteBuffer;

    if-nez v1, :cond_2

    iget-object v1, v0, LHa/d;->V:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_0
    iget-object v4, v0, LHa/d;->V:Ljava/util/ArrayList;
    ...
    :goto_1
    iput-object v4, v0, LHa/d;->x:Ljava/nio/ByteBuffer;
    ...
    iget-object v4, v0, LHa/d;->W:Ljava/util/ArrayList;
    ...
    iget v4, v0, LHa/d;->s:I

    iget v5, v0, LHa/d;->q:I
    ...
    iget-object v8, v0, LHa/d;->f:Landroid/media/MediaCodec;

    invoke-virtual {v8, v6}, Landroid/media/MediaCodec;->getInputImage(I)Landroid/media/Image;

    move-result-object v8

    iget v9, v0, LHa/d;->m:I

    iget v10, v0, LHa/d;->s:I

    iget v11, v0, LHa/d;->p:I

    rem-int v12, v10, v11

    mul-int/2addr v12, v9

    iget v13, v0, LHa/d;->n:I

    div-int/2addr v10, v11

    iget v11, v0, LHa/d;->o:I

    rem-int/2addr v10, v11

    mul-int/2addr v10, v13

    iget-object v11, v0, LHa/d;->u:Landroid/graphics/Rect;
    ...
    iget v9, v0, LHa/d;->k:I

    iget v10, v0, LHa/d;->l:I

    iget-object v11, v0, LHa/d;->u:Landroid/graphics/Rect;

    iget-object v12, v0, LHa/d;->w:Landroid/graphics/Rect;
    ...
    iget-object v5, v0, LHa/d;->f:Landroid/media/MediaCodec;
    ...
    :goto_b
    iget v2, v0, LHa/d;->s:I

    add-int/lit8 v3, v2, 0x1

    iput v3, v0, LHa/d;->s:I
    ...
    iget v1, v0, LHa/d;->s:I

    iget v2, v0, LHa/d;->q:I
    ...
    :cond_10
    iget-object v1, v0, LHa/d;->y:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_1
    iget-boolean v2, v0, LHa/d;->t:Z

    or-int/2addr v2, v4

    iput-boolean v2, v0, LHa/d;->t:Z

    iget-object v2, v0, LHa/d;->y:Ljava/util/ArrayList;

    iget-object v3, v0, LHa/d;->x:Ljava/nio/ByteBuffer;
    ...
    iput-object v1, v0, LHa/d;->x:Ljava/nio/ByteBuffer;
...
.method public final close()V
    ...
    iget-object v0, p0, LHa/d;->i:Landroid/os/Handler;

    new-instance v1, LHa/d$b;

    invoke-direct {v1, p0}, LHa/d$b;-><init>(LHa/d;)V
...
.method public final d()V
    ...
    iget-object v1, p0, LHa/d;->h0:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :try_start_0
    iget-object v3, p0, LHa/d;->f:Landroid/media/MediaCodec;
    ...
    :cond_0
    :goto_0
    iput-object v1, p0, LHa/d;->f:Landroid/media/MediaCodec;
    ...
    :try_start_2
    iput-boolean v2, p0, LHa/d;->t:Z

    iget-object v2, p0, LHa/d;->y:Ljava/util/ArrayList;
    ...
    :try_start_3
    iget-object v0, p0, LHa/d;->e0:LHa/b;

    if-eqz v0, :cond_1

    iget-object v2, v0, LHa/b;->e:LHa/h;

    if-eqz v2, :cond_1

    iput-object v1, v0, LHa/b;->e:LHa/h;
    :try_end_3
    ...
    :cond_1
    :try_start_4
    iput-object v1, p0, LHa/d;->e0:LHa/b;
    ...
    :goto_3
    :try_start_5
    iget-object v0, p0, LHa/d;->d0:LHa/c;
    ...
    :goto_4
    :try_start_6
    iput-object v1, p0, LHa/d;->d0:LHa/c;
    ...
    :goto_6
    :try_start_7
    iget-object v0, p0, LHa/d;->a0:Landroid/graphics/SurfaceTexture;
    ...
    :goto_7
    :try_start_8
    iput-object v1, p0, LHa/d;->a0:Landroid/graphics/SurfaceTexture;
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    :cond_0
    iget-object v1, v0, LHa/c;->a:Landroid/opengl/EGLDisplay;

    iget-object v2, v0, LHa/c;->c:Landroid/opengl/EGLSurface;

    iget-object v0, v0, LHa/c;->b:Landroid/opengl/EGLContext;
    ...
    iget-object v2, p0, LHa/d;->Z:LHa/d$e;

    iget v3, p0, LHa/d;->s:I

    iget v4, p0, LHa/d;->q:I
    ...
    :cond_3
    :goto_1
    iput-wide v0, v2, LHa/d$e;->c:J

    invoke-virtual {v2}, LHa/d$e;->a()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    invoke-virtual {p0}, LHa/d;->b()V

    :cond_4
    invoke-virtual {p1}, Landroid/graphics/SurfaceTexture;->releaseTexImage()V

    iget-object p1, p0, LHa/d;->d0:LHa/c;

    iget-object p1, p1, LHa/c;->a:Landroid/opengl/EGLDisplay;
