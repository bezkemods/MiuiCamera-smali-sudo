...
# instance fields
.field public final synthetic c:LHa/f;
...
.method public constructor <init>(LHa/f;)V
    ...
    iput-object p1, p0, LHa/f$a;->c:LHa/f;

    invoke-direct {p0, p1}, LHa/d$d;-><init>(LHa/f;)V
...
.method public final onOutputFormatChanged(Landroid/media/MediaCodec;Landroid/media/MediaFormat;)V
    ...
    iget-object p0, p0, LHa/f$a;->c:LHa/f;
    ...
    iget-boolean p1, p0, LHa/d;->r:Z

    if-eqz p1, :cond_1

    const-string p1, "tile-width"

    iget v0, p0, LHa/d;->m:I
    ...
    iget-boolean p1, p0, LHa/i$c;->a:Z
    ...
    :cond_2
    iget-object p1, p0, LHa/i$c;->b:LHa/g;

    iget-object v0, p1, LHa/i;->j:[I
    ...
    :catch_0
    iput p0, p1, LHa/i;->c:I

    :goto_0
    iget v0, p1, LHa/i;->e:I

    new-array v0, v0, [I

    iput-object v0, p1, LHa/i;->j:[I

    iget v0, p1, LHa/i;->d:I
    ...
    invoke-static {v0, v1, v2}, LA3/H2;->m(ILjava/lang/String;Ljava/lang/String;)V

    iget-object v1, p1, LHa/i;->g:Landroid/media/MediaMuxer;
    ...
    iget-object v3, p1, LHa/i;->g:Landroid/media/MediaMuxer;
    ...
    :cond_6
    iget-object p2, p1, LHa/i;->g:Landroid/media/MediaMuxer;

    invoke-virtual {p2}, Landroid/media/MediaMuxer;->start()V

    iget-object p2, p1, LHa/i;->i:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {p2, p0}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    invoke-virtual {p1}, LHa/i;->d()V
