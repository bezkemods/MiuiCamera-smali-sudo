...
.method public constructor <init>(LKa/r;)V
    ...
    iput-object p1, p0, LKa/q;->a:LKa/r;
...
.method public final onImageAvailable(Landroid/media/ImageReader;)V
    ...
    iget-object v3, v0, LKa/q;->a:LKa/r;

    iget-boolean v3, v3, LKa/r;->g:Z
    ...
    iget-object v0, v0, LKa/q;->a:LKa/r;
    ...
    iput-object v4, v0, LKa/r;->B:Landroid/os/HandlerThread;

    :cond_1
    iput-object v4, v0, LKa/r;->C:Landroid/os/Handler;
    ...
    iget-object v3, v3, LKa/r;->a:Ljava/lang/ref/WeakReference;
    ...
    :cond_3
    invoke-interface {v3}, Lcom/android/camera/module/J;->getModuleCallback()Lcom/android/camera/module/K;
    ...
    :cond_5
    invoke-interface {v3}, Lcom/android/camera/module/J;->getAppStateMgr()Ls3/b;
    ...
    :cond_6
    iget-object v8, v0, LKa/q;->a:LKa/r;

    invoke-virtual {v8, v4, v3}, LKa/r;->u(Lcom/android/camera/ui/e0;Ls3/b;)V
    ...
    invoke-virtual {v3, v6, v7}, LKa/r;->k(J)I

    move-result v13

    iget-object v0, v0, LKa/q;->a:LKa/r;

    iget-object v3, v0, LKa/r;->c:LKa/b;

    if-eqz v3, :cond_b

    iget-object v3, v3, LKa/b;->b:LLa/d;
    ...
    iget-object v12, v0, LKa/r;->y:LQ0/e;
    ...
    iput-object v5, v0, LLa/h;->a:Landroid/media/Image;

    invoke-virtual {v5}, Landroid/media/Image;->getTimestamp()J

    move-result-wide v3

    iput-wide v3, v0, LLa/h;->b:J
    ...
    iget-object v1, v9, LLa/c;->f:Ljava/util/ArrayList;
    ...
    :try_start_3
    iget-object v2, v9, LLa/c;->f:Ljava/util/ArrayList;
    ...
    :try_start_4
    invoke-virtual {v9, v0}, LLa/d;->C(Ljava/util/ArrayList;)V
    :try_end_4
    ...
    iget-object v3, v9, LLa/d;->B:LMa/b;
    ...
    invoke-direct/range {v8 .. v17}, LLa/g;-><init>(LLa/e;[ZLLa/h;LQ0/e;IZLFe/b$a;ZLLa/h;)V

    invoke-direct {v4, v6}, Lrc/a;-><init>(Ljava/lang/Runnable;)V

    iget-object v0, v3, LMa/b;->k:LMa/b$a;

    if-eqz v0, :cond_a

    const-wide/16 v6, 0x32

    invoke-virtual {v4, v0, v6, v7}, Lrc/a;->a(Landroid/os/Handler;J)Z
