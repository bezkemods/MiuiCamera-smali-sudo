...
.method static constructor <clinit>()V
    ...
    sput-object v0, LTb/j;->d:LWe/n;

    return-void
.end method

.method public static a(Landroid/app/Application;LTb/a;Landroidx/fragment/app/FragmentManager;Ljava/lang/String;Lcom/xiaomi/camera/upgrade/fragment/UpdateDialogFragment$a;)V
    .locals 18
    ...
    sget-object v5, LTb/j;->a:Lio/reactivex/disposables/Disposable;
    ...
    sget-object v8, LTb/j;->c:LWe/n;

    invoke-virtual {v8}, LWe/n;->getValue()Ljava/lang/Object;
    ...
    invoke-direct {v8, v0, v6}, LUb/a;-><init>(Landroid/app/Application;Z)V

    new-instance v6, LTb/h;

    const/4 v9, 0x0

    invoke-direct {v6, v9, v1, v2, v0}, LTb/h;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    new-instance v9, LRc/c;

    const/4 v10, 0x1

    invoke-direct {v9, v6, v10}, LRc/c;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v8, v2, v9}, LTb/i;-><init>(Ljava/lang/Object;I)V

    new-instance v2, LLc/a;

    const/4 v9, 0x3

    invoke-direct {v2, v8, v9}, LLc/a;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v2, v0, v5, v3, v4}, LTb/f;-><init>(Landroid/app/Application;Ljava/lang/ref/WeakReference;Ljava/lang/String;Lcom/xiaomi/camera/upgrade/fragment/UpdateDialogFragment$a;)V

    new-instance v0, LQc/q;

    const/4 v6, 0x2

    invoke-direct {v0, v2, v6}, LQc/q;-><init>(Ljava/lang/Object;I)V

    new-instance v2, LTb/g;

    const/4 v6, 0x0

    invoke-direct {v2, v6, v5, v3, v4}, LTb/g;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    sput-object v0, LTb/j;->a:Lio/reactivex/disposables/Disposable;
...
.method public static c(Lcom/xiaomi/camera/upgrade/UpgradeBean;Landroidx/fragment/app/FragmentManager;Ljava/lang/String;Lcom/xiaomi/camera/upgrade/fragment/UpdateDialogFragment$a;)V
    ...
    sput-object p0, LTb/j;->b:Lcom/xiaomi/camera/upgrade/fragment/UpdateDialogFragment;
...
.method public static d(Landroid/app/Application;Lcom/xiaomi/camera/upgrade/preference/DrawablePreference;)V
    ...
    invoke-static {p0}, LTb/j;->b(Landroid/content/Context;)Z

    move-result p0

    if-eqz p0, :cond_0

    sget v0, LTb/e;->update_new_version:I

    goto :goto_0

    :cond_0
    sget v0, LTb/e;->update_latest_version:I
    ...
    sget p0, LTb/b;->update_find_new_version_text_color:I

    goto :goto_1

    :cond_1
    sget p0, LTb/b;->black_40_transparent_with_dark_mode:I
