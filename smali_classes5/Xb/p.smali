...
.method public static final c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/Runnable;Ljava/lang/CharSequence;Ljava/lang/Runnable;Ljava/lang/CharSequence;Ljava/lang/Runnable;Ljava/lang/String;ZLjava/lang/Runnable;)Lmiuix/appcompat/app/AlertDialog;
    ...
    invoke-direct {v0, p4, p8, p6}, LXb/n;-><init>(Ljava/lang/Runnable;Ljava/lang/Runnable;Ljava/lang/Runnable;)V

    new-instance p4, LV5/e;

    const/4 p6, 0x1

    invoke-direct {p4, p11, p6}, LV5/e;-><init>(Ljava/lang/Object;I)V

    new-instance p6, LXb/m;

    invoke-direct {p6}, Ljava/lang/Object;-><init>()V

    iput-object v0, p6, LXb/m;->a:Landroid/content/DialogInterface$OnClickListener;

    iput-object p4, p6, LXb/m;->b:LV5/e;
    ...
    invoke-virtual {p4, p1}, Lmiuix/appcompat/app/AlertDialog$a;->I(Ljava/lang/CharSequence;)V

    invoke-virtual {p4, p2}, Lmiuix/appcompat/app/AlertDialog$a;->o(Ljava/lang/CharSequence;)V

    const/4 p0, 0x1

    invoke-virtual {p4, p0}, Lmiuix/appcompat/app/AlertDialog$a;->d(Z)V

    invoke-virtual {p4, p6}, Lmiuix/appcompat/app/AlertDialog$a;->w(Landroid/content/DialogInterface$OnCancelListener;)V

    new-instance p0, LXb/o;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    invoke-virtual {p4, p0}, Lmiuix/appcompat/app/AlertDialog$a;->z(Landroid/content/DialogInterface$OnKeyListener;)V

    if-eqz p9, :cond_0

    invoke-virtual {p4, p9, p10}, Lmiuix/appcompat/app/AlertDialog$a;->e(Ljava/lang/String;Z)V

    :cond_0
    if-eqz p3, :cond_1

    invoke-virtual {p4, p3, p6}, Lmiuix/appcompat/app/AlertDialog$a;->C(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V

    :cond_1
    if-eqz p7, :cond_2

    invoke-virtual {p4, p7, p6}, Lmiuix/appcompat/app/AlertDialog$a;->t(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V

    :cond_2
    if-eqz p5, :cond_3

    invoke-virtual {p4, p5, p6}, Lmiuix/appcompat/app/AlertDialog$a;->v(Ljava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    ...
    invoke-direct {p2, p6}, LXb/l;-><init>(LXb/m;)V
