...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LXb/f;->c:Ljava/lang/Boolean;
...
.method public static n(Landroid/content/Intent;)Z
    ...
    invoke-static {p0}, LXb/f;->r(Landroid/content/Intent;)Z
...
.method public static r(Landroid/content/Intent;)Z
    ...
    invoke-static {p0}, LXb/f;->p(Landroid/content/Intent;)Z
...
.method public final a(Landroidx/fragment/app/FragmentActivity;)Z
    ...
    :cond_3
    iget-object v1, p0, LXb/f;->a:Landroid/content/Intent;
    ...
    iget-object p1, p0, LXb/f;->a:Landroid/content/Intent;

    invoke-static {p1}, LXb/f;->j(Landroid/content/Intent;)Z
    ...
    invoke-static {p0, v4}, LA/O;->b(Ljava/lang/String;Z)Ljava/lang/String;
...
.method public final b()V
    ...
    invoke-virtual {p0}, LXb/f;->q()Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object v0, p0, LXb/f;->a:Landroid/content/Intent;
...
.method public final c()Z
    ...
    iget-object v1, p0, LXb/f;->c:Ljava/lang/Boolean;

    if-nez v1, :cond_9

    invoke-virtual {p0}, LXb/f;->d()Ljava/lang/String;
    ...
    :cond_9
    :goto_1
    iget-object p0, p0, LXb/f;->c:Ljava/lang/Boolean;
...
.method public final d()Ljava/lang/String;
    ...
    iget-object v0, p0, LXb/f;->b:Landroid/net/Uri;

    if-nez v0, :cond_0

    iget-object v0, p0, LXb/f;->a:Landroid/content/Intent;

    invoke-static {v0}, LXb/f;->v(Landroid/content/Intent;)Landroid/net/Uri;

    move-result-object v0

    iput-object v0, p0, LXb/f;->b:Landroid/net/Uri;

    :cond_0
    iget-object p0, p0, LXb/f;->b:Landroid/net/Uri;
...
.method public final o()Z
    ...
    iget-object v3, p0, LXb/f;->a:Landroid/content/Intent;
    ...
    :cond_6
    iget-object v6, p0, LXb/f;->a:Landroid/content/Intent;
    ...
    :cond_8
    sget-object v8, LA/f3$a;->a:LA/f3;

    iget v8, v8, LA/f3;->a:I
    ...
    invoke-static {v6}, LXb/f;->p(Landroid/content/Intent;)Z
...
.method public final x(Landroid/content/Intent;)V
    ...
    iput-object p1, p0, LXb/f;->a:Landroid/content/Intent;

    invoke-static {p1}, LXb/f;->v(Landroid/content/Intent;)Landroid/net/Uri;
    ...
    invoke-static {p1}, LXb/f$a;->a(Landroid/os/Bundle;)V
