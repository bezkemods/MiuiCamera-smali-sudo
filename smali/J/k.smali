...
.method public constructor <init>(Landroid/view/ViewGroup;Landroid/view/View$OnTouchListener;)V
    ...
    invoke-direct {p0, p1, p2}, LJ/n;-><init>(Landroid/view/ViewGroup;Landroid/view/View$OnTouchListener;)V

    new-instance p1, LJ/k$a;

    invoke-direct {p1, p0}, LJ/k$a;-><init>(LJ/k;)V

    iput-object p1, p0, LJ/k;->l:LJ/k$a;
...
.method public final a(LH/m;)V
    ...
    invoke-virtual {v7, v5, v4}, LT9/a;->q(Ljava/lang/String;Ljava/lang/String;)LT9/a;
    ...
    invoke-virtual {v4, v5, v6}, LT9/a;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    :goto_0
    iget-object v4, p0, LJ/k;->k:LH/m;
    ...
    invoke-virtual {p0, v0, v3}, LJ/n;->k(Landroid/widget/TextView;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1, v0}, LJ/n;->k(Landroid/widget/TextView;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2, p1}, LJ/n;->k(Landroid/widget/TextView;Ljava/lang/String;)V
    ...
    iget-object p0, p0, LJ/k;->l:LJ/k$a;

    invoke-virtual {p1, p0}, Lq3/b;->d(Lq3/b$a;)V
...
.method public final b(FILH/m;Landroid/graphics/Rect;)Landroid/widget/FrameLayout$LayoutParams;
    .locals 2

    iget-object p0, p0, LJ/n;->a:Landroid/view/View;
...
.method public final e(LH/m;FIZ)V
    .locals 6

    if-eqz p4, :cond_0

    iget-object p4, p0, LJ/n;->a:Landroid/view/View;
    ...
    :goto_1
    iget-object p4, p0, LJ/n;->d:Landroid/graphics/Rect;

    invoke-virtual {p4}, Landroid/graphics/Rect;->width()I

    move-result v3

    iget-object p0, p0, LJ/n;->d:Landroid/graphics/Rect;
...
.method public final l(ILandroid/graphics/Rect;Landroid/util/Size;)V
    ...
    iget-object p1, p0, LJ/n;->d:Landroid/graphics/Rect;
    ...
    :cond_1
    invoke-super {p0, p1, p2, p3}, LJ/n;->l(ILandroid/graphics/Rect;Landroid/util/Size;)V
