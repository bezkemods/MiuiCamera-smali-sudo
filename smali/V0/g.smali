...
# instance fields
.field public a:LV0/e;


# direct methods
.method public static a(Landroid/util/Size;Lec/c;Lec/c;IZZ)Landroid/graphics/Rect;
    .locals 19
    ...
    iget-boolean v10, v0, Lec/c;->d:Z

    new-array v11, v14, [I

    invoke-virtual/range {p1 .. p1}, Lec/c;->d()I

    move-result v16

    aput v16, v11, v13

    invoke-virtual/range {p1 .. p1}, Lec/c;->a()I

    move-result v16

    aput v16, v11, v7

    invoke-virtual/range {p1 .. p1}, Lec/c;->b()I

    move-result v16

    aput v16, v11, v15

    invoke-virtual/range {p1 .. p1}, Lec/c;->c()I
    ...
    invoke-static {v0, v11}, LV1/A;->g(Ljava/lang/StringBuilder;[I)Ljava/lang/String;
    ...
    invoke-static {v0}, LEc/a;->i([I)Landroid/graphics/Rect;
    ...
    invoke-static {v0, v8}, LV1/A;->g(Ljava/lang/StringBuilder;[I)Ljava/lang/String;
    ...
    iget-boolean v12, v1, Lec/c;->d:Z

    new-array v0, v14, [I

    invoke-virtual/range {p2 .. p2}, Lec/c;->d()I

    move-result v6

    aput v6, v0, v13

    invoke-virtual/range {p2 .. p2}, Lec/c;->a()I

    move-result v6

    aput v6, v0, v7

    invoke-virtual/range {p2 .. p2}, Lec/c;->b()I

    move-result v6

    aput v6, v0, v15

    invoke-virtual/range {p2 .. p2}, Lec/c;->c()I
    ...
    invoke-static {v1}, LEc/a;->i([I)Landroid/graphics/Rect;
...
.method public static b(LV0/e;)V
    .locals 2

    iget-object v0, p0, LV0/e;->h:Landroid/util/Size;
    ...
    iget-object v0, p0, LV0/e;->g:Landroid/util/Size;
    ...
    iget-object v1, p0, LV0/e;->h:Landroid/util/Size;
    ...
    iget-object p0, p0, LV0/e;->g:Landroid/util/Size;
...
.method public static c(LV0/e;Lcom/android/camera/effect/renders/p;Landroid/graphics/Rect;)V
    .locals 9
    ...
    invoke-virtual {p1}, Lcom/android/camera/effect/renders/p;->f()Lf6/b;

    move-result-object v2

    check-cast v2, Lf6/n;

    invoke-virtual {v2}, Lf6/n;->j()Landroid/graphics/Bitmap;
    ...
    iget-object v7, p0, LV0/e;->g:Landroid/util/Size;
    ...
    iget-object v5, p0, LV0/e;->g:Landroid/util/Size;
    ...
    invoke-virtual {p0}, Lf6/n;->j()Landroid/graphics/Bitmap;
...
.method public final d(Landroid/graphics/Rect;)V
    ...
    iget-object p0, p0, LV0/g;->a:LV0/e;
    ...
    iget-boolean v1, v0, LV0/f;->s:Z

    iget-object v4, p0, LV0/e;->c:Landroid/hardware/HardwareBuffer;

    iget v5, p0, LV0/e;->l:I
    ...
    iput-object v4, v0, LV0/f;->k:[B

    if-eqz v1, :cond_3

    iget-object v0, p0, LV0/e;->b:LV0/f;

    iget-object v1, v0, LV0/f;->k:[B
    ...
    iget-object v4, p0, LV0/e;->h:Landroid/util/Size;

    invoke-virtual {v4}, Landroid/util/Size;->getWidth()I

    move-result v4

    iget-object v5, p0, LV0/e;->h:Landroid/util/Size;
    ...
    invoke-static {v4, v5, p1, v6, v7}, LA/l2;->b(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p1, v1, v4, v0, v5}, LA/w3;->k(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/String;
    ...
    :cond_7
    invoke-static {p1, v7}, LEc/a;->p(Landroid/graphics/Rect;F)Landroid/graphics/Rect;

    move-result-object p1

    :cond_8
    :goto_1
    iget-object p0, p0, LV0/e;->b:LV0/f;

    iput-object p1, p0, LV0/f;->l:Landroid/graphics/Rect;
