...
.field private final context:Laf/h;

.field private final file:Ljava/io/File;

.field private final inMemoryMutex:LNg/a;

.field private final lazySharedCounter:LWe/f;
...
.field private final lockFile$delegate:LWe/f;

.field private final updateNotifications:LHg/e;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LHg/e<",
            "LWe/s;",
...
.method public constructor <init>(Laf/h;Ljava/io/File;)V
    .locals 1
    ...
    iput-object p1, p0, Landroidx/datastore/core/MultiProcessCoordinator;->context:Laf/h;
    ...
    invoke-virtual {p1, p2}, Landroidx/datastore/core/MulticastFileObserver$Companion;->observe(Ljava/io/File;)LHg/e;

    move-result-object p1

    iput-object p1, p0, Landroidx/datastore/core/MultiProcessCoordinator;->updateNotifications:LHg/e;
    ...
    iput-object p1, p0, Landroidx/datastore/core/MultiProcessCoordinator;->inMemoryMutex:LNg/a;
    ...
    iput-object p1, p0, Landroidx/datastore/core/MultiProcessCoordinator;->lockFile$delegate:LWe/f;
    ...
    iput-object p1, p0, Landroidx/datastore/core/MultiProcessCoordinator;->lazySharedCounter:LWe/f;
...
.method private final getLockFile()Ljava/io/File;
    ...
    iget-object p0, p0, Landroidx/datastore/core/MultiProcessCoordinator;->lockFile$delegate:LWe/f;
...
.method private final getSharedCounter()Landroidx/datastore/core/SharedCounter;
    ...
    iget-object p0, p0, Landroidx/datastore/core/MultiProcessCoordinator;->lazySharedCounter:LWe/f;
...
.method private final withLazyCounter(Llf/p;Laf/e;)Ljava/lang/Object;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    iget-object v0, p0, Landroidx/datastore/core/MultiProcessCoordinator;->lazySharedCounter:LWe/f;

    invoke-interface {v0}, LWe/f;->isInitialized()Z
    ...
    invoke-interface {p1, p0, p2}, Llf/p;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_0
    iget-object v0, p0, Landroidx/datastore/core/MultiProcessCoordinator;->context:Laf/h;

    new-instance v1, Landroidx/datastore/core/MultiProcessCoordinator$withLazyCounter$2;

    const/4 v2, 0x0

    invoke-direct {v1, p1, p0, v2}, Landroidx/datastore/core/MultiProcessCoordinator$withLazyCounter$2;-><init>(Llf/p;Landroidx/datastore/core/MultiProcessCoordinator;Laf/e;)V
...
.method public getUpdateNotifications()LHg/e;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object p0, p0, Landroidx/datastore/core/MultiProcessCoordinator;->updateNotifications:LHg/e;

    return-object p0
.end method

.method public getVersion(Laf/e;)Ljava/lang/Object;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, v2}, Landroidx/datastore/core/MultiProcessCoordinator$getVersion$$inlined$withLazyCounter$1;-><init>(Landroidx/datastore/core/MultiProcessCoordinator;Laf/e;)V

    invoke-static {v1, v0, p1}, LEg/f;->e(Llf/p;Laf/h;Laf/e;)Ljava/lang/Object;
...
.method public incrementAndGetVersion(Laf/e;)Ljava/lang/Object;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p0, v2}, Landroidx/datastore/core/MultiProcessCoordinator$incrementAndGetVersion$$inlined$withLazyCounter$1;-><init>(Landroidx/datastore/core/MultiProcessCoordinator;Laf/e;)V
...
.method public lock(Llf/l;Laf/e;)Ljava/lang/Object;
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v0, p0, p2}, Landroidx/datastore/core/MultiProcessCoordinator$lock$1;-><init>(Landroidx/datastore/core/MultiProcessCoordinator;Laf/e;)V
    ...
    iget-object p2, p0, Landroidx/datastore/core/MultiProcessCoordinator;->inMemoryMutex:LNg/a;
    ...
    invoke-interface {p2, v0}, LNg/a;->b(Lcf/c;)Ljava/lang/Object;
    ...
    invoke-static {p0, v2, v0}, Landroidx/datastore/core/MultiProcessCoordinator$Companion;->access$getExclusiveFileLockWithRetryIfDeadlock(Landroidx/datastore/core/MultiProcessCoordinator$Companion;Ljava/io/FileOutputStream;Laf/e;)Ljava/lang/Object;
    ...
    invoke-interface {v2, v0}, Llf/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_5
    :try_start_7
    invoke-static {p1, v6}, LEg/J;->b(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_7
    .catchall {:try_start_7 .. :try_end_7} :catchall_3

    invoke-interface {v0, v6}, LNg/a;->c(Ljava/lang/Object;)V
    ...
    :try_start_a
    invoke-static {p1, p0}, LEg/J;->b(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    :goto_8
    invoke-interface {p2, v6}, LNg/a;->c(Ljava/lang/Object;)V

    throw p0
.end method

.method public tryLock(Llf/p;Laf/e;)Ljava/lang/Object;
    .locals 18
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct {v3, v1, v0}, Landroidx/datastore/core/MultiProcessCoordinator$tryLock$1;-><init>(Landroidx/datastore/core/MultiProcessCoordinator;Laf/e;)V
    ...
    :try_start_0
    invoke-static {v0}, LWe/l;->b(Ljava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget-object v5, v1, Landroidx/datastore/core/MultiProcessCoordinator;->inMemoryMutex:LNg/a;

    invoke-interface {v5, v8}, LNg/a;->a(Ljava/lang/Object;)Z
    ...
    invoke-interface {v2, v0, v3}, Llf/p;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v2, v8}, LNg/a;->c(Ljava/lang/Object;)V
    ...
    invoke-static {v12, v1, v11}, LCg/m;->P(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v1, v12, v11}, LCg/m;->P(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    :goto_7
    :try_start_8
    invoke-static {v4, v8}, LEg/J;->b(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_8
    .catchall {:try_start_8 .. :try_end_8} :catchall_5

    if-eqz v1, :cond_b

    invoke-interface {v3, v8}, LNg/a;->c(Ljava/lang/Object;)V
    ...
    :try_start_c
    invoke-static {v4, v3}, LEg/J;->b(Ljava/io/Closeable;Ljava/lang/Throwable;)V
