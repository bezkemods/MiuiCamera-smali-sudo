...
# instance fields
.field private final didRun:LEg/q;
...
.field private final runMutex:LNg/a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/datastore/core/RunOnce;->runMutex:LNg/a;

    invoke-static {}, LEg/v0;->a()LEg/r;

    move-result-object v0

    iput-object v0, p0, Landroidx/datastore/core/RunOnce;->didRun:LEg/q;
...
# virtual methods
.method public final awaitComplete(Laf/e;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p0, p0, Landroidx/datastore/core/RunOnce;->didRun:LEg/q;

    invoke-interface {p0, p1}, LEg/M;->l(Laf/e;)Ljava/lang/Object;
...
.method public abstract doRun(Laf/e;)Ljava/lang/Object;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Laf/e<",
...
.method public final runIfNeeded(Laf/e;)Ljava/lang/Object;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Landroidx/datastore/core/RunOnce$runIfNeeded$1;-><init>(Landroidx/datastore/core/RunOnce;Laf/e;)V
    ...
    iget-object p1, p0, Landroidx/datastore/core/RunOnce;->didRun:LEg/q;

    invoke-interface {p1}, LEg/p0;->v()Z
    ...
    :cond_4
    iget-object p1, p0, Landroidx/datastore/core/RunOnce;->runMutex:LNg/a;
    ...
    :goto_1
    :try_start_1
    iget-object v2, p0, Landroidx/datastore/core/RunOnce;->didRun:LEg/q;

    invoke-interface {v2}, LEg/p0;->v()Z
    ...
    invoke-interface {p1, v5}, LNg/a;->c(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/datastore/core/RunOnce;->doRun(Laf/e;)Ljava/lang/Object;
    ...
    :goto_2
    :try_start_3
    iget-object p1, v0, Landroidx/datastore/core/RunOnce;->didRun:LEg/q;

    sget-object v0, LWe/s;->a:LWe/s;

    invoke-interface {p1, v0}, LEg/q;->g(Ljava/lang/Object;)Z
    :try_end_3
