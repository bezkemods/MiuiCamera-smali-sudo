...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "name",
        "<init>",
        "(Llf/a;Ljava/util/Set;Llf/p;Llf/q;Landroid/content/Context;Ljava/lang/String;)V",
        "(Llf/a;Ljava/util/Set;Llf/p;Llf/q;)V",
        "sharedPreferencesName",
        "(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;Llf/p;Llf/q;)V",
        "LWe/s;",
        ...
        "currentData",
        "shouldMigrate",
        "(Ljava/lang/Object;Laf/e;)Ljava/lang/Object;",
        "cleanUp",
...
.field private final migrate:Llf/q;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Llf/q<",
            "Landroidx/datastore/migrations/SharedPreferencesView;",
...
.field private final sharedPrefs$delegate:LWe/f;

.field private final shouldRunMigration:Llf/p;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Llf/p<",
            "TT;",
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;Llf/p;Llf/q;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 24
    invoke-direct/range {v1 .. v7}, Landroidx/datastore/migrations/SharedPreferencesMigration;-><init>(Llf/a;Ljava/util/Set;Llf/p;Llf/q;Landroid/content/Context;Ljava/lang/String;)V

    return-void
.end method

.method public synthetic constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;Llf/p;Llf/q;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 6
    ...
    invoke-direct {p4, p3}, Landroidx/datastore/migrations/SharedPreferencesMigration$3;-><init>(Laf/e;)V
    ...
    .line 22
    invoke-direct/range {v0 .. v5}, Landroidx/datastore/migrations/SharedPreferencesMigration;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;Llf/p;Llf/q;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;Llf/q;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v1 .. v8}, Landroidx/datastore/migrations/SharedPreferencesMigration;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/util/Set;Llf/p;Llf/q;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Llf/q;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public constructor <init>(Llf/a;Ljava/util/Set;Llf/p;Llf/q;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public synthetic constructor <init>(Llf/a;Ljava/util/Set;Llf/p;Llf/q;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0
    ...
    invoke-direct {p3, p5}, Landroidx/datastore/migrations/SharedPreferencesMigration$2;-><init>(Laf/e;)V

    .line 18
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/datastore/migrations/SharedPreferencesMigration;-><init>(Llf/a;Ljava/util/Set;Llf/p;Llf/q;)V

    return-void
.end method

.method private constructor <init>(Llf/a;Ljava/util/Set;Llf/p;Llf/q;Landroid/content/Context;Ljava/lang/String;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    iput-object p3, p0, Landroidx/datastore/migrations/SharedPreferencesMigration;->shouldRunMigration:Llf/p;

    .line 7
    iput-object p4, p0, Landroidx/datastore/migrations/SharedPreferencesMigration;->migrate:Llf/q;
    ...
    iput-object p1, p0, Landroidx/datastore/migrations/SharedPreferencesMigration;->sharedPrefs$delegate:LWe/f;
    ...
    .line 12
    :cond_0
    invoke-static {p2}, LXe/u;->v0(Ljava/lang/Iterable;)Ljava/util/Set;
...
.method public synthetic constructor <init>(Llf/a;Ljava/util/Set;Llf/p;Llf/q;Landroid/content/Context;Ljava/lang/String;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 7
    ...
    invoke-direct {p3, p7}, Landroidx/datastore/migrations/SharedPreferencesMigration$1;-><init>(Laf/e;)V
    ...
    .line 15
    invoke-direct/range {v0 .. v6}, Landroidx/datastore/migrations/SharedPreferencesMigration;-><init>(Llf/a;Ljava/util/Set;Llf/p;Llf/q;Landroid/content/Context;Ljava/lang/String;)V

    return-void
.end method

.method public constructor <init>(Llf/a;Ljava/util/Set;Llf/q;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v1 .. v7}, Landroidx/datastore/migrations/SharedPreferencesMigration;-><init>(Llf/a;Ljava/util/Set;Llf/p;Llf/q;ILkotlin/jvm/internal/DefaultConstructorMarker;)V

    return-void
.end method

.method public constructor <init>(Llf/a;Llf/q;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private final getSharedPrefs()Landroid/content/SharedPreferences;
    ...
    iget-object p0, p0, Landroidx/datastore/migrations/SharedPreferencesMigration;->sharedPrefs$delegate:LWe/f;
...
.method private final getSharedPrefsFile(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p2, v0}, Landroidx/concurrent/futures/a;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
# virtual methods
.method public cleanUp(Laf/e;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public migrate(Ljava/lang/Object;Laf/e;)Ljava/lang/Object;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;",
    ...
    iget-object v0, p0, Landroidx/datastore/migrations/SharedPreferencesMigration;->migrate:Llf/q;
    ...
    invoke-interface {v0, v1, p1, p2}, Llf/q;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public shouldMigrate(Ljava/lang/Object;Laf/e;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;",
    ...
    invoke-direct {v0, p0, p2}, Landroidx/datastore/migrations/SharedPreferencesMigration$shouldMigrate$1;-><init>(Landroidx/datastore/migrations/SharedPreferencesMigration;Laf/e;)V
    ...
    iget-object p2, p0, Landroidx/datastore/migrations/SharedPreferencesMigration;->shouldRunMigration:Llf/p;
    ...
    invoke-interface {p2, p1, v0}, Llf/p;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
