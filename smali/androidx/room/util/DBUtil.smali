...
.method public static final dropFtsSyncTriggers(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    invoke-virtual {v0, v3}, LYe/b;->add(Ljava/lang/Object;)Z
    ...
    invoke-static {v0}, LBg/l;->g(LYe/b;)LYe/b;

    move-result-object v0

    invoke-virtual {v0, v4}, LYe/b;->listIterator(I)Ljava/util/ListIterator;
    ...
    check-cast v1, LYe/b$b;

    invoke-virtual {v1}, LYe/b$b;->hasNext()Z

    move-result v2

    if-eqz v2, :cond_2

    invoke-virtual {v1}, LYe/b$b;->next()Ljava/lang/Object;
    ...
    invoke-static {v1, v2, v4}, LCg/m;->P(Ljava/lang/String;Ljava/lang/String;Z)Z
