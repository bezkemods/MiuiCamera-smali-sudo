...
.method private static final readColumns(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Map;
    ...
    invoke-static {v2, v5}, LEg/J;->b(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    new-instance v10, LYe/c;

    invoke-direct {v10}, LYe/c;-><init>()V
    ...
    invoke-virtual {v10, v11, v5}, LYe/c;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_2
    invoke-virtual {v10}, LYe/c;->d()LYe/c;
    ...
    invoke-static {v2, v1}, LEg/J;->b(Ljava/io/Closeable;Ljava/lang/Throwable;)V
...
.method private static final readForeignKeyFieldMappings(Landroid/database/Cursor;)Ljava/util/List;
    ...
    invoke-virtual {v4, v5}, LYe/b;->add(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, LXe/u;->m0(Ljava/util/AbstractList;)Ljava/util/List;
...
.method private static final readForeignKeys(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    new-instance v6, LYe/g;

    invoke-direct {v6}, LYe/g;-><init>()V
    ...
    invoke-virtual {v6, v7}, LYe/g;->add(Ljava/lang/Object;)Z

    goto/16 :goto_0

    :cond_4
    invoke-static {v6}, LJg/i;->c(LYe/g;)LYe/g;
...
.method private static final readIndices(Landroidx/sqlite/db/SupportSQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    ...
    :cond_0
    new-instance v5, LYe/g;

    invoke-direct {v5}, LYe/g;-><init>()V
    ...
    :cond_3
    :try_start_1
    invoke-virtual {v5, v7}, LYe/g;->add(Ljava/lang/Object;)Z
    ...
    :cond_4
    invoke-static {v5}, LJg/i;->c(LYe/g;)LYe/g;
