...
.method public final build(Ljava/util/List;)Landroidx/room/AmbiguousColumnResolver$Solution;
    ...
    invoke-virtual {v3}, Landroidx/room/AmbiguousColumnResolver$Match;->getResultRange()Lrf/d;

    move-result-object v5

    iget v5, v5, Lrf/b;->b:I

    invoke-virtual {v3}, Landroidx/room/AmbiguousColumnResolver$Match;->getResultRange()Lrf/d;

    move-result-object v6

    iget v6, v6, Lrf/b;->a:I
    ...
    invoke-virtual {v5}, Landroidx/room/AmbiguousColumnResolver$Match;->getResultRange()Lrf/d;

    move-result-object v5

    iget v5, v5, Lrf/b;->a:I
    ...
    invoke-virtual {v6}, Landroidx/room/AmbiguousColumnResolver$Match;->getResultRange()Lrf/d;

    move-result-object v6

    iget v6, v6, Lrf/b;->b:I
    ...
    invoke-direct {v0, v3, v5, v4}, Lrf/b;-><init>(III)V
    ...
    :cond_5
    invoke-virtual {v0}, Lrf/b;->iterator()Ljava/util/Iterator;
    ...
    invoke-virtual {v5}, LXe/C;->nextInt()I
    ...
    invoke-virtual {v8}, Landroidx/room/AmbiguousColumnResolver$Match;->getResultRange()Lrf/d;

    move-result-object v8

    iget v9, v8, Lrf/b;->a:I

    if-gt v9, v5, :cond_8

    iget v8, v8, Lrf/b;->b:I
