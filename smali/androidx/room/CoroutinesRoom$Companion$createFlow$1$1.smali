...
# instance fields
.field final synthetic $$this$flow:LHg/f;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LHg/f<",
            "TR;>;"
...
# direct methods
.method public constructor <init>(ZLandroidx/room/RoomDatabase;LHg/f;[Ljava/lang/String;Ljava/util/concurrent/Callable;Laf/e;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    iput-object p3, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->$$this$flow:LHg/f;
...
.method public final create(Ljava/lang/Object;Laf/e;)Laf/e;
    ...
    iget-object v3, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->$$this$flow:LHg/f;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;-><init>(ZLandroidx/room/RoomDatabase;LHg/f;[Ljava/lang/String;Ljava/util/concurrent/Callable;Laf/e;)V
...
.method public final invoke(LEg/F;Laf/e;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->create(Ljava/lang/Object;Laf/e;)Laf/e;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->invoke(LEg/F;Laf/e;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v1, v3, v4}, LGg/k;->a(ILGg/a;I)LGg/c;
    ...
    invoke-direct {v7, v1, v8}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$observer$1;-><init>([Ljava/lang/String;LGg/h;)V

    sget-object v1, LWe/s;->a:LWe/s;

    invoke-interface {v8, v1}, LGg/y;->j(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {v4, v5}, Laf/h;->get(Laf/h$b;)Laf/h$a;
    ...
    invoke-virtual {v4}, Landroidx/room/TransactionElement;->getTransactionDispatcher$room_ktx_release()Laf/f;
    ...
    invoke-static {v4}, Landroidx/room/CoroutinesRoomKt;->getTransactionDispatcher(Landroidx/room/RoomDatabase;)LEg/C;
    ...
    invoke-static {v4}, Landroidx/room/CoroutinesRoomKt;->getQueryDispatcher(Landroidx/room/RoomDatabase;)LEg/C;
    ...
    invoke-static {v5, v3, v6}, LGg/k;->a(ILGg/a;I)LGg/c;
    ...
    invoke-direct/range {v5 .. v11}, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$1;-><init>(Landroidx/room/RoomDatabase;Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1$observer$1;LGg/h;Ljava/util/concurrent/Callable;LGg/h;Laf/e;)V

    const/4 v5, 0x2

    invoke-static {p1, v4, v12, v5}, LEg/f;->b(LEg/F;Laf/f;Llf/p;I)LEg/C0;

    iget-object p1, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->$$this$flow:LHg/f;

    iput v2, p0, Landroidx/room/CoroutinesRoom$Companion$createFlow$1$1;->label:I

    invoke-static {p1, v3, v2, p0}, LCh/j;->c(LHg/f;LGg/h;ZLcf/c;)Ljava/lang/Object;
