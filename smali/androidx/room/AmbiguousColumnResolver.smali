...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "onHashMatch",
        "rabinKarpSearch",
        "(Ljava/util/List;[Ljava/lang/String;Llf/q;)V",
        "T",
        "",
        "current",
        "depth",
        ...
        "block",
        "dfs",
        "(Ljava/util/List;Ljava/util/List;ILlf/l;)V",
        "Match",
        "ResultColumn",
        "Solution",
        "room-common"
...
.method private final dfs(Ljava/util/List;Ljava/util/List;ILlf/l;)V
    .locals 2
    ...
    invoke-static {p2}, LXe/u;->s0(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object p0

    invoke-interface {p4, p0}, Llf/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1, p2, v1, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILlf/l;)V

    invoke-static {p2}, LXe/q;->K(Ljava/util/List;)V
...
.method public static synthetic dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILlf/l;ILjava/lang/Object;)V
    .locals 0
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILlf/l;)V

    return-void
.end method

.method private final rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Llf/q;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3, p2, v3, v4}, Llf/q;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final resolve([Ljava/lang/String;[[Ljava/lang/String;)[[I
    ...
    invoke-static {v2, v6}, LXe/q;->I(Ljava/util/Collection;[Ljava/lang/Object;)V
    ...
    :cond_4
    invoke-static {v2}, LJg/i;->c(LYe/g;)LYe/g;
    ...
    iget-object v10, v2, LYe/g;->a:LYe/c;

    invoke-virtual {v10, v8}, LYe/c;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v4, v10}, LYe/b;->add(Ljava/lang/Object;)Z
    ...
    :cond_6
    invoke-static {v4}, LBg/l;->g(LYe/b;)LYe/b;
    ...
    invoke-direct {v9, v0, v7, v10}, Landroidx/room/AmbiguousColumnResolver;->rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Llf/q;)V
    ...
    invoke-virtual {v0, v3}, LYe/b;->listIterator(I)Ljava/util/ListIterator;
    ...
    check-cast v15, LYe/b$b;

    invoke-virtual {v15}, LYe/b$b;->hasNext()Z

    move-result v16

    if-eqz v16, :cond_9

    invoke-virtual {v15}, LYe/b$b;->next()Ljava/lang/Object;
    ...
    invoke-virtual {v13, v3}, LYe/b;->add(Ljava/lang/Object;)Z
    ...
    :cond_9
    invoke-static {v13}, LBg/l;->g(LYe/b;)LYe/b;

    move-result-object v3

    invoke-virtual {v3}, LYe/b;->isEmpty()Z
    ...
    invoke-static {v0, v12, v1}, LA/Q;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v10 .. v16}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILlf/l;ILjava/lang/Object;)V
    ...
    invoke-static/range {v4 .. v10}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILlf/l;ILjava/lang/Object;)V
