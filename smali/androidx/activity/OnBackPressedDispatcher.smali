...
.field private final onBackPressedCallbacks:LXe/h;
...
.method public constructor <init>(Ljava/lang/Runnable;Landroidx/core/util/Consumer;)V
    ...
    iput-object p1, p0, Landroidx/activity/OnBackPressedDispatcher;->onBackPressedCallbacks:LXe/h;
    ...
    invoke-virtual {p1, p2, v0, v1, v2}, Landroidx/activity/OnBackPressedDispatcher$Api34Impl;->createOnBackAnimationCallback(Llf/l;Llf/l;Llf/a;Llf/a;)Landroid/window/OnBackInvokedCallback;
    ...
    invoke-virtual {p1, p2}, Landroidx/activity/OnBackPressedDispatcher$Api33Impl;->createOnBackInvokedCallback(Llf/a;)Landroid/window/OnBackInvokedCallback;
...
.method public static final synthetic access$getOnBackPressedCallbacks$p(Landroidx/activity/OnBackPressedDispatcher;)LXe/h;
    .locals 0

    iget-object p0, p0, Landroidx/activity/OnBackPressedDispatcher;->onBackPressedCallbacks:LXe/h;
...
.method private final onBackCancelled()V
    ...
    iget-object v0, p0, Landroidx/activity/OnBackPressedDispatcher;->onBackPressedCallbacks:LXe/h;
...
.method private final updateEnabledCallbacks()V
    ...
    iget-object v1, p0, Landroidx/activity/OnBackPressedDispatcher;->onBackPressedCallbacks:LXe/h;

    const/4 v2, 0x0

    if-eqz v1, :cond_0

    invoke-virtual {v1}, LXe/h;->isEmpty()Z
...
.method public final addCallback(Landroidx/lifecycle/LifecycleOwner;Landroidx/activity/OnBackPressedCallback;)V
    ...
    invoke-virtual {p2, p1}, Landroidx/activity/OnBackPressedCallback;->setEnabledChangedCallback$activity_release(Llf/a;)V
...
.method public final addCancellableCallback$activity_release(Landroidx/activity/OnBackPressedCallback;)Landroidx/activity/Cancellable;
    ...
    invoke-virtual {v0, p1}, LXe/h;->addLast(Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v1}, Landroidx/activity/OnBackPressedCallback;->setEnabledChangedCallback$activity_release(Llf/a;)V
