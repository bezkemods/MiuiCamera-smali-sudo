...
.method static constructor <clinit>()V
    ...
    sput-object v0, LA/W3;->q:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public static b(Landroid/database/Cursor;)LA/W3$a;
    .locals 19
    ...
    invoke-static {v2, v3}, LXb/t;->n(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_1
    invoke-direct/range {v4 .. v16}, LA/W3$a;-><init>(JIJLjava/lang/String;IIZZJ)V
    :try_end_1
    ...
    invoke-static {v0, v3}, LA/N2;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LA/W3;
    .locals 11
    ...
    :cond_0
    new-instance v3, LA/W3;

    invoke-direct {v3}, Ljava/lang/Object;-><init>()V

    iput-boolean v1, v3, LA/W3;->c:Z

    iput-boolean v1, v3, LA/W3;->d:Z

    iput-boolean v1, v3, LA/W3;->e:Z

    iput-boolean v1, v3, LA/W3;->h:Z

    const/4 v4, -0x1

    iput v4, v3, LA/W3;->i:I

    iput v4, v3, LA/W3;->j:I

    const-wide/16 v4, -0x1

    iput-wide v4, v3, LA/W3;->k:J

    iput-boolean v1, v3, LA/W3;->l:Z

    iput-object v0, v3, LA/W3;->o:Ljava/lang/Boolean;

    const/4 v4, 0x1

    iput-boolean v4, v3, LA/W3;->p:Z

    iput-object p0, v3, LA/W3;->a:Landroid/net/Uri;
    ...
    :goto_2
    iput-object p1, v3, LA/W3;->b:Landroid/graphics/Bitmap;

    return-object v3
.end method

.method public static d([BIILandroid/net/Uri;)LA/W3;
    .locals 4
    ...
    :cond_0
    invoke-static {p0}, Lf8/a;->c([B)Lf8/b;

    move-result-object v0

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Lf8/b;->u()Landroid/graphics/Bitmap;
    ...
    :cond_2
    invoke-static {p3, v0, p1, v1}, LA/W3;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LA/W3;
...
.method public static e(Landroid/content/Context;Landroid/net/Uri;)LA/W3;
    .locals 25
    ...
    invoke-static {v7, v1}, LA/N2;->d(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v3, v4, v5, v10}, LA/W3;->k(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v6, v14, v5, v10}, LA/W3;->m(IIILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {v18 .. v24}, LA/W3;->f(Landroid/media/MediaMetadataRetriever;Ljava/lang/String;Ljava/io/FileDescriptor;Landroid/app/Application;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    :goto_c
    invoke-static {v7, v0, v1, v1}, LA/W3;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LA/W3;

    move-result-object v0

    if-eqz v0, :cond_10

    invoke-virtual {v0, v8, v9}, LA/W3;->o(J)V
...
.method public static f(Landroid/media/MediaMetadataRetriever;Ljava/lang/String;Ljava/io/FileDescriptor;Landroid/app/Application;Landroid/net/Uri;II)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {p1 .. p6}, LA/W3;->g(Landroid/media/MediaMetadataRetriever;IIIILandroid/media/MediaMetadataRetriever$BitmapParams;)Landroid/graphics/Bitmap;
...
.method public static h(Landroid/content/ContentResolver;)LA/W3$a;
    .locals 11
    ...
    invoke-static {v3, v4}, Landroidx/concurrent/futures/a;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v5}, Landroidx/concurrent/futures/a;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v4}, LA3/H2;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    sget-object v4, Ll4/C;->c:Ljava/lang/String;
    ...
    invoke-static {v6}, LA/W3;->b(Landroid/database/Cursor;)LA/W3$a;
    ...
    invoke-static {p0}, LA/W3;->b(Landroid/database/Cursor;)LA/W3$a;
...
.method public static i(Landroid/content/Context;Landroid/content/ContentResolver;)LA/W3;
    .locals 23
    ...
    sget-object v2, LA/W3;->q:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    invoke-static {v15}, LXb/c;->b(Ljava/io/Closeable;)V

    invoke-static {v12}, LXb/c;->b(Ljava/io/Closeable;)V

    invoke-static {v14}, LXb/c;->b(Ljava/io/Closeable;)V
    ...
    invoke-static {v1, v4}, LXb/c;->i(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    invoke-static {v4, v0, v1, v1}, LA/W3;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LA/W3;

    move-result-object v0

    if-eqz v0, :cond_b

    iput-boolean v5, v0, LA/W3;->e:Z

    iput v2, v0, LA/W3;->i:I

    iput v9, v0, LA/W3;->j:I

    const/4 v1, 0x1

    iput-boolean v1, v0, LA/W3;->c:Z

    iput-boolean v7, v0, LA/W3;->h:Z

    invoke-virtual {v0, v10, v11}, LA/W3;->o(J)V

    sget v1, LA/W3;->s:I

    iput v1, v0, LA/W3;->m:I
    ...
    invoke-static/range {v16 .. v16}, LXb/c;->b(Ljava/io/Closeable;)V
...
.method public static j(J)LA/W3;
    .locals 18
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    invoke-direct {v10, v0}, Ljj/d;-><init>(Lfj/a;)V

    invoke-static {v7}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v0

    iput-object v0, v10, Ljj/d;->f:Ljava/lang/Integer;

    sget-object v0, Lcom/android/camera/db/greendao/SaveTaskDao$Properties;->Id:Lfj/d;

    filled-new-array {v0}, [Lfj/d;

    move-result-object v0

    invoke-virtual {v10, v0}, Ljj/d;->b([Lfj/d;)V

    invoke-virtual {v10}, Ljj/d;->a()Ljj/c;
    ...
    iget-object v11, v0, Ljj/a;->e:Ljava/lang/Thread;

    if-ne v10, v11, :cond_0

    iget-object v10, v0, Ljj/a;->a:Lfj/a;

    iget-object v10, v10, Lfj/a;->b:LJa/b;

    iget-object v10, v10, LJa/b;->a:Ljava/lang/Object;

    check-cast v10, Landroid/database/sqlite/SQLiteDatabase;

    iget-object v11, v0, Ljj/a;->c:Ljava/lang/String;

    iget-object v12, v0, Ljj/a;->d:[Ljava/lang/String;
    ...
    iget-object v0, v0, Ljj/a;->b:LG1/l;
    ...
    :try_start_1
    invoke-virtual {v0, v10}, Lfj/a;->h(Landroid/database/Cursor;)Ljava/util/ArrayList;
    ...
    invoke-static {v2, v1}, Ll4/C;->w(Landroid/content/ContextWrapper;Landroid/net/Uri;)Z
    ...
    invoke-static {v1, v2, v0, v6}, LA/W3;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LA/W3;
    ...
    invoke-virtual {v0, v1, v2}, LA/W3;->o(J)V
...
.method public static k(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static/range {p0 .. p4}, LA/W3;->l(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
...
.method public static l(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p0, p4, v8}, Ll4/C;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
...
.method public final o(J)V
    ...
    iput-wide p1, p0, LA/W3;->k:J

    const-string v0, "setFileSize: "

    const-string v1, ", mUri: "

    invoke-static {p1, p2, v0, v1}, LA/l2;->c(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-object p2, p0, LA/W3;->a:Landroid/net/Uri;
...
.method public final p(J)V
    ...
    iput-object v0, p0, LA/W3;->f:Ljava/lang/String;
    ...
    iput-object p1, p0, LA/W3;->g:Ljava/lang/String;
...
.method public final q(Landroid/net/Uri;)V
    ...
    iget-object v0, p0, LA/W3;->a:Landroid/net/Uri;
    ...
    iput-object p1, p0, LA/W3;->a:Landroid/net/Uri;

    iput-boolean v2, p0, LA/W3;->d:Z
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, LA/W3;->a:Landroid/net/Uri;
    ...
    iget-object v1, p0, LA/W3;->b:Landroid/graphics/Bitmap;
