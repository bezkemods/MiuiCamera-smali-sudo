...
.field public final f:LA/b3$a;

.field public final g:LA/H1;

.field public final h:LA/y;
...
.method public constructor <init>(Lcom/android/camera/Camera;)V
    ...
    iput-boolean v0, p0, LA/b3;->c:Z

    new-instance v0, LA/b3$a;

    invoke-direct {v0, p0}, LA/b3$a;-><init>(LA/b3;)V

    iput-object v0, p0, LA/b3;->f:LA/b3$a;
    ...
    iput-object v0, p0, LA/b3;->g:LA/H1;

    new-instance v0, LA/y;

    invoke-direct {v0, p0, v1}, LA/y;-><init>(Ljava/lang/Object;I)V

    iput-object v0, p0, LA/b3;->h:LA/y;

    new-instance v0, Ljava/lang/ref/WeakReference;

    invoke-direct {v0, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, LA/b3;->a:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static a(Lcom/android/camera/Camera;LA/W3;Landroid/net/Uri;Landroid/graphics/Rect;F)Landroid/content/Intent;
    .locals 8
    ...
    sget-object p2, LA/F2$a;->a:LA/F2;

    iget p2, p2, LA/F2;->g:F
    ...
    invoke-static {v1, v2}, LXb/f;->w(Landroid/content/Intent;Z)V
    ...
    invoke-static {p2}, Lic/a;->a(Landroid/content/Context;)Z
    ...
    iget-boolean p2, p1, LA/W3;->e:Z

    if-eqz p2, :cond_d

    iget p2, p1, LA/W3;->i:I
    ...
    invoke-static {p3, p2}, LA/B2;->f(Landroid/graphics/Rect;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, L炤炨炪烩炪炮烩炣炢炱炮炤炢烩炤炨炪炪炨炩烩炄炨炪炪炨炩;->E1()Z
...
.method public static b(Lcom/android/camera/Camera;Landroid/net/Uri;)V
    ...
    invoke-static {v2}, Lo0/b;->F(Ljava/lang/Long;)Lm0/b;
    ...
    invoke-static {p0, p1}, Ll4/C;->w(Landroid/content/ContextWrapper;Landroid/net/Uri;)Z
    ...
    invoke-static {p0, p1}, LXb/c;->i(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    invoke-static {p1, v2, v0, p0}, LA/M;->f(Ljava/lang/String;Ljava/lang/String;ZZ)Ljava/lang/String;
...
# virtual methods
.method public final c(LA/W3;Lcom/android/camera/Camera;)V
    .locals 8
    .param p1    # LA/W3;
    ...
    invoke-virtual {p2}, Lcom/android/camera/ActivityBase;->cj()Z
    ...
    invoke-virtual {v4}, L炤炨炪烩炪炮烩炣炢炱炮炤炢烩炤炨炪炪炨炩烩炄炨炪炪炨炩;->w4()Z
    ...
    :cond_1
    invoke-virtual {p2}, Lcom/android/camera/ActivityBase;->Si()Lcom/xiaomi/camera/base/viewmodels/CameraMainViewModel;

    move-result-object p2

    iget-object p2, p2, Lcom/xiaomi/camera/base/viewmodels/CameraMainViewModel;->i:Lcom/android/camera/module/J;

    invoke-interface {p2}, Lcom/android/camera/module/J;->isPurePreview()Z

    move-result p2

    if-eqz p2, :cond_2

    sget-object v4, LDe/a;->h:LDe/a;

    invoke-virtual {v3, v4, p2}, Lo5/f;->z(LDe/a;Z)V

    goto :goto_1

    :cond_2
    sget-object p2, LDe/a;->h:LDe/a;

    invoke-virtual {v3, p2}, Lo5/f;->y(LDe/a;)V
    ...
    :cond_4
    :goto_1
    iget-object p2, p0, LA/b3;->b:Landroid/os/Messenger;
    ...
    invoke-virtual {p2}, L炤炨炪烩炪炮烩炣炢炱炮炤炢烩炤炨炪炪炨炩烩炄炨炪炪炨炩;->E1()Z

    move-result p2

    if-eqz p2, :cond_7

    iget p2, p1, LA/W3;->m:I
    ...
    :cond_7
    :goto_2
    sget-object p2, LA/L3;->f:LA/L3$a;

    invoke-virtual {p2}, LWb/d;->b()Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v4, p1, LA/W3;->a:Landroid/net/Uri;

    iget-object v5, p1, LA/W3;->b:Landroid/graphics/Bitmap;

    invoke-virtual {p2, v4, v5}, LA/L3;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;)Z
    ...
    :cond_8
    :try_start_1
    invoke-virtual {p2}, LA/L3;->c()Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v2, p0, LA/b3;->b:Landroid/os/Messenger;
    ...
    :try_start_3
    iget-object v7, p2, LA/L3;->e:Landroid/net/Uri;
    :try_end_3
    ...
    iget-object p1, p1, LA/W3;->o:Ljava/lang/Boolean;
    ...
    iget-object p1, p0, LA/b3;->b:Landroid/os/Messenger;
    ...
    iget-object p0, p0, LA/b3;->b:Landroid/os/Messenger;
