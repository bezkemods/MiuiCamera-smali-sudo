...
# direct methods
.method public constructor <init>(ZZLjava/lang/ref/WeakReference;LA/Z3;LA/W3;)V
    .locals 1
    ...
    iput v0, p0, LA/Z3$b;->n:I

    iput-boolean p1, p0, LA/Z3$b;->h:Z

    iput-boolean p2, p0, LA/Z3$b;->i:Z

    iput-object p3, p0, LA/Z3$b;->k:Ljava/lang/ref/WeakReference;

    new-instance p1, Ljava/lang/ref/WeakReference;

    invoke-direct {p1, p4}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, LA/Z3$b;->l:Ljava/lang/ref/WeakReference;

    new-instance p1, Ljava/lang/ref/WeakReference;

    invoke-direct {p1, p5}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, LA/Z3$b;->m:Ljava/lang/ref/WeakReference;
...
.method public final e([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-boolean v3, v1, LA/Z3$b;->h:Z
    ...
    iget-object v2, v1, LA/Z3$b;->k:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {v6}, LA/W3;->h(Landroid/content/ContentResolver;)LA/W3$a;
    ...
    :cond_2
    iget-object v8, v7, LA/W3$a;->d:Landroid/net/Uri;

    :goto_2
    const-string v9, "LoadThumbnailTask: lastUri = "

    invoke-static {v8, v9}, LA/N2;->d(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v9, v1, LA/Z3$b;->m:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {v12, v13}, LA/N2;->d(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v12}, LXb/c;->i(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    :cond_3
    iget-wide v14, v7, LA/W3$a;->j:J

    :goto_3
    invoke-virtual {v9, v14, v15}, LA/W3;->o(J)V
    ...
    :cond_6
    :goto_5
    iput-boolean v11, v1, LA/Z3$b;->h:Z
    ...
    invoke-static {v12}, Lo0/b;->F(Ljava/lang/Long;)Lm0/b;
    ...
    iget-boolean v0, v1, LA/Z3$b;->h:Z

    if-eqz v0, :cond_e

    invoke-static {v2, v6}, LA/W3;->i(Landroid/content/Context;Landroid/content/ContentResolver;)LA/W3;
    ...
    iget-object v6, v0, LA/W3;->a:Landroid/net/Uri;
    ...
    :cond_d
    iput-boolean v11, v1, LA/Z3$b;->i:Z
    ...
    :cond_f
    new-array v8, v11, [LA/W3;

    const/4 v9, 0x2

    iput v9, v1, LA/Z3$b;->n:I

    invoke-virtual {v2}, Lcom/android/camera/ActivityBase;->Zb()LXb/f;

    move-result-object v12

    iget-object v12, v12, LXb/f;->a:Landroid/content/Intent;

    invoke-static {v12}, LXb/f;->n(Landroid/content/Intent;)Z
    ...
    invoke-virtual {v2}, Lcom/android/camera/ActivityBase;->Yi()Z
    ...
    invoke-static {v12}, LA/W3;->h(Landroid/content/ContentResolver;)LA/W3$a;
    ...
    invoke-static/range {v16 .. v17}, LA/W3;->j(J)LA/W3;
    ...
    iget-object v0, v0, LA/W3;->a:Landroid/net/Uri;
    ...
    :cond_14
    iget-boolean v13, v9, LA/W3$a;->i:Z
    ...
    iget-wide v10, v4, LA/W3$a;->c:J

    invoke-static {v10, v11}, LA/W3;->j(J)LA/W3;
    ...
    iget-object v2, v10, LA/W3;->a:Landroid/net/Uri;
    ...
    iget-object v10, v4, LA/W3$a;->d:Landroid/net/Uri;
    ...
    invoke-static {v10, v0}, LA/N2;->d(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v10, v4, LA/W3$a;->e:Ljava/lang/String;
    ...
    iget v13, v4, LA/W3$a;->b:I

    move-object/from16 v21, v6

    move-object/from16 v20, v7

    iget-wide v6, v4, LA/W3$a;->a:J
    ...
    invoke-static {v2, v6, v7, v13, v10}, LA/W3;->l(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    sget-boolean v19, Lw7/c;->k:Z

    if-eqz v19, :cond_1a

    invoke-static {v2, v6, v7, v13, v10}, LA/W3;->k(Landroid/content/Context;JILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    iget v0, v4, LA/W3$a;->f:I

    iget v2, v4, LA/W3$a;->g:I

    invoke-static {v0, v2, v13, v10}, LA/W3;->m(IIILjava/lang/String;)Landroid/graphics/Bitmap;
    ...
    iget-object v3, v9, LA/W3$a;->d:Landroid/net/Uri;
    ...
    iget-object v2, v9, LA/W3$a;->d:Landroid/net/Uri;
    ...
    :cond_1d
    iget-object v0, v9, LA/W3$a;->e:Ljava/lang/String;
    ...
    invoke-static {v2, v3}, LA/W3;->e(Landroid/content/Context;Landroid/net/Uri;)LA/W3;

    move-result-object v2

    if-eqz v2, :cond_1f

    iget-object v0, v2, LA/W3;->b:Landroid/graphics/Bitmap;
    ...
    :cond_20
    :goto_11
    iget-object v0, v4, LA/W3$a;->d:Landroid/net/Uri;

    invoke-static {v12, v0}, LXb/c;->i(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    invoke-static {v0, v3}, LA/N2;->d(Landroid/net/Uri;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v2, v6, v6}, LA/W3;->c(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)LA/W3;
    ...
    iget-boolean v2, v4, LA/W3$a;->h:Z

    if-eqz v2, :cond_21

    const/4 v2, 0x1

    iput-boolean v2, v0, LA/W3;->e:Z

    iget v2, v4, LA/W3$a;->f:I

    iput v2, v0, LA/W3;->i:I

    iget v2, v4, LA/W3$a;->g:I

    iput v2, v0, LA/W3;->j:I

    :cond_21
    iget-wide v2, v4, LA/W3$a;->j:J

    invoke-virtual {v0, v2, v3}, LA/W3;->o(J)V
    ...
    invoke-static {v3, v0, v14}, LMf/f;->g(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :goto_15
    iput-boolean v3, v1, LA/Z3$b;->i:Z
    ...
    invoke-static {v7, v3}, LXb/c;->i(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    :cond_2c
    iput-boolean v2, v1, LA/Z3$b;->j:Z
    ...
    iget-wide v2, v1, LA/W3$a;->c:J

    goto :goto_1c

    :goto_1d
    invoke-virtual {v4, v2, v3}, LA/W3;->p(J)V
    ...
    :cond_30
    iget-boolean v3, v1, LA/W3$a;->i:Z

    :goto_1e
    iput-boolean v3, v4, LA/W3;->h:Z
    ...
    :cond_32
    iget-wide v3, v1, LA/W3$a;->c:J

    :goto_20
    invoke-virtual {v0, v3, v4}, LA/W3;->p(J)V
...
.method public final h(Ljava/lang/Object;)V
    ...
    iget-boolean v2, p0, LA/Z3$b;->j:Z
    ...
    iget-object v0, p0, LA/Z3$b;->l:Ljava/lang/ref/WeakReference;
    ...
    iget-boolean v1, p0, LA/Z3$b;->j:Z
    ...
    :cond_1
    iget-object v1, v0, LA/Z3;->a:LA/W3;
    ...
    iget-boolean p0, p0, LA/Z3$b;->i:Z

    const/4 v1, 0x1

    invoke-virtual {v0, p1, v1, v2, p0}, LA/Z3;->g(LA/W3;ZZZ)V
