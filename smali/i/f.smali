...
# direct methods
.method public static a(Li/l;Li/n;Lorg/w3c/dom/Node;Ljava/lang/String;Z)Li/n;
    .locals 7
    ...
    :cond_0
    invoke-virtual {v0, v1}, Li/q;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    invoke-virtual {v0, v1, v3}, Li/q;->e(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p1, p0, Li/l;->a:Li/n;

    invoke-static {p1, v1, v4, v6}, Li/o;->e(Li/n;Ljava/lang/String;Ljava/lang/String;Z)Li/n;

    move-result-object p1

    iput-boolean v5, p1, Li/n;->g:Z

    invoke-virtual {v0, p2}, Li/q;->a(Ljava/lang/String;)Ll/a;
    ...
    iput-boolean v6, p0, Li/n;->h:Z

    iput-boolean v6, p1, Li/n;->h:Z
    ...
    invoke-direct {v1, p2, p3, v3}, Li/n;-><init>(Ljava/lang/String;Ljava/lang/String;Lk/e;)V

    iput-boolean v5, v1, Li/n;->i:Z

    if-nez v0, :cond_4

    invoke-virtual {p1, v1}, Li/n;->b(Li/n;)V

    goto :goto_1

    :cond_4
    invoke-virtual {p1, v6, v1}, Li/n;->a(ILi/n;)V
    ...
    iput-object p0, v1, Li/n;->a:Ljava/lang/String;
...
.method public static b(Li/n;Ljava/lang/String;Ljava/lang/String;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lh/c;
    ...
    invoke-direct {v1, p1, p2, v0}, Li/n;-><init>(Ljava/lang/String;Ljava/lang/String;Lk/e;)V

    invoke-virtual {p0, v1}, Li/n;->c(Li/n;)V

    return-void
.end method

.method public static c(Li/n;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lh/c;
    ...
    invoke-virtual {p0, v0}, Li/n;->h(I)Li/n;
    ...
    invoke-virtual {v1, v0}, Li/n;->l(I)Li/n;

    move-result-object v2

    invoke-virtual {v1, v2}, Li/n;->r(Li/n;)V

    invoke-virtual {p0, v2}, Li/n;->c(Li/n;)V
    ...
    :cond_1
    :goto_0
    iget-object v2, v1, Li/n;->e:Ljava/util/ArrayList;
    ...
    :goto_3
    iget-object v0, v1, Li/n;->b:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1}, Li/n;->b(Li/n;)V
...
.method public static f(Li/l;Li/n;Lorg/w3c/dom/Node;Z)V
    .locals 16
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lh/c;
    ...
    invoke-static {v0, v8, v9, v4, v10}, Li/f;->a(Li/l;Li/n;Lorg/w3c/dom/Node;Ljava/lang/String;Z)Li/n;
    ...
    invoke-static {v8, v6, v5}, Li/f;->b(Li/n;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v8, v14, v5}, Li/f;->b(Li/n;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v8, v5, v6, v7}, Li/f;->a(Li/l;Li/n;Lorg/w3c/dom/Node;Ljava/lang/String;Z)Li/n;
...
.method public static g(Li/l;Li/n;Lorg/w3c/dom/Node;Z)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lh/c;
    ...
    invoke-static {p0, p1, p2, v0, p3}, Li/f;->a(Li/l;Li/n;Lorg/w3c/dom/Node;Ljava/lang/String;Z)Li/n;
    ...
    invoke-static {p0, v5, v0}, Li/f;->b(Li/n;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p3}, Landroidx/constraintlayout/core/a;->g(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :cond_6
    iput-object p3, p0, Li/n;->b:Ljava/lang/String;

    return-void
.end method

.method public static h(Li/l;Li/n;Lorg/w3c/dom/Node;Z)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lh/c;
    ...
    iget-object v5, p1, Li/n;->a:Ljava/lang/String;
    ...
    iput-object v4, p1, Li/n;->a:Ljava/lang/String;
    ...
    invoke-static {p0, p1, v4, v5, p3}, Li/f;->a(Li/l;Li/n;Lorg/w3c/dom/Node;Ljava/lang/String;Z)Li/n;
    ...
    :cond_c
    invoke-static {p0, p1, p2, p3}, Li/f;->i(Li/l;Li/n;Lorg/w3c/dom/Node;Z)V

    return-void
.end method

.method public static i(Li/l;Li/n;Lorg/w3c/dom/Node;Z)V
    .locals 16
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lh/c;
    ...
    :cond_a
    :goto_7
    invoke-static {v0, v1, v5, v2}, Li/f;->f(Li/l;Li/n;Lorg/w3c/dom/Node;Z)V
    ...
    invoke-static {v0, v1, v5, v2}, Li/f;->g(Li/l;Li/n;Lorg/w3c/dom/Node;Z)V
    ...
    invoke-static {v0, v1, v5, v13, v2}, Li/f;->a(Li/l;Li/n;Lorg/w3c/dom/Node;Ljava/lang/String;Z)Li/n;

    move-result-object v3

    invoke-virtual {v3}, Li/n;->k()Lk/e;
    ...
    invoke-static {v3, v15, v8}, Li/f;->b(Li/n;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v3, v5, v7}, Li/f;->i(Li/l;Li/n;Lorg/w3c/dom/Node;Z)V

    iget-boolean v5, v3, Li/n;->j:Z

    if-eqz v5, :cond_0

    invoke-static {v3}, Li/f;->c(Li/n;)V
    ...
    invoke-static {v3, v15, v6}, Li/f;->b(Li/n;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3, v9, v8}, Li/f;->b(Li/n;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_11
    invoke-static {v0, v3, v6, v12}, Li/f;->h(Li/l;Li/n;Lorg/w3c/dom/Node;Z)V

    iget-boolean v6, v3, Li/n;->j:Z
    ...
    invoke-virtual {v3}, Li/n;->n()Z

    move-result v6

    if-eqz v6, :cond_24

    invoke-virtual {v3}, Li/n;->p()Ljava/util/Iterator;
    ...
    invoke-static {v3}, Li/o;->h(Li/n;)V
