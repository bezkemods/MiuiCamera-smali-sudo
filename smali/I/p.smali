...
.method public final a()LH/m;
    ...
    sget-object v4, LI/d;->c:Ljava/lang/Boolean;

    if-nez v4, :cond_0

    const-string v4, "cam.app.use.debug.gps"

    invoke-static {v4, v3}, LWb/f;->c(Ljava/lang/String;Z)Z
    ...
    sput-object v4, LI/d;->c:Ljava/lang/Boolean;
    ...
    :goto_0
    invoke-virtual/range {p0 .. p0}, LI/p;->c()Ljava/util/HashMap;
    ...
    iget-wide v11, v10, LH/h;->a:D

    iget-wide v13, v10, LH/h;->b:D
    ...
    :goto_1
    iget-wide v12, v10, LH/h;->c:D

    iget-wide v14, v10, LH/h;->d:D
    ...
    invoke-virtual/range {p0 .. p0}, LI/p;->d()Ljava/util/ArrayList;
    ...
    iget-object v3, v1, LH/m;->a:Ljava/lang/String;
