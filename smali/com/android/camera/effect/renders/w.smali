...
.method public constructor <init>(Lf6/g;ILW0/b;Landroid/app/Application;)V
    .locals 0
    ...
    iput-object p3, p0, Lcom/android/camera/effect/renders/w;->c:LW0/b;

    if-eqz p3, :cond_0

    iget-boolean p1, p3, LW0/z;->h:Z

    if-nez p1, :cond_0

    invoke-virtual {p3, p4}, LW0/z;->a(Landroid/content/Context;)V
...
.method public final destroy()V
    ...
    iget-object v0, p0, Lcom/android/camera/effect/renders/w;->c:LW0/b;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iget-boolean v2, v0, LW0/z;->h:Z

    if-eqz v2, :cond_0

    iput-boolean v1, v0, LW0/z;->h:Z

    iget v2, v0, LW0/z;->d:I

    const-string v3, "GPUImageFilter"

    invoke-static {v2, v3}, Lcom/xiaomi/gl/MIGL;->glDeleteProgram(ILjava/lang/String;)V

    iput v1, v0, LW0/z;->d:I

    iget v2, v0, LW0/b;->p:I
...
.method public final draw(LQ0/b;)Z
    ...
    iget v1, p1, LQ0/g;->c:I

    iget-object p1, p1, LQ0/g;->b:Landroid/graphics/Rect;

    sget-object v3, Lp9/b;->a:Landroid/content/Context;
    ...
    invoke-virtual {v0, v1, p1, p0, v3}, LW0/z;->b(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)V
    ...
    iget-object v1, p1, LQ0/c;->c:Lf6/b;
    ...
    :cond_5
    iget-object v5, p0, Lcom/android/camera/effect/renders/n;->mGLCanvas:Lf6/g;

    invoke-virtual {v1, v5}, Lf6/b;->f(Lf6/g;)Z
    ...
    :cond_6
    invoke-virtual {p0, v1, v4}, Lcom/android/camera/effect/renders/r;->bindTexture(Lf6/b;I)Z
    ...
    invoke-virtual {v0, p1, v1, p0, v3}, LW0/z;->b(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)V
