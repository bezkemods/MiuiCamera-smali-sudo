...
.method public constructor <init>(Lcom/android/camera/b;)V
    ...
    invoke-virtual {p1}, L炤炨炪烩炪炮烩炣炢炱炮炤炢烩炤炨炪炪炨炩烩炄炨炪炪炨炩;->W2()Z
...
.method public static j(Landroid/util/SparseArray;Landroid/util/SparseArray;)Z
    ...
    invoke-virtual {v4, v3}, LY5/e;->equals(Ljava/lang/Object;)Z
...
.method public final a(Landroid/util/SparseArray;II)Landroid/util/SparseArray;
    ...
    iget-object v0, p0, Lcom/android/camera/b$b;->b:LP9/r;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, LP9/r;->k()Z
    ...
    iget-object v3, p0, Lcom/android/camera/b$b;->b:LP9/r;
    ...
    iget-object p1, p0, Lcom/android/camera/b$b;->b:LP9/r;

    iget-object v0, p1, LP9/r;->j:Ljava/lang/Object;
    ...
    iget-object p2, p1, LP9/r;->j:Ljava/lang/Object;
    ...
    :try_start_8
    iget-object p1, p1, LP9/r;->e:Landroid/util/SparseArray;
    ...
    :try_start_9
    invoke-static {p1}, LY5/d;->b(Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    :try_start_10
    iget-object v5, v3, LP9/r;->e:Landroid/util/SparseArray;
    ...
    iget-object v0, v3, LP9/r;->j:Ljava/lang/Object;
    ...
    iput-object v3, p0, Lcom/android/camera/b$b;->b:LP9/r;
    ...
    :try_start_16
    iget-object v3, v3, LP9/r;->e:Landroid/util/SparseArray;
    ...
    :try_start_17
    invoke-static {v3}, LY5/d;->b(Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    invoke-virtual {p0}, Lcom/android/camera/b$b;->f()LP9/r;

    move-result-object v1

    iget-object v3, v1, LP9/r;->j:Ljava/lang/Object;
    ...
    :try_start_21
    iget-object p2, v1, LP9/r;->j:Ljava/lang/Object;
    ...
    iget-object p2, p0, Lcom/android/camera/b$b;->b:LP9/r;
    ...
    iput-object v1, p0, Lcom/android/camera/b$b;->b:LP9/r;

    invoke-virtual {v1, p1}, LP9/r;->n(Landroid/util/SparseArray;)Landroid/util/SparseArray;
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/b$b;->c()LP9/r;
    ...
    iget-object v5, p0, LP9/r;->j:Ljava/lang/Object;

    monitor-enter v5

    :try_start_0
    iget-object v6, p0, LP9/r;->c:Ljava/util/HashMap;
    ...
    invoke-virtual {v6}, LP9/l;->n()Z

    move-result v7

    if-nez v7, :cond_3

    invoke-virtual {v6}, LP9/l;->x()Z

    move-result v7

    if-eqz v7, :cond_3

    iget-object p1, p0, LP9/r;->b:LP9/l;

    if-eq p1, v6, :cond_2

    if-eqz p1, :cond_1

    invoke-virtual {p1}, LP9/l;->w()V
    ...
    :cond_1
    :goto_0
    iput-object v6, p0, LP9/r;->b:LP9/l;
    ...
    :cond_3
    iget-object v4, p0, LP9/r;->b:LP9/l;

    if-eqz v4, :cond_4

    invoke-virtual {v4}, LP9/l;->w()V
    ...
    iget-object v6, p0, LP9/r;->E:LP9/r$e;

    invoke-direct {v4, v6, p1}, LP9/g;-><init>(LP9/r$e;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {v4, v6, p1}, LP9/b;-><init>(LP9/r$e;Lcom/xiaomi/engine/BufferFormat;)V

    :goto_1
    iget v6, p0, LP9/r;->a:I

    if-lez v6, :cond_7

    iput v6, v4, LP9/l;->a:I

    :cond_7
    iput v6, v4, LP9/l;->e:I

    invoke-virtual {v4}, LP9/b;->J()V

    invoke-virtual {v4, p1}, LP9/l;->b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;

    move-result-object v6

    iget-object v7, p0, LP9/r;->A:LP9/r$a;
    ...
    invoke-virtual {p0, v3}, LP9/c;->i(I)V
...
.method public final f()LP9/r;
    ...
    invoke-direct {v0, v1}, LP9/r;-><init>(Lcom/android/camera/b$a;)V
...
.method public final k()Z
    ...
    iget-object v2, p0, LP9/r;->b:LP9/l;

    iget-object v3, p0, LP9/r;->m:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    iget-object v4, p0, LP9/r;->k:Ljava/util/HashMap;
    ...
    iget-object v7, v6, LP9/o;->P:Ljava/lang/Object;

    if-ne v7, v2, :cond_1

    iget-boolean v7, v6, LP9/o;->z:Z

    if-nez v7, :cond_2

    iget v6, v6, LP9/o;->Q:I
    ...
    invoke-virtual {p0, v5}, LP9/l;->o(I)Z
...
.method public final l(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    invoke-virtual {p0, p1, p2}, LP9/n;->e(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
...
.method public final m(IJ)V
    ...
    iget-object p0, p0, LP9/r;->B:LP9/r$b;

    const/4 v2, 0x1

    invoke-direct {v1, p2, p3, p0, v2}, LP9/s;-><init>(JLP9/r$b;Z)V
    ...
    iget-object p0, p1, LP9/n;->a:Landroid/os/HandlerThread;
    ...
    iget-object p0, p1, LP9/n;->b:LP9/n$a;
    ...
    iget-object p2, p1, LP9/n;->b:LP9/n$a;
    ...
    invoke-virtual {p1, v1}, LP9/n;->h(LP9/s;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final n(LP9/o;)V
    .locals 17

    move-object/from16 v0, p1

    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/b$b;->c()LP9/r;
    ...
    iget-object v1, v1, LP9/r;->o:LP9/r$g;

    iget-object v3, v1, LP9/r$g;->a:LP9/r;
    ...
    invoke-virtual {v4, v5, v6}, LP9/c;->f(II)I

    move-result v4

    iput v4, v3, LP9/r;->z:I

    iget-wide v11, v0, LP9/o;->e:J

    iget-object v3, v0, LP9/o;->L:Lv9/d;
    ...
    iget-boolean v4, v0, LP9/o;->G:Z

    const/4 v15, 0x1

    if-nez v4, :cond_2

    iget-object v4, v1, LP9/r$g;->a:LP9/r;

    invoke-static {v4, v11, v12, v0}, LP9/r;->f(LP9/r;JLP9/o;)V

    iget-object v4, v0, LP9/o;->x0:Lcom/android/camera/module/Camera2Module$d;
    ...
    :cond_0
    iget v4, v0, LP9/o;->A:I

    const/4 v7, 0x4

    if-eq v4, v7, :cond_1

    iput-boolean v15, v0, LP9/o;->z:Z

    :cond_1
    iget-object v4, v1, LP9/r$g;->a:LP9/r;

    iget-object v4, v4, LP9/r;->b:LP9/l;

    iput-object v4, v0, LP9/o;->P:Ljava/lang/Object;
    ...
    :goto_0
    iget v10, v0, LP9/o;->B:I

    iget-boolean v14, v0, LP9/o;->G:Z

    new-instance v6, Lv9/b;

    iget v8, v0, LP9/o;->A:I

    iget-object v13, v0, LP9/o;->a0:Ljava/lang/String;
    ...
    invoke-direct/range {v7 .. v15}, Lv9/b;-><init>(IIIJLjava/lang/String;ZLP9/l;)V

    iget v4, v0, LP9/o;->k0:I

    iput v4, v6, Lv9/b;->x:I

    iget-object v4, v1, LP9/r$g;->a:LP9/r;

    iget-object v4, v4, LP9/r;->B:LP9/r$b;

    iput-object v4, v6, Lv9/b;->q:LP9/r$b;

    iget-boolean v4, v0, LP9/o;->J:Z

    iput-boolean v4, v6, Lv9/b;->l:Z

    iput-object v3, v6, Lv9/b;->o:Lv9/d;

    iget-object v3, v0, LP9/o;->i0:Lv9/a;

    iput-object v3, v6, Lv9/b;->v:Lv9/a;

    iget-boolean v3, v0, LP9/o;->O:Z

    iput-boolean v3, v6, Lv9/b;->m:Z
    ...
    invoke-static {v3, v15}, LA/O;->b(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    iput-boolean v15, v6, Lv9/b;->s:Z

    :cond_5
    sget-object v3, LP9/n$e;->a:LP9/n;

    iget-object v3, v3, LP9/n;->b:LP9/n$a;
    ...
    invoke-direct {v2, v4, v1, v6, v0}, LA/x;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
