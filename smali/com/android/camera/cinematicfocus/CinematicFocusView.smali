...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p2, LV/b;->a:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p2, LV/b;->g:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p2, LV/b;->h:Ljava/util/HashMap;
    ...
    iput-object p1, p2, LV/b;->b:Landroid/content/Context;

    new-instance v1, Landroid/graphics/Paint;

    invoke-direct {v1}, Landroid/graphics/Paint;-><init>()V

    iput-object v1, p2, LV/b;->c:Landroid/graphics/Paint;
    ...
    iput-object v1, p2, LV/b;->d:Landroid/graphics/Paint;
    ...
    iput-object v1, p2, LV/b;->e:Landroid/graphics/Paint;
    ...
    iput-object p1, p2, LV/b;->f:Landroid/graphics/Paint;
    ...
    iput-object p2, p0, Lcom/android/camera/cinematicfocus/CinematicFocusView;->a:LV/b;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/android/camera/cinematicfocus/CinematicFocusView;->a:LV/b;

    iget-object p0, p0, Lcom/android/camera/cinematicfocus/CinematicFocusView;->b:Ljava/util/ArrayList;

    iput-object p0, v0, LV/b;->a:Ljava/util/ArrayList;

    invoke-virtual {v0, p1}, LV/b;->draw(Landroid/graphics/Canvas;)V
