...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v2, p0, Lui/a;->e:I

    iput-object p1, p0, Lui/a;->b:Landroid/content/Context;

    const/4 v2, 0x1

    iput-boolean v2, p0, Lui/a;->d:Z

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v3

    sget v4, Lqi/c;->miuix_appcompat_arrow_popup_window_list_max_height:I

    invoke-virtual {v3, v4}, Landroid/content/res/Resources;->getDimensionPixelOffset(I)I

    move-result v3

    iput v3, p0, Lui/a;->c:I

    invoke-static {p1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object p1

    sget v3, Lqi/f;->miuix_appcompat_arrow_popup_view:I
    ...
    iput-object p1, p0, Lui/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;
    ...
    iget-object p1, p0, Lui/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;

    invoke-virtual {p1, p0}, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->setArrowPopupWindow(Lui/a;)V
    ...
    invoke-direct {v4, p1}, Lti/a;-><init>(Lmiuix/popupwidget/internal/widget/ArrowPopupView;)V
    ...
    invoke-direct {v4, p1}, Lti/b;-><init>(Lmiuix/popupwidget/internal/widget/ArrowPopupView;)V
    ...
    iput v3, p1, Lui/c;->g:I

    invoke-virtual {p1, v2}, Landroid/widget/PopupWindow;->setFocusable(Z)V

    iget-object v3, p1, Lui/a;->b:Landroid/content/Context;

    invoke-static {v3}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v3

    sget v4, Lqi/f;->miuix_appcompat_guide_popup_content_view:I
    ...
    iput-object v0, p1, Lui/c;->f:Landroid/widget/LinearLayout;

    invoke-virtual {p1, v0}, Lui/a;->setContentView(Landroid/view/View;)V

    iget-object v0, p1, Lui/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v0, p1, Lui/c;->f:Landroid/widget/LinearLayout;
    ...
    invoke-direct {v1, p1}, Lui/b;-><init>(Lui/c;)V
...
.method public final a()V
    ...
    iget-object p0, p0, Lui/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->b0:Landroid/view/animation/AnimationSet;
    ...
    iput-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->b0:Landroid/view/animation/AnimationSet;
    ...
    iget-object v1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->b0:Landroid/view/animation/AnimationSet;
...
.method public final c(I)V
    ...
    iget-object v0, p0, Lui/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;

    invoke-virtual {v0}, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->getContentFrameWrapperBottomPadding()I

    move-result v0

    iget-object v1, p0, Lui/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;
...
.method public final setHeight(I)V
    ...
    invoke-virtual {p0, p1}, Lui/a;->c(I)V
...
.method public final showAsDropDown(Landroid/view/View;II)V
    ...
    .line 1
    invoke-virtual {p0, p2, p1, p3}, Lui/a;->d(ILandroid/view/View;I)V
...
.method public final update(IIIIZ)V
    ...
    invoke-virtual {p0, p4}, Lui/a;->c(I)V
