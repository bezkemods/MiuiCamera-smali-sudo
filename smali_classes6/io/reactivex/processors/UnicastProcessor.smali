...
# virtual methods
.method public checkTerminated(ZZZLtj/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZZ",
    ...
    invoke-interface {p4, p0}, Ltj/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {p4, p1}, Ltj/c;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    :cond_2
    invoke-interface {p4}, Ltj/c;->onComplete()V
...
.method public drain()V
    ...
    invoke-virtual {p0, v0}, Lio/reactivex/processors/UnicastProcessor;->drainFused(Ltj/c;)V

    goto :goto_1

    :cond_1
    invoke-virtual {p0, v0}, Lio/reactivex/processors/UnicastProcessor;->drainRegular(Ltj/c;)V
...
.method public drainFused(Ltj/c;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_2
    invoke-interface {p1, v4}, Ltj/c;->onNext(Ljava/lang/Object;)V
...
.method public drainRegular(Ltj/c;)V
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual/range {v0 .. v5}, Lio/reactivex/processors/UnicastProcessor;->checkTerminated(ZZZLtj/c;Lio/reactivex/internal/queue/SpscLinkedArrayQueue;)Z
    ...
    invoke-interface {v5, v8}, Ltj/c;->onNext(Ljava/lang/Object;)V
