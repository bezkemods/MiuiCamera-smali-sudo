...
.method public static deferredRequest(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;J)V
    ...
    invoke-interface {v0, p2, p3}, Ltj/d;->request(J)V
...
.method public static deferredSetOnce(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;Ltj/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p2}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Ltj/d;)Z
    ...
    invoke-interface {p2, p0, p1}, Ltj/d;->request(J)V
...
.method public static replace(Ljava/util/concurrent/atomic/AtomicReference;Ltj/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static reportMoreProduced(J)V
    ...
    invoke-static {p0, p1, v1}, LV1/A;->c(JLjava/lang/String;)Ljava/lang/String;
...
.method public static set(Ljava/util/concurrent/atomic/AtomicReference;Ltj/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Ltj/d;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Ltj/d;J)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-static {p0, p1}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Ltj/d;)Z
    ...
    .line 7
    invoke-interface {p1, p2, p3}, Ltj/d;->request(J)V
...
.method public static validate(Ltj/d;Ltj/d;)Z
    .locals 1
