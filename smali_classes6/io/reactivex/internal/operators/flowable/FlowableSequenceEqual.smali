...
.method public constructor <init>(Ltj/b;Ltj/b;Lio/reactivex/functions/BiPredicate;I)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->first:Ltj/b;

    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->second:Ltj/b;
...
.method public subscribeActual(Ltj/c;)V
    ...
    invoke-direct {v0, p1, v1, v2}, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual$EqualCoordinator;-><init>(Ltj/c;ILio/reactivex/functions/BiPredicate;)V

    invoke-interface {p1, v0}, Ltj/c;->onSubscribe(Ltj/d;)V

    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->first:Ltj/b;

    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual;->second:Ltj/b;

    invoke-virtual {v0, p1, p0}, Lio/reactivex/internal/operators/flowable/FlowableSequenceEqual$EqualCoordinator;->subscribe(Ltj/b;Ltj/b;)V
