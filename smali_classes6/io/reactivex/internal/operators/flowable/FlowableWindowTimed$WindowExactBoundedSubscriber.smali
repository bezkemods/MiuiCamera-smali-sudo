...
# direct methods
.method public constructor <init>(Ltj/c;JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;IJZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, v0}, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;-><init>(Ltj/c;Lio/reactivex/internal/fuseable/SimplePlainQueue;)V
...
.method public drainLoop()V
    ...
    iget-object v2, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Ltj/c;
    ...
    iget-object v2, v0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Ltj/d;
    ...
    invoke-interface {v2, v3}, Ltj/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Ltj/d;

    invoke-interface {v1}, Ltj/d;->cancel()V
    ...
    invoke-interface {v2, v1}, Ltj/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v4, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Ltj/c;

    invoke-interface {v4, v3}, Ltj/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Ltj/c;
    ...
    invoke-interface {v1, v2}, Ltj/c;->onError(Ljava/lang/Throwable;)V
...
.method public onComplete()V
    ...
    :cond_0
    iget-object p0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Ltj/c;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Ltj/c;

    invoke-interface {v0, p1}, Ltj/c;->onNext(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Ltj/d;

    invoke-interface {p1}, Ltj/d;->cancel()V

    iget-object p1, p0, Lio/reactivex/internal/subscribers/QueueDrainSubscriber;->downstream:Ltj/c;
    ...
    invoke-interface {p1, v0}, Ltj/c;->onError(Ljava/lang/Throwable;)V
...
.method public onSubscribe(Ltj/d;)V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Ltj/d;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableWindowTimed$WindowExactBoundedSubscriber;->upstream:Ltj/d;
    ...
    invoke-interface {v0, p0}, Ltj/c;->onError(Ljava/lang/Throwable;)V
