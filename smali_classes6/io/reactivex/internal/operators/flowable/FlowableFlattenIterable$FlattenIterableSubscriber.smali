...
# direct methods
.method public constructor <init>(Ltj/c;Lio/reactivex/functions/Function;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Ltj/c;
...
.method public cancel()V
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Ltj/d;
...
.method public checkTerminated(ZZLtj/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    invoke-interface {p3, p1}, Ltj/c;->onError(Ljava/lang/Throwable;)V
    ...
    invoke-interface {p3}, Ltj/c;->onComplete()V
...
.method public consumedOne(Z)V
    ...
    iget-object p0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Ltj/d;

    int-to-long v0, p1

    invoke-interface {p0, v0, v1}, Ltj/d;->request(J)V
...
.method public drain()V
    ...
    :cond_0
    iget-object v2, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Ltj/c;
    ...
    :goto_2
    invoke-virtual {v1, v9, v11, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLtj/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
    ...
    iget-object v3, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Ltj/d;

    invoke-interface {v3}, Ltj/d;->cancel()V
    ...
    invoke-interface {v2, v0}, Ltj/c;->onError(Ljava/lang/Throwable;)V
    ...
    iget-object v0, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Ltj/d;
    ...
    invoke-virtual {v1, v15, v4, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLtj/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
    ...
    invoke-interface {v2, v5}, Ltj/c;->onNext(Ljava/lang/Object;)V

    iget-boolean v5, v1, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->done:Z

    invoke-virtual {v1, v5, v4, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLtj/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
    ...
    :goto_6
    invoke-virtual {v1, v5, v8, v2, v3}, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->checkTerminated(ZZLtj/c;Lio/reactivex/internal/fuseable/SimpleQueue;)Z
...
.method public onSubscribe(Ltj/d;)V
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->upstream:Ltj/d;
    ...
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Ltj/c;
    ...
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->downstream:Ltj/c;

    invoke-interface {v0, p0}, Ltj/c;->onSubscribe(Ltj/d;)V

    iget p0, p0, Lio/reactivex/internal/operators/flowable/FlowableFlattenIterable$FlattenIterableSubscriber;->prefetch:I

    int-to-long v0, p0

    invoke-interface {p1, v0, v1}, Ltj/d;->request(J)V
