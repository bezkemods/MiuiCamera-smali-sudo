...
.method static constructor <clinit>()V
    ...
    invoke-static {v1, v0}, LTf/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    const-string v2, "java/lang/annotation/Annotation.annotationType()Ljava/lang/Class;"

    invoke-static {v0, v2}, LXe/I;->C(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/LinkedHashSet;

    move-result-object v0

    sput-object v0, LAf/w;->a:Ljava/util/LinkedHashSet;

    sget-object v0, Lig/c;->e:Lig/c;

    sget-object v2, Lig/c;->f:Lig/c;

    filled-new-array {v0, v2}, [Lig/c;
    ...
    invoke-virtual {v5}, Lag/f;->b()Ljava/lang/String;
    ...
    iget-object v6, v3, Lig/c;->b:Ljava/lang/String;
    ...
    invoke-virtual {v3}, Lig/c;->c()Ljava/lang/String;
    ...
    invoke-static {v5, v3}, LTf/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v3}, LTf/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v3

    invoke-static {v2, v3}, LXe/I;->B(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v6, v3}, LTf/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v8}, LTf/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v8

    invoke-static {v2, v8}, LXe/I;->B(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v7, v3}, LTf/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v3}, LTf/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v2, LAf/w;->b:Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v2}, LTf/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v3}, LTf/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v3}, LTf/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v1, v3}, LTf/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v8}, LTf/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v10, v8}, LTf/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v2, LAf/w;->c:Ljava/util/LinkedHashSet;

    filled-new-array {v11}, [Ljava/lang/String;

    move-result-object v2

    invoke-static {v1, v2}, LTf/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v0}, LTf/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    invoke-static {v1, v0}, LXe/I;->B(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v10, v1}, LTf/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v0, LAf/w;->d:Ljava/util/LinkedHashSet;

    sget-object v10, Lig/c;->e:Lig/c;

    sget-object v14, Lig/c;->g:Lig/c;

    sget-object v12, Lig/c;->l:Lig/c;

    sget-object v13, Lig/c;->j:Lig/c;

    sget-object v15, Lig/c;->i:Lig/c;

    sget-object v16, Lig/c;->k:Lig/c;

    sget-object v17, Lig/c;->h:Lig/c;

    move-object v11, v14

    filled-new-array/range {v10 .. v17}, [Lig/c;
    ...
    invoke-virtual {v2}, Lig/c;->f()Lag/c;
    ...
    invoke-static {v3}, LTf/x;->a([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v2, v3}, LTf/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v2

    invoke-static {v1, v2}, LXe/q;->H(Ljava/util/Collection;Ljava/lang/Iterable;)V
    ...
    invoke-static {v0}, LTf/x;->a([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v7, v0}, LTf/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v1}, LTf/x;->a([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v6, v1}, LTf/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v0, LAf/w;->e:Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v0}, LTf/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    sput-object v0, LAf/w;->f:Ljava/util/LinkedHashSet;
