...
.method public constructor <init>(Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;ZIIIIIIII)V
    ...
    iput v12, v0, Lai/c;->c:F

    new-instance v13, Lai/b;

    const/4 v3, 0x0

    invoke-direct {v13, v0, v3}, Lai/b;-><init>(Ljava/lang/Object;I)V

    new-instance v14, Lai/c$a;

    invoke-direct {v14, v0}, Lai/c$a;-><init>(Lai/c;)V

    new-instance v15, Lai/c$b;

    invoke-direct {v15, v0}, Lai/c$b;-><init>(Lai/c;)V

    new-instance v9, Lai/c$c;

    const-string v3, "ContentAlpha"

    invoke-direct {v9, v3}, Lmiuix/animation/property/FloatProperty;-><init>(Ljava/lang/String;)V

    new-instance v8, Lai/c$d;

    invoke-direct {v8, v0}, Lai/c$d;-><init>(Lai/c;)V

    new-instance v7, Lai/c$e;

    const-string v3, "Alpha"

    invoke-direct {v7, v3}, Lmiuix/animation/property/FloatProperty;-><init>(Ljava/lang/String;)V

    iput v10, v0, Lai/c;->a:I

    iput v11, v0, Lai/c;->b:I

    iput-boolean v2, v0, Lai/c;->r:Z
    ...
    invoke-direct/range {v3 .. v9}, Lai/a;-><init>(IIIIII)V

    iput-object v12, v0, Lai/c;->d:Lai/a;

    invoke-virtual {v12, v10}, Lai/a;->setAlpha(I)V

    new-instance v3, Lai/a;

    move/from16 v4, p4

    invoke-direct {v3, v4, v10, v11}, Lai/a;-><init>(III)V

    iput-object v3, v0, Lai/c;->e:Lai/a;

    const/4 v4, 0x0

    invoke-virtual {v3, v4}, Lai/a;->setAlpha(I)V

    new-instance v4, Lai/a;

    move/from16 v5, p5

    invoke-direct {v4, v5, v10, v11}, Lai/a;-><init>(III)V

    iput-object v4, v0, Lai/c;->f:Lai/a;

    const/16 v5, 0xff

    invoke-virtual {v4, v5}, Lai/a;->setAlpha(I)V

    iput-object v1, v0, Lai/c;->g:Lmiuix/internal/view/CheckBoxAnimatedStateListDrawable;
    ...
    iput-object v5, v0, Lai/c;->h:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v5, v0, Lai/c;->h:Lmiuix/animation/physics/SpringAnimation;
    ...
    iput-object v5, v0, Lai/c;->k:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v5, v0, Lai/c;->k:Lmiuix/animation/physics/SpringAnimation;
    ...
    invoke-direct {v10, v0}, Lai/d;-><init>(Lai/c;)V
    ...
    iput-object v5, v0, Lai/c;->n:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v5, v0, Lai/c;->n:Lmiuix/animation/physics/SpringAnimation;
    ...
    iput-object v5, v0, Lai/c;->i:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v5, v0, Lai/c;->i:Lmiuix/animation/physics/SpringAnimation;
    ...
    iput-object v5, v0, Lai/c;->j:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v3, v0, Lai/c;->j:Lmiuix/animation/physics/SpringAnimation;
    ...
    iput-object v3, v0, Lai/c;->l:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v3, v0, Lai/c;->l:Lmiuix/animation/physics/SpringAnimation;
    ...
    iput-object v3, v0, Lai/c;->o:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v2, v0, Lai/c;->o:Lmiuix/animation/physics/SpringAnimation;
    ...
    iput-object v2, v0, Lai/c;->m:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v2, v0, Lai/c;->m:Lmiuix/animation/physics/SpringAnimation;
    ...
    iput-object v2, v0, Lai/c;->p:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v2, v0, Lai/c;->p:Lmiuix/animation/physics/SpringAnimation;
    ...
    iput-object v2, v0, Lai/c;->q:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v1, v0, Lai/c;->q:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v0, v0, Lai/c;->q:Lmiuix/animation/physics/SpringAnimation;
