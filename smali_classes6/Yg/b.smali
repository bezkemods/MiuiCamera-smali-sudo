...
.method public constructor <init>(Lcom/android/camera/Camera;)V
    ...
    iput-object v2, p0, LYg/b;->a:Landroid/graphics/Path;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v2

    sget v3, LXg/b;->radius_large:I

    invoke-virtual {v2, v3}, Landroid/content/res/Resources;->getDimension(I)F

    move-result v2

    iput v2, p0, LYg/b;->b:F

    new-instance v2, Landroid/graphics/Paint;

    invoke-direct {v2}, Landroid/graphics/Paint;-><init>()V

    iput-object v2, p0, LYg/b;->d:Landroid/graphics/Paint;

    const/4 v3, 0x2

    invoke-virtual {p0, v3, v0}, Landroid/view/View;->setLayerType(ILandroid/graphics/Paint;)V

    sget-object v3, LXg/e;->RoundedView:[I
    ...
    sget v0, LXg/e;->RoundedView_cornerRadius:I

    iget v1, p0, LYg/b;->b:F

    invoke-virtual {p1, v0, v1}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v0

    iput v0, p0, LYg/b;->b:F

    sget p0, LXg/e;->RoundedView_borderColor:I
    ...
    sget p0, LXg/e;->RoundedView_borderWidth:I
...
.method public final dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, LYg/b;->a:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-object v1, p0, LYg/b;->c:[F
    ...
    iget-object p0, p0, LYg/b;->d:Landroid/graphics/Paint;
