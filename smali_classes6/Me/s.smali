...
.method public constructor <init>()V
    ...
    iput-object v1, p0, LMe/s;->m:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, LMe/s;->n:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, LMe/s;->o:Landroid/graphics/Rect;

    new-instance v1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {v1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object v1, p0, LMe/s;->p:Ljava/util/concurrent/locks/ReentrantLock;

    iput-boolean v0, p0, LMe/s;->q:Z

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, LMe/s;->t:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, LMe/s;->u:Ljava/util/ArrayList;

    iput-boolean v0, p0, LMe/t;->a:Z

    sget-object v0, LGe/a;->a:LGe/a$a;

    iput-object v0, p0, LMe/s;->e:LGe/a;

    iput-object v0, p0, LMe/s;->f:LGe/a;
...
.method public final b(LBe/k;)V
    ...
    iput-object v0, p0, LMe/s;->s:LMe/a;

    iget-object v1, p0, LMe/t;->c:LBe/k;

    iput-object v1, v0, LMe/t;->c:LBe/k;

    iget-object v1, v1, LBe/k;->A:LMe/u;

    sget-object v2, LDe/d;->b:LDe/d;

    invoke-virtual {v1, v2}, LMe/u;->b(LDe/d;)LMe/t;

    move-result-object v1

    check-cast v1, LMe/I;

    iput-object v1, v0, LMe/a;->d:LMe/I;

    iget-object v1, v0, LMe/t;->c:LBe/k;

    iget-object v1, v1, LBe/k;->A:LMe/u;

    sget-object v2, LDe/d;->c:LDe/d;
    ...
    iput-object v1, v0, LMe/a;->e:LMe/L;

    iget-object v1, v0, LMe/t;->c:LBe/k;

    iget-object v1, v1, LBe/k;->A:LMe/u;

    sget-object v2, LDe/d;->d:LDe/d;
    ...
    iput-object v1, v0, LMe/a;->h:LMe/d;

    iget-object p0, p0, LMe/s;->s:LMe/a;

    invoke-virtual {p0, p1}, LMe/a;->b(LBe/k;)V
...
.method public final d()V
    ...
    iget-object v1, p0, LMe/s;->s:LMe/a;

    invoke-virtual {v1}, LMe/a;->d()V

    iput-boolean v0, p0, LMe/s;->q:Z

    invoke-virtual {p0}, LMe/s;->k()V
...
.method public final e(LBe/l;)I
    ...
    iget-object v3, p0, LMe/s;->m:Landroid/graphics/Rect;

    if-eq v0, v1, :cond_2

    iget-object v0, p0, LMe/s;->s:LMe/a;

    invoke-virtual {v0, p1}, LMe/a;->e(LBe/l;)I
    ...
    iget-boolean v4, p0, LMe/s;->k:Z

    if-eqz v4, :cond_0

    iget-object v3, p0, LMe/s;->o:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, LMe/s;->f:LGe/a;
    ...
    :cond_1
    iget-object v0, p0, LMe/s;->e:LGe/a;
    ...
    iget-object v1, p1, LBe/l;->h:LDe/a;
    ...
    invoke-virtual/range {v4 .. v9}, LMe/s;->l(LBe/l;ZILandroid/graphics/Rect;LGe/a;)I
    ...
    iget-object v5, p0, LMe/s;->m:Landroid/graphics/Rect;

    iget-object v6, p0, LMe/s;->e:LGe/a;

    move-object v1, p0

    move-object v2, p1

    invoke-virtual/range {v1 .. v6}, LMe/s;->l(LBe/l;ZILandroid/graphics/Rect;LGe/a;)I
...
.method public final h(LGe/a;)[I
    ...
    :cond_0
    invoke-virtual {p1}, LGe/a;->b()[Ljava/lang/String;
    ...
    sget-object p0, LMe/s;->v:[I

    return-object p0
.end method

.method public final i()LGe/f;
    .locals 2

    iget-boolean v0, p0, LMe/s;->q:Z
    ...
    :cond_0
    iget-boolean v0, p0, LMe/s;->r:Z

    if-eqz v0, :cond_2

    invoke-virtual {p0}, LMe/s;->j()Z
    ...
    iput-boolean v0, p0, LMe/s;->r:Z

    :cond_2
    iget-object p0, p0, LMe/s;->d:LGe/f;
...
.method public final j()Z
    ...
    iget-object v3, p0, LMe/s;->p:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v3}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-object v3, p0, LMe/s;->g:Landroid/view/Surface;
    ...
    iget-object v0, p0, LMe/s;->g:Landroid/view/Surface;
    ...
    iget-object v3, p0, LMe/t;->c:LBe/k;

    iget-object v3, v3, LBe/k;->f:LGe/c;

    iget-object v5, p0, LMe/s;->g:Landroid/view/Surface;

    iget-object v6, p0, LMe/s;->e:LGe/a;

    invoke-virtual {p0, v6}, LMe/s;->h(LGe/a;)[I

    move-result-object v6

    invoke-direct {v0, v3, v5, v6}, LGe/f;-><init>(LGe/c;Landroid/view/Surface;[I)V

    iput-object v0, p0, LMe/s;->d:LGe/f;
    ...
    iget-object p0, p0, LMe/s;->p:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public final k()V
    ...
    iget-object v0, p0, LMe/s;->p:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v0}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    iget-object v1, p0, LMe/s;->d:LGe/f;
    ...
    iput-object v1, p0, LMe/s;->d:LGe/f;
...
.method public final l(LBe/l;ZILandroid/graphics/Rect;LGe/a;)I
    .locals 19
    ...
    invoke-virtual/range {p0 .. p0}, LMe/s;->i()LGe/f;
    ...
    iget-object v9, v1, LBe/l;->f:Landroid/graphics/Rect;
    ...
    iget-object v11, v0, LMe/s;->n:Landroid/graphics/Rect;
    ...
    iget v12, v0, LMe/s;->j:I

    invoke-static {v7, v8, v10, v12}, LMe/s;->g([FLandroid/util/Size;Landroid/util/Size;I)V

    iget-boolean v8, v0, LMe/s;->k:Z
    ...
    invoke-virtual {v2}, LGe/e;->b()I

    move-result v10

    invoke-virtual {v2}, LGe/e;->a()I
    ...
    iget v12, v0, LMe/s;->h:I

    iget v13, v0, LMe/s;->i:I
    ...
    :cond_3
    iget-object v10, v1, LBe/l;->h:LDe/a;

    if-ne v10, v15, :cond_8

    iget-object v10, v0, LMe/t;->c:LBe/k;

    iget-object v10, v10, LBe/k;->J:Ljava/util/concurrent/atomic/AtomicLong;

    invoke-virtual {v10}, Ljava/util/concurrent/atomic/AtomicLong;->get()J

    move-result-wide v12

    iget v10, v0, LMe/s;->l:I
    ...
    iget-object v3, v3, LBe/k;->i:Landroid/util/Size;
    ...
    iget-object v9, v3, LBe/k;->v:LKe/a;

    iget-object v3, v1, LBe/l;->a:LOe/b;

    iget v10, v3, LOe/b;->b:I

    iget-object v11, v1, LBe/l;->b:LGe/a;

    iget v14, v0, LMe/s;->h:I

    iget v3, v0, LMe/s;->i:I
    ...
    invoke-virtual/range {v9 .. v18}, LKe/a;->a(ILGe/a;ILGe/a;II[FLandroid/graphics/Rect;LGe/h;)V
    ...
    iget v8, v0, LMe/s;->j:I

    invoke-static {v3, v4, v5, v8}, LMe/s;->g([FLandroid/util/Size;Landroid/util/Size;I)V

    iget-object v3, v0, LMe/t;->c:LBe/k;

    iget-object v8, v3, LBe/k;->w:LKe/a;

    iget-object v10, v1, LBe/l;->e:LGe/a;

    iget v13, v0, LMe/s;->h:I

    iget v14, v0, LMe/s;->i:I

    iget-object v15, v1, LBe/l;->i:[F
    ...
    invoke-virtual/range {v8 .. v17}, LKe/a;->a(ILGe/a;ILGe/a;II[FLandroid/graphics/Rect;LGe/h;)V

    iget-object v3, v1, LBe/l;->j:LGe/h;

    invoke-virtual {v3}, LGe/h;->d()V

    :goto_5
    iget-object v3, v1, LBe/l;->h:LDe/a;

    if-ne v3, v6, :cond_b

    iget-object v3, v0, LMe/s;->t:Ljava/util/ArrayList;
    ...
    iget-boolean v5, v4, LMe/t;->a:Z

    if-eqz v5, :cond_a

    iget v5, v0, LMe/s;->i:I

    iget-object v6, v0, LMe/s;->m:Landroid/graphics/Rect;

    invoke-virtual {v4, v1, v7, v5, v6}, LMe/t;->f(LBe/l;[FILandroid/graphics/Rect;)V
    ...
    iget-object v3, v0, LMe/s;->u:Ljava/util/ArrayList;
    ...
    iget-object v7, v0, LMe/s;->g:Landroid/view/Surface;

    iget v8, v0, LMe/s;->h:I

    iget v9, v0, LMe/s;->i:I

    iget-object v4, v0, LMe/t;->c:LBe/k;

    iget-boolean v10, v4, LBe/k;->b:Z

    move-object/from16 v6, p5

    invoke-interface/range {v5 .. v10}, LMe/C;->a(LGe/a;Landroid/view/Surface;IIZ)V
    ...
    invoke-direct {v3, v2, v4}, LA/O1;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object v0, v1, LBe/l;->a:LOe/b;
