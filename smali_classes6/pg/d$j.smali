...
.method public constructor <init>(Lpg/d;)V
    ...
    iput-object p1, p0, Lpg/d$j;->a:Lpg/d;
...
.method public final invoke()Ljava/lang/Object;
    ...
    iget-object p0, p0, Lpg/d$j;->a:Lpg/d;

    invoke-virtual {p0}, Lpg/d;->isInline()Z
    ...
    iget-object v2, v0, Lng/n;->b:LXf/c;
    ...
    iget-object v7, p0, Lpg/d;->e:LVf/b;
    ...
    iget-object v4, v7, LVf/b;->W:Ljava/util/List;
    ...
    invoke-static {v4, v8}, LXe/m;->y(Ljava/lang/Iterable;I)I
    ...
    invoke-static {v2, v9}, LAg/a;->s(LXf/c;I)Lag/f;
    ...
    :cond_1
    iget-object v4, v7, LVf/b;->a0:Ljava/util/List;

    invoke-interface {v4}, Ljava/util/List;->size()I

    move-result v4

    iget-object v9, v7, LVf/b;->Z:Ljava/util/List;
    ...
    invoke-direct {v11, v4, v9}, LWe/j;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v13, v4, v12}, LWe/j;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-virtual {v11, v13}, LWe/j;->equals(Ljava/lang/Object;)Z

    move-result v4

    if-eqz v4, :cond_2

    iget-object v2, v7, LVf/b;->a0:Ljava/util/List;
    ...
    invoke-virtual {v0, v7}, LXf/g;->a(I)LVf/p;
    ...
    invoke-direct {v9, v0, v4}, LWe/j;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-virtual {v11, v9}, LWe/j;->equals(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_5

    iget-object v4, v7, LVf/b;->Z:Ljava/util/List;
    ...
    invoke-virtual {v3, v4}, Lpg/g;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v6, v0}, LXe/u;->y0(Ljava/lang/Iterable;Ljava/lang/Iterable;)Ljava/util/ArrayList;

    move-result-object v0

    invoke-direct {v2, v0}, LBf/C;-><init>(Ljava/util/ArrayList;)V
    ...
    iget v6, v7, LVf/b;->x:I

    invoke-static {v2, v6}, LAg/a;->s(LXf/c;I)Lag/f;

    move-result-object v6

    iget v8, v7, LVf/b;->c:I
    ...
    iget-object v0, v7, LVf/b;->y:LVf/p;
    ...
    iget v8, v7, LVf/b;->V:I

    invoke-virtual {v0, v8}, LXf/g;->a(I)LVf/p;
    ...
    invoke-virtual {v3, v0}, Lpg/g;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_9
    invoke-virtual {v4, v6}, Lpg/h;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v2, v6, v0}, LBf/v;-><init>(Lag/f;Lug/h;)V
    ...
    :cond_d
    iget-object v0, p0, Lpg/d;->f:LXf/a;

    const/4 v2, 0x5

    invoke-virtual {v0, v5, v2, v5}, LXf/a;->a(III)Z
    ...
    invoke-virtual {p0, v0}, Lpg/d;->D0(Lag/f;)Lrg/J;

    move-result-object v1

    if-eqz v1, :cond_e

    new-instance p0, LBf/v;

    invoke-direct {p0, v0, v1}, LBf/v;-><init>(Lag/f;Lug/h;)V
