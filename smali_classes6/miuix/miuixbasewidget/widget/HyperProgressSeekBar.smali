...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v1, Ldi/a;->miuixProgressSeekBarStyle:I
    ...
    sget-object v6, Ldi/j;->HyperProgressSeekBar:[I

    sget v7, Ldi/i;->Widget_HyperProgressSeekBar_DayNight:I
    ...
    sget v1, Ldi/j;->HyperProgressSeekBar_progressBarMode:I
    ...
    sget v8, Ldi/b;->miuix_appcompat_hyper_progress_seekbar_shadow_default_color:I
    ...
    sget v9, Ldi/c;->miuix_appcompat_hyper_progress_seekbar_shadow_radius:I

    invoke-virtual {v8, v9}, Landroid/content/res/Resources;->getDimension(I)F

    move-result v8

    sget v9, Ldi/j;->HyperProgressSeekBar_shadowDx:I
    ...
    sget v9, Ldi/j;->HyperProgressSeekBar_shadowDy:I
    ...
    sget v9, Ldi/j;->HyperProgressSeekBar_shadowHorizontalExtend:I
    ...
    sget v9, Ldi/j;->HyperProgressSeekBar_shadowVerticalExtend:I
    ...
    sget v9, Ldi/j;->HyperProgressSeekBar_shadowRadius:I
    ...
    sget v3, Ldi/j;->HyperProgressSeekBar_shadowColor:I
    ...
    sget v7, Ldi/c;->miuix_appcompat_hyper_progress_seekbar_shadow_clip_radius:I
    ...
    sget v8, Ldi/c;->miuix_appcompat_hyper_progress_seekbar_min_height:I
    ...
    sget v8, Ldi/c;->miuix_appcompat_hyper_progress_seekbar_height:I
    ...
    sget v3, Ldi/j;->HyperProgressSeekBar_progressSeekBarMinHeight:I
    ...
    sget v3, Ldi/j;->HyperProgressSeekBar_progressSeekBarMaxHeight:I
    ...
    sget v8, Ldi/c;->miuix_appcompat_hyper_progress_seekbar_padding_offset:I

    invoke-virtual {v3, v8}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v3

    sget v8, Ldi/j;->HyperProgressSeekBar_paddingOffset:I
    ...
    sget v3, Ldi/g;->music_player_tracker:I
    ...
    invoke-static {v1}, LDh/h;->a(Ljava/lang/String;)Landroid/graphics/RuntimeShader;
    ...
    sget v3, Ldi/g;->music_player_tracker_middle:I
    ...
    sget v3, Ldi/b;->miuix_appcompat_hyper_progress_seekbar_foreground_normal_color_light:I
    ...
    sget v4, Ldi/b;->miuix_appcompat_hyper_progress_seekbar_background_disabled_color_light:I
    ...
    sget v5, Ldi/b;->miuix_appcompat_hyper_progress_seekbar_background_normal_color_light:I
    ...
    sget v5, Ldi/b;->miuix_appcompat_hyper_progress_seekbar_background_disabled_color_dark:I
    ...
    sget v5, Ldi/j;->HyperProgressSeekBar_foregroundPrimaryColor:I
    ...
    sget v1, Ldi/j;->HyperProgressSeekBar_foregroundPrimaryDisableColor:I
    ...
    sget v1, Ldi/j;->HyperProgressSeekBar_backgroundPrimaryColor:I

    invoke-virtual {p2, v1, v4}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result v1

    iput v1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->V:I

    sget v1, Ldi/j;->HyperProgressSeekBar_backgroundPrimaryDisableColor:I
    ...
    sget p1, Ldi/j;->HyperProgressSeekBar_progressAlpha:I
    ...
    iput p1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->c0:I

    sget v3, Ldi/j;->HyperProgressSeekBar_progressPressedAlpha:I
...
.method public final b(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v0, v1}, Landroidx/core/text/util/c;->b(Landroid/graphics/RuntimeShader;[F)V
    ...
    invoke-static {v0, v1}, LMe/w;->c(Landroid/graphics/RuntimeShader;F)V
...
.method public final c(Landroid/graphics/Canvas;)V
    ...
    sget v9, Ldi/b;->miuix_color_transparent:I
...
.method public final e()V
    ...
    sget v1, Ldi/d;->miuix_hyper_progressbar_light_head:I
    ...
    invoke-static {v0, v1}, LMe/y;->c(Landroid/graphics/RuntimeShader;Landroid/graphics/BitmapShader;)V

    iget-object v0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->b:Landroid/graphics/RuntimeShader;

    invoke-static {v0, v2}, LMe/z;->c(Landroid/graphics/RuntimeShader;[F)V

    iget-object v0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->b:Landroid/graphics/RuntimeShader;

    iget v1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->g:F

    invoke-static {v0, v1}, Landroidx/appcompat/app/c;->c(Landroid/graphics/RuntimeShader;F)V
    ...
    invoke-static {v0, v2}, LIh/k;->c(Landroid/content/Context;F)I
    ...
    invoke-static {v0, v5}, LIh/k;->c(Landroid/content/Context;F)I
    ...
    invoke-static {v0, v3}, LIh/k;->c(Landroid/content/Context;F)I
    ...
    invoke-static {v0, v1}, LDh/g;->c(Landroid/graphics/RuntimeShader;[F)V

    iget-object p0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->b:Landroid/graphics/RuntimeShader;

    invoke-static {p0, v2}, Landroidx/core/text/util/c;->b(Landroid/graphics/RuntimeShader;[F)V
...
.method public final g()V
    ...
    iget-object v5, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->a0:Landroid/content/res/ColorStateList;

    if-nez v5, :cond_0

    if-eqz v4, :cond_0

    iput-object v4, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->a0:Landroid/content/res/ColorStateList;

    :cond_0
    iget-object v4, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->a0:Landroid/content/res/ColorStateList;
    ...
    iput-object v6, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->a0:Landroid/content/res/ColorStateList;
    ...
    iput-object v1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->a0:Landroid/content/res/ColorStateList;

    :cond_3
    iget-object v1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->a0:Landroid/content/res/ColorStateList;
    ...
    iget v4, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->W:I
    ...
    iget v4, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->V:I
    ...
    iget v1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->W:I
    ...
    iput-object v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->a0:Landroid/content/res/ColorStateList;
...
.method public final onLayout(ZIIII)V
    ...
    invoke-static {p1, p2}, Landroidx/core/text/util/c;->b(Landroid/graphics/RuntimeShader;[F)V
    ...
    :goto_0
    invoke-static {p1, p3}, LMe/x;->c(Landroid/graphics/RuntimeShader;I)V
...
.method public final onSizeChanged(IIII)V
    ...
    invoke-static {p1, p3}, Landroidx/core/view/accessibility/d;->b(Landroid/graphics/RuntimeShader;[F)V

    iget-object p0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->b:Landroid/graphics/RuntimeShader;

    invoke-static {p0, p3}, Landroidx/core/text/util/b;->a(Landroid/graphics/RuntimeShader;[F)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_2
    iput-boolean v8, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->b0:Z

    :goto_0
    return v6

    :cond_3
    iget-boolean v2, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->b0:Z

    if-nez v2, :cond_4

    invoke-virtual {v1, v0}, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar$g;->onStartTrackingTouch(Landroid/widget/SeekBar;)V

    iput-boolean v6, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->b0:Z
...
.method public setBackgroundPrimaryColor(I)V
    ...
    :cond_0
    iput p1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->V:I
