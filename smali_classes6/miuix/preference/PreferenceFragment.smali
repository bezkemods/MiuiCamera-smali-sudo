...
.method public static hb(Landroid/view/ViewGroup;)Landroid/view/ViewGroup$MarginLayoutParams;
    .locals 2
...
# virtual methods
.method public final Cb(Landroidx/core/graphics/Insets;)V
    .locals 7
...
.method public final Db(Landroid/content/Context;LGh/b;II)Z
    .locals 11
    ...
    iget-object p3, p3, Lmiuix/appcompat/app/AppCompatActivity;->b:Lmiuix/appcompat/app/m;

    invoke-virtual {p3}, Lmiuix/appcompat/app/m;->q()Z
...
.method public final Ma(Landroid/view/ViewGroup;Landroidx/core/graphics/Insets;)V
    .locals 3
    ...
    :cond_0
    invoke-static {p1}, Lmiuix/preference/PreferenceFragment;->hb(Landroid/view/ViewGroup;)Landroid/view/ViewGroup$MarginLayoutParams;
...
.method public final ae(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    .locals 0
...
.method public final getActionBar()Lmiuix/appcompat/app/ActionBar;
    ...
    :cond_0
    instance-of p0, v0, Lmiuix/appcompat/app/w;

    if-eqz p0, :cond_1

    check-cast v0, Lmiuix/appcompat/app/w;

    invoke-interface {v0}, Lmiuix/appcompat/app/w;->getActionBar()Lmiuix/appcompat/app/ActionBar;
...
.method public final m(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, v0}, Lmiuix/preference/PreferenceFragment;->Cb(Landroidx/core/graphics/Insets;)V
    ...
    invoke-virtual {p0, v0, p1}, Lmiuix/preference/PreferenceFragment;->Ma(Landroid/view/ViewGroup;Landroidx/core/graphics/Insets;)V
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p0}, Lmiuix/preference/PreferenceFragment;->vb()V
    ...
    invoke-static {v1}, LGh/b$a;->a(I)LGh/b;

    move-result-object v1

    iput-object v1, p0, Lmiuix/preference/PreferenceFragment;->k:LGh/b;

    if-eqz v1, :cond_3

    iget-boolean v2, p0, Lmiuix/preference/PreferenceFragment;->i:Z

    iput-boolean v2, v1, LGh/b;->a:Z
    ...
    invoke-virtual {p0, p1, v1, v2, v2}, Lmiuix/preference/PreferenceFragment;->Db(Landroid/content/Context;LGh/b;II)Z
    ...
    iget-object v1, p0, Lmiuix/preference/PreferenceFragment;->k:LGh/b;

    iget-boolean v2, v1, LGh/b;->a:Z

    if-eqz v2, :cond_2

    invoke-virtual {v1}, LGh/b;->a()I
    ...
    iget-object v1, p0, Lmiuix/preference/PreferenceFragment;->e:Lvi/k;

    if-eqz v1, :cond_3

    invoke-virtual {v1, p1}, Lvi/k;->F1(I)Z
    ...
    iget-object v0, p0, Lmiuix/preference/PreferenceFragment;->e:Lvi/k;
    ...
    invoke-virtual {v0, p1}, Lvi/k;->e(Landroid/content/Context;)V

    iget-object p1, p0, Lmiuix/preference/PreferenceFragment;->e:Lvi/k;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iget-object v3, p0, Lmiuix/preference/PreferenceFragment;->k:LGh/b;

    if-eqz v3, :cond_0

    iput-boolean v2, v3, LGh/b;->a:Z
    ...
    sget v1, Lvi/s;->preferenceCardStyleEnable:I

    invoke-static {v1, v0, p1}, LZh/d;->i(ILandroid/content/Context;I)I
...
.method public final onCreateAdapter(Landroidx/preference/PreferenceScreen;)Landroidx/recyclerview/widget/RecyclerView$Adapter;
    ...
    invoke-direct {v0, p1, v1, v2}, Lvi/k;-><init>(Landroidx/preference/PreferenceScreen;ZI)V

    iput-object v0, p0, Lmiuix/preference/PreferenceFragment;->e:Lvi/k;

    iget p1, p0, Lmiuix/preference/PreferenceFragment;->l:I

    invoke-virtual {v0, p1}, Lvi/k;->F1(I)Z
    ...
    iput p1, v0, Lvi/k;->u:I

    :cond_1
    iget-object p0, p0, Lmiuix/preference/PreferenceFragment;->e:Lvi/k;
...
.method public final onCreateRecyclerView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroidx/recyclerview/widget/RecyclerView;
    ...
    sget p3, Lvi/x;->miuix_preference_recyclerview:I
    ...
    :cond_1
    invoke-static {p2}, Lmiuix/preference/PreferenceFragment;->hb(Landroid/view/ViewGroup;)Landroid/view/ViewGroup$MarginLayoutParams;
    ...
    sget p3, Loh/a$h;->action_bar_overlay_layout:I
    ...
    :cond_4
    new-instance p3, Lvi/j;

    invoke-direct {p3, p0}, Lvi/j;-><init>(Lmiuix/preference/PreferenceFragment;)V

    invoke-static {p2, p3}, LZh/h;->a(Landroid/view/ViewGroup;LZh/h$a;)V
...
.method public final onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-interface {v1}, Lmiuix/appcompat/app/w;->n9()Z
    ...
    invoke-interface {v1}, Lmiuix/appcompat/app/w;->W7()Landroid/content/Context;
    ...
    sget v2, Lvi/s;->windowActionBarOverlay:I

    invoke-static {v0, v2, v1}, LZh/d;->d(Landroid/content/Context;IZ)Z
    ...
    invoke-static {v0}, LGh/b$a;->a(I)LGh/b;

    move-result-object v0

    iput-object v0, p0, Lmiuix/preference/PreferenceFragment;->k:LGh/b;

    if-eqz v0, :cond_5

    iget-boolean v2, p0, Lmiuix/preference/PreferenceFragment;->i:Z

    iput-boolean v2, v0, LGh/b;->a:Z
    ...
    iget-object v2, p0, Lmiuix/preference/PreferenceFragment;->k:LGh/b;

    iget-boolean v3, v2, LGh/b;->a:Z

    if-eqz v3, :cond_4

    invoke-virtual {v2}, LGh/b;->a()I
    ...
    iget-object v0, p0, Lmiuix/preference/PreferenceFragment;->k:LGh/b;
    ...
    invoke-virtual {p0, v0, v3, v2, v1}, Lmiuix/preference/PreferenceFragment;->Db(Landroid/content/Context;LGh/b;II)Z
...
.method public final onDestroyView()V
    ...
    invoke-virtual {p0, v0}, Lmiuix/appcompat/app/ActionBar;->q(Landroid/view/View;)V
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lmiuix/preference/PreferenceFragment;->Vd()Landroid/graphics/Rect;
...
.method public final vb()V
    ...
    sget v3, Lvi/s;->preferenceCardPageBackground:I

    invoke-static {v2, v3}, LZh/d;->g(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v3}, Lmiuix/appcompat/app/m;->q()Z
    ...
    sget v4, Lvi/s;->preferenceCardPageNoFloatingBackground:I

    invoke-static {v3, v4}, LZh/d;->g(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0}, LIh/a;->g(Landroid/content/Context;)Z
