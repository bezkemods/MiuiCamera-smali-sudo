...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Lvi/s;->dropdownPreferenceStyle:I
    ...
    sget-object v3, Lvi/A;->DropDownPreference:[I
    ...
    sget v5, Lvi/A;->DropDownPreference_adapter:I

    invoke-virtual {v4, v5}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object v5

    sget v6, Lvi/A;->DropDownPreference_dimVisible:I

    invoke-virtual {v4, v6, v2}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v6

    sget v7, Lvi/A;->DropDownPreference_iconOnlyEnabled:I
    ...
    invoke-static {p2, v5}, LA/N2;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-boolean v1, v2, Lph/a;->e:Z

    invoke-static {p1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v4

    iput-object v4, v2, Lph/a;->d:Landroid/view/LayoutInflater;

    invoke-virtual {p1, p2, v3, v0, v1}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p2

    sget v0, Lvi/A;->DropDownPreference_entries:I
    ...
    iput-object v0, v2, Lph/a;->a:[Ljava/lang/CharSequence;

    sget v0, Lvi/A;->DropDownPreference_entryValues:I
    ...
    sget v0, Lvi/A;->DropDownPreference_entrySummaries:I

    invoke-static {p2, v0, v1}, Landroidx/core/content/res/TypedArrayUtils;->getTextArray(Landroid/content/res/TypedArray;II)[Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, v2, Lph/a;->b:[Ljava/lang/CharSequence;

    invoke-static {p2, v7, v1, v1}, Landroidx/core/content/res/TypedArrayUtils;->getBoolean(Landroid/content/res/TypedArray;IIZ)Z

    move-result v0

    iput-boolean v0, v2, Lph/a;->e:Z

    sget v0, Lvi/A;->DropDownPreference_entryIcons:I
    ...
    iput-object p2, v2, Lph/a;->c:[Landroid/graphics/drawable/Drawable;
    ...
    :cond_5
    iput-object p1, v2, Lph/a;->c:[Landroid/graphics/drawable/Drawable;
    ...
    sget v3, Loh/a$j;->miuix_appcompat_simple_spinner_layout_integrated:I

    invoke-direct {p1, p2, v3, v2, v0}, Luh/b;-><init>(Landroid/content/Context;ILandroid/widget/ArrayAdapter;Luh/b$b;)V

    iput-object p1, p0, Lmiuix/preference/DropDownPreference;->f:Luh/b;
    ...
    iget-object p2, p1, Lph/a;->a:[Ljava/lang/CharSequence;
...
.method public final notifyChanged()V
    ...
    iget-object v0, p0, Lmiuix/preference/DropDownPreference;->f:Luh/b;
...
.method public final onAttached()V
    ...
    sget v1, Lvi/x;->miuix_preference_flexible_layout:I

    if-eq v0, v1, :cond_1

    sget v2, Lvi/x;->miuix_dropdown_preference_flexible_layout:I
    ...
    sget v1, Lvi/x;->miuix_dropdown_preference_flexible_layout:I
...
.method public final onBindViewHolder(Landroidx/preference/PreferenceViewHolder;)V
    ...
    iget-object v0, v0, Luh/b;->a:Landroid/widget/ArrayAdapter;
    ...
    sget v4, Lvi/x;->miuix_appcompat_simple_spinner_flexible_layout_integrated:I
    ...
    invoke-direct {v0, v3, v4, v6, v5}, Luh/b;-><init>(Landroid/content/Context;ILandroid/widget/ArrayAdapter;Luh/b$b;)V

    iput-object v0, p0, Lmiuix/preference/DropDownPreference;->f:Luh/b;
    ...
    iget-object v3, p0, Lmiuix/preference/DropDownPreference;->f:Luh/b;
