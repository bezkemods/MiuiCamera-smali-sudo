.class public final Lmiuix/appcompat/app/m;
...
.field public final Z:Lmiuix/appcompat/app/AppCompatActivity$a;

.field public final a0:Lmiuix/appcompat/app/AppCompatActivity$b;
...
.field public j0:Lmiuix/appcompat/app/m$a;
...
.field public l0:Lmiuix/appcompat/app/m$c;

.field public m0:LG2/d;

.field public final n0:Lmiuix/appcompat/app/m$b;
...
.method public constructor <init>(Lmiuix/appcompat/app/AppCompatActivity;Lmiuix/appcompat/app/AppCompatActivity$a;Lmiuix/appcompat/app/AppCompatActivity$b;)V
    ...
    iput-boolean p1, p0, Lmiuix/appcompat/app/m;->b0:Z

    iput-boolean p1, p0, Lmiuix/appcompat/app/m;->c0:Z

    const/4 v0, 0x0

    iput-object v0, p0, Lmiuix/appcompat/app/m;->f0:Landroid/view/ViewGroup;

    iput-boolean p1, p0, Lmiuix/appcompat/app/m;->h0:Z

    new-instance p1, Lmiuix/appcompat/app/m$b;

    invoke-direct {p1, p0}, Lmiuix/appcompat/app/m$b;-><init>(Lmiuix/appcompat/app/m;)V

    iput-object p1, p0, Lmiuix/appcompat/app/m;->n0:Lmiuix/appcompat/app/m$b;
    ...
    iput-object p1, p0, Lmiuix/appcompat/app/m;->g0:Ljava/lang/String;

    iput-object p2, p0, Lmiuix/appcompat/app/m;->Z:Lmiuix/appcompat/app/AppCompatActivity$a;

    iput-object p3, p0, Lmiuix/appcompat/app/m;->a0:Lmiuix/appcompat/app/AppCompatActivity$b;
...
.method public final Ld(Landroid/view/Menu;Landroid/view/Menu;)V
    ...
    iget-object p0, p0, Lmiuix/appcompat/app/m;->Z:Lmiuix/appcompat/app/AppCompatActivity$a;
...
.method public final Pa()Lmiuix/appcompat/internal/app/widget/ActionBarImpl;
    ...
    invoke-virtual {p0}, Lmiuix/appcompat/app/m;->l()V

    :cond_0
    iget-object v0, p0, Lmiuix/appcompat/app/m;->y:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;
...
.method public final invalidateOptionsMenu()V
    ...
    iget-object p0, p0, Lmiuix/appcompat/app/m;->n0:Lmiuix/appcompat/app/m$b;

    invoke-virtual {p0}, Lmiuix/appcompat/app/m$b;->run()V
...
.method public final l()V
    ...
    :cond_0
    iget-object v0, p0, Lmiuix/appcompat/app/m;->k0:Landroid/view/Window;
    ...
    iget-object v2, p0, Lmiuix/appcompat/app/m;->k0:Landroid/view/Window;
    ...
    instance-of v4, v2, Lmiuix/appcompat/app/m$c;

    if-nez v4, :cond_2

    new-instance v3, Lmiuix/appcompat/app/m$c;

    invoke-direct {v3, p0, v2}, Lmiuix/appcompat/app/m$c;-><init>(Lmiuix/appcompat/app/m;Landroid/view/Window$Callback;)V

    iput-object v3, p0, Lmiuix/appcompat/app/m;->l0:Lmiuix/appcompat/app/m$c;

    invoke-virtual {v0, v3}, Landroid/view/Window;->setCallback(Landroid/view/Window$Callback;)V

    iput-object v0, p0, Lmiuix/appcompat/app/m;->k0:Landroid/view/Window;
    ...
    iput-object v3, p0, Lmiuix/appcompat/app/m;->Y:Landroid/view/LayoutInflater;

    sget-object v3, Loh/a$m;->Window:[I

    invoke-virtual {v1, v3}, Lmiuix/appcompat/app/AppCompatActivity;->obtainStyledAttributes([I)Landroid/content/res/TypedArray;

    move-result-object v4

    sget v5, Loh/a$m;->Window_responsiveEnabled:I
    ...
    invoke-direct {v5, p0, p0}, Lmiuix/appcompat/app/m$a;-><init>(Lmiuix/appcompat/app/m;Lmiuix/appcompat/app/m;)V

    iput-object v5, p0, Lmiuix/appcompat/app/m;->j0:Lmiuix/appcompat/app/m$a;

    :cond_5
    sget v5, Loh/a$m;->Window_windowLayoutMode:I
    ...
    :cond_6
    sget v5, Loh/a$m;->Window_windowActionBar:I
    ...
    :cond_7
    sget v3, Loh/a$m;->Window_windowActionBarOverlay:I
    ...
    :cond_8
    sget v3, Loh/a$m;->Window_isMiuixFloatingTheme:I

    invoke-virtual {v4, v3, v6}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v3

    iput-boolean v3, p0, Lmiuix/appcompat/app/m;->b0:Z

    sget v3, Loh/a$m;->Window_windowFloating:I

    invoke-virtual {v4, v3, v6}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v3

    iput-boolean v3, p0, Lmiuix/appcompat/app/m;->c0:Z

    sget v3, Loh/a$m;->Window_windowTranslucentStatus:I
    ...
    iput v3, p0, Lmiuix/appcompat/app/m;->d0:I

    iget-boolean v3, p0, Lmiuix/appcompat/app/m;->b0:Z

    const/4 v5, 0x0

    if-eqz v3, :cond_b

    invoke-static {v1}, Lrh/b;->a(Lmiuix/appcompat/app/AppCompatActivity;)I
    ...
    invoke-static {v1, v7}, LZh/d;->g(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v7

    iput-object v7, v3, Lrh/e;->b:Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v3, v1}, Lrh/h;-><init>(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    :goto_2
    iput-object v3, p0, Lmiuix/appcompat/app/m;->e0:Lrh/a;

    iput-object v5, p0, Lmiuix/appcompat/app/m;->f0:Landroid/view/ViewGroup;

    invoke-virtual {v2}, Landroid/view/Window;->getContext()Landroid/content/Context;

    move-result-object v3

    sget v7, Loh/a$c;->windowActionBar:I

    invoke-static {v3, v7, v6}, LZh/d;->d(Landroid/content/Context;IZ)Z

    move-result v8

    if-eqz v8, :cond_d

    sget v8, Loh/a$c;->windowActionBarMovable:I

    invoke-static {v3, v8, v6}, LZh/d;->d(Landroid/content/Context;IZ)Z

    move-result v8

    if-eqz v8, :cond_c

    sget v8, Loh/a$j;->miuix_appcompat_screen_action_bar_movable:I
    ...
    :cond_d
    sget v8, Loh/a$j;->miuix_appcompat_screen_simple:I

    :goto_3
    sget v9, Loh/a$c;->startingWindowOverlay:I

    invoke-static {v3, v9}, LZh/d;->c(Landroid/content/Context;I)I
    ...
    invoke-static {v3, v7, v0}, LZh/d;->d(Landroid/content/Context;IZ)Z
    ...
    sget v7, Loh/a$c;->windowTranslucentStatus:I

    invoke-static {v7, v3, v6}, LZh/d;->i(ILandroid/content/Context;I)I

    move-result v3

    invoke-static {v2, v3}, LJh/a;->a(Landroid/view/Window;I)Z
    ...
    iget-object v7, p0, Lmiuix/appcompat/app/m;->e0:Lrh/a;

    if-eqz v7, :cond_10

    invoke-virtual {p0}, Lmiuix/appcompat/app/m;->q()Z

    move-result v7

    iput-boolean v7, p0, Lmiuix/appcompat/app/m;->c0:Z

    iget-object v8, p0, Lmiuix/appcompat/app/m;->e0:Lrh/a;

    invoke-virtual {v8, v7}, Lrh/a;->l(Z)V

    iget-object v7, p0, Lmiuix/appcompat/app/m;->e0:Lrh/a;

    iget-boolean v8, p0, Lmiuix/appcompat/app/m;->c0:Z

    invoke-virtual {v7, v3, v8}, Lrh/a;->j(Landroid/view/View;Z)Landroid/view/ViewGroup;

    move-result-object v3

    iput-object v3, p0, Lmiuix/appcompat/app/m;->f0:Landroid/view/ViewGroup;

    iget-boolean v7, p0, Lmiuix/appcompat/app/m;->c0:Z

    invoke-virtual {p0, v7}, Lmiuix/appcompat/app/m;->r(Z)V

    iget-object v7, p0, Lmiuix/appcompat/app/m;->e0:Lrh/a;

    invoke-virtual {v7}, Lrh/a;->n()Z
    ...
    new-instance v8, Lmiuix/appcompat/app/n;

    invoke-direct {v8, p0}, Lmiuix/appcompat/app/n;-><init>(Lmiuix/appcompat/app/m;)V
    ...
    sget v7, Loh/a$h;->action_bar_overlay_layout:I
    ...
    iput-object v7, p0, Lmiuix/appcompat/app/m;->y:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;
    ...
    iget-object v7, p0, Lmiuix/appcompat/app/m;->y:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;
    ...
    iget-object v8, p0, Lmiuix/appcompat/app/d;->t:LGh/b;

    invoke-virtual {v7, v8}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingPolicy(LGh/b;)V
    ...
    iget-object v2, p0, Lmiuix/appcompat/app/m;->y:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;
    ...
    iput-object v2, p0, Lmiuix/appcompat/app/m;->W:Landroid/view/ViewGroup;

    :cond_13
    iget-object v2, p0, Lmiuix/appcompat/app/m;->e0:Lrh/a;

    if-eqz v2, :cond_14

    iget-object v3, p0, Lmiuix/appcompat/app/m;->f0:Landroid/view/ViewGroup;

    invoke-virtual {p0}, Lmiuix/appcompat/app/m;->q()Z

    move-result v5

    invoke-virtual {v2, v3, v5}, Lrh/a;->f(Landroid/view/View;Z)V
    ...
    invoke-virtual {v2, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setContentInsetStateCallback(Lmiuix/appcompat/app/v;)V

    iget-object v2, p0, Lmiuix/appcompat/app/m;->y:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;

    invoke-virtual {v2, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->a(LGh/a;)V
    ...
    sget v3, Loh/a$h;->action_bar_container:I
    ...
    iput-object v2, p0, Lmiuix/appcompat/app/m;->V:Lmiuix/appcompat/internal/app/widget/ActionBarContainer;
    ...
    sget v5, Loh/a$d;->abc_split_action_bar_is_narrow:I

    invoke-virtual {v3, v5}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v3

    iput-boolean v3, p0, Lmiuix/appcompat/app/m;->i0:Z

    goto :goto_5

    :cond_18
    sget v3, Loh/a$m;->Window_windowSplitActionBar:I
    ...
    :goto_5
    iget-boolean v3, p0, Lmiuix/appcompat/app/m;->i0:Z

    if-eqz v3, :cond_19

    iget-object v3, p0, Lmiuix/appcompat/app/m;->y:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;

    invoke-virtual {p0, v0, v2, v3}, Lmiuix/appcompat/app/d;->c(ZZLmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;)V

    sget v0, Loh/a$m;->Window_hyperSplitMenuEnabled:I
    ...
    :cond_19
    sget v0, Loh/a$m;->Window_endActionMenuEnabled:I
    ...
    sget v0, Loh/a$m;->Window_hyperActionMenuEnabled:I
...
.method public final n(ILandroid/view/MenuItem;)Z
    ...
    iget-object v0, p0, Lmiuix/appcompat/app/m;->Z:Lmiuix/appcompat/app/AppCompatActivity$a;

    iget-object v0, v0, Lmiuix/appcompat/app/AppCompatActivity$a;->a:Lmiuix/appcompat/app/AppCompatActivity;

    invoke-static {v0, p1, p2}, Lmiuix/appcompat/app/AppCompatActivity;->Ei(Lmiuix/appcompat/app/AppCompatActivity;ILandroid/view/MenuItem;)Z
...
.method public final o(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    :cond_0
    iget-object v0, p0, Lmiuix/appcompat/app/m;->W:Landroid/view/ViewGroup;
    ...
    :cond_1
    iget-object p0, p0, Lmiuix/appcompat/app/m;->l0:Lmiuix/appcompat/app/m$c;
...
.method public final onMenuItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p0, v0, p1}, Lmiuix/appcompat/app/m;->n(ILandroid/view/MenuItem;)Z
...
.method public final p(Z)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/app/d;->t:LGh/b;
    ...
    :cond_0
    iget-object p0, p0, Lmiuix/appcompat/app/m;->y:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;
...
.method public final r(Z)V
    ...
    invoke-static {v0}, Lmiuix/appcompat/app/k;->a(Landroid/view/Window;)V

    goto :goto_5

    :cond_5
    invoke-static {v0}, Lmiuix/appcompat/app/l;->a(Landroid/view/Window;)V
