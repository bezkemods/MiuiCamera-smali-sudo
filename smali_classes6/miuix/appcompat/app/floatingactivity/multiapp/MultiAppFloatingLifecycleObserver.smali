...
.method public final onCreate()V
    ...
    :cond_6
    :goto_2
    invoke-static {v3}, Lqh/b;->b(Lmiuix/appcompat/app/AppCompatActivity;)I

    move-result p0

    iget-object v0, v3, Lmiuix/appcompat/app/AppCompatActivity;->b:Lmiuix/appcompat/app/m;
    ...
    :cond_8
    sget-boolean p0, Lqh/b;->a:Z

    if-eqz p0, :cond_9

    invoke-static {v3, v5}, Lqh/b;->c(Lmiuix/appcompat/app/AppCompatActivity;Z)V

    goto :goto_4

    :cond_9
    sget p0, Loh/a$a;->miuix_appcompat_floating_window_enter_anim_normal_rom_enter:I

    sget v0, Loh/a$a;->miuix_appcompat_floating_window_enter_anim_normal_rom_exit:I
...
.method public final onResume()V
    ...
    invoke-virtual {v2}, Lmiuix/appcompat/app/AppCompatActivity;->We()V
    ...
    invoke-virtual {v2}, Lmiuix/appcompat/app/AppCompatActivity;->Hi()Landroid/view/View;

    move-result-object p0

    new-instance v0, Lsh/a;

    invoke-direct {v0, v3, p0}, Lsh/a;-><init>(Landroid/view/View;Landroid/view/View;)V
