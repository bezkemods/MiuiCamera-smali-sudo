...
# interfaces
.implements Lmiuix/appcompat/app/u;
.implements Lqh/d;
.implements LEi/a;
.implements LGh/c;
...
# instance fields
.field public a:LIh/n;

.field public final b:Lmiuix/appcompat/app/m;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0, v1, v2}, Lmiuix/appcompat/app/m;-><init>(Lmiuix/appcompat/app/AppCompatActivity;Lmiuix/appcompat/app/AppCompatActivity$a;Lmiuix/appcompat/app/AppCompatActivity$b;)V

    iput-object v0, p0, Lmiuix/appcompat/app/AppCompatActivity;->b:Lmiuix/appcompat/app/m;

    return-void
.end method

.method public static synthetic Ci(Lmiuix/appcompat/app/AppCompatActivity;)V
    .locals 0
...
.method public static synthetic Di(Lmiuix/appcompat/app/AppCompatActivity;)V
    .locals 0
...
.method public static synthetic Ei(Lmiuix/appcompat/app/AppCompatActivity;ILandroid/view/MenuItem;)Z
    .locals 0
...
.method public static synthetic Fi(Lmiuix/appcompat/app/AppCompatActivity;ILandroid/view/Menu;)Z
    .locals 0
...
.method public static synthetic Gi(Lmiuix/appcompat/app/AppCompatActivity;ILandroid/view/View;Landroid/view/Menu;)Z
    .locals 0
...
.method public final Hi()Landroid/view/View;
    .locals 0
    ...
    invoke-virtual {p0}, Lrh/a;->b()Landroid/view/View;
...
.method public final L4()V
    ...
    invoke-interface {p0}, Lqh/d;->L4()V
...
.method public final We()V
    ...
    invoke-interface {p0}, Lqh/d;->We()V
...
.method public bindViewWithContentInset(Landroid/view/View;)V
    ...
    invoke-direct {v0, v1, v2, v3, v4}, LZh/h$b;-><init>(IIII)V

    iput-object v0, p0, Lmiuix/appcompat/app/d;->p:LZh/h$b;
...
.method public finish()V
    ...
    iget-object v0, p0, Lmiuix/appcompat/app/AppCompatActivity;->b:Lmiuix/appcompat/app/m;

    iget-object v1, v0, Lmiuix/appcompat/app/m;->e0:Lrh/a;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lrh/a;->a()Z
    ...
    iput-boolean v2, v0, Lmiuix/appcompat/app/m;->h0:Z
...
.method public final isFinishing()Z
    ...
    iget-boolean v0, v0, Lmiuix/appcompat/app/m;->h0:Z
...
.method public final m(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, p1}, Lmiuix/appcompat/app/m;->m(Landroid/graphics/Rect;)V
...
.method public final onActionModeFinished(Landroid/view/ActionMode;)V
    ...
    invoke-virtual {p0}, Lmiuix/appcompat/app/m;->k()Landroidx/lifecycle/LifecycleOwner;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object v1, v0, Lmiuix/appcompat/app/m;->j0:Lmiuix/appcompat/app/m$a;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, LGi/b;->c()V

    :cond_0
    iget-object p0, p0, Lmiuix/appcompat/app/AppCompatActivity;->a:LIh/n;

    iget-boolean v1, p0, LIh/n;->a:Z

    if-nez v1, :cond_2

    iget-boolean v1, p0, LIh/n;->b:Z
    ...
    :cond_1
    sget-object v1, LIh/a;->a:Landroid/graphics/Point;

    const/4 v1, 0x1

    iput-boolean v1, p0, LIh/n;->b:Z

    iput-boolean v1, p0, LIh/n;->a:Z

    :cond_2
    :goto_0
    iget-object p0, v0, Lmiuix/appcompat/app/d;->a:Lmiuix/appcompat/app/AppCompatActivity;

    iget-object v1, p0, Lmiuix/appcompat/app/AppCompatActivity;->a:LIh/n;

    const/4 v2, 0x0

    invoke-static {p0, v1, p1, v2}, LIh/a;->k(Landroid/content/Context;LIh/n;Landroid/content/res/Configuration;Z)V

    new-instance v1, LG2/d;

    const/4 v2, 0x6

    invoke-direct {v1, v2, v0, p1}, LG2/d;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    iput-object v1, v0, Lmiuix/appcompat/app/m;->m0:LG2/d;
    ...
    iget-object v1, v0, Lmiuix/appcompat/app/m;->m0:LG2/d;
    ...
    iget-object p0, v0, Lmiuix/appcompat/app/m;->y:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;

    if-eqz p0, :cond_5

    iget-object v1, v0, Lmiuix/appcompat/app/d;->t:LGh/b;

    invoke-virtual {p0, v1}, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->setExtraPaddingPolicy(LGh/b;)V

    :cond_5
    iget-object p0, v0, Lmiuix/appcompat/app/m;->Z:Lmiuix/appcompat/app/AppCompatActivity$a;
    ...
    iget-object p0, v0, Lmiuix/appcompat/app/m;->j0:Lmiuix/appcompat/app/m$a;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {p0}, LIh/a;->i(Landroid/content/Context;)V
    ...
    sget-boolean v2, Lxh/b;->a:Z

    const/4 v3, 0x1

    if-nez v2, :cond_0

    sput-boolean v3, Lxh/b;->a:Z
    ...
    invoke-direct {v5, v2, v6}, Lrh/i;-><init>(Ljava/lang/Object;I)V
    ...
    :cond_0
    sget v2, Loh/a$c;->windowExtraPaddingHorizontal:I

    const/4 v4, 0x0

    invoke-static {v2, v1, v4}, LZh/d;->i(ILandroid/content/Context;I)I
    ...
    :cond_1
    sget v2, Loh/a$c;->windowExtraPaddingHorizontalEnable:I
    ...
    :cond_2
    sget v4, Loh/a$c;->windowExtraPaddingHorizontalInitEnable:I

    iget-boolean v5, v0, Lmiuix/appcompat/app/d;->w:Z

    invoke-static {v1, v4, v5}, LZh/d;->d(Landroid/content/Context;IZ)Z
    ...
    :cond_3
    sget v5, Loh/a$c;->windowExtraPaddingApplyToContentEnable:I

    iget-boolean v6, v0, Lmiuix/appcompat/app/d;->x:Z

    invoke-static {v1, v5, v6}, LZh/d;->d(Landroid/content/Context;IZ)Z
    ...
    :cond_4
    invoke-virtual {v0, v2}, Lmiuix/appcompat/app/m;->p(Z)V
    ...
    :cond_6
    iget-object v2, v0, Lmiuix/appcompat/app/m;->Z:Lmiuix/appcompat/app/AppCompatActivity$a;
    ...
    invoke-virtual {v0}, Lmiuix/appcompat/app/m;->l()V

    iget-boolean v0, v0, Lmiuix/appcompat/app/m;->b0:Z
    ...
    :goto_0
    invoke-static {p0}, LIh/a;->a(Landroid/content/Context;)LIh/n;

    move-result-object p1

    const/4 v0, 0x0

    invoke-static {p0, p1, v0, v3}, LIh/a;->k(Landroid/content/Context;LIh/n;Landroid/content/res/Configuration;Z)V

    iput-object p1, p0, Lmiuix/appcompat/app/AppCompatActivity;->a:LIh/n;

    invoke-static {p0}, LIh/k;->n(Landroid/content/Context;)Z
    ...
    invoke-direct {v0, p0, v1}, Lmiuix/appcompat/app/j;-><init>(Lmiuix/appcompat/app/AppCompatActivity;I)V
...
.method public final onCreatePanelView(I)Landroid/view/View;
    ...
    iget-boolean p1, p0, Lmiuix/appcompat/app/m;->i0:Z
...
.method public onDestroy()V
    ...
    iget-object v2, v0, Lmiuix/appcompat/app/m;->n0:Lmiuix/appcompat/app/m$b;

    invoke-virtual {v1, v2}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iget-object v0, v0, Lmiuix/appcompat/app/m;->m0:LG2/d;
    ...
    :cond_2
    invoke-static {p0}, LIh/a;->j(Landroid/content/Context;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lmiuix/appcompat/app/AppCompatActivity;->a:LIh/n;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    instance-of v2, v1, Lmiuix/appcompat/app/z;

    if-eqz v2, :cond_0

    check-cast v1, Lmiuix/appcompat/app/z;

    invoke-interface {v1, p1, p2}, Lmiuix/appcompat/app/z;->onKeyDown(ILandroid/view/KeyEvent;)Z
...
.method public final onKeyLongPress(ILandroid/view/KeyEvent;)Z
    ...
    invoke-interface {v1, p1, p2}, Lmiuix/appcompat/app/z;->onKeyLongPress(ILandroid/view/KeyEvent;)Z
...
.method public final onKeyMultiple(IILandroid/view/KeyEvent;)Z
    ...
    invoke-interface {v1, p1, p2, p3}, Lmiuix/appcompat/app/z;->onKeyMultiple(IILandroid/view/KeyEvent;)Z
...
.method public onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    invoke-interface {v1, p1, p2}, Lmiuix/appcompat/app/z;->onKeyUp(ILandroid/view/KeyEvent;)Z
...
.method public final onMenuItemSelected(ILandroid/view/MenuItem;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lmiuix/appcompat/app/m;->n(ILandroid/view/MenuItem;)Z
...
.method public final onPostResume()V
    ...
    invoke-static {v0}, Lmiuix/appcompat/app/AppCompatActivity;->Ci(Lmiuix/appcompat/app/AppCompatActivity;)V
...
.method public final onRestoreInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/app/m;->V:Lmiuix/appcompat/internal/app/widget/ActionBarContainer;
    ...
    iget-object p0, p0, Lmiuix/appcompat/app/m;->V:Lmiuix/appcompat/internal/app/widget/ActionBarContainer;
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v0, p0, Lmiuix/appcompat/app/m;->e0:Lrh/a;
    ...
    iget-object v0, v0, Lmiuix/appcompat/app/m;->g0:Ljava/lang/String;
...
.method public onStop()V
    ...
    invoke-static {v0}, Lmiuix/appcompat/app/AppCompatActivity;->Di(Lmiuix/appcompat/app/AppCompatActivity;)V
...
.method public final r9()V
    ...
    invoke-interface {p0}, Lqh/d;->r9()V
...
.method public final setContentView(I)V
    ...
    .line 8
    iget-object v0, p0, Lmiuix/appcompat/app/m;->Y:Landroid/view/LayoutInflater;

    iget-object v1, p0, Lmiuix/appcompat/app/m;->W:Landroid/view/ViewGroup;
...
.method public setContentView(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1, v0}, Lmiuix/appcompat/app/m;->o(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final setContentView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {p0, p1, p2}, Lmiuix/appcompat/app/m;->o(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final startActionMode(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode;
    ...
    sget v1, Loh/a$h;->content_mask_vs:I
    ...
    :cond_0
    sget v1, Loh/a$h;->content_mask:I
...
.method public unregisterCoordinateScrollView(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, Lmiuix/appcompat/app/ActionBar;->q(Landroid/view/View;)V
