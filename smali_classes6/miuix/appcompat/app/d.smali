...
.method public final c(ZZLmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;)V
    ...
    sget v0, Loh/a$h;->split_action_bar_vs:I
    ...
    sget p0, Loh/a$h;->content_mask_vs:I
    ...
    :cond_2
    sget p0, Loh/a$h;->content_mask:I
    ...
    :cond_3
    sget p0, Loh/a$h;->action_bar_container:I
    ...
    sget v1, Loh/a$h;->action_context_bar_vs:I
    ...
    :cond_4
    sget v1, Loh/a$h;->action_context_bar:I
...
.method public final f()V
    ...
    iput-object v0, p0, Lmiuix/appcompat/app/d;->t:LGh/b;

    if-eqz v0, :cond_0

    iget-boolean p0, p0, Lmiuix/appcompat/app/d;->u:Z

    iput-boolean p0, v0, LGh/b;->a:Z
...
.method public final g(Landroid/graphics/Rect;)V
    ...
    :cond_0
    iget-object v0, p0, Lmiuix/appcompat/app/d;->p:LZh/h$b;

    iget v1, v0, LZh/h$b;->a:I

    iget v2, v0, LZh/h$b;->b:I

    iget v3, v0, LZh/h$b;->c:I

    iget v0, v0, LZh/h$b;->d:I

    iget-object v4, p0, Lmiuix/appcompat/app/d;->o:Landroid/view/View;

    invoke-static {v4}, LZh/h;->c(Landroid/view/View;)Z
...
.method public final getActionBar()Lmiuix/appcompat/app/ActionBar;
    ...
    invoke-interface {p0}, Lmiuix/appcompat/app/b;->Pa()Lmiuix/appcompat/internal/app/widget/ActionBarImpl;
...
.method public final i(Lmiuix/appcompat/internal/view/menu/d;)V
    ...
    iget-object v2, v0, Lmiuix/appcompat/internal/app/widget/b;->h:Lmiuix/appcompat/internal/view/menu/action/a;
    ...
    :cond_2
    iget-object v1, v0, Lmiuix/appcompat/internal/app/widget/b;->g:Lmiuix/appcompat/internal/view/menu/action/b;
    ...
    iget-boolean v2, v0, Lmiuix/appcompat/internal/app/widget/b;->j:Z

    if-nez v2, :cond_3

    iget-boolean v2, v0, Lmiuix/appcompat/internal/app/widget/b;->k:Z
    ...
    iget-boolean v2, v0, Lmiuix/appcompat/internal/app/widget/b;->l:Z
    ...
    sget v10, Loh/a$h;->miuix_split_action_menu_group:I
    ...
    sget v9, Loh/a$h;->miuix_hyper_split_parent_item:I
    ...
    :goto_3
    iget-boolean v6, v0, Lmiuix/appcompat/internal/app/widget/b;->m:Z
    ...
    sget v10, Loh/a$h;->miuix_action_end_menu_group:I
    ...
    :goto_a
    iget-boolean p1, v0, Lmiuix/appcompat/internal/app/widget/b;->j:Z

    iget-boolean v2, v0, Lmiuix/appcompat/internal/app/widget/ActionBarView;->q1:Z

    if-eqz p1, :cond_1a

    iget-object p1, v0, Lmiuix/appcompat/internal/app/widget/b;->h:Lmiuix/appcompat/internal/view/menu/action/a;

    if-nez p1, :cond_18

    iget-boolean p1, v0, Lmiuix/appcompat/internal/app/widget/b;->m:Z
    ...
    sget v6, Loh/a$j;->miuix_appcompat_responsive_action_menu_layout:I

    sget v7, Loh/a$j;->miuix_appcompat_action_menu_item_layout:I
    ...
    iput-object v4, p1, Lmiuix/appcompat/internal/view/menu/action/e;->V:Ljava/util/HashMap;

    new-instance v4, Ljava/util/HashMap;

    invoke-direct {v4}, Ljava/util/HashMap;-><init>()V

    iput-object v4, p1, Lmiuix/appcompat/internal/view/menu/action/e;->W:Ljava/util/HashMap;

    iput-boolean v5, p1, Lmiuix/appcompat/internal/view/menu/action/e;->Y:Z
    ...
    iput-object p1, v0, Lmiuix/appcompat/internal/app/widget/b;->h:Lmiuix/appcompat/internal/view/menu/action/a;
    ...
    iget-object v1, v0, Lmiuix/appcompat/internal/app/widget/b;->h:Lmiuix/appcompat/internal/view/menu/action/a;
    ...
    :cond_1a
    iget-boolean p1, v0, Lmiuix/appcompat/internal/app/widget/b;->k:Z
    ...
    iget-boolean p1, v0, Lmiuix/appcompat/internal/app/widget/b;->l:Z
    ...
    sget v9, Loh/a$j;->miuix_appcompat_action_end_menu_layout:I

    sget v10, Loh/a$j;->miuix_appcompat_action_end_menu_item_layout:I

    sget v11, Loh/a$j;->miuix_appcompat_action_bar_expanded_menu_layout:I

    sget v12, Loh/a$j;->miuix_appcompat_action_bar_list_menu_item_layout:I
    ...
    iput-object v1, p1, Lmiuix/appcompat/internal/view/menu/action/d;->W:Ljava/util/HashMap;

    new-instance v1, Ljava/util/HashMap;

    invoke-direct {v1}, Ljava/util/HashMap;-><init>()V

    iput-object v1, p1, Lmiuix/appcompat/internal/view/menu/action/d;->Y:Ljava/util/HashMap;

    iput-boolean v5, p1, Lmiuix/appcompat/internal/view/menu/action/d;->Z:Z
    ...
    sget v4, Loh/a$d;->abc_action_bar_expanded_action_views_exclusive:I
    ...
    :cond_1f
    :goto_e
    iput-object v1, v0, Lmiuix/appcompat/internal/app/widget/b;->h:Lmiuix/appcompat/internal/view/menu/action/a;
    ...
    iget-boolean v0, p1, Lmiuix/appcompat/internal/app/widget/b;->k:Z
    ...
    invoke-interface {p0, v0, p1}, Lmiuix/appcompat/app/b;->Ld(Landroid/view/Menu;Landroid/view/Menu;)V
...
.method public final j(I)V
    ...
    sget v2, Loh/a$i;->window_translucent_status:I
    ...
    invoke-static {v0, p1}, LJh/a;->a(Landroid/view/Window;I)Z
