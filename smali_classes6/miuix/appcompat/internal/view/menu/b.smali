...
.method public final b()V
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LCh/e;
...
.method public final f()Z
    ...
    invoke-direct {v0, v2, v1}, LDh/e;-><init>(Landroid/content/Context;Landroid/view/View;)V

    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LDh/e;

    const v1, 0x800055

    invoke-virtual {v0, v1}, Lui/h;->c(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LDh/e;

    iput-object p0, v0, Lui/h;->u:Landroid/widget/PopupWindow$OnDismissListener;

    iput-object p0, v0, LDh/e;->q0:LDh/e$c;

    const/4 v1, 0x0

    iput-boolean v1, v0, Lui/h;->d0:Z

    new-instance v0, LCh/e;

    const/4 v3, 0x1

    invoke-direct {v0, v2, v3}, LCh/e;-><init>(Landroid/content/Context;Z)V

    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LCh/e;
    ...
    iget-object v4, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LCh/e;

    invoke-virtual {v4, v0}, LCh/e;->d(Ljava/util/HashMap;)V

    :cond_1
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LCh/e;

    invoke-virtual {v0, v2}, LCh/e;->e(Lmiuix/appcompat/internal/view/menu/d;)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LDh/e;

    iget-object v2, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LCh/e;

    iget-object v0, v0, LDh/e;->j0:LDh/e$d;

    iput-object v2, v0, LDh/e$d;->b:Landroid/widget/ListAdapter;

    iget-object v0, v2, LCh/e;->e:Ljava/util/HashMap;
    ...
    iget-object v2, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LDh/e;

    iput-boolean v0, v2, LDh/e;->s0:Z

    invoke-virtual {v2, v1}, Lui/h;->setHorizontalOffset(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LDh/e;

    invoke-virtual {v0, v1}, Lui/h;->setVerticalOffset(I)V

    iget v0, p0, Lmiuix/appcompat/internal/view/menu/b;->h:I

    if-lez v0, :cond_2

    iget-object v1, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LDh/e;

    iput v0, v1, Lui/h;->l:I
    ...
    invoke-virtual {v0, v1}, LDh/e;->E(Landroid/view/View;)V
...
.method public final isShowing()Z
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LDh/e;

    iget-boolean p0, p0, Lui/h;->e0:Z
...
.method public final j()V
    ...
    iget-object v0, v0, LCh/e;->g:Ljava/util/HashMap;
    ...
    iget-object v0, v0, LCh/e;->i:Ljava/util/HashMap;
