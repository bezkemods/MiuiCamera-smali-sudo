...
.method public constructor <init>(Lmiuix/appcompat/widget/Spinner;Landroid/content/Context;)V
    ...
    sget v0, Loh/a$f;->miuix_appcompat_drop_down_menu_padding_single_item:I
    ...
    sget v1, Loh/a$f;->miuix_appcompat_drop_down_item_min_height:I
    ...
    iput p1, p2, Lri/b;->d:I

    const p1, 0x800053

    invoke-super {p0, p1}, Lui/h;->c(I)V
...
.method public final k(Landroid/widget/ListAdapter;Landroid/content/Context;)[[I
    ...
    iget-object p2, p0, Lui/h;->b:Landroid/view/View;
    ...
    iget-object p0, p0, Lui/h;->b:Landroid/view/View;
...
.method public final m(Landroid/view/View;)Z
    ...
    invoke-super {p0, p1}, Lui/h;->m(Landroid/view/View;)Z
...
.method public final o(Landroid/widget/ListAdapter;)V
    ...
    invoke-super {p0, p1}, Lui/h;->o(Landroid/widget/ListAdapter;)V
...
.method public final show(II)V
    ...
    instance-of v1, v1, Lmiuix/appcompat/app/u;
    ...
    check-cast v1, Lmiuix/appcompat/app/u;

    invoke-interface {v1}, Lmiuix/appcompat/app/u;->P4()Z
    ...
    invoke-virtual {p0, v1}, Lui/h;->q(Landroid/view/View;)V
    ...
    invoke-virtual {v1}, Lri/b;->toString()Ljava/lang/String;
    ...
    invoke-virtual {p0, v2}, Lui/h;->p(Landroid/view/View;)V

    :cond_4
    iget-object v3, v1, Lri/b;->q:Landroid/graphics/Rect;

    invoke-virtual {v3}, Landroid/graphics/Rect;->centerX()I

    move-result v3

    iget-object v4, v1, Lri/b;->p:Landroid/graphics/Rect;
    ...
    invoke-super {p0, v3}, Lui/h;->c(I)V
    ...
    invoke-interface {v3, v1}, Lri/a;->c(Lri/b;)I

    move-result v3

    iget-object v4, p0, Lui/h;->e:Lri/a;

    invoke-interface {v4, v1}, Lri/a;->g(Lri/b;)I

    move-result v4

    iget v5, v1, Lri/b;->g:I

    invoke-virtual {p0, v5}, Landroid/widget/PopupWindow;->setWidth(I)V

    iget v1, v1, Lri/b;->h:I
    ...
    invoke-virtual {p0, v2, v1, v3, v4}, Lui/h;->showAtLocation(Landroid/view/View;III)V
    ...
    :goto_3
    iget-object v1, p0, Lui/h;->f:Landroid/widget/ListView;
