...
.field public e:LIh/g;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field

.field public f:LIh/f;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 7
    sget-object v2, Loh/a$m;->MiuixButton:[I

    sget v4, Loh/a$l;->Widget_Button:I
    ...
    .line 8
    sget p3, Loh/a$m;->MiuixButton_isLightTheme:I
...
.method public final b()V
    ...
    iget-object v3, v0, Lmiuix/appcompat/widget/Button;->e:LIh/g;
    ...
    invoke-virtual {v3, v4}, LIh/g;->b(Z)LIh/f;

    move-result-object v3

    iput-object v3, v0, Lmiuix/appcompat/widget/Button;->f:LIh/f;
    ...
    invoke-static {v3}, LIh/d;->a(Landroid/content/Context;)Z
    ...
    iget-object v5, v0, Lmiuix/appcompat/widget/Button;->f:LIh/f;

    iget-object v5, v5, LIh/f;->c:LIh/f$b;
    ...
    :cond_2
    :goto_0
    iget-object v3, v0, Lmiuix/appcompat/widget/Button;->f:LIh/f;

    iget-object v3, v3, LIh/f;->e:LIh/f$a;

    if-eqz v3, :cond_4

    sget-object v5, LIh/d;->a:Ljava/lang/Boolean;
    ...
    iget v8, v3, LIh/f$a;->g:F

    mul-float/2addr v8, v5

    add-float/2addr v8, v7

    iget v5, v3, LIh/f$a;->b:F

    iget v7, v3, LIh/f$a;->c:F

    iget v9, v3, LIh/f$a;->d:F

    iget v10, v3, LIh/f$a;->e:F

    iget v11, v3, LIh/f$a;->f:F

    iget v12, v3, LIh/f$a;->h:F

    iget v13, v3, LIh/f$a;->i:F

    iget v14, v3, LIh/f$a;->j:F

    iget v15, v3, LIh/f$a;->k:F

    iget v1, v3, LIh/f$a;->l:F

    iget v2, v3, LIh/f$a;->m:F

    move/from16 v17, v4

    iget v4, v3, LIh/f$a;->n:F

    iget v0, v3, LIh/f$a;->o:F

    move/from16 v18, v0

    iget v0, v3, LIh/f$a;->p:F

    move/from16 v19, v0

    iget v0, v3, LIh/f$a;->q:F

    move/from16 v20, v0

    iget v0, v3, LIh/f$a;->r:F

    move/from16 v21, v0

    iget v0, v3, LIh/f$a;->s:F

    move/from16 v22, v0

    iget v0, v3, LIh/f$a;->t:F

    iget v3, v3, LIh/f$a;->u:F
    ...
    invoke-static {v0, v3}, LIh/c;->b(Landroid/view/View;[F)Z
    ...
    invoke-static/range {p0 .. p0}, LIh/c;->a(Landroid/view/View;)Z

    :goto_1
    iget-object v1, v0, Lmiuix/appcompat/widget/Button;->f:LIh/f;
    ...
    :cond_5
    iget-object v1, v1, LIh/f;->d:LIh/f$d;

    if-eqz v1, :cond_c

    iget-object v2, v0, Lmiuix/appcompat/widget/Button;->g:LRh/b;
    ...
    iget v7, v1, LIh/f$d;->b:F

    iget v10, v1, LIh/f$d;->e:F

    iget v6, v1, LIh/f$d;->a:I

    iget v8, v1, LIh/f$d;->c:F

    iget v9, v1, LIh/f$d;->d:F

    move-object v4, v11

    move v5, v6

    invoke-direct/range {v4 .. v10}, LRh/a;-><init>(IIFFFF)V

    move/from16 v1, v17

    invoke-direct {v2, v3, v11, v1}, LRh/b;-><init>(Landroid/content/Context;LRh/a;Z)V

    iput-object v2, v0, Lmiuix/appcompat/widget/Button;->g:LRh/b;

    iget-object v1, v2, LRh/b;->b:LRh/a;

    if-eqz v1, :cond_6

    iget-boolean v3, v1, LRh/a;->g:Z

    const/4 v4, 0x1

    if-eq v3, v4, :cond_7

    iput-boolean v4, v1, LRh/a;->g:Z
    ...
    :cond_7
    :goto_2
    iget-boolean v1, v2, LRh/b;->c:Z

    if-eqz v1, :cond_f

    iget-boolean v1, v2, LRh/b;->l:Z
    ...
    :cond_8
    invoke-virtual {v2, v0, v4}, LRh/b;->a(Landroid/view/View;Z)V

    :goto_3
    iget-object v1, v0, Lmiuix/appcompat/widget/Button;->g:LRh/b;

    iget-boolean v2, v1, LRh/b;->c:Z
    ...
    :cond_9
    iget v2, v1, LRh/b;->k:I

    iget v3, v1, LRh/b;->e:F

    iget v4, v1, LRh/b;->f:F

    iget v5, v1, LRh/b;->g:F

    iget-object v1, v1, LRh/b;->b:LRh/a;

    iget v6, v1, LRh/a;->f:F

    iget-boolean v7, v1, LRh/a;->g:Z
    ...
    invoke-static/range {v0 .. v6}, LIh/h;->b(Landroid/view/View;IFFFFZ)V
    ...
    iget v10, v1, LIh/f$d;->a:I

    sget-object v5, Landroid/graphics/BlurMaskFilter$Blur;->NORMAL:Landroid/graphics/BlurMaskFilter$Blur;

    iget v12, v1, LIh/f$d;->c:F

    iget v13, v1, LIh/f$d;->d:F

    iget v11, v1, LIh/f$d;->b:F

    iget v14, v1, LIh/f$d;->e:F

    move-object v8, v3

    move v9, v10

    invoke-direct/range {v8 .. v14}, LRh/a;-><init>(IIFFFF)V

    iput-object v3, v2, LRh/b;->b:LRh/a;

    iget-object v1, v2, LRh/b;->a:Landroid/content/Context;

    invoke-virtual {v1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    iget-boolean v3, v2, LRh/b;->d:Z
    ...
    iget-object v5, v2, LRh/b;->b:LRh/a;

    invoke-virtual {v2, v3, v1, v5}, LRh/b;->d(ZFLRh/a;)V

    iget v1, v2, LRh/b;->g:F
    ...
    :goto_4
    iput-boolean v1, v2, LRh/b;->l:Z

    iget-object v1, v0, Lmiuix/appcompat/widget/Button;->g:LRh/b;

    iget-boolean v2, v1, LRh/b;->l:Z

    invoke-virtual {v1, v0, v2}, LRh/b;->a(Landroid/view/View;Z)V
...
.method public getCurrentMaterial()LIh/f;
    .locals 0
    .annotation build Landroidx/annotation/Nullable;
    .end annotation

    iget-object p0, p0, Lmiuix/appcompat/widget/Button;->f:LIh/f;
...
.method public getMaterial()LIh/g;
    ...
    iget-object p0, p0, Lmiuix/appcompat/widget/Button;->e:LIh/g;
...
.method public setMaterial(LIh/f;)V
    .locals 1
    .param p1    # LIh/f;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-direct {v0, p1}, LIh/g;-><init>(LIh/f;)V

    invoke-virtual {p0, v0}, Lmiuix/appcompat/widget/Button;->setMaterial(LIh/g;)V
...
.method public setMaterial(LIh/g;)V
    ...
    .line 6
    iput-object p1, p0, Lmiuix/appcompat/widget/Button;->e:LIh/g;

    .line 7
    invoke-virtual {p0, v0}, Lmiuix/appcompat/widget/Button;->i(Z)V

    .line 8
    invoke-static {p0}, LIh/c;->a(Landroid/view/View;)Z
...
.method public setMaterial(Lmiuix/theme/token/MaterialDayNightToken;)V
    ...
    .line 2
    invoke-static {p1}, LIh/g;->a(Lmiuix/theme/token/MaterialDayNightToken;)LIh/g;

    move-result-object p1

    invoke-virtual {p0, p1}, Lmiuix/appcompat/widget/Button;->setMaterial(LIh/g;)V
...
.method public setMaterial(Lmiuix/theme/token/MaterialToken;)V
    ...
    invoke-static {v0}, LIh/g;->a(Lmiuix/theme/token/MaterialDayNightToken;)LIh/g;
