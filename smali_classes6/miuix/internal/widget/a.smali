...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lmiuix/appcompat/app/AlertDialog;Landroid/view/Window;Lbi/a;)V
    .locals 5
    ...
    iput-object v1, p0, Lmiuix/internal/widget/a;->I:LDh/b;
    ...
    iput-object p4, p0, Lmiuix/internal/widget/a;->u:Lbi/a;
    ...
    :cond_0
    sget-object p3, Lbi/a;->a:Lbi/a;

    if-ne p4, p3, :cond_1

    sget p3, Loh/a$c;->actionSheetAlertStyle:I

    goto :goto_0

    :cond_1
    sget p3, Loh/a$c;->actionSheetArrowStyle:I

    :goto_0
    sget-object p4, Loh/a$m;->ActionSheet:[I
    ...
    sget p3, Loh/a$m;->ActionSheet_actionSheetLayout:I

    sget p4, Loh/a$j;->miuix_appcompat_action_sheet_layout:I
    ...
    sget p3, Loh/a$m;->ActionSheet_actionSheetContentLayout:I

    sget p4, Loh/a$j;->miuix_appcompat_action_sheet_alert_content:I
    ...
    sget p3, Loh/a$m;->ActionSheet_actionSheetListItem:I

    sget p4, Loh/a$j;->miuix_appcompat_action_sheet_list_item:I
...
.method public final b(Lmiuix/appcompat/app/h;)V
    ...
    sget-object v2, Lbi/a;->b:Lbi/a;

    iget-object v3, p0, Lmiuix/internal/widget/a;->u:Lbi/a;
    ...
    iget-object p0, p0, Lmiuix/internal/widget/a;->I:LDh/b;
...
.method public final e(Z)V
    ...
    iget-object v0, p0, Lmiuix/internal/widget/a;->t:Lbi/c;
    ...
    iget-object v5, p0, Lmiuix/internal/widget/a;->t:Lbi/c;

    invoke-interface {v5}, Lbi/c;->d()Lbi/b;

    move-result-object v5

    invoke-virtual {v2, v5}, Lmiuix/internal/widget/ArrowActionSheetPanel;->setArrowMode(Lbi/b;)V

    :cond_1
    iget-object v2, p0, Lmiuix/internal/widget/a;->t:Lbi/c;

    iget-object v5, p0, Lmiuix/internal/widget/a;->C:Landroid/graphics/Point;

    iget v6, v5, Landroid/graphics/Point;->x:I

    invoke-interface {v2, v3, v6, v1}, Lbi/c;->e(Landroid/content/Context;ILandroid/view/WindowInsets;)I
    ...
    invoke-interface {v2, v3, v1}, Lbi/c;->b(Landroid/content/Context;Landroid/view/WindowInsets;)[I
    ...
    invoke-interface {v0, v3, v1}, Lbi/c;->c(Landroid/content/Context;Landroid/view/WindowInsets;)[I
    ...
    :cond_5
    iget-object v0, p0, Lmiuix/internal/widget/a;->u:Lbi/a;
    ...
    sget v6, Loh/a$h;->actionSheetScrollView:I
    ...
    sget v6, Loh/a$h;->alertContentWrapper:I
    ...
    sget v6, Loh/a$h;->action_sheet_content_container:I
    ...
    sget v6, Loh/a$h;->action_sheet_message:I
    ...
    sget p1, Loh/a$k;->miuix_appcompat_action_sheet_default_message:I
    ...
    :cond_b
    sget v6, Loh/a$h;->actionSheetSpringBack:I
    ...
    sget v6, Loh/a$h;->action_sheet_list_view:I
    ...
    invoke-direct {v6, p0}, Lbi/d;-><init>(Lmiuix/internal/widget/a;)V
    ...
    sget v6, Loh/a$h;->action_sheet_cancel_button:I
    ...
    sget p1, Loh/a$k;->miuix_appcompat_cancel_description:I
    ...
    new-instance v6, Lbi/h;

    invoke-direct {v6, p0}, Lbi/h;-><init>(Lmiuix/internal/widget/a;)V
    ...
    invoke-direct {v6, p0, v7}, LA/D1;-><init>(Ljava/lang/Object;I)V
    ...
    :cond_13
    invoke-static {v3}, LIh/a;->b(Landroid/content/Context;)Landroid/graphics/Point;

    move-result-object p1

    sget-boolean v1, Lii/a;->b:Z
    ...
    invoke-static {v3}, LIh/k;->e(Landroid/content/Context;)I
...
.method public final f(Landroid/view/WindowInsets;)V
    ...
    invoke-interface {v0, v1, p1}, Lbi/c;->c(Landroid/content/Context;Landroid/view/WindowInsets;)[I

    move-result-object v0

    iget-object v2, p0, Lmiuix/internal/widget/a;->t:Lbi/c;

    invoke-interface {v2, v1, p1}, Lbi/c;->b(Landroid/content/Context;Landroid/view/WindowInsets;)[I
    ...
    :goto_1
    iget-object v4, p0, Lmiuix/internal/widget/a;->t:Lbi/c;

    invoke-interface {v4, v1, v3, p1}, Lbi/c;->e(Landroid/content/Context;ILandroid/view/WindowInsets;)I

    move-result p1

    iget-object v1, p0, Lmiuix/internal/widget/a;->t:Lbi/c;
...
.method public final g()V
    ...
    invoke-static {v1, v0}, LIh/a;->d(Landroid/content/Context;Landroid/content/res/Configuration;)LIh/n;

    move-result-object v0

    iget-object v1, p0, Lmiuix/internal/widget/a;->C:Landroid/graphics/Point;

    iget-object v2, v0, LIh/n;->c:Landroid/graphics/Point;
    ...
    iget-object v0, v0, LIh/n;->d:Landroid/graphics/Point;
