...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p1, p2}, Lqh/a;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    iput-object v0, p0, Lmiuix/internal/widget/DialogParentPanel;->a:Lqh/a;

    const/4 p0, 0x1

    iput-boolean p0, v0, Lqh/a;->d:Z
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Lmiuix/internal/widget/DialogParentPanel;->a:Lqh/a;
    ...
    sget v4, Loh/a$h;->contentPanel:I
...
.method public final onFinishInflate()V
    ...
    sget v0, Loh/a$h;->contentPanel:I
...
.method public final onMeasure(II)V
    ...
    iget-object v7, p0, Lmiuix/internal/widget/DialogParentPanel;->a:Lqh/a;

    iget-object v3, v7, Lqh/a;->h:Landroid/util/TypedValue;

    iget-object v4, v7, Lqh/a;->f:Landroid/util/TypedValue;

    iget-object v5, v7, Lqh/a;->k:Landroid/util/TypedValue;

    iget-object v6, v7, Lqh/a;->l:Landroid/util/TypedValue;
    ...
    invoke-virtual/range {v0 .. v6}, Lqh/a;->a(IZLandroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;Landroid/util/TypedValue;)I
    ...
    :cond_0
    iget-object v3, v7, Lqh/a;->e:Landroid/util/TypedValue;

    iget-object v4, v7, Lqh/a;->g:Landroid/util/TypedValue;

    iget-object v5, v7, Lqh/a;->i:Landroid/util/TypedValue;

    iget-object v6, v7, Lqh/a;->j:Landroid/util/TypedValue;
