...
.field private mLevelSupplier:LOh/a;

.field private mRowSpacing:I

.field private mViewList:LNh/c;
...
.method public static synthetic a(Lmiuix/flexible/template/AbstractMarkTemplate;LNh/d;LNh/d;)I
    .locals 0

    invoke-direct {p0, p1, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->lambda$measureViewList$0(LNh/d;LNh/d;)I
...
.method private synthetic lambda$measureViewList$0(LNh/d;LNh/d;)I
    .locals 0

    invoke-virtual {p0, p1}, Lmiuix/flexible/template/AbstractMarkTemplate;->getViewNodePriority(LNh/d;)I

    move-result p1

    invoke-virtual {p0, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->getViewNodePriority(LNh/d;)I
...
.method private layoutViewList(LNh/c;ZIII)V
    .locals 18
    ...
    iget v0, v9, LNh/d;->c:I

    add-int v0, p4, v0

    iget v1, v9, LNh/d;->d:I

    add-int v1, p5, v1

    new-instance v2, Ljava/util/ArrayList;

    iget-object v3, v9, LNh/c;->g:Ljava/util/ArrayList;
    ...
    iget-object v5, v4, LNh/d;->b:Landroid/view/View;
    ...
    iget-object v0, v5, LNh/c;->g:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, LNh/d;->b:Landroid/view/View;
    ...
    iget v0, v9, LNh/d;->d:I

    iget v1, v5, LNh/d;->d:I

    invoke-static {v0, v1, v3, v7}, Landroidx/appcompat/widget/a;->b(IIII)I
    ...
    iget v1, v5, LNh/d;->c:I

    invoke-static {v0, v1, v3, v6}, Landroidx/appcompat/widget/a;->b(IIII)I
    ...
    invoke-direct/range {v0 .. v5}, Lmiuix/flexible/template/AbstractMarkTemplate;->layoutViewList(LNh/c;ZIII)V

    iget v0, v9, LNh/c;->f:I

    if-ne v0, v10, :cond_6

    iget v0, v11, LNh/d;->c:I
    ...
    :cond_8
    iget-object v1, v0, LNh/d;->b:Landroid/view/View;
    ...
    iget v2, v9, LNh/d;->d:I

    iget v0, v0, LNh/d;->d:I

    const/4 v3, 0x2

    invoke-static {v2, v0, v3, v7}, Landroidx/appcompat/widget/a;->b(IIII)I
    ...
    iget v2, v9, LNh/d;->c:I

    iget v0, v0, LNh/d;->c:I

    const/4 v5, 0x2

    invoke-static {v2, v0, v5, v6}, Landroidx/appcompat/widget/a;->b(IIII)I
...
.method private measureChildView(LNh/d;IIII)V
    .locals 7

    iget-object v0, p1, LNh/d;->b:Landroid/view/View;
    ...
    iput p2, p1, LNh/d;->c:I

    iput p3, p1, LNh/d;->d:I

    :cond_8
    return-void
.end method

.method private measureViewList(LNh/c;LNh/c;IIII)V
    .locals 19
    ...
    iget-object v1, v9, LNh/c;->g:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v0 .. v6}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureViewList(LNh/c;LNh/c;IIII)V

    iget v0, v9, LNh/c;->f:I

    if-ne v0, v12, :cond_3

    iget v0, v13, LNh/d;->c:I
    ...
    iget-object v0, v4, LNh/d;->b:Landroid/view/View;
    ...
    invoke-direct/range {v0 .. v5}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureChildView(LNh/d;IIII)V

    iget v0, v9, LNh/c;->f:I

    if-ne v0, v12, :cond_5

    iget v0, v6, LNh/d;->c:I
    ...
    :cond_b
    iget-object v0, v5, LNh/d;->b:Landroid/view/View;
    ...
    :cond_14
    iput v15, v9, LNh/d;->d:I

    iget-object v0, v9, LNh/c;->g:Ljava/util/ArrayList;
    ...
    invoke-virtual {v7, v2, v10}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(LNh/c;I)Z

    move-result v0

    if-eqz v0, :cond_16

    iget v3, v2, LNh/d;->c:I

    iget v4, v9, LNh/d;->d:I
    ...
    iget v0, v2, LNh/d;->c:I

    iget v1, v9, LNh/d;->c:I

    if-ge v0, v1, :cond_15

    invoke-virtual {v7, v2, v12}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(LNh/c;I)Z

    move-result v0

    if-eqz v0, :cond_15

    iget v3, v9, LNh/d;->c:I

    iget v4, v2, LNh/d;->d:I
    ...
    iget-object v0, v1, LNh/d;->b:Landroid/view/View;
    ...
    iget v2, v9, LNh/c;->f:I

    if-ne v2, v12, :cond_19

    iget v2, v1, LNh/d;->d:I

    iget v4, v9, LNh/d;->d:I

    if-ge v2, v4, :cond_19

    iget v2, v1, LNh/d;->c:I
    ...
    iget v0, v1, LNh/d;->c:I

    iget v2, v9, LNh/d;->c:I

    if-ge v0, v2, :cond_15

    iget v3, v1, LNh/d;->d:I
...
.method public buildViewTree(Landroid/view/ViewGroup;)V
    ...
    invoke-direct {p1, p0}, LNh/a;-><init>(Lmiuix/flexible/template/AbstractMarkTemplate;)V

    invoke-static {v1, p1}, Ljava/util/Arrays;->sort([Ljava/lang/Object;Ljava/util/Comparator;)V

    new-instance p1, LNh/c;

    invoke-direct {p1}, LNh/c;-><init>()V

    const/4 v0, 0x1

    iput v0, p1, LNh/d;->a:I

    const/high16 v3, 0x3f800000    # 1.0f

    iput v3, p1, LNh/d;->e:F

    iput v0, p1, LNh/c;->f:I

    invoke-static {v1, v2, p1, p0}, LNh/b;->a([Landroid/view/View;ILNh/c;Lmiuix/flexible/template/AbstractMarkTemplate;)I

    iput-object p1, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:LNh/c;

    return-void
.end method

.method public createLevelSupplier()LOh/a;
    .locals 1
...
.method public dp2px(F)I
    ...
    invoke-static {p0, p1}, LIh/k;->b(FF)I
...
.method public final getLevel()I
    ...
    iget-object v0, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mLevelSupplier:LOh/a;

    invoke-interface {v0}, LOh/a;->getLevel()I
...
.method public getViewNodePriority(LNh/d;)I
    .locals 2
    ...
    iget-object p1, p1, LNh/c;->g:Ljava/util/ArrayList;
...
.method public hasMatchParentChild(LNh/c;I)Z
    .locals 3
    ...
    invoke-virtual {p0, v0, p2}, Lmiuix/flexible/template/AbstractMarkTemplate;->hasMatchParentChild(LNh/c;I)Z
...
.method public init(Landroid/view/ViewGroup;Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p1, LMh/c;->HyperCellLayout:[I
    ...
    sget v2, LMh/c;->HyperCellLayout_android_gravity:I
    ...
    :cond_0
    sget v2, LMh/c;->HyperCellLayout_column_spacing:I
    ...
    :cond_1
    sget v2, LMh/c;->HyperCellLayout_row_spacing:I
    ...
    :cond_4
    invoke-virtual {p0}, Lmiuix/flexible/template/AbstractMarkTemplate;->createLevelSupplier()LOh/a;

    move-result-object p1

    iput-object p1, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mLevelSupplier:LOh/a;
...
.method public onLayout(Landroid/view/ViewGroup;ZIIII)V
    ...
    iget-object p2, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:LNh/c;
    ...
    iget-object p5, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:LNh/c;

    iget p5, p5, LNh/d;->d:I

    invoke-static {p6, p5, v2, p3}, Landroidx/appcompat/widget/a;->b(IIII)I
    ...
    iget-object p3, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:LNh/c;

    iget p3, p3, LNh/d;->d:I
    ...
    iget-object p1, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:LNh/c;

    iget p1, p1, LNh/d;->c:I

    invoke-static {p3, p1, v2, p2}, Landroidx/appcompat/widget/a;->b(IIII)I
    ...
    :goto_2
    iget-object v2, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:LNh/c;

    move-object v1, p0

    invoke-direct/range {v1 .. v6}, Lmiuix/flexible/template/AbstractMarkTemplate;->layoutViewList(LNh/c;ZIII)V
...
.method public onMeasure(Landroid/view/ViewGroup;II)[I
    ...
    iget-object v4, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:LNh/c;
    ...
    invoke-direct/range {v2 .. v8}, Lmiuix/flexible/template/AbstractMarkTemplate;->measureViewList(LNh/c;LNh/c;IIII)V
    ...
    :cond_1
    iget-object p0, p0, Lmiuix/flexible/template/AbstractMarkTemplate;->mViewList:LNh/c;

    iget p0, p0, LNh/d;->d:I
