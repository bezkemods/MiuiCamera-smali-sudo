...
.method public final a(Landroid/content/Context;Landroid/view/Display;Landroid/content/res/Configuration;)V
    ...
    invoke-static {v11}, LA/M2;->j(Ljava/lang/String;)V
    ...
    invoke-static {v8}, LA/M2;->j(Ljava/lang/String;)V
    ...
    invoke-static {v8, v9, v5}, LA3/H2;->k(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v9}, LA/M2;->j(Ljava/lang/String;)V
    ...
    invoke-static {v12}, LA/M2;->j(Ljava/lang/String;)V
    ...
    sget-boolean v8, Lii/a;->g:Z

    if-eqz v8, :cond_d

    invoke-static/range {p1 .. p1}, Lii/b;->c(Landroid/content/Context;)Z
    ...
    const-string v6, "updateDeviceScale by userDeviceScale "
    ...
    const-string v7, "updateDeviceScale by calcu "
    ...
    :goto_f
    sget-boolean v7, Lii/a;->f:Z

    sget v9, Lmiuix/autodensity/k;->b:F

    if-nez v7, :cond_31

    sget-boolean v7, Lii/a;->h:Z

    if-eqz v7, :cond_32

    :cond_31
    invoke-static/range {p1 .. p1}, LIh/a;->b(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    const-string v6, "updateConfig deviceScale:"
