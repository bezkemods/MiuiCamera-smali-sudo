...
.field public n:LHc/c;

.field public final o:LHc/c$a;

.field public final p:Landroid/os/Handler;

.field public q:LHc/e;
...
# direct methods
.method public constructor <init>(LHc/g$b;)V
    .locals 7
    ...
    iput-object v0, p0, LHc/g;->a:Ljava/lang/String;

    new-instance v1, Ljava/util/Stack;

    invoke-direct {v1}, Ljava/util/Stack;-><init>()V

    iput-object v1, p0, LHc/g;->d:Ljava/util/Stack;

    new-instance v2, LQ0/e;

    invoke-direct {v2}, LQ0/e;-><init>()V

    iput-object v2, p0, LHc/g;->e:LQ0/e;

    const/4 v2, 0x0

    iput v2, p0, LHc/g;->s:I

    new-instance v3, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {v3}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object v3, p0, LHc/g;->t:Ljava/util/concurrent/locks/ReentrantLock;

    const/4 v3, 0x1

    new-array v4, v3, [I

    iput-object v4, p0, LHc/g;->v:[I

    const v4, 0xac44

    iput v4, p0, LHc/g;->z:I

    const/4 v4, 0x2

    iput v4, p0, LHc/g;->A:I

    const v4, 0x17700

    iput v4, p0, LHc/g;->B:I

    new-instance v4, LHc/g$a;

    invoke-direct {v4, p0}, LHc/g$a;-><init>(LHc/g;)V

    iput-object v4, p0, LHc/g;->G:LHc/g$a;

    const-string v4, "camera.debug.dump_milive"

    invoke-static {v4, v2}, LWb/f;->c(Ljava/lang/String;Z)Z

    move-result v4

    iput-boolean v4, p0, LHc/g;->w:Z

    iget-object v5, p1, LHc/g$b;->a:Ljava/lang/ref/WeakReference;

    iput-object v5, p0, LHc/g;->b:Ljava/lang/ref/WeakReference;

    iget v6, p1, LHc/g$b;->b:I

    iput v6, p0, LHc/g;->h:I

    iget-object v6, p1, LHc/g$b;->c:Ljava/lang/String;

    iput-object v6, p0, LHc/g;->i:Ljava/lang/String;

    iget-object v6, p1, LHc/g$b;->d:LHc/c$a;

    iput-object v6, p0, LHc/g;->o:LHc/c$a;

    iget-object v6, p1, LHc/g$b;->f:Landroid/os/Handler;

    iput-object v6, p0, LHc/g;->p:Landroid/os/Handler;

    iget-object p1, p1, LHc/g$b;->e:Ljava/util/List;
    ...
    iput-object v0, p0, LHc/g;->c:Lo5/f;
...
.method public final b(Ljava/lang/String;)V
    ...
    iput-object p1, p0, LHc/g;->j:Ljava/lang/String;
...
.method public final c(I)V
    ...
    iget v2, p0, LHc/g;->s:I

    invoke-static {v2}, LHc/g;->a(I)Ljava/lang/String;
    ...
    invoke-static {p1}, LHc/g;->a(I)Ljava/lang/String;
    ...
    iput p1, p0, LHc/g;->s:I

    iget-object p1, p0, LHc/g;->n:LHc/c;

    if-eqz p1, :cond_3

    iget p0, p0, LHc/g;->s:I

    iput p0, p1, LHc/c;->l:I
    ...
    :cond_0
    iget-object p0, p1, LHc/c;->h:Landroid/os/Handler;

    new-instance v0, LA/E1;

    const/4 v1, 0x3

    invoke-direct {v0, p1, v1}, LA/E1;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object v0, p1, LHc/c;->h:Landroid/os/Handler;

    new-instance v1, LA/u2;

    const/4 v2, 0x1

    invoke-direct {v1, v2, p1, p0}, LA/u2;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public final d(LHc/c$a;)V
    .locals 10
    ...
    invoke-direct/range {v1 .. v7}, LHc/e;-><init>(LHc/g;JJLHc/c$a;)V

    iput-object v0, p0, LHc/g;->q:LHc/e;

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v0

    iput-wide v0, p0, LHc/g;->r:J

    iget-object p1, p0, LHc/g;->q:LHc/e;
...
.method public final e()V
    ...
    iget-object v1, p0, LHc/g;->c:Lo5/f;

    iget-object v1, v1, Lo5/f;->p:LBe/k;

    iget-object v1, v1, LBe/k;->q:LOe/a;

    invoke-virtual {v1, v0}, LOe/a;->b([F)V
    ...
    iget-object v3, p0, LHc/g;->C:LT0/c;

    iget-object v3, v3, LT0/c;->b:Lf6/j;

    iget v3, v3, Lf6/b;->a:I
    ...
    iget-object v0, p0, LHc/g;->y:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;
    ...
    iget-object v2, p0, LHc/g;->j:Ljava/lang/String;
    ...
    iget-object v2, p0, LHc/g;->y:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    iget-object p0, p0, LHc/g;->j:Ljava/lang/String;
    ...
    :cond_2
    iget-object p0, p0, LHc/g;->y:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;
