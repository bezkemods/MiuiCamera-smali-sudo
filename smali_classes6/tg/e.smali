...
.method public bridge synthetic b(Lag/f;LJf/b;)Ljava/util/Collection;
    .locals 0

    invoke-virtual {p0, p1, p2}, Ltg/e;->i(Lag/f;LJf/b;)Ljava/util/Set;
...
.method public e(Lag/f;LJf/b;)LBf/h;
    ...
    invoke-static {p1}, Lag/f;->i(Ljava/lang/String;)Lag/f;

    move-result-object p1

    invoke-direct {p0, p1}, Ltg/a;-><init>(Lag/f;)V
...
.method public bridge synthetic g(Lag/f;LJf/b;)Ljava/util/Collection;
    .locals 0

    invoke-virtual {p0, p1, p2}, Ltg/e;->h(Lag/f;LJf/b;)Ljava/util/Set;
...
.method public h(Lag/f;LJf/b;)Ljava/util/Set;
    .locals 9
    ...
    sget-object p1, Ltg/h;->e:Ltg/h;

    const/4 p2, 0x0

    new-array p2, p2, [Ljava/lang/String;

    invoke-static {p1, p2}, Ltg/i;->c(Ltg/h;[Ljava/lang/String;)Ltg/f;

    move-result-object v6

    sget-object v7, LBf/A;->c:LBf/A;

    sget-object v8, LBf/q;->e:LBf/q$h;
    ...
    invoke-virtual/range {v0 .. v8}, LEf/S;->O0(LEf/Q;LBf/P;Ljava/util/List;Ljava/util/List;Ljava/util/List;Lrg/C;LBf/A;LBf/r;)LEf/S;
...
.method public i(Lag/f;LJf/b;)Ljava/util/Set;
    .locals 0
    ...
    sget-object p0, Ltg/i;->f:Ljava/util/Set;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object p0, p0, Ltg/e;->b:Ljava/lang/String;
