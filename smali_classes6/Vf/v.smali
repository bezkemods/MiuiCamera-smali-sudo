...
# static fields
.field public static final e:LVf/v;

.field public static final f:LVf/v$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LVf/v;->f:LVf/v$a;
    ...
    iput-object v1, v0, LVf/v;->b:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    .line 7
    iput-byte v0, p0, LVf/v;->c:B

    .line 8
    iput v0, p0, LVf/v;->d:I

    .line 9
    sget-object v0, Lbg/c;->a:Lbg/o;

    iput-object v0, p0, LVf/v;->a:Lbg/c;

    return-void
.end method

.method public constructor <init>(LVf/v$b;)V
    .locals 1
    ...
    .line 5
    iput-object p1, p0, LVf/v;->a:Lbg/c;
...
.method public constructor <init>(Lbg/d;Lbg/f;)V
    ...
    iput-object v0, p0, LVf/v;->b:Ljava/util/List;
    ...
    iput-object v5, p0, LVf/v;->b:Ljava/util/List;
    ...
    :cond_3
    :goto_1
    iget-object v5, p0, LVf/v;->b:Ljava/util/List;

    sget-object v6, LVf/u;->l:LVf/u$a;
    ...
    .line 26
    iget-object p2, p0, LVf/v;->b:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, LVf/v;->b:Ljava/util/List;
    ...
    iput-object p2, p0, LVf/v;->a:Lbg/c;
    ...
    .line 31
    iget-object p1, p0, LVf/v;->b:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, LVf/v;->b:Ljava/util/List;
...
.method public final a(Lbg/e;)V
    ...
    invoke-virtual {p0}, LVf/v;->getSerializedSize()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, LVf/v;->b:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, LVf/v;->a:Lbg/c;
...
.method public final getSerializedSize()I
    ...
    :goto_0
    iget-object v2, p0, LVf/v;->b:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, LVf/v;->a:Lbg/c;
...
.method public final newBuilderForType()Lbg/p$a;
    ...
    new-instance p0, LVf/v$b;

    invoke-direct {p0}, LVf/v$b;-><init>()V
