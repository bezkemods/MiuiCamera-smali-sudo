...
# static fields
.field public static final e:LVf/n;

.field public static final f:LVf/n$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LVf/n;->f:LVf/n$a;

    new-instance v0, LVf/n;

    invoke-direct {v0}, LVf/n;-><init>()V

    sput-object v0, LVf/n;->e:LVf/n;

    invoke-static {}, Ljava/util/Collections;->emptyList()Ljava/util/List;

    move-result-object v1

    iput-object v1, v0, LVf/n;->b:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    .line 7
    iput-byte v0, p0, LVf/n;->c:B

    .line 8
    iput v0, p0, LVf/n;->d:I

    .line 9
    sget-object v0, Lbg/c;->a:Lbg/o;

    iput-object v0, p0, LVf/n;->a:Lbg/c;

    return-void
.end method

.method public constructor <init>(LVf/n$b;)V
    .locals 1
    ...
    .line 5
    iput-object p1, p0, LVf/n;->a:Lbg/c;
...
.method public constructor <init>(Lbg/d;Lbg/f;)V
    ...
    iput-object v0, p0, LVf/n;->b:Ljava/util/List;
    ...
    iput-object v5, p0, LVf/n;->b:Ljava/util/List;
    ...
    :cond_3
    :goto_1
    iget-object v5, p0, LVf/n;->b:Ljava/util/List;

    sget-object v6, LVf/n$c;->i:LVf/n$c$a;
    ...
    .line 26
    iget-object p2, p0, LVf/n;->b:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, LVf/n;->b:Ljava/util/List;
    ...
    iput-object p2, p0, LVf/n;->a:Lbg/c;
    ...
    .line 31
    iget-object p1, p0, LVf/n;->b:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, LVf/n;->b:Ljava/util/List;
...
.method public final a(Lbg/e;)V
    ...
    invoke-virtual {p0}, LVf/n;->getSerializedSize()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, LVf/n;->b:Ljava/util/List;
    ...
    :cond_0
    iget-object p0, p0, LVf/n;->a:Lbg/c;
...
.method public final getSerializedSize()I
    ...
    :goto_0
    iget-object v2, p0, LVf/n;->b:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, LVf/n;->a:Lbg/c;
...
.method public final isInitialized()Z
    ...
    :goto_0
    iget-object v3, p0, LVf/n;->b:Ljava/util/List;
    ...
    check-cast v3, LVf/n$c;

    invoke-virtual {v3}, LVf/n$c;->isInitialized()Z

    move-result v3

    if-nez v3, :cond_2

    iput-byte v2, p0, LVf/n;->c:B
...
.method public final newBuilderForType()Lbg/p$a;
    ...
    new-instance p0, LVf/n$b;

    invoke-direct {p0}, LVf/n$b;-><init>()V
