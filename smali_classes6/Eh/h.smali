...
# direct methods
.method public constructor <init>(LEh/e;Landroid/view/View;ILmiuix/animation/base/AnimConfig;)V
    .locals 0
    ...
    iput-object p1, p0, LEh/h;->d:LEh/e;

    iput-object p2, p0, LEh/h;->a:Landroid/view/View;

    iput p3, p0, LEh/h;->b:I

    iput-object p4, p0, LEh/h;->c:Lmiuix/animation/base/AnimConfig;
...
.method public final onCancelled(Landroid/view/WindowInsetsAnimationController;)V
    ...
    iget-object p1, p0, LEh/h;->d:LEh/e;

    iget-object p1, p1, LEh/e;->f:Landroid/view/WindowInsetsAnimationController;

    if-nez p1, :cond_0

    iget-object p1, p0, LEh/h;->a:Landroid/view/View;
    ...
    iget-object v2, p0, LEh/h;->c:Lmiuix/animation/base/AnimConfig;
    ...
    :cond_0
    iget-object p0, p0, LEh/h;->d:LEh/e;

    const/4 p1, 0x0

    iput-object p1, p0, LEh/e;->f:Landroid/view/WindowInsetsAnimationController;
...
.method public final onReady(Landroid/view/WindowInsetsAnimationController;I)V
    ...
    iget-object p2, p0, LEh/h;->c:Lmiuix/animation/base/AnimConfig;

    iget-object v0, p0, LEh/h;->a:Landroid/view/View;

    iget-object v1, p0, LEh/h;->d:LEh/e;

    iget-object v2, v1, LEh/e;->b:Lmiuix/animation/IFolme;
    ...
    :cond_0
    iput-object p1, v1, LEh/e;->f:Landroid/view/WindowInsetsAnimationController;

    invoke-static {p1}, Landroidx/core/view/D;->b(Landroid/view/WindowInsetsAnimationController;)Landroid/graphics/Insets;

    move-result-object p1

    iget-object v1, v1, LEh/e;->f:Landroid/view/WindowInsetsAnimationController;

    invoke-static {v1}, Landroidx/core/view/z;->a(Landroid/view/WindowInsetsAnimationController;)Landroid/graphics/Insets;
    ...
    iget v3, p0, LEh/h;->b:I

    int-to-float v3, v3

    new-instance v4, LEh/h$a;

    invoke-direct {v4, p0, v2, p1, v1}, LEh/h$a;-><init>(LEh/h;FLandroid/graphics/Insets;Landroid/graphics/Insets;)V
