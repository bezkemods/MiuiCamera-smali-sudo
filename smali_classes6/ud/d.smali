...
# direct methods
.method public static a(Lhd/f$a;)V
    .locals 10
    ...
    sget-object v3, LId/b;->a:Ljava/lang/String;

    invoke-virtual {v2, v3}, LGd/d;->j(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7, v1, v0}, LCc/b;->b(ILjava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    :cond_0
    invoke-static {v4}, LXb/t;->i(Ljava/lang/String;)Z
    ...
    invoke-static {v7, v6, v0}, LCc/b;->b(ILjava/lang/String;Ljava/lang/String;)V

    iget-object p0, p0, Lhd/f$a;->a:Lhd/f;

    const/4 v0, 0x0

    iput-object v0, p0, Lhd/f;->s0:Lhd/f$a;
    ...
    invoke-static {v3, v1, v4}, LCc/b;->b(ILjava/lang/String;Ljava/lang/String;)V

    new-instance v4, Ljava/io/File;

    sget-object v5, Lvd/a;->a:Ljava/lang/String;
    ...
    sget-object v8, Lvd/a;->b:Ljava/lang/String;
    ...
    invoke-static {v0, v6, v1}, LCc/b;->b(ILjava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, v0, Lhd/f;->W:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_4
    iget-object v1, v0, Lhd/f;->V:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v2}, LGd/d;->h()I

    move-result v2

    invoke-direct {v1, v2}, Lnd/f;-><init>(I)V

    iput-object v1, v0, Lhd/f;->r:Lnd/f;

    iget-object v1, v1, Lnd/f;->a:Lnd/e;

    iput-object v1, v0, Lhd/f;->e0:Lnd/e;
    ...
    iget-object v0, v0, Lhd/f;->q:Lcom/faceunity/core/faceunity/FUAIKit;
    ...
    invoke-static {v7, v6, p0}, LCc/b;->b(ILjava/lang/String;Ljava/lang/String;)V
...
.method public static b(Ljava/lang/String;Lhd/f$a;)V
    .locals 13
    ...
    iput-object v4, v0, Lae/c;->a:[B

    iput-object v5, v0, Lae/c;->b:[B
    ...
    invoke-direct/range {v6 .. v11}, Lud/a;-><init>(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lhd/f$a;Ljava/util/concurrent/atomic/AtomicBoolean;)V

    invoke-static {v12, v3}, LBg/l;->u(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
    ...
    invoke-direct/range {v3 .. v9}, Lud/b;-><init>([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lhd/f$a;Ljava/util/concurrent/atomic/AtomicInteger;)V

    invoke-static {v12, p0}, LBg/l;->u(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
