...
.field public final q:LRc/e$a;

.field public final r:Landroid/os/Handler;

.field public s:LOc/f;
...
# direct methods
.method public constructor <init>(LOc/h$b;)V
    .locals 6
    ...
    iput-object v0, p0, LOc/h;->a:Ljava/lang/String;

    new-instance v1, Ljava/util/Stack;

    invoke-direct {v1}, Ljava/util/Stack;-><init>()V

    iput-object v1, p0, LOc/h;->d:Ljava/util/Stack;

    new-instance v2, LQ0/e;

    invoke-direct {v2}, LQ0/e;-><init>()V

    iput-object v2, p0, LOc/h;->e:LQ0/e;

    const/4 v2, 0x0

    iput v2, p0, LOc/h;->u:I

    new-instance v3, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {v3}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object v3, p0, LOc/h;->w:Ljava/util/concurrent/locks/ReentrantLock;

    const v3, 0xac44

    iput v3, p0, LOc/h;->V:I

    const/4 v3, 0x2

    iput v3, p0, LOc/h;->W:I

    const v3, 0x17700

    iput v3, p0, LOc/h;->Y:I

    new-instance v3, LOc/h$a;

    invoke-direct {v3, p0}, LOc/h$a;-><init>(LOc/h;)V

    iput-object v3, p0, LOc/h;->h0:LOc/h$a;
    ...
    iget-object v4, p1, LOc/h$b;->a:Ljava/lang/ref/WeakReference;

    iput-object v4, p0, LOc/h;->f:Ljava/lang/ref/WeakReference;

    iget v5, p1, LOc/h$b;->b:I

    iput v5, p0, LOc/h;->i:I

    iget-object v5, p1, LOc/h$b;->c:LRc/e;

    iput-object v5, p0, LOc/h;->p:LRc/e;

    iget-object v5, p1, LOc/h$b;->d:LRc/e$a;

    iput-object v5, p0, LOc/h;->q:LRc/e$a;

    iget-object v5, p1, LOc/h$b;->f:Landroid/os/Handler;

    iput-object v5, p0, LOc/h;->r:Landroid/os/Handler;

    iget-object p1, p1, LOc/h$b;->e:Ljava/util/List;
    ...
    iput-object v0, p0, LOc/h;->b:Lo5/f;
    ...
    iput-object p1, p0, LOc/h;->c:Lcom/xiaomi/milive/data/LiveMasterProcessing;
...
.method public final c()V
    ...
    iget-object v1, v0, LTe/a;->d:Lcom/xiaomi/milab/videosdk/XmsTimeline;
    ...
    :cond_0
    iget-object v2, p0, LOc/h;->f:Ljava/lang/ref/WeakReference;
    ...
    iget-object v3, p0, LOc/h;->b0:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;
    ...
    iget-object v4, p0, LOc/h;->a:Ljava/lang/String;

    const-string v5, "initXms "

    invoke-static {v4, v5, v3}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v0, v0, LTe/a;->c:Ljava/util/HashMap;
    ...
    iget-object v2, p0, LOc/h;->h0:LOc/h$a;
    ...
    iput-object v0, p0, LOc/h;->b0:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;

    invoke-virtual {v1}, Lcom/xiaomi/milab/videosdk/XmsTimeline;->appendAudioTrack()Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    move-result-object v0

    iput-object v0, p0, LOc/h;->y:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    invoke-virtual {v1}, Lcom/xiaomi/milab/videosdk/XmsTimeline;->appendVideoTrack()Lcom/xiaomi/milab/videosdk/XmsVideoTrack;

    move-result-object v0

    iput-object v0, p0, LOc/h;->e0:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;

    iget-object v0, p0, LOc/h;->y:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    iget-object v2, p0, LOc/h;->l:Ljava/lang/String;

    iget v3, p0, LOc/h;->i:I
    ...
    iget-object v0, p0, LOc/h;->b:Lo5/f;
...
.method public final d(Lcom/xiaomi/milive/data/EffectItem;)V
    ...
    invoke-direct {v2, v3, p0, v0, p1}, LA3/A2;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public final f(Lcom/xiaomi/milive/data/LiveWorkspaceItem;)V
    ...
    invoke-virtual {p0, p1}, LOc/h;->i(I)V
...
.method public final h(Ljava/lang/String;)V
    ...
    iput-object p1, p0, LOc/h;->l:Ljava/lang/String;
...
.method public final i(I)V
    ...
    iget v2, p0, LOc/h;->u:I

    invoke-static {v2}, LOc/h;->b(I)Ljava/lang/String;
    ...
    invoke-static {p1}, LOc/h;->b(I)Ljava/lang/String;
    ...
    iput p1, p0, LOc/h;->u:I

    iget-object p1, p0, LOc/h;->p:LRc/e;

    if-eqz p1, :cond_3

    iget p0, p0, LOc/h;->u:I

    iput p0, p1, LRc/e;->h:I
    ...
    :cond_0
    iget-object p0, p1, LRc/e;->f:Landroid/os/Handler;

    new-instance v0, LA/X3;

    const/4 v1, 0x6

    invoke-direct {v0, p1, v1}, LA/X3;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object v0, p1, LRc/e;->f:Landroid/os/Handler;

    new-instance v1, LA/q3;

    const/4 v2, 0x3

    invoke-direct {v1, v2, p1, p0}, LA/q3;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v0, p1, v1}, LA/U3;-><init>(Ljava/lang/Object;I)V
...
.method public final k(LRc/e$a;)V
    .locals 10
    ...
    iget-object v2, p0, LOc/h;->f0:Lcom/xiaomi/milive/data/LiveWorkspaceItem;
    ...
    invoke-direct/range {v1 .. v7}, LOc/f;-><init>(LOc/h;JJLRc/e$a;)V

    iput-object v0, p0, LOc/h;->s:LOc/f;
...
.method public final l()V
    ...
    iget-object v1, v1, LTe/a;->d:Lcom/xiaomi/milab/videosdk/XmsTimeline;

    iget-boolean v2, p0, LOc/h;->c0:Z
    ...
    iput-boolean v0, p0, LOc/h;->c0:Z

    :cond_0
    iget-object p0, p0, LOc/h;->b0:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;
...
.method public final m()V
    ...
    :cond_0
    iget-object v0, p0, LOc/h;->c:Lcom/xiaomi/milive/data/LiveMasterProcessing;

    invoke-virtual {v0}, Lcom/xiaomi/milive/data/LiveMasterProcessing;->getCurrentWorkspaceItem()Lcom/xiaomi/milive/data/LiveWorkspaceItem;

    move-result-object v0

    iput-object v0, p0, LOc/h;->f0:Lcom/xiaomi/milive/data/LiveWorkspaceItem;

    iget-object v0, p0, LOc/h;->l:Ljava/lang/String;

    invoke-static {v0}, Landroid/text/TextUtils;->isEmpty(Ljava/lang/CharSequence;)Z

    move-result v0

    iget v2, p0, LOc/h;->i:I

    if-nez v0, :cond_1

    iget-object v0, p0, LOc/h;->f0:Lcom/xiaomi/milive/data/LiveWorkspaceItem;
    ...
    iget-object v5, p0, LOc/h;->l:Ljava/lang/String;
    ...
    iget-object p0, p0, LOc/h;->l:Ljava/lang/String;
