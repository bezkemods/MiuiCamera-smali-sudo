...
.method public constructor <init>(Landroid/view/View;Landroid/content/Context;Z)V
    ...
    iput-object p1, p0, LNc/c;->t:Landroid/view/View;

    iput-boolean p3, p0, LNc/c;->q:Z

    iput-object p2, p0, LNc/c;->d:Landroid/content/Context;
...
.method public final declared-synchronized a(FII)V
    ...
    iput v0, v1, LNc/c;->r:F

    iput v2, v1, LNc/c;->o:I

    iput v3, v1, LNc/c;->p:I

    iget-object v2, v1, LNc/c;->u:Landroid/util/Size;

    invoke-virtual {v2}, Landroid/util/Size;->getWidth()I

    move-result v2

    iget-object v3, v1, LNc/c;->u:Landroid/util/Size;

    invoke-virtual {v3}, Landroid/util/Size;->getHeight()I

    move-result v3

    iget-object v6, v1, LNc/c;->s:Landroid/util/Size;

    invoke-virtual {v6}, Landroid/util/Size;->getWidth()I

    move-result v6

    iget-object v7, v1, LNc/c;->s:Landroid/util/Size;

    invoke-virtual {v7}, Landroid/util/Size;->getHeight()I

    move-result v7

    iget v9, v1, LNc/c;->p:I
    ...
    :cond_4
    iput v11, v1, LNc/c;->g:I

    iput v8, v1, LNc/c;->k:I

    iput v10, v1, LNc/c;->j:I
    ...
    iget-object v8, v1, LNc/c;->d:Landroid/content/Context;

    invoke-virtual {v8}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v8

    const v11, 0x7f07149f
    ...
    :cond_8
    iput v2, v1, LNc/c;->g:I

    sget-boolean v2, Ls0/f;->n:Z

    if-eqz v2, :cond_9

    iget-object v2, v1, LNc/c;->d:Landroid/content/Context;
    ...
    iput v0, v1, LNc/c;->k:I

    :goto_7
    iget v0, v1, LNc/c;->f:I

    iget v2, v1, LNc/c;->g:I

    add-int/2addr v0, v2

    div-int/lit8 v0, v0, 0x2

    iput v0, v1, LNc/c;->h:I

    iget v0, v1, LNc/c;->j:I

    iget v2, v1, LNc/c;->k:I

    add-int/2addr v0, v2

    div-int/lit8 v0, v0, 0x2

    iput v0, v1, LNc/c;->l:I
