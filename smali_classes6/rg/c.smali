...
# direct methods
.method public static a(Lrg/Z;Lug/h;Lrg/Z$b;)Z
    .locals 9
    ...
    invoke-interface {v0, p1}, Lug/m;->k(Lug/h;)Z
    ...
    :cond_0
    invoke-interface {v0, p1}, Lug/m;->m(Lug/g;)Z
    ...
    iget-object v1, p0, Lrg/Z;->g:Ljava/util/ArrayDeque;
    ...
    invoke-interface {v0, v4}, Lug/m;->k(Lug/h;)Z
    ...
    invoke-interface {v0, v6}, Lug/m;->H(Lug/h;)Z

    move-result v7

    if-eqz v7, :cond_6

    invoke-interface {v0, v6}, Lug/m;->k(Lug/h;)Z
    ...
    :cond_6
    invoke-interface {v0, v6}, Lug/m;->m(Lug/g;)Z
...
.method public static b(Lrg/Z;Lug/h;Lug/k;)Z
    .locals 3

    iget-object v0, p0, Lrg/Z;->c:Lsg/b;

    invoke-interface {v0, p1}, Lug/m;->B(Lug/h;)Z
    ...
    :cond_1
    iget-boolean p0, p0, Lrg/Z;->b:Z

    if-eqz p0, :cond_2

    invoke-interface {v0, p1}, Lug/m;->n(Lug/h;)Z
