...
.field public final synthetic q:LDh/e$d;


# direct methods
.method public constructor <init>(LDh/e$d;Landroid/graphics/Rect;Landroid/view/View;IIIIIIIIIIIIII)V
    .locals 2
    ...
    iput-object v1, v0, LDh/l;->q:LDh/e$d;

    move-object v1, p2

    iput-object v1, v0, LDh/l;->a:Landroid/graphics/Rect;

    move-object v1, p3

    iput-object v1, v0, LDh/l;->b:Landroid/view/View;

    move v1, p4

    iput v1, v0, LDh/l;->c:I

    move v1, p5

    iput v1, v0, LDh/l;->d:I

    move v1, p6

    iput v1, v0, LDh/l;->e:I
    ...
    iput v1, v0, LDh/l;->g:I

    move v1, p9

    iput v1, v0, LDh/l;->h:I

    move v1, p10

    iput v1, v0, LDh/l;->i:I

    move v1, p11

    iput v1, v0, LDh/l;->j:I

    move v1, p12

    iput v1, v0, LDh/l;->k:I

    move v1, p13

    iput v1, v0, LDh/l;->l:I

    move/from16 v1, p14

    iput v1, v0, LDh/l;->m:I

    move/from16 v1, p15

    iput v1, v0, LDh/l;->n:I

    move/from16 v1, p16

    iput v1, v0, LDh/l;->o:I

    move/from16 v1, p17

    iput v1, v0, LDh/l;->p:I
...
.method public final onPreDraw()Z
    ...
    iget-object v2, p0, LDh/l;->q:LDh/e$d;

    iget-object v3, v2, LDh/e$d;->a:Lmiuix/smooth/SmoothFrameLayout2;

    sget v4, Loh/a$h;->tag_secondary_popup_menu_item_head:I
    ...
    :cond_0
    iget-object v4, v2, LDh/e$d;->a:Lmiuix/smooth/SmoothFrameLayout2;
    ...
    iget-object v4, p0, LDh/l;->a:Landroid/graphics/Rect;

    invoke-virtual {v4}, Landroid/graphics/Rect;->height()I

    move-result v4

    iput v4, v2, LDh/e$d;->l:I

    iget-object v4, p0, LDh/l;->b:Landroid/view/View;

    invoke-virtual {v4}, Landroid/view/View;->getPaddingTop()I

    move-result v5

    iput v5, v2, LDh/e$d;->m:I

    invoke-virtual {v4}, Landroid/view/View;->getPaddingBottom()I

    move-result v4

    iput v4, v2, LDh/e$d;->n:I

    invoke-virtual {v3}, Landroid/view/View;->getHeight()I

    move-result v4

    iput v4, v2, LDh/e$d;->o:I

    invoke-virtual {v3}, Landroid/view/View;->getPaddingTop()I

    move-result v4

    iput v4, v2, LDh/e$d;->p:I

    invoke-virtual {v3}, Landroid/view/View;->getPaddingBottom()I

    move-result v10

    iput v10, v2, LDh/e$d;->q:I

    iget v11, v2, LDh/e$d;->l:I

    iget v12, v2, LDh/e$d;->o:I

    iget v7, v2, LDh/e$d;->m:I

    iget v8, v2, LDh/e$d;->p:I

    iget v9, v2, LDh/e$d;->n:I

    iput-object v3, v2, LDh/e$d;->k:Landroid/view/View;

    new-instance v3, Lmiuix/animation/base/AnimConfig;

    invoke-direct {v3}, Lmiuix/animation/base/AnimConfig;-><init>()V

    new-instance v4, LDh/l$a;

    move-object v5, v4

    move-object v6, p0

    invoke-direct/range {v5 .. v12}, LDh/l$a;-><init>(LDh/l;IIIIII)V
    ...
    sget-object v3, LDh/e$f;->g:LDh/e$f$a;
    ...
    iget-object v4, v2, LDh/e$d;->i:LDh/e$f;

    invoke-static {v4}, Lmiuix/animation/Folme;->use(Lmiuix/animation/FolmeObject;)Lmiuix/animation/Folme$ObjectFolmeImpl;

    iget-object v4, v2, LDh/e$d;->i:LDh/e$f;

    iget v4, v4, LDh/e$f;->d:F

    iget-object v5, v2, LDh/e$d;->s:LDh/e;

    iget v5, v5, LDh/e;->p0:F

    iget-object v6, v2, LDh/e$d;->a:Lmiuix/smooth/SmoothFrameLayout2;
    ...
    sget-object v7, LDh/e$f;->h:LDh/e$f$b;
    ...
    iget-object v3, v2, LDh/e$d;->i:LDh/e$f;

    iget-object v3, v3, LDh/e$f;->f:Lmiuix/animation/Folme$ObjectFolmeImpl;
    ...
    iget-object v2, v2, LDh/e$d;->i:LDh/e$f;
