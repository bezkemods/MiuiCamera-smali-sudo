...
.method public constructor <init>(Lcom/faceunity/core/avatar/model/Avatar;)V
    ...
    iput-object p1, p0, Lyd/c;->a:Lcom/faceunity/core/avatar/model/Avatar;
    ...
    iput-object p1, p0, Lyd/c;->d:LWe/n;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lyd/c;->e:Ljava/util/HashMap;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lyd/c;->f:Ljava/util/ArrayList;

    new-instance p1, Lyd/c$a;

    invoke-direct {p1, p0}, Lyd/c$a;-><init>(Lyd/c;)V

    iput-object p1, p0, Lyd/c;->g:Lyd/c$a;
...
.method public final a(Ljava/util/ArrayList;Ljava/util/HashMap;Ljava/util/ArrayList;)V
    ...
    iget-object v0, p0, Lyd/c;->d:LWe/n;
    ...
    iget-object v1, v0, Lyd/d;->c:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v1}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    iget-object v2, v0, Lyd/d;->a:Ljava/util/LinkedList;
    ...
    iput p1, v0, Lyd/d;->b:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-virtual {v1}, Ljava/util/concurrent/locks/ReentrantLock;->unlock()V

    iget-object p1, p0, Lyd/c;->e:Ljava/util/HashMap;

    invoke-virtual {p1}, Ljava/util/HashMap;->clear()V

    invoke-virtual {p1, p2}, Ljava/util/HashMap;->putAll(Ljava/util/Map;)V

    iget-object p0, p0, Lyd/c;->f:Ljava/util/ArrayList;
...
.method public final b(Ljava/lang/String;)V
    ...
    invoke-direct {v0, p1, v1}, LDd/a;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object v0, p0, Lyd/c;->e:Ljava/util/HashMap;
    ...
    :cond_0
    iget-object v0, p0, Lyd/c;->a:Lcom/faceunity/core/avatar/model/Avatar;
    ...
    invoke-direct {v2, v0, v3}, LDd/b;-><init>(Ljava/lang/Object;I)V

    invoke-static {v1, v2}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Llf/a;)V

    iget-object v2, p0, Lyd/c;->f:Ljava/util/ArrayList;
    ...
    invoke-direct {v2, p1, v0}, Lyd/b;-><init>(Ljava/util/List;I)V

    invoke-static {v1, v2}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Llf/a;)V

    invoke-static {v0, p1}, LXe/u;->X(ILjava/util/List;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1, v2}, LK4/r;-><init>(Ljava/lang/Object;I)V

    invoke-static {v1, v0}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Llf/a;)V

    invoke-virtual {p0, p1}, Lyd/c;->c(Lcom/faceunity/core/entity/FUAnimationBundleData;)V

    iget-object p0, p0, Lyd/c;->d:LWe/n;
    ...
    iget-object p1, p0, Lyd/d;->c:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public final c(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
    ...
    invoke-direct {v0, p1}, Lyd/a;-><init>(Lcom/faceunity/core/entity/FUAnimationBundleData;)V

    const-string v1, "KIT_EditorAnimationEngine"

    invoke-static {v1, v0}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Llf/a;)V

    iget-object p0, p0, Lyd/c;->a:Lcom/faceunity/core/avatar/model/Avatar;
...
.method public final d()V
    ...
    iget-object v0, p0, Lyd/c;->b:Lyd/e;
    ...
    iput-object v2, v0, Lyd/e;->c:Lyd/e$a;

    iget-object v0, v0, Lyd/e;->b:LWe/n;

    invoke-virtual {v0}, LWe/n;->getValue()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lyd/e$b;

    iput-boolean v1, v0, Lyd/e$b;->a:Z

    :cond_0
    iput-object v2, p0, Lyd/c;->b:Lyd/e;

    iput-boolean v1, p0, Lyd/c;->c:Z
...
.method public final e()V
    ...
    iget-object v1, p0, Lyd/c;->a:Lcom/faceunity/core/avatar/model/Avatar;

    invoke-direct {v0, v1}, Lyd/e;-><init>(Lcom/faceunity/core/avatar/model/Avatar;)V

    iget-object v1, p0, Lyd/c;->g:Lyd/c$a;

    const-string v2, "listener"

    invoke-static {v1, v2}, Lkotlin/jvm/internal/l;->f(Ljava/lang/Object;Ljava/lang/String;)V

    iput-object v1, v0, Lyd/e;->c:Lyd/e$a;

    new-instance v1, Ljava/lang/Thread;

    iget-object v2, v0, Lyd/e;->b:LWe/n;

    invoke-virtual {v2}, LWe/n;->getValue()Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Lyd/e$b;

    invoke-direct {v1, v2}, Ljava/lang/Thread;-><init>(Ljava/lang/Runnable;)V

    invoke-virtual {v1}, Ljava/lang/Thread;->start()V

    iput-object v0, p0, Lyd/c;->b:Lyd/e;
