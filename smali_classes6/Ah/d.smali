...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    sget-object v1, Loh/a$m;->OverflowMenuButton:[I
    ...
    sget v0, Loh/a$m;->OverflowMenuButton_android_drawableTop:I

    invoke-virtual {p2, v0}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    sget v1, Loh/a$m;->OverflowMenuButton_android_text:I

    invoke-virtual {p2, v1}, Landroid/content/res/TypedArray;->getText(I)Ljava/lang/CharSequence;

    move-result-object v1

    sget v3, Loh/a$m;->OverflowMenuButton_android_contentDescription:I

    invoke-virtual {p2, v3}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object v3

    sget v4, Loh/a$m;->OverflowMenuButton_largeFontAdaptationEnabled:I
    ...
    invoke-direct {p2, p0}, LAh/b;-><init>(Landroid/widget/LinearLayout;)V

    iput-object p2, p0, LAh/d;->a:LAh/b;

    iget-object v4, p2, LAh/b;->b:Landroid/widget/ImageView;
    ...
    :cond_1
    iget-object v0, p2, LAh/b;->c:Landroid/widget/TextView;

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v0, p2, LAh/b;->d:Landroid/widget/LinearLayout;
    ...
    :cond_3
    :goto_1
    iget-object v1, p2, LAh/b;->c:Landroid/widget/TextView;
    ...
    :goto_2
    invoke-virtual {p2, p1}, LAh/b;->b(Z)V
    ...
    invoke-virtual {p0, v5}, LAh/d;->setEnabled(Z)V
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p0, p0, LAh/d;->a:LAh/b;

    invoke-virtual {p0, p1}, LAh/b;->a(Landroid/content/res/Configuration;)V
...
.method public final performClick()Z
    ...
    iget-object p0, p0, LAh/d;->b:LA/T1;
...
.method public final setEnabled(Z)V
    ...
    iget-object v0, p0, LAh/b;->b:Landroid/widget/ImageView;

    invoke-virtual {v0, p1}, Landroid/view/View;->setEnabled(Z)V

    iget-object p0, p0, LAh/b;->c:Landroid/widget/TextView;
