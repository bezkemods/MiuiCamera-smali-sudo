...
.method public constructor <init>(LGe/b;)V
    ...
    iput-object v0, p0, LGe/b$b;->a:Ljava/lang/ref/WeakReference;
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    iget-object p0, p0, LGe/b$b;->a:Ljava/lang/ref/WeakReference;
    ...
    iget-object p1, p0, LGe/b;->d:LGe/b$a;
    ...
    iget-object p1, p1, LMe/e$a;->a:Lcom/android/camera/module/video/h;
    ...
    :try_start_0
    iget-object v2, p1, Lcom/android/camera/module/video/h;->b:LGe/f;
    ...
    iput-object v0, p1, Lcom/android/camera/module/video/h;->b:LGe/f;
    ...
    :cond_3
    :goto_2
    iput-object v0, p0, LGe/b;->d:LGe/b$a;

    :cond_4
    iget p1, p0, LGe/b;->e:I
    ...
    :cond_8
    iget p1, p0, LGe/b;->s:I

    const-string v2, "ComputeRenderThread"

    invoke-static {p1, v2}, Lcom/xiaomi/gl/MIGL;->glDeleteProgram(ILjava/lang/String;)V

    iput v1, p0, LGe/b;->s:I

    iget p1, p0, LGe/b;->t:I

    const-string v2, "ComputeRenderThread"

    invoke-static {p1, v2}, Lcom/xiaomi/gl/MIGL;->glDeleteProgram(ILjava/lang/String;)V

    iput v1, p0, LGe/b;->t:I

    iget-object p1, p0, LGe/b;->b:Landroid/graphics/SurfaceTexture;
    ...
    iput-object v0, p0, LGe/b;->b:Landroid/graphics/SurfaceTexture;

    :cond_9
    iget-object p1, p0, LGe/b;->l:LGe/d;
    ...
    invoke-virtual {p1}, LGe/e;->d()Z

    iget-object p1, p0, LGe/b;->m:LGe/c;

    iget-object p1, p1, LGe/c;->a:Landroid/opengl/EGLDisplay;

    iget-object v2, p0, LGe/b;->l:LGe/d;

    iget-object v2, v2, LGe/e;->b:Landroid/opengl/EGLSurface;

    invoke-static {p1, v2}, Landroid/opengl/EGL14;->eglDestroySurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;)Z

    iput-object v0, p0, LGe/b;->l:LGe/d;
    ...
    invoke-virtual {p1}, LGe/c;->a()V

    iput-object v0, p0, LGe/b;->m:LGe/c;

    :cond_b
    iget-object p1, p0, LGe/b;->a:LGe/b$b;
