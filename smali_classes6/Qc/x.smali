...
.method static constructor <clinit>()V
    ...
    sput-object v0, LQc/x;->n:Landroid/os/HandlerThread;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, LQc/x;->c:I

    iput v0, p0, LQc/x;->d:I

    iput v0, p0, LQc/x;->j:I

    new-instance v1, LQc/x$a;

    invoke-direct {v1, p0}, LQc/x$a;-><init>(LQc/x;)V

    iput-object v1, p0, LQc/x;->m:LQc/x$a;

    iput-object p1, p0, LQc/x;->a:Landroid/content/Context;
    ...
    iput-object p1, p0, LQc/x;->g:Landroid/os/Handler;

    new-instance p1, Landroid/os/Handler;

    sget-object v1, LQc/x;->n:Landroid/os/HandlerThread;
    ...
    iput-object p1, p0, LQc/x;->h:Landroid/os/Handler;
...
.method public final a()V
    ...
    iget-object v1, p0, LQc/x;->b:Landroid/media/MediaPlayer;
...
.method public final b()Z
    ...
    iget-object v0, p0, LQc/x;->b:Landroid/media/MediaPlayer;

    if-eqz v0, :cond_0

    iget v0, p0, LQc/x;->c:I
...
.method public final d(Z)V
    ...
    iput-object v0, p0, LQc/x;->b:Landroid/media/MediaPlayer;
    ...
    :cond_0
    :goto_0
    iget-object p1, p0, LQc/x;->e:Landroid/media/AudioManager;

    if-eqz p1, :cond_1

    iget-object p0, p0, LQc/x;->m:LQc/x$a;
...
.method public final e()V
    ...
    iget-object v0, p0, LQc/x;->h:Landroid/os/Handler;
...
.method public final handleMessage(Landroid/os/Message;)Z
    ...
    iget-object p1, p0, LQc/x;->b:Landroid/media/MediaPlayer;

    if-eqz p1, :cond_3

    iget p1, p0, LQc/x;->c:I
    ...
    :pswitch_b
    iput v6, p0, LQc/x;->d:I

    invoke-virtual {p0, v5}, LQc/x;->d(Z)V
    ...
    iput v8, p0, LQc/x;->d:I

    iget-object p1, p0, LQc/x;->e:Landroid/media/AudioManager;

    if-nez p1, :cond_5

    iget-object p1, p0, LQc/x;->a:Landroid/content/Context;
    ...
    iput-object p1, p0, LQc/x;->e:Landroid/media/AudioManager;

    :cond_5
    iget-object p1, p0, LQc/x;->e:Landroid/media/AudioManager;

    iget-object v0, p0, LQc/x;->m:LQc/x$a;
    ...
    invoke-virtual {p0, v2}, LQc/x;->d(Z)V

    new-instance p1, Landroid/media/MediaPlayer;

    invoke-direct {p1}, Landroid/media/MediaPlayer;-><init>()V

    iput-object p1, p0, LQc/x;->b:Landroid/media/MediaPlayer;
    ...
    iget-object v0, p0, LQc/x;->i:Ljava/lang/String;
    ...
    :cond_6
    iput v5, p0, LQc/x;->c:I

    iput v5, p0, LQc/x;->d:I
    :try_end_1
...
.method public final onCompletion(Landroid/media/MediaPlayer;)V
    ...
    iget-object v0, p0, LQc/x;->g:Landroid/os/Handler;

    new-instance v1, LA/h0;

    invoke-direct {v1, p0, p1}, LA/h0;-><init>(LQc/x;Landroid/media/MediaPlayer;)V
...
.method public final onError(Landroid/media/MediaPlayer;II)Z
    ...
    invoke-direct {v1, p0, p1, p2, p3}, LA/U3;-><init>(LQc/x;Landroid/media/MediaPlayer;II)V
...
.method public final onPrepared(Landroid/media/MediaPlayer;)V
    ...
    invoke-direct {v1, p0, p1}, LA3/F;-><init>(LQc/x;Landroid/media/MediaPlayer;)V
...
.method public final onSeekComplete(Landroid/media/MediaPlayer;)V
    ...
    invoke-direct {v1, p0, p1}, LA/O1;-><init>(LQc/x;Landroid/media/MediaPlayer;)V
