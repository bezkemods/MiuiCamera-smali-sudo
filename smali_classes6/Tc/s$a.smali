...
.field public final synthetic l:LTc/s;


# direct methods
.method public constructor <init>(LTc/s;Landroid/content/Context;Lcom/xiaomi/mimoji/common/fragment/bottomlist/FragmentMimojiBottomList;Landroid/widget/RelativeLayout;)V
    .locals 6
    ...
    iput-object p1, p0, LTc/s$a;->l:LTc/s;

    const/16 p1, 0x68

    iput p1, p0, LTc/s$a;->a:I

    const/4 p1, 0x3

    new-array v1, p1, [I

    iput-object v1, p0, LTc/s$a;->b:[I

    const/4 v2, 0x0

    iput-boolean v2, p0, LTc/s$a;->k:Z

    iput-object p2, p0, LTc/s$a;->j:Landroid/content/Context;

    iput-object p4, p0, LTc/s$a;->c:Landroid/widget/RelativeLayout;

    new-instance p4, Landroid/widget/ImageView;

    invoke-direct {p4, p2}, Landroid/widget/ImageView;-><init>(Landroid/content/Context;)V

    iput-object p4, p0, LTc/s$a;->g:Landroid/widget/ImageView;
    ...
    iput-object v3, p0, LTc/s$a;->h:Landroid/widget/ImageView;
    ...
    iput-object v4, p0, LTc/s$a;->i:Landroid/widget/ImageView;
    ...
    iget-object p3, p0, LTc/s$a;->g:Landroid/widget/ImageView;

    invoke-static {p3, v2}, Lcom/android/camera/features/mode/capture/A;->g(Landroid/widget/ImageView;Z)V

    invoke-static {p3}, Lcom/android/camera/features/mode/capture/A;->e(Landroid/view/View;)V

    iget-object p3, p0, LTc/s$a;->h:Landroid/widget/ImageView;

    invoke-static {p3, v2}, Lcom/android/camera/features/mode/capture/A;->g(Landroid/widget/ImageView;Z)V

    invoke-static {p3}, Lcom/android/camera/features/mode/capture/A;->e(Landroid/view/View;)V

    iget-object p3, p0, LTc/s$a;->i:Landroid/widget/ImageView;
    ...
    iput-object p3, p0, LTc/s$a;->d:Landroid/widget/RelativeLayout$LayoutParams;

    new-instance p3, Landroid/widget/RelativeLayout$LayoutParams;

    invoke-direct {p3, p1, p2}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    iput-object p3, p0, LTc/s$a;->e:Landroid/widget/RelativeLayout$LayoutParams;

    new-instance p3, Landroid/widget/RelativeLayout$LayoutParams;

    invoke-direct {p3, p1, p2}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    iput-object p3, p0, LTc/s$a;->f:Landroid/widget/RelativeLayout$LayoutParams;
...
.method public static b(Z)V
    ...
    invoke-direct {v1, p0, v2}, LA/T3;-><init>(II)V
...
.method public final a(III)V
    ...
    iget-boolean v7, v0, LTc/s$a;->k:Z

    iget-object v8, v0, LTc/s$a;->i:Landroid/widget/ImageView;

    iget-object v9, v0, LTc/s$a;->g:Landroid/widget/ImageView;

    iget-object v10, v0, LTc/s$a;->h:Landroid/widget/ImageView;

    const/4 v11, 0x1

    if-nez v7, :cond_0

    iget-object v7, v0, LTc/s$a;->c:Landroid/widget/RelativeLayout;
    ...
    iput-boolean v11, v0, LTc/s$a;->k:Z

    :cond_0
    iget-object v7, v0, LTc/s$a;->l:LTc/s;

    iget-boolean v12, v7, LTc/s;->g:Z

    if-nez v12, :cond_a

    iget-boolean v12, v7, LTc/s;->f:Z
    ...
    :cond_1
    iget-object v12, v0, LTc/s$a;->b:[I
    ...
    iget-boolean v11, v7, LTc/s;->j:Z

    if-eqz v11, :cond_3

    iget-wide v5, v7, LTc/s;->a:D
    ...
    invoke-direct {v2, v0}, LTc/p;-><init>(LTc/s$a;)V
    ...
    invoke-direct {v3, v0}, LTc/q;-><init>(LTc/s$a;)V
    ...
    invoke-direct {v1, v0}, LTc/r;-><init>(LTc/s$a;)V
    ...
    invoke-static {v0}, LTc/s$a;->b(Z)V
    ...
    iput v2, v0, LTc/s$a;->a:I

    iget v2, v7, LTc/s;->e:I

    sub-int v2, v2, p1

    iget-object v3, v0, LTc/s$a;->j:Landroid/content/Context;
    ...
    invoke-direct {v4, v0, v1, v2}, LTc/m;-><init>(LTc/s$a;II)V
    ...
    new-instance v5, LTc/n;

    invoke-direct {v5, v0, v1, v2}, LTc/n;-><init>(LTc/s$a;II)V
    ...
    invoke-direct {v3, v0, v1, v2}, LTc/o;-><init>(LTc/s$a;II)V
