...
.field public b:LEd/c;

.field public c:LEd/b;

.field public d:LEd/d;
...
.field public r:LDd/d;

.field public volatile s:Z

.field public t:Lyd/c;

.field public u:Lzd/d;
...
.field public final w:Lce/g;

.field public final x:Lce/h;

.field public final y:LNf/j;
...
.method public constructor <init>(Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;)V
    ...
    iput-object p1, p0, Lce/l;->a:Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;

    new-instance p1, Landroidx/lifecycle/MutableLiveData;

    invoke-direct {p1}, Landroidx/lifecycle/MutableLiveData;-><init>()V

    iput-object p1, p0, Lce/l;->f:Landroidx/lifecycle/MutableLiveData;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lce/l;->h:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, Lce/l;->k:LWe/n;

    new-instance p1, LDd/a;

    const/4 v0, 0x1

    invoke-direct {p1, p0, v0}, LDd/a;-><init>(Ljava/lang/Object;I)V
    ...
    iput-object p1, p0, Lce/l;->p:Lcom/faceunity/core/faceunity/FUSceneKit;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lce/l;->q:Z

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lce/l;->v:Ljava/util/HashMap;

    new-instance p1, Lce/g;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lce/l;->w:Lce/g;

    new-instance p1, Lce/h;

    invoke-direct {p1, p0}, Lce/h;-><init>(Lce/l;)V

    iput-object p1, p0, Lce/l;->x:Lce/h;

    new-instance p1, LNf/j;

    invoke-direct {p1, p0}, LNf/j;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Lce/l;->y:LNf/j;
...
.method public final a(Lzd/c;)V
    ...
    invoke-direct {v0, p1, v1}, LK4/r;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object v2, p1, Lzd/c;->a:Ljava/lang/String;

    iget-object v0, v0, LEd/c;->d:Ljava/util/HashMap;
    ...
    :cond_0
    iget-object v3, p0, Lce/l;->a:Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;
    ...
    iget-object v6, v6, Lzd/d;->b:Ljava/lang/String;
    ...
    invoke-direct {v6, v3, v4}, LFd/a;-><init>(Lcom/xiaomi/mimoji/mimojifu2/faceunity/editor/widget/CustomCategoryLinearLayout;I)V
    ...
    :cond_5
    iput-object p1, p0, Lce/l;->g:Lzd/c;
    ...
    iget-object p1, p0, Lce/l;->t:Lyd/c;

    if-eqz p1, :cond_7

    invoke-virtual {p1}, Lyd/c;->d()V
    ...
    invoke-virtual {p0, p1}, Lyd/c;->c(Lcom/faceunity/core/entity/FUAnimationBundleData;)V
...
.method public final b(Lzd/d;)V
    ...
    invoke-direct {v4, v5, v1}, Lce/b;-><init>(ILzd/d;)V

    const-string v5, "KIT_EditorViewModel"

    invoke-static {v5, v4}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Llf/a;)V

    iput-object v1, v0, Lce/l;->u:Lzd/d;

    new-instance v4, LK4/s;

    invoke-direct {v4, v1, v3}, LK4/s;-><init>(Ljava/lang/Object;I)V

    invoke-static {v5, v4}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Llf/a;)V

    iget-object v4, v0, Lce/l;->c:LEd/b;

    const/4 v6, 0x0

    if-eqz v4, :cond_6

    iget v4, v4, LEd/b;->b:I

    iget-object v7, v0, Lce/l;->b:LEd/c;

    const-string v8, "mEditorSourceRepo"

    if-eqz v7, :cond_5

    invoke-static {v4}, LEd/c;->g(I)Ljava/lang/String;

    move-result-object v4

    sget-object v7, Lxd/a;->a:Ljava/lang/String;
    ...
    iget-object v7, v1, Lzd/d;->c:Lorg/json/JSONObject;
    ...
    iget-object v4, v0, Lce/l;->n:Lcom/faceunity/core/avatar/model/Scene;
    ...
    invoke-static {v4, v7, v2, v3, v6}, Lcom/faceunity/core/avatar/scene/CameraAnimation;->setAnimation$default(Lcom/faceunity/core/avatar/scene/CameraAnimation;Lcom/faceunity/core/entity/FUAnimationBundleData;ZILjava/lang/Object;)V
    ...
    :cond_1
    :goto_0
    iget-object v3, v0, Lce/l;->b:LEd/c;

    if-eqz v3, :cond_4

    iget-object v4, v1, Lzd/d;->a:Ljava/lang/String;

    iget-object v3, v3, LEd/c;->f:Ljava/util/HashMap;
    ...
    :cond_2
    iget-object v7, v0, Lce/l;->a:Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;

    invoke-virtual {v7, v3}, Lcom/xiaomi/mimoji/mimojifu2/ui/fragment/FragmentFu2Edit;->Ac(Ljava/util/ArrayList;)V

    iget-object v7, v0, Lce/l;->h:Ljava/util/ArrayList;

    invoke-virtual {v7}, Ljava/util/ArrayList;->clear()V

    invoke-virtual {v7, v3}, Ljava/util/ArrayList;->addAll(Ljava/util/Collection;)Z

    sget-object v3, Lxd/a;->h:Lxd/a$b;

    invoke-virtual {v3, v4}, Lxd/a$b;->contains(Ljava/lang/Object;)Z
    ...
    invoke-direct {v7, v2, v1}, Lce/b;-><init>(ILzd/d;)V

    invoke-static {v5, v7}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Llf/a;)V

    iget-object v2, v0, Lce/l;->k:LWe/n;
    ...
    invoke-direct {v7, v8, v0, v1}, LDd/c;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v0, v4, v6}, Lce/a;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {v5, v0}, Lcom/faceunity/toolbox/utils/FULogger;->i(Ljava/lang/String;Llf/a;)V
