...
.field public final c:Lwf/h$a;


# direct methods
.method public constructor <init>(LBf/u;Lwf/f;Z)V
    .locals 8
    ...
    iput-object p2, p0, Lwf/h;->a:Lwf/f;

    iput-boolean p3, p0, Lwf/h;->b:Z
    ...
    invoke-static {p3}, Lbc/f;->t(Lrg/C;)Ljava/lang/Class;
    ...
    invoke-static {p3, p1}, Lbc/f;->m(Ljava/lang/Class;LBf/b;)Ljava/lang/reflect/Method;
    ...
    :goto_0
    invoke-static {p1}, Ldg/k;->a(LBf/b;)Z
    ...
    new-instance p1, Lwf/h$a;

    sget-object p2, Lrf/d;->d:Lrf/d;

    new-array p3, v2, [Ljava/lang/reflect/Method;

    invoke-direct {p1, p2, p3, v1}, Lwf/h$a;-><init>(Lrf/d;[Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;)V

    goto/16 :goto_9

    :cond_1
    instance-of p3, p2, Lwf/g$g$c;
    ...
    :cond_2
    instance-of p3, p1, LBf/j;

    if-eqz p3, :cond_4

    instance-of p2, p2, Lwf/e;
    ...
    invoke-static {p2}, Ldg/k;->b(LBf/k;)Z
    ...
    invoke-interface {p3}, LBf/j;->E()LBf/e;
    ...
    invoke-static {v3, v4}, Lrf/e;->v(II)Lrf/d;
    ...
    iget v6, v3, Lrf/b;->a:I

    iget v7, v3, Lrf/b;->b:I
    ...
    invoke-static {v6}, Lbc/f;->t(Lrg/C;)Ljava/lang/Class;

    move-result-object v6

    if-eqz v6, :cond_c

    invoke-static {v6, p1}, Lbc/f;->m(Ljava/lang/Class;LBf/b;)Ljava/lang/reflect/Method;
    ...
    invoke-direct {p1, v3, v4, v1}, Lwf/h$a;-><init>(Lrf/d;[Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;)V

    :goto_9
    iput-object p1, p0, Lwf/h;->c:Lwf/h$a;
    ...
    iget-object p1, p0, Lwf/h;->a:Lwf/f;

    invoke-interface {p1}, Lwf/f;->getParameterTypes()Ljava/util/List;
    ...
    invoke-direct {p2, p0}, Lkf/a;-><init>(Ljava/lang/String;)V
...
.method public final a()Ljava/lang/reflect/Member;
    ...
    iget-object p0, p0, Lwf/h;->a:Lwf/f;
...
.method public final call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lwf/h;->c:Lwf/h$a;

    iget-object v1, v0, Lwf/h$a;->a:Lrf/d;
    ...
    iget v3, v1, Lrf/b;->a:I

    const/4 v4, 0x0

    iget v1, v1, Lrf/b;->b:I

    if-gt v3, v1, :cond_2

    :goto_0
    iget-object v5, v0, Lwf/h$a;->b:[Ljava/lang/reflect/Method;
    ...
    invoke-static {v5}, Lvf/X;->e(Ljava/lang/reflect/Type;)Ljava/lang/Object;
    ...
    invoke-interface {p0, v2}, Lwf/f;->call([Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    iget-object p1, v0, Lwf/h$a;->c:Ljava/lang/reflect/Method;
...
.method public final getReturnType()Ljava/lang/reflect/Type;
    ...
    invoke-interface {p0}, Lwf/f;->getReturnType()Ljava/lang/reflect/Type;
