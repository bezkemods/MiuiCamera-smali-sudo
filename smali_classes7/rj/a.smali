...
# direct methods
.method public static a(Lmj/a;Lrj/b;)Ljava/util/LinkedList;
    .locals 10
    ...
    invoke-static {p0}, Loj/g;->b(Lmj/a;)Ljava/util/ArrayList;
    ...
    check-cast v1, Loj/g$a;

    iget-object v3, v1, Loj/g$a;->b:Lorg/jcodec/containers/mp4/boxes/b;
    ...
    iget-wide v3, v1, Loj/g$a;->a:J

    invoke-virtual {p0, v3, v4}, Lmj/a;->a(J)V

    iget-object v0, v1, Loj/g$a;->b:Lorg/jcodec/containers/mp4/boxes/b;

    iget-wide v3, v0, Lorg/jcodec/containers/mp4/boxes/b;->b:J

    long-to-int v0, v3

    invoke-static {p0, v0}, Lmj/b;->b(Ljava/nio/channels/ByteChannel;I)Ljava/nio/ByteBuffer;
    ...
    sget-object v4, Loj/b;->b:Loj/b;

    invoke-static {v0, v3, v4}, Loj/c;->a(Ljava/nio/ByteBuffer;Lorg/jcodec/containers/mp4/boxes/b;Loj/b;)Lorg/jcodec/containers/mp4/boxes/Box;
    ...
    check-cast v7, Loj/g$a;

    iget-object v8, v7, Loj/g$a;->b:Lorg/jcodec/containers/mp4/boxes/b;
    ...
    check-cast v6, Loj/g$a;

    iget-wide v7, v6, Loj/g$a;->a:J

    invoke-virtual {p0, v7, v8}, Lmj/a;->a(J)V

    iget-object v7, v6, Loj/g$a;->b:Lorg/jcodec/containers/mp4/boxes/b;

    iget-wide v7, v7, Lorg/jcodec/containers/mp4/boxes/b;->b:J

    long-to-int v7, v7

    invoke-static {p0, v7}, Lmj/b;->b(Ljava/nio/channels/ByteChannel;I)Ljava/nio/ByteBuffer;

    move-result-object v7

    new-instance v8, Llj/e;

    invoke-direct {v8, v6, v7}, Llj/e;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    sget-object v8, Loj/b;->b:Loj/b;

    invoke-static {v7, v6, v8}, Loj/c;->a(Ljava/nio/ByteBuffer;Lorg/jcodec/containers/mp4/boxes/b;Loj/b;)Lorg/jcodec/containers/mp4/boxes/Box;
    ...
    invoke-direct {v8, v7, v6}, Llj/e;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object v6, v6, Llj/e;->b:Ljava/lang/Object;
    ...
    iget-object v5, p1, Llj/e;->a:Ljava/lang/Object;

    check-cast v5, Ljava/nio/ByteBuffer;

    iget-object p1, p1, Llj/e;->b:Ljava/lang/Object;

    check-cast p1, Lorg/jcodec/containers/mp4/boxes/Box;

    invoke-static {v5, p1}, Lrj/a;->b(Ljava/nio/ByteBuffer;Lorg/jcodec/containers/mp4/boxes/Box;)Z
    ...
    :cond_7
    invoke-interface {p1, v3}, Lrj/b;->b(Lorg/jcodec/containers/mp4/boxes/MovieBox;)V

    :cond_8
    invoke-static {v0, v3}, Lrj/a;->b(Ljava/nio/ByteBuffer;Lorg/jcodec/containers/mp4/boxes/Box;)Z
    ...
    :cond_9
    new-instance p0, Llj/e;

    invoke-direct {p0, v1, v0}, Llj/e;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
