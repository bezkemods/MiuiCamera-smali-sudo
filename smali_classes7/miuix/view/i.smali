...
.method public static b(Landroid/content/Context;I[I)[I
    ...
    invoke-static {p0, v0}, LZh/d;->g(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public final a(Z)V
    ...
    invoke-static {v0, p1}, LIh/i;->e(ILandroid/view/View;)Z

    move-result v1

    if-eqz v1, :cond_3

    invoke-static {v0, p1}, LIh/i;->f(ILandroid/view/View;)Z

    :cond_3
    invoke-static {p1}, LIh/i;->b(Landroid/view/View;)V
...
.method public final d()V
    ...
    invoke-static {v3, v5}, LIh/i;->e(ILandroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {v3, v5}, LIh/i;->f(ILandroid/view/View;)Z
    ...
    :cond_1
    :goto_0
    invoke-static {v5}, LIh/i;->b(Landroid/view/View;)V
    ...
    invoke-interface {v4, v0}, Lmiuix/view/i$a;->b(Z)LIh/f$b;
    ...
    iget v8, v0, LIh/f$b;->a:I

    iget-object v0, v0, LIh/f$b;->b:LIh/f$c;

    if-eqz v0, :cond_7

    iget-object v9, v0, LIh/f$c;->a:[I

    iget-object v0, v0, LIh/f$c;->b:[I
    ...
    invoke-static {v6}, LIh/k;->d(Landroid/graphics/drawable/Drawable;)Ljava/lang/Integer;
    ...
    invoke-static {v0, v5, v4}, LIh/i;->d(ILandroid/view/View;I)Z
    ...
    :cond_a
    invoke-static {v4, v5}, LIh/i;->f(ILandroid/view/View;)Z
    ...
    sget-object v1, LIh/d;->a:Ljava/lang/Boolean;
    ...
    :cond_d
    :try_start_1
    sget-object v1, LIh/i;->b:Ljava/lang/reflect/Method;
    ...
    sput-object v1, LIh/i;->b:Ljava/lang/reflect/Method;
    ...
    :catch_1
    sput-object v6, LIh/i;->b:Ljava/lang/reflect/Method;
    ...
    const-string v9, "warning!! colorInts("

    const-string v10, ") and blendModes("

    const-string v11, ") size not match. "

    invoke-static {v2, v4, v9, v10, v11}, LA/l2;->b(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :cond_13
    :try_start_2
    sget-object p0, LIh/i;->d:Ljava/lang/reflect/Method;
    ...
    sput-object p0, LIh/i;->d:Ljava/lang/reflect/Method;
    ...
    :catch_2
    sput-object v6, LIh/i;->d:Ljava/lang/reflect/Method;
    ...
    invoke-static {v2, v5, v4}, LIh/i;->a(ILandroid/view/View;I)Z
