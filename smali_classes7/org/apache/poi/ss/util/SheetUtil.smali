...
.method public static getCellWidth(Lorg/apache/poi/ss/usermodel/Cell;ILorg/apache/poi/ss/usermodel/DataFormatter;Z)D
    ...
    invoke-static {v8, v10, v13}, Landroidx/appcompat/widget/a;->h(Ljava/lang/StringBuilder;Ljava/lang/String;C)Ljava/lang/String;
    ...
    invoke-static {v2, v10, v6, v8}, Lorg/apache/poi/ss/util/SheetUtil;->copyAttributes(Lorg/apache/poi/ss/usermodel/Font;Ljava/text/AttributedString;II)V
    ...
    sget-object v13, Lorg/apache/poi/ss/util/SheetUtil;->fontRenderContext:Ljava/awt/font/FontRenderContext;

    invoke-direct {v8, v10, v13}, Ljava/awt/font/TextLayout;-><init>(Ljava/text/AttributedCharacterIterator;Ljava/awt/font/FontRenderContext;)V
    ...
    new-instance v10, Ljava/awt/geom/AffineTransform;

    invoke-direct {v10}, Ljava/awt/geom/AffineTransform;-><init>()V
    ...
    invoke-virtual {v10, v13}, Ljava/awt/geom/AffineTransform;->concatenate(Ljava/awt/geom/AffineTransform;)V

    const-wide/high16 v13, 0x3ff0000000000000L    # 1.0

    invoke-static {v13, v14, v11, v12}, Ljava/awt/geom/AffineTransform;->getScaleInstance(DD)Ljava/awt/geom/AffineTransform;

    move-result-object v15

    invoke-virtual {v10, v15}, Ljava/awt/geom/AffineTransform;->concatenate(Ljava/awt/geom/AffineTransform;)V

    invoke-virtual {v8, v10}, Ljava/awt/font/TextLayout;->getOutline(Ljava/awt/geom/AffineTransform;)Ljava/awt/Shape;
    ...
    invoke-virtual {v8}, Ljava/awt/Rectangle;->getWidth()D
    ...
    invoke-virtual {v8}, Ljava/awt/font/TextLayout;->getBounds()Ljava/awt/geom/Rectangle2D;
    ...
    invoke-interface {v6}, Lorg/apache/poi/ss/usermodel/CellStyle;->getIndention()S
