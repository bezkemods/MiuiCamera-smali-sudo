...
.method private getWatermarkParagraph(Ljava/lang/String;I)Lorg/apache/poi/xwpf/usermodel/XWPFParagraph;
    ...
    sget-object p1, LCj/c;->C:Lorg/apache/xmlbeans/SchemaType;
    ...
    invoke-interface {p0}, LCj/c;->i()LCj/e;

    move-result-object p0

    const-string p1, "_x0000_t136"

    invoke-interface {p0, p1}, LCj/e;->setId(Ljava/lang/String;)V

    invoke-interface {p0}, LCj/e;->f()V

    invoke-interface {p0}, LCj/e;->a()V

    invoke-interface {p0}, LCj/e;->k()V

    invoke-interface {p0}, LCj/e;->l()V

    invoke-interface {p0}, LCj/e;->d()LCj/b;
