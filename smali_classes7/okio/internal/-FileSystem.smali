...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Lokio/FileSystem;Lokio/Path;Z)LBg/h;",
        "LBg/j;",
        "fileSystem",
        "LXe/h;",
        "stack",
        "postorder",
        "collectRecursively",
        "(LBg/j;Lokio/FileSystem;LXe/h;Lokio/Path;ZZLaf/e;)Ljava/lang/Object;",
        "symlinkTarget",
...
# direct methods
.method public static final collectRecursively(LBg/j;Lokio/FileSystem;LXe/h;Lokio/Path;ZZLaf/e;)Ljava/lang/Object;
    .locals 16
    ...
    invoke-direct {v5, v3}, Lokio/internal/-FileSystem$collectRecursively$1;-><init>(Laf/e;)V
    ...
    invoke-static {v3}, LWe/l;->b(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1, v5}, LBg/j;->c(Ljava/lang/Object;Lcf/a;)V
    ...
    invoke-virtual {v7, v13}, LXe/h;->contains(Ljava/lang/Object;)Z
    ...
    invoke-static {v1, v2}, LA/S;->k(Lokio/Path;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_9
    invoke-virtual {v7, v13}, LXe/h;->addLast(Ljava/lang/Object;)V
    ...
    invoke-static/range {p0 .. p6}, Lokio/internal/-FileSystem;->collectRecursively(LBg/j;Lokio/FileSystem;LXe/h;Lokio/Path;ZZLaf/e;)Ljava/lang/Object;
    ...
    :cond_b
    invoke-virtual {v7}, LXe/h;->removeLast()Ljava/lang/Object;
    ...
    invoke-virtual {v11, v1, v5}, LBg/j;->c(Ljava/lang/Object;Lcf/a;)V
...
.method public static final commonCopy(Lokio/FileSystem;Lokio/Path;Lokio/Path;)V
    ...
    invoke-static {p0, p1}, LA/M2;->c(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static final commonCreateDirectories(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-virtual {v0, v1}, LXe/h;->addFirst(Ljava/lang/Object;)V
...
.method public static final commonDeleteRecursively(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-direct {v0, p0, p1, v1}, Lokio/internal/-FileSystem$commonDeleteRecursively$sequence$1;-><init>(Lokio/FileSystem;Lokio/Path;Laf/e;)V

    new-instance p1, LBg/i;

    invoke-direct {p1}, LBg/j;-><init>()V

    invoke-static {p1, p1, v0}, LAe/b;->i(Laf/e;Laf/e;Llf/p;)Laf/e;

    move-result-object v0

    iput-object v0, p1, LBg/i;->d:Laf/e;

    :goto_0
    invoke-virtual {p1}, LBg/i;->hasNext()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p1}, LBg/i;->next()Ljava/lang/Object;
...
.method public static final commonListRecursively(Lokio/FileSystem;Lokio/Path;Z)LBg/h;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p0, p2, v1}, Lokio/internal/-FileSystem$commonListRecursively$1;-><init>(Lokio/Path;Lokio/FileSystem;ZLaf/e;)V
...
.method public static final commonMetadata(Lokio/FileSystem;Lokio/Path;)Lokio/FileMetadata;
    ...
    invoke-static {p1, v0}, LA/S;->k(Lokio/Path;Ljava/lang/String;)Ljava/lang/String;
