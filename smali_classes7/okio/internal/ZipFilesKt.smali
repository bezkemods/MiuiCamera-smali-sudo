...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Lokio/ZipFileSystem;",
        "openZip",
        "(Lokio/Path;Lokio/FileSystem;Llf/l;)Lokio/ZipFileSystem;",
        "",
        "entries",
        "",
        "buildIndex",
...
.method private static final buildIndex(Ljava/util/List;)Ljava/util/Map;
    ...
    invoke-static {v1, v2}, LXe/u;->n0(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/List;
...
.method public static final openZip(Lokio/Path;Lokio/FileSystem;Llf/l;)Lokio/ZipFileSystem;
    .locals 18
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_5
    invoke-static {v5, v11}, LEg/J;->b(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_5
    ...
    :try_start_8
    invoke-static {v5, v1}, LEg/J;->b(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    :try_start_9
    invoke-static {v3, v11}, LEg/J;->b(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_9
    ...
    invoke-interface {v2, v6}, Llf/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v4, v11}, LEg/J;->b(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v4, v1}, LEg/J;->b(Ljava/io/Closeable;Ljava/lang/Throwable;)V

    throw v2
.end method

.method public static synthetic openZip$default(Lokio/Path;Lokio/FileSystem;Llf/l;ILjava/lang/Object;)Lokio/ZipFileSystem;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lokio/internal/ZipFilesKt;->openZip(Lokio/Path;Lokio/FileSystem;Llf/l;)Lokio/ZipFileSystem;
...
.method public static final readEntry(Lokio/BufferedSource;)Lokio/internal/ZipEntry;
    ...
    invoke-static {v6, v2}, LCg/p;->R(Ljava/lang/String;C)Z
    ...
    invoke-static {v8, v12, v15}, Lokio/internal/ZipFilesKt;->readExtra(Lokio/BufferedSource;ILlf/p;)V
    ...
    invoke-static {v11, v1, v4}, LCg/m;->H(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method private static final readExtra(Lokio/BufferedSource;ILlf/p;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2, v8, v9}, Llf/p;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static final readOrSkipLocalHeader(Lokio/BufferedSource;Lokio/FileMetadata;)Lokio/FileMetadata;
    ...
    invoke-static {v0, v5, v2}, Lokio/internal/ZipFilesKt;->readExtra(Lokio/BufferedSource;ILlf/p;)V
