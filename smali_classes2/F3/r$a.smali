...
.method public constructor <init>(LF3/r;)V
    ...
    iput-object p1, p0, LF3/r$a;->a:LF3/r;
...
.method public final accept(Ljava/lang/Object;)V
    ...
    iget-object v2, v0, LF3/r$a;->a:LF3/r;

    iget-object v2, v2, LF3/r;->q:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-object v3, v0, LF3/r$a;->a:LF3/r;

    iget-boolean v3, v3, LF3/r;->T:Z
    ...
    iget-object v4, v0, LF3/r$a;->a:LF3/r;

    iget v4, v4, LA/T2;->j:I
    ...
    iget v4, v2, LA/T2;->j:I

    if-eq v4, v5, :cond_4

    iget-boolean v5, v2, LF3/r;->C:Z
    ...
    :cond_3
    invoke-virtual {v2, v8}, LF3/r;->s(I)V

    iget-object v2, v0, LF3/r$a;->a:LF3/r;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-boolean v6, v2, LA/T2;->i:Z

    goto :goto_1

    :cond_4
    :goto_0
    iput-boolean v3, v2, LF3/r;->C:Z

    invoke-virtual {v2, v7}, LF3/r;->s(I)V

    iget-object v2, v0, LF3/r$a;->a:LF3/r;

    invoke-virtual {v2}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {v2}, LF3/r;->v()V

    iget-object v2, v0, LF3/r$a;->a:LF3/r;

    iget-object v2, v2, LF3/r;->z:LF3/r$c;
    ...
    iget-boolean v3, v2, LF3/r;->B:Z

    if-eqz v3, :cond_5

    invoke-virtual {v2, v4, v7}, LF3/r;->p(II)V

    iget-object v2, v0, LF3/r$a;->a:LF3/r;

    invoke-virtual {v2}, LF3/r;->n()V

    goto :goto_1

    :cond_5
    invoke-virtual {v2}, LF3/r;->g()V

    :goto_1
    iget-object v0, v0, LF3/r$a;->a:LF3/r;

    invoke-static {v0, v1}, LF3/r;->d(LF3/r;Lcom/android/camera/module/loader/camera2/FocusTask;)V
    ...
    :cond_7
    invoke-virtual {v2, v4}, LF3/r;->s(I)V
    ...
    invoke-virtual {v2, v5, v4}, LF3/r;->p(II)V
    ...
    iget-object v9, v0, LF3/r$a;->a:LF3/r;

    iget v9, v9, LA/T2;->j:I
    ...
    iget-object v11, v0, LF3/r;->A:Ljava/lang/ref/WeakReference;

    invoke-virtual {v11}, Ljava/lang/ref/Reference;->get()Ljava/lang/Object;

    move-result-object v11

    check-cast v11, LF3/r$b;
    ...
    invoke-interface {v11}, LF3/r$b;->showFocusViewWhenCaf()Z
    ...
    invoke-interface {v9}, LV3/o0;->Ne()Z

    move-result v11

    if-eqz v11, :cond_11

    invoke-interface {v9, v7}, LV3/o0;->Ze(I)V
    ...
    invoke-virtual {v0}, LF3/r;->getFocusMode()I
    ...
    iget-object v11, v0, LF3/r;->N:Landroid/graphics/Rect;
    ...
    invoke-interface {v9, v3}, LV3/o0;->w9(Z)V

    :cond_13
    iget-object v11, v0, LF3/r;->z:LF3/r$c;

    if-eqz v2, :cond_16

    iget v2, v0, LA/T2;->j:I

    if-eq v2, v5, :cond_15

    invoke-virtual {v0, v6}, LF3/r;->s(I)V

    invoke-virtual {v11, v3}, Landroid/os/Handler;->removeMessages(I)V

    invoke-virtual {v11, v6}, Landroid/os/Handler;->removeMessages(I)V

    iget-boolean v2, v0, LF3/r;->U:Z
    ...
    invoke-virtual {v2}, L炤炨炪烩炪炮烩炣炢炱炮炤炢烩炤炨炪炪炨炩烩炄炨炪炪炨炩;->t()I
    ...
    invoke-interface {v9, v5, v6, v0}, LV3/o0;->Yc(III)V

    invoke-interface {v9}, LV3/o0;->u3()V
    ...
    iget-wide v5, v0, LF3/r;->x:J

    invoke-static {v13, v14, v5, v6, v12}, LA/Q;->d(JJLjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v7}, LF3/r;->s(I)V

    goto :goto_9

    :cond_17
    invoke-virtual {v0, v4}, LF3/r;->s(I)V
    ...
    invoke-interface {v9, v4, v1, v3}, LV3/o0;->Yc(III)V
    ...
    invoke-virtual {v0, v4, v7}, LF3/r;->p(II)V

    invoke-virtual {v0}, LF3/r;->n()V

    goto :goto_c

    :cond_1a
    invoke-virtual {v0}, LF3/r;->g()V
