...
.method public constructor <init>(Lcom/android/camera/Camera;)V
    ...
    const-class v3, L苟苓苑芒苝苒苘苎苓苕苘芒苟苝苑苙苎苝芒苕苒苌苉苈苘苙苊苕苟苙芒苘苙苊苕苟苙苏芒苳芍苻;

    const-class v4, L턢턮턬텯턠턯턥턳턮턨턥텯턢턠턬턤턳턠텯턨턯턱턴턵턥턤턷턨턢턤텯턥턤턷턨턢턤턲텯턎텰턆턍턨턵턤;

    const-class v0, L낂낎낌냏낀낏낅낓낎낈낅냏낂낀낌낄낓낀냏낈낏낑낔낕낅낄낗낈낂낄냏낅낄낗낈낂낄낒냏났냐낦;

    const-class v1, L걤걨걪갩걦걩걣걵걨걮걣갩걤걦걪걢걵걦갩걮걩걷걲걳걣걢걱걮걤걢갩걣걢걱걮걤걢건갩걊갶걀걐걯걮걳걢;

    const-class v2, L嘣嘯嘭噮嘡嘮嘤嘲嘯嘩嘤噮嘣嘡嘭嘥嘲嘡噮嘩嘮嘰嘵嘴嘤嘥嘶嘩嘣嘥噮嘤嘥嘶嘩嘣嘥嘳噮嘎噱嘇;

    const-class v5, L撬撠撢擡撮撡撫撽撠撦撫擡撬撮撢撪撽撮擡撦撡撿撺撻撫撪撹撦撬撪擡撫撪撹撦撬撪撼擡撟擾撈;

    const-class v6, L燁燍燏熌燃燌燆燐燍燋燆熌燁燃燏燇燐燃熌燋燌燒燗燖燆燇燔燋燁燇熌燆燇燔燋燁燇燑熌燲熓燰燋燌燅;
    ...
    iput-object v1, v0, Lg3/d;->a:Ljava/util/ArrayList;

    iput-object v0, p0, Lg3/c;->b:Lg3/d;
...
.method public final C2(FZZ)I
    ...
    iget-object p0, p0, Lg3/c;->b:Lg3/d;
    ...
    iget-object p2, p0, Lg3/d;->a:Ljava/util/ArrayList;

    invoke-static {v0, p2}, LA3/H2;->f(ILjava/util/ArrayList;)Ljava/lang/Object;
    ...
    :cond_4
    iget-object v4, p0, Lg3/d;->a:Ljava/util/ArrayList;
    ...
    :goto_2
    iget-object p3, p0, Lg3/d;->a:Ljava/util/ArrayList;
...
.method public final Lb(Landroid/view/KeyEvent;)Z
    .locals 0
    ...
    invoke-static {p1}, LAe/b;->j(Landroid/view/InputDevice;)I
...
.method public final P1(Landroid/view/InputEvent;)Z
    ...
    instance-of p0, p0, L燁燍燏熌燃燌燆燐燍燋燆熌燁燃燏燇燐燃熌燋燌燒燗燖燆燇燔燋燁燇熌燆燇燔燋燁燇燑熌燲熓燰燋燌燅;
...
.method public final Te(IIZ)V
    ...
    invoke-static {p1}, Lcom/android/camera/data/data/h;->b(I)Z
    ...
    invoke-virtual {v0, p2}, LF3/f;->b0(I)Z
    ...
    :cond_c
    invoke-virtual {p0, p1}, Lg3/d;->a(I)V
...
.method public final V1(Landroid/view/InputEvent;)Z
    ...
    instance-of p1, p0, L嘣嘯嘭噮嘡嘮嘤嘲嘯嘩嘤噮嘣嘡嘭嘥嘲嘡噮嘩嘮嘰嘵嘴嘤嘥嘶嘩嘣嘥噮嘤嘥嘶嘩嘣嘥嘳噮嘎噱嘇;

    if-nez p1, :cond_1

    instance-of p1, p0, L苟苓苑芒苝苒苘苎苓苕苘芒苟苝苑苙苎苝芒苕苒苌苉苈苘苙苊苕苟苙芒苘苙苊苕苟苙苏芒苳芍苻;

    if-nez p1, :cond_1

    instance-of p0, p0, L턢턮턬텯턠턯턥턳턮턨턥텯턢턠턬턤턳턠텯턨턯턱턴턵턥턤턷턨턢턤텯턥턤턷턨턢턤턲텯턎텰턆턍턨턵턤;
...
.method public final df(Landroid/view/KeyEvent;)I
    .locals 0
...
.method public final e9(Landroid/view/KeyEvent;)Z
    .locals 0
...
.method public final ef(Landroid/view/KeyEvent;)Z
    .locals 0
...
.method public final k4(Landroid/view/KeyEvent;)Z
    .locals 0
...
.method public final m(Landroid/view/InputDevice;)V
    ...
    invoke-static {p0, v2, v3, v4, v5}, LA/l2;->b(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final n()V
    ...
    invoke-direct {v2, p0, v1}, LA/Z1;-><init>(Lcom/android/camera/Camera;I)V
...
.method public final onInputDeviceRemoved(I)V
    ...
    invoke-direct {v1, p1}, Lcom/android/camera/fragment/s;-><init>(I)V
