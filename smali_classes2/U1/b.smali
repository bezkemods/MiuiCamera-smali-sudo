...
# direct methods
.method public static b(IZZZZ)LU1/b;
    .locals 1
    ...
    iput-boolean p1, v0, LU1/b;->c:Z

    iput p0, v0, LU1/b;->a:I

    iput-boolean p2, v0, LU1/b;->b:Z

    iput-boolean p3, v0, LU1/b;->e:Z

    const/4 p0, 0x1

    iput-boolean p0, v0, LU1/b;->m:Z

    iput-boolean p4, v0, LU1/b;->f:Z
...
.method public final a()V
    ...
    iget-object v2, v2, Lb0/d0;->n:Le6/y;

    if-eqz v2, :cond_7

    iget-boolean v4, v2, Le6/y;->f:Z

    if-eqz v4, :cond_7

    iput-boolean v3, p0, LU1/b;->l:Z

    iget v2, v2, Le6/y;->b:I
    ...
    invoke-virtual {v2, v4}, Lb0/V;->l(I)Z

    move-result v4

    if-eqz v4, :cond_7

    iget v4, p0, LU1/b;->g:I

    invoke-virtual {v2}, Lb0/V;->h()I
    ...
    :goto_1
    iput-boolean v2, p0, LU1/b;->d:Z

    iput-boolean v6, p0, LU1/b;->h:Z
    ...
    iput-boolean v2, p0, LU1/b;->k:Z

    if-nez v2, :cond_9

    iget-boolean v2, p0, LU1/b;->l:Z

    if-eqz v2, :cond_a

    :cond_9
    iput-boolean v6, p0, LU1/b;->d:Z

    :cond_a
    if-eqz v0, :cond_b

    iget-boolean v0, p0, LU1/b;->c:Z
    ...
    :goto_2
    iput-boolean v0, p0, LU1/b;->i:Z

    iput-boolean v3, p0, LU1/b;->m:Z
