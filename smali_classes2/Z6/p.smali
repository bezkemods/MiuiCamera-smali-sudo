...
.method public final a(LJ6/C;LJ6/c;)LJ6/n;
    ...
    sget-object p2, Ly6/k$c;->d:Ly6/k$c;
    ...
    :goto_0
    iget-boolean p2, p0, LZ6/p;->c:Z

    if-eq p1, p2, :cond_2

    new-instance p0, LZ6/p;

    invoke-direct {p0, p1}, LZ6/p;-><init>(Z)V
...
.method public final bridge synthetic f(Ljava/lang/Object;Lz6/f;LJ6/C;)V
    ...
    invoke-virtual {p0, p1, p2}, LZ6/p;->o(Ljava/net/InetAddress;Lz6/f;)V
...
.method public final g(Ljava/lang/Object;Lz6/f;LJ6/C;LU6/h;)V
    ...
    iput-object v0, p3, LH6/c;->b:Ljava/lang/Class;

    invoke-virtual {p4, p2, p3}, LU6/h;->e(Lz6/f;LH6/c;)LH6/c;

    move-result-object p3

    invoke-virtual {p0, p1, p2}, LZ6/p;->o(Ljava/net/InetAddress;Lz6/f;)V

    invoke-virtual {p4, p2, p3}, LU6/h;->f(Lz6/f;LH6/c;)LH6/c;

    return-void
.end method

.method public final o(Ljava/net/InetAddress;Lz6/f;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
