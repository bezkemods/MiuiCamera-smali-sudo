...
.method public synthetic constructor <init>(Landroidx/fragment/app/Fragment;I)V
    ...
    iput-object p1, p0, LI2/A;->b:Landroidx/fragment/app/Fragment;
...
.method public final onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    iget-object p4, p0, LI2/A;->b:Landroidx/fragment/app/Fragment;
    ...
    instance-of p2, p0, Lcom/android/camera/data/data/w;
    ...
    iget-object p4, p0, Lcom/android/camera/data/data/w;->c:Ljava/lang/String;

    iget p5, p0, Lcom/android/camera/data/data/w;->b:I

    invoke-interface {p2, p5, p3, p4, p1}, LV3/r0;->z1(ILjava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, p2, p1}, Lcom/xiaomi/cam/watermark/b;->i(Ljava/lang/String;Z)V

    const-string p3, "custom_text"

    invoke-virtual {p0, p2, p3}, Lcom/xiaomi/cam/watermark/b;->W(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p4}, Landroidx/fragment/app/Fragment;->requireContext()Landroid/content/Context;

    move-result-object p3

    iget-object p5, p0, Lcom/xiaomi/cam/watermark/b;->f:Ln9/I;

    invoke-virtual {p5, p2}, Ln9/I;->n(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p5

    invoke-virtual {p0, p3, p2, p5}, Lcom/xiaomi/cam/watermark/b;->S(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p2}, LXb/f;->n(Landroid/content/Intent;)Z

    move-result p2

    if-eqz p2, :cond_2

    invoke-static {p3, p1}, LXb/f;->w(Landroid/content/Intent;Z)V
