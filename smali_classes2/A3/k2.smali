...
.method static constructor <clinit>()V
    ...
    sput-object v1, LA3/k2;->H:[F

    new-array v0, v0, [F

    fill-array-data v0, :array_1

    sput-object v0, LA3/k2;->I:[F
...
.method public constructor <init>(Lcom/xiaomi/inceptionmediaprocess/OpenGlRender;)V
    ...
    iput p1, p0, LA3/k2;->a:I

    iput p1, p0, LA3/k2;->b:I

    iput p1, p0, LA3/k2;->c:I

    iput p1, p0, LA3/k2;->d:I

    const/4 v0, 0x0

    iput-object v0, p0, LA3/k2;->j:Ljava/nio/ByteBuffer;

    iput-object v0, p0, LA3/k2;->k:Ljava/nio/ByteBuffer;

    const/16 v0, 0x10

    new-array v0, v0, [F

    iput-object v0, p0, LA3/k2;->m:[F

    const/4 v0, 0x1

    iput-boolean v0, p0, LA3/k2;->p:Z

    new-array v1, v0, [I

    iput-object v1, p0, LA3/k2;->y:[I

    iput p1, p0, LA3/k2;->B:I

    iput-boolean p1, p0, LA3/k2;->E:Z

    new-array p1, v0, [I

    iput-object p1, p0, LA3/k2;->F:[I

    new-array p1, v0, [I

    iput-object p1, p0, LA3/k2;->G:[I
...
.method public static b(Ljava/lang/String;)I
    ...
    invoke-static {v1, v0}, LA3/k2;->c(ILjava/lang/String;)I

    move-result v0

    const v1, 0x8b30

    invoke-static {v1, p0}, LA3/k2;->c(ILjava/lang/String;)I

    move-result v1

    const-string v2, "vertex shader: #version 310 es\nlayout (location = 0) in vec4 vertexIn;\nlayout (location = 1) in vec2 textureIn;\nout vec2 textureOut;uniform mat4 modelViewProjectionMatrix;void main() {gl_Position = modelViewProjectionMatrix*vertexIn ;textureOut = (vec4(textureIn.x ,  textureIn.y , 0.0, 1.0)).xy;} -- "
    ...
    invoke-static {v2, p0, v1}, LA/M;->g(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
...
.method public final a(IIIII)V
    ...
    iget p1, p0, LA3/k2;->A:I

    invoke-static {p1, p2}, Landroid/opengl/GLES20;->glUniform1i(II)V

    invoke-static {}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit()V

    iget p1, p0, LA3/k2;->g:I

    iget p4, p0, LA3/k2;->B:I

    invoke-static {p1, p4}, Landroid/opengl/GLES20;->glUniform1i(II)V

    invoke-static {}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit()V

    iget p1, p0, LA3/k2;->r:I

    iget-boolean p4, p0, LA3/k2;->E:Z
    ...
    iget-boolean p1, p0, LA3/k2;->p:Z

    if-eqz p1, :cond_1

    iput-boolean p2, p0, LA3/k2;->p:Z

    :cond_1
    iget p1, p0, LA3/k2;->q:I

    invoke-static {p1, p2}, Landroid/opengl/GLES20;->glUniform1i(II)V

    invoke-static {}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit()V

    iget-object p1, p0, LA3/k2;->m:[F

    invoke-static {p1, p2}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    int-to-float v2, p5

    iget-object v0, p0, LA3/k2;->m:[F
    ...
    iget-object v5, p0, LA3/k2;->j:Ljava/nio/ByteBuffer;
    ...
    iget-object v5, p0, LA3/k2;->k:Ljava/nio/ByteBuffer;
