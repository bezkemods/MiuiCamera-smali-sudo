...
.method public static final b(Ljava/lang/reflect/Method;)Ljava/lang/String;
    ...
    sget-object v6, Lvf/W;->a:Lvf/W;

    invoke-static/range {v2 .. v7}, LXe/k;->N([Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Llf/l;I)Ljava/lang/String;
...
.method public static e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, p0, p1}, LE2/x;->o(ILjava/lang/String;Ljava/lang/String;)V
...
.method public static g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    invoke-static {p0, v2, p2}, LE2/x;->q(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V

    goto :goto_0

    :cond_2
    :goto_1
    invoke-static {p0, p1, p2}, LE2/x;->q(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V

    :cond_3
    return-void
.end method

.method public static final h(Lrg/C;)Lrg/C;
    .locals 1
    ...
    instance-of v0, p0, Lrg/p0;

    if-eqz v0, :cond_0

    check-cast p0, Lrg/p0;

    invoke-interface {p0}, Lrg/p0;->k0()Lrg/C;
...
.method public static j()Ljava/lang/String;
    ...
    sget v1, Lu9/d;->time_stamp_date_format_minute:I
...
.method public static final k(Lrg/q0;Lrg/C;)Lrg/q0;
    .locals 1
    ...
    invoke-static {p1}, LE2/x;->h(Lrg/C;)Lrg/C;

    move-result-object p1

    invoke-static {p0, p1}, LE2/x;->w(Lrg/q0;Lrg/C;)Lrg/q0;
...
.method public static n(Landroidx/fragment/app/FragmentActivity;Z)Ljava/lang/String;
    .locals 9
    ...
    invoke-static {p1, v1}, LE2/x;->v(Ljava/lang/String;C)Ljava/lang/String;
...
.method public static o(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1, v2}, LE2/x;->p(ILjava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    :cond_2
    :goto_1
    invoke-static {p0, p1, p2}, LE2/x;->p(ILjava/lang/String;Ljava/lang/String;)V
...
.method public static r(Ljava/io/FileInputStream;)Ljava/lang/String;
    ...
    invoke-static {p0, v3}, LA/X;->h(Ljava/io/IOException;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {p0, v1}, LE2/x;->v(Ljava/lang/String;C)Ljava/lang/String;
    ...
    invoke-static {v1, v3, v2}, LA/b4;->c(Landroid/content/Context;IZ)V
    ...
    invoke-static {p0, v1}, LA/X;->h(Ljava/io/IOException;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public static t(Ljava/util/List;Lrg/i0;LBf/k;Ljava/util/ArrayList;)Lrg/m0;
    .locals 1
    ...
    invoke-static {p0, p1, p2, p3, v0}, LE2/x;->u(Ljava/util/List;Lrg/i0;LBf/k;Ljava/util/ArrayList;[Z)Lrg/m0;
...
.method public static u(Ljava/util/List;Lrg/i0;LBf/k;Ljava/util/ArrayList;[Z)Lrg/m0;
    .locals 19
    ...
    invoke-interface {v11}, LCf/a;->getAnnotations()LCf/h;

    move-result-object v6

    invoke-interface {v11}, LBf/Z;->p()Z

    move-result v7

    invoke-interface {v11}, LBf/Z;->r()I
    ...
    invoke-interface {v11}, LBf/Z;->a0()Lqg/l;
    ...
    invoke-static/range {v5 .. v11}, LEf/X;->E0(LBf/k;LCf/h;ZILag/f;ILqg/l;)LEf/X;

    move-result-object v5

    invoke-interface/range {v18 .. v18}, LBf/Z;->i()Lrg/a0;

    move-result-object v6

    new-instance v7, Lrg/h0;

    invoke-virtual {v5}, LEf/k;->m()Lrg/J;

    move-result-object v8

    invoke-direct {v7, v8}, Lrg/h0;-><init>(Lrg/C;)V
    ...
    invoke-direct {v1, v12, v15}, Lrg/b0;-><init>(Ljava/util/Map;Z)V

    invoke-static {v0, v1}, Lrg/m0;->f(Lrg/i0;Lrg/i0;)Lrg/m0;

    move-result-object v5

    new-instance v6, Lrg/j0;

    invoke-direct {v6, v0}, Lrg/j0;-><init>(Lrg/i0;)V

    invoke-static {v6, v1}, Lrg/m0;->f(Lrg/i0;Lrg/i0;)Lrg/m0;
    ...
    invoke-static {v10, v3, v4}, LA3/s2;->m(LBf/Z;Lrg/a0;I)Z
    ...
    invoke-virtual {v10, v11, v8}, Lrg/m0;->j(ILrg/C;)Lrg/C;
    ...
    :cond_3
    iget-boolean v8, v7, LEf/X;->l:Z

    if-nez v8, :cond_5

    invoke-static {v10}, LEg/J;->f(Lrg/C;)Z
    ...
    :cond_4
    iget-object v8, v7, LEf/X;->k:Ljava/util/ArrayList;
    ...
    invoke-virtual {v7}, LEf/X;->G0()Ljava/lang/String;
    ...
    :cond_6
    iget-boolean v6, v7, LEf/X;->l:Z

    if-nez v6, :cond_7

    iput-boolean v2, v7, LEf/X;->l:Z
...
.method public static final w(Lrg/q0;Lrg/C;)Lrg/q0;
    .locals 1
    ...
    invoke-interface {p0}, Lrg/p0;->getOrigin()Lrg/q0;
    ...
    invoke-virtual {p1, p0}, Lrg/C;->equals(Ljava/lang/Object;)Z
    ...
    invoke-direct {v0, p0, p1}, Lrg/M;-><init>(Lrg/J;Lrg/C;)V
    ...
    invoke-direct {v0, p0, p1}, Lrg/y;-><init>(Lrg/w;Lrg/C;)V
