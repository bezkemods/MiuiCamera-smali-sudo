...
.method public static a(Lcom/xiaomi/cam/watermark/b;Z)V
    ...
    invoke-virtual {p0, v0}, Lcom/xiaomi/cam/watermark/b;->h(Z)V

    :cond_0
    invoke-virtual {p0}, Lcom/xiaomi/cam/watermark/b;->y()Z

    move-result v1

    if-eqz v1, :cond_3

    iget-object v1, p0, Lcom/xiaomi/cam/watermark/b;->f:Ln9/I;

    invoke-virtual {v1}, Ln9/I;->o()Ljava/util/LinkedHashMap;
    ...
    invoke-static {v3, v4, v0, v5}, LCg/p;->a0(Ljava/lang/String;CII)I
    ...
    :cond_2
    invoke-virtual {p0, v3, v0}, Lcom/xiaomi/cam/watermark/b;->i(Ljava/lang/String;Z)V
...
.method public static b(Landroid/app/Application;Landroid/location/Location;)Ljava/lang/String;
    .locals 4
    ...
    invoke-static {p0, p1}, Lb3/e;->c(Landroid/content/Context;Landroid/location/Location;)Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lb3/e;->d(IZ)Ljava/lang/String;
...
.method public static c(Landroid/content/Context;Landroid/location/Location;)Ljava/lang/String;
    .locals 2
    ...
    iget-object p1, p1, LH2/g;->a:Ljava/lang/String;

    const-string v1, "getLocationAddress(...)"

    invoke-static {p1, v1}, Lkotlin/jvm/internal/l;->e(Ljava/lang/Object;Ljava/lang/String;)V

    const-string v1, "getNormalLocationAddress: address is "
...
.method public static d(IZ)Ljava/lang/String;
    ...
    invoke-virtual {v0, p1}, LH2/g;->b(Z)Ljava/util/ArrayList;
    ...
    :cond_3
    :goto_1
    invoke-static {v1, p1}, LA3/H2;->f(ILjava/util/ArrayList;)Ljava/lang/Object;
...
.method public static f(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    iget-object p2, p2, Lcom/xiaomi/cam/watermark/b;->f:Ln9/I;

    if-eqz p2, :cond_0

    invoke-virtual {p2, p0, v2}, Ln9/I;->s(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-virtual {p2, p1, v0}, Ln9/I;->s(Ljava/lang/Object;Ljava/lang/String;)V

    :cond_0
    const-string p2, "saveLocationDataToUserConfig->locationLatlng->"

    const-string v0, ", locationAddress->"

    invoke-static {p2, p0, v0, p1}, LA/N;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, v2}, Ln9/I;->s(Ljava/lang/Object;Ljava/lang/String;)V
