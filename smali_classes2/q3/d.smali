...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lq3/d;->g:Lq3/b$b;

    new-instance v0, Lq3/d$b;

    const-string v1, "gps"

    invoke-direct {v0, p0, v1}, Lq3/d$b;-><init>(Lq3/d;Ljava/lang/String;)V

    new-instance v1, Lq3/d$b;

    const-string v2, "network"

    invoke-direct {v1, p0, v2}, Lq3/d$b;-><init>(Lq3/d;Ljava/lang/String;)V

    filled-new-array {v0, v1}, [Lq3/d$b;

    move-result-object v0

    iput-object v0, p0, Lq3/d;->j:[Lq3/d$b;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lq3/d;->k:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput-object v0, p0, Lq3/d;->f:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Lq3/d;->f:Landroid/os/HandlerThread;
    ...
    invoke-direct {v1, p0, v0}, Lq3/d$a;-><init>(Lq3/d;Landroid/os/Looper;)V

    iput-object v1, p0, Lq3/d;->a:Lq3/d$a;

    return-void
.end method

.method public static h(Lq3/d;)V
    .locals 4

    const-string v0, "NormalLocationManager"

    iget-object v1, p0, Lq3/d;->j:[Lq3/d$b;

    iget-object p0, p0, Lq3/d;->b:Landroid/location/LocationManager;
    ...
    iput-boolean v2, p0, Lq3/d$b;->b:Z
...
.method public final a(Landroid/location/Location;)Lq3/b$b;
    ...
    invoke-virtual/range {v0 .. v6}, Lq3/d;->i(JDD)V
    ...
    iget-wide v12, v7, Lq3/d;->i:J

    iget-wide v14, v7, Lq3/d;->h:J
    ...
    iget-object v0, v7, Lq3/d;->g:Lq3/b$b;
...
.method public final b()Landroid/location/Location;
    ...
    :goto_0
    iget-object v2, p0, Lq3/d;->j:[Lq3/d$b;
    ...
    iget-boolean v5, v3, Lq3/d$b;->b:Z

    if-eqz v5, :cond_0

    iget-object v3, v3, Lq3/d$b;->a:Landroid/location/Location;
    ...
    invoke-static {v1, p0, v0}, LMf/f;->g(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p0

    aget-object v0, v2, v1

    iget-object v0, v0, Lq3/d$b;->c:Ljava/lang/String;
    ...
    invoke-static {v3}, Lq3/d;->l(Landroid/location/Location;)V
    ...
    :cond_2
    iget-object v1, p0, Lq3/d;->d:Landroid/location/Location;
    ...
    iget-object p0, p0, Lq3/d;->d:Landroid/location/Location;

    invoke-static {p0}, Lq3/d;->l(Landroid/location/Location;)V
...
.method public final c()Landroid/location/Location;
    ...
    :cond_0
    invoke-virtual {p0}, Lq3/d;->b()Landroid/location/Location;
...
.method public final d(Lq3/b$a;)V
    ...
    iget-object p0, p0, Lq3/d;->k:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-direct {v1, p1, v2}, LKa/j;-><init>(Ljava/lang/Object;I)V
...
.method public final e()Landroid/location/Location;
    ...
    :cond_0
    iget-object p0, p0, Lq3/d;->e:Landroid/location/Location;
...
.method public final f(Z)V
    ...
    invoke-direct {v0, p0, p1, v1}, Lcom/android/camera/fragment/B;-><init>(Ljava/lang/Object;ZI)V

    iget-object p0, p0, Lq3/d;->a:Lq3/d$a;
...
.method public final g(Lq3/b$a;)V
    ...
    invoke-direct {v0, p1, v1}, LF1/d;-><init>(Ljava/lang/Object;I)V
...
.method public final i(JDD)V
    ...
    invoke-static/range {v5 .. v10}, LK2/j;->a(DDD)D
    ...
    invoke-static/range {v13 .. v18}, LK2/j;->a(DDD)D
    ...
    iput-wide v7, v0, Lq3/d;->h:J

    iput-wide v7, v0, Lq3/d;->i:J
...
.method public final k()V
    ...
    iget-object v0, v1, Lq3/d;->f:Landroid/os/HandlerThread;

    iget-object v3, v1, Lq3/d;->j:[Lq3/d$b;

    iget-object v4, v1, Lq3/d;->b:Landroid/location/LocationManager;
    ...
    iput-object v4, v1, Lq3/d;->b:Landroid/location/LocationManager;

    :cond_0
    iget-object v5, v1, Lq3/d;->b:Landroid/location/LocationManager;
    ...
    iget-object v13, v1, Lq3/d;->b:Landroid/location/LocationManager;
    ...
    iget-object v0, v1, Lq3/d;->a:Lq3/d$a;
    ...
    :cond_2
    iget-object v0, v1, Lq3/d;->e:Landroid/location/Location;

    iget-object v4, v1, Lq3/d;->d:Landroid/location/Location;

    invoke-static {v0, v4}, Lq3/d;->j(Landroid/location/Location;Landroid/location/Location;)Landroid/location/Location;
    ...
    :cond_3
    iget-object v0, v1, Lq3/d;->b:Landroid/location/LocationManager;
    ...
    iput-object v0, v1, Lq3/d;->b:Landroid/location/LocationManager;
    ...
    iget-object v6, v1, Lq3/d;->b:Landroid/location/LocationManager;
    ...
    invoke-static {v0, v6}, Lq3/d;->j(Landroid/location/Location;Landroid/location/Location;)Landroid/location/Location;

    move-result-object v0

    iput-object v0, v1, Lq3/d;->e:Landroid/location/Location;

    iget-object v6, v1, Lq3/d;->d:Landroid/location/Location;

    invoke-static {v6, v0}, Lq3/d;->j(Landroid/location/Location;Landroid/location/Location;)Landroid/location/Location;
    ...
    iget-object v0, v1, Lq3/d;->d:Landroid/location/Location;
    ...
    iput-object v0, v1, Lq3/d;->d:Landroid/location/Location;

    goto :goto_4

    :cond_5
    iput-object v3, v1, Lq3/d;->d:Landroid/location/Location;
