...
.field public final s:LP5/g;

.field public t:LO5/d;
...
# direct methods
.method public constructor <init>(Lcom/android/camera/module/K;ZLjava/util/List;LP5/g;)V
    .locals 17
    ...
    iput-object v0, v1, LO5/k;->j:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v13}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, v1, LO5/k;->k:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v13}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, v1, LO5/k;->l:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v13}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, v1, LO5/k;->m:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, v1, LO5/k;->o:Landroid/graphics/Rect;

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, v1, LO5/k;->p:F

    new-instance v14, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v14, v13}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v14, v1, LO5/k;->w:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v14, v1, LO5/k;->r:Ljava/lang/ref/WeakReference;

    move-object/from16 v14, p4

    iput-object v14, v1, LO5/k;->s:LP5/g;
    ...
    iput-object v15, v1, LO5/k;->q:Lcom/android/camera/ui/GLTextureView;

    new-instance v5, LO5/h;

    invoke-direct {v5, v1}, LO5/h;-><init>(LO5/k;)V
    ...
    iput-object v5, v1, LO5/k;->u:Landroid/os/Handler;
    ...
    invoke-static {v5}, Lcom/android/camera/data/data/j;->s(I)Ljava/lang/String;
    ...
    :goto_4
    invoke-static {v15, v2}, LO5/k;->b(FLjava/util/List;)Landroid/util/Size;

    move-result-object v0

    iput-object v0, v1, LO5/k;->f:Landroid/util/Size;

    invoke-static {v9, v2}, LO5/k;->b(FLjava/util/List;)Landroid/util/Size;
    ...
    invoke-static {v0, v2}, LO5/k;->b(FLjava/util/List;)Landroid/util/Size;
    ...
    invoke-static {v7, v2}, LO5/k;->b(FLjava/util/List;)Landroid/util/Size;
    ...
    invoke-static/range {p4 .. p4}, LP5/h;->v3(LP5/g;)Z
    ...
    iput-object v7, v1, LO5/k;->f:Landroid/util/Size;
    ...
    invoke-static {v0}, Ls0/f;->A(F)I

    move-result v0

    invoke-direct {v2, v7, v0}, Landroid/util/Size;-><init>(II)V

    iput-object v2, v1, LO5/k;->g:Landroid/util/Size;

    :cond_c
    iget-object v0, v1, LO5/k;->f:Landroid/util/Size;

    if-eqz v0, :cond_d

    iget-object v0, v1, LO5/k;->g:Landroid/util/Size;
    ...
    iput-object v3, v1, LO5/k;->f:Landroid/util/Size;

    new-instance v3, Landroid/util/Size;

    invoke-direct {v3, v2, v0}, Landroid/util/Size;-><init>(II)V

    iput-object v3, v1, LO5/k;->g:Landroid/util/Size;
    ...
    iput-object v0, v1, LO5/k;->g:Landroid/util/Size;

    :cond_12
    :goto_9
    new-instance v0, LO5/c;

    iget-object v2, v1, LO5/k;->q:Lcom/android/camera/ui/GLTextureView;

    iget-object v3, v1, LO5/k;->g:Landroid/util/Size;

    move/from16 v4, p2

    invoke-direct {v0, v2, v3, v4}, LO5/c;-><init>(Landroid/view/View;Landroid/util/Size;Z)V

    iput-object v0, v1, LO5/k;->v:LO5/c;

    sget v0, LBa/b;->ic_zoom_map_eis_cv:I

    iput v0, v1, LO5/k;->h:I
    ...
    :goto_a
    iput v0, v1, LO5/k;->i:I

    invoke-virtual/range {p0 .. p0}, LO5/k;->c()V
...
.method public final a()Landroid/view/Surface;
    ...
    iget-object v1, p0, LO5/k;->f:Landroid/util/Size;
    ...
    iput-object v0, p0, LO5/k;->a:Landroid/graphics/SurfaceTexture;

    iget-object v2, p0, LO5/k;->f:Landroid/util/Size;

    invoke-virtual {v2}, Landroid/util/Size;->getWidth()I

    move-result v2

    iget-object v3, p0, LO5/k;->f:Landroid/util/Size;
    ...
    iget-object v2, p0, LO5/k;->a:Landroid/graphics/SurfaceTexture;

    invoke-direct {v0, v2}, Landroid/view/Surface;-><init>(Landroid/graphics/SurfaceTexture;)V

    iput-object v0, p0, LO5/k;->e:Landroid/view/Surface;

    iget-object v0, p0, LO5/k;->a:Landroid/graphics/SurfaceTexture;

    new-instance v2, LO5/g;

    invoke-direct {v2, p0}, LO5/g;-><init>(LO5/k;)V
    ...
    iget-object v2, p0, LO5/k;->q:Lcom/android/camera/ui/GLTextureView;
    ...
    :cond_0
    iget-object p0, p0, LO5/k;->e:Landroid/view/Surface;
...
.method public final c()V
    ...
    iget-object v1, p0, LO5/k;->v:LO5/c;
    ...
    :cond_0
    invoke-virtual {v1}, LO5/c;->c()V

    invoke-virtual {v1}, LO5/c;->a()V
    ...
    invoke-virtual {v1}, LO5/c;->b()Landroid/graphics/Rect;

    move-result-object v0

    iget-object v1, p0, LO5/k;->q:Lcom/android/camera/ui/GLTextureView;
    ...
    invoke-direct {v2, v3, p0, v0}, LO5/e;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    invoke-virtual {v1, v2}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    invoke-virtual {p0}, LO5/k;->f()V
...
.method public final d()V
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, LO5/k;->u:Landroid/os/Handler;
...
.method public final e(F)V
    ...
    invoke-virtual {v0}, L炤炨炪烩炪炮烩炣炢炱炮炤炢烩炤炨炪炪炨炩烩炄炨炪炪炨炩;->o1()F
    ...
    iget-object p1, p0, LO5/k;->v:LO5/c;

    if-eqz p1, :cond_0

    iget-object p0, p0, LO5/k;->w:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput v1, p1, LO5/c;->a:I

    iput v1, p1, LO5/c;->d:I

    iget-object p0, p1, LO5/c;->i:Landroid/view/View;
...
.method public final g(LD3/a;Z)V
    ...
    iget-object v1, p0, LO5/k;->m:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object p2, p0, LO5/k;->g:Landroid/util/Size;
    ...
    :cond_3
    :goto_0
    iget-object p1, p0, LO5/k;->w:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_4
    iget-object p1, p0, LO5/k;->k:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_5
    iget-object p1, p0, LO5/k;->o:Landroid/graphics/Rect;
    ...
    :goto_1
    iget-object p2, p0, LO5/k;->j:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object p2, p0, LO5/k;->u:Landroid/os/Handler;

    new-instance v4, LO5/f;

    const/4 v5, 0x0

    invoke-direct {v4, p0, p1, v5}, LO5/f;-><init>(Ljava/lang/Object;ZI)V
    ...
    iget-object p1, p0, LO5/k;->q:Lcom/android/camera/ui/GLTextureView;
    ...
    iget-object p1, p0, LO5/k;->u:Landroid/os/Handler;
    ...
    :cond_8
    :goto_2
    iget-object p1, p0, LO5/k;->n:LO5/l;

    if-eqz p1, :cond_9

    iget-object p0, p0, LO5/k;->o:Landroid/graphics/Rect;

    iput-object p0, p1, LO5/l;->f:Landroid/graphics/Rect;
