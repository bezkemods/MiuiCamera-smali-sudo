...
.method public final run()V
    ...
    iget-boolean v2, p0, LO5/f;->b:Z

    iget-object v3, p0, LO5/f;->c:Ljava/lang/Object;

    const/4 v4, 0x0

    const/4 v5, 0x2

    iget p0, p0, LO5/f;->a:I

    packed-switch p0, :pswitch_data_0

    check-cast v3, Lcom/google/firebase/installations/FirebaseInstallations;

    invoke-static {v3, v2}, Lcom/google/firebase/installations/FirebaseInstallations;->c(Lcom/google/firebase/installations/FirebaseInstallations;Z)V
    ...
    iget-object p0, v3, LO5/k;->v:LO5/c;

    invoke-virtual {p0}, LO5/c;->b()Landroid/graphics/Rect;
    ...
    sget v8, LBa/c;->camera_app_root:I
    ...
    :cond_1
    sget v8, LBa/c;->zoom_map_content:I
    ...
    iput-object v12, v2, LIb/i;->a:Ljava/lang/String;
    ...
    iput-object v13, v12, LIb/g;->a:Ljava/util/LinkedHashMap;

    new-instance v13, Ljava/util/LinkedHashMap;

    invoke-direct {v13}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v13, v12, LIb/g;->b:Ljava/util/LinkedHashMap;

    new-instance v13, Ljava/util/LinkedHashMap;

    invoke-direct {v13}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v13, v12, LIb/g;->e:Ljava/util/LinkedHashMap;

    iput-object v12, v2, LIb/i;->b:LIb/g;

    const-string v12, "attr_operate_state"

    const-string v13, "value_zoom_map_show_window"

    invoke-virtual {v2, v13, v12}, LIb/i;->c(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-virtual {v2}, LIb/i;->d()V

    iget-object v2, v3, LO5/k;->q:Lcom/android/camera/ui/GLTextureView;
    ...
    iget-object v2, v3, LO5/k;->x:Landroid/animation/AnimatorSet;

    if-eqz v2, :cond_5

    invoke-virtual {v2}, Landroid/animation/AnimatorSet;->end()V

    iput-object v11, v3, LO5/k;->x:Landroid/animation/AnimatorSet;
    ...
    iget-object v7, v3, LO5/k;->q:Lcom/android/camera/ui/GLTextureView;
    ...
    invoke-direct {p0, v3}, LO5/i;-><init>(LO5/k;)V
    ...
    iput-object v7, v3, LO5/k;->x:Landroid/animation/AnimatorSet;
    ...
    invoke-direct {p0, v3, v4}, LO5/j;-><init>(Ljava/lang/Object;I)V
