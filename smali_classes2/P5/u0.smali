...
.field public O:LP9/o;


# direct methods
.method public constructor <init>(LP5/Z;Landroid/hardware/camera2/CaptureResult;Lv9/a;)V
    .locals 0

    invoke-direct {p0, p1, p3}, LP5/o0;-><init>(LP5/Z;Lv9/a;)V

    const/16 p3, 0xb

    iput p3, p0, LP5/u0;->I:I

    const/4 p3, -0x1

    iput p3, p0, LP5/u0;->N:I

    iput-object p2, p0, LP5/o0;->w:Landroid/hardware/camera2/CaptureResult;

    iget-object p1, p1, LP5/Z;->m0:LP5/a1;

    iput-object p1, p0, LP5/u0;->B:LP5/a1;
...
.method public final k()V
    ...
    iget-boolean v1, p0, LP5/u0;->H:Z

    if-nez v1, :cond_0

    invoke-virtual {p0}, LP5/u0;->x()V

    :cond_0
    iput-boolean v0, p0, LP5/o0;->y:Z

    iget-object v1, p0, LP5/u0;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;

    invoke-virtual {v1}, Lcom/xiaomi/camera/imagecodec/FeatureSetting;->getFrameCount()I

    move-result v1

    iput v1, p0, LP5/u0;->D:I
    ...
    :cond_1
    iget-object v3, v1, LP5/Z;->E:LP5/g;
    ...
    iget-boolean v6, p0, LP5/u0;->C:Z

    if-eqz v6, :cond_4

    const/16 v2, 0x9

    invoke-static {v0, v2, v3}, LP5/h;->A0(IILP5/g;)Z
...
.method public final m()V
    ...
    invoke-virtual {p0}, LP5/u0;->w()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v4

    iget-object v5, p0, LP5/u0;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
    ...
    :cond_2
    iget-object v5, v1, LP5/Z;->E:LP5/g;

    invoke-static {v5}, LP5/h;->i(LP5/g;)I

    move-result v5

    iget-object v7, v1, LP5/Z;->F:LP5/G;
    ...
    iget-object v9, p0, LP5/u0;->M:Landroid/util/Size;

    invoke-virtual {v9}, Landroid/util/Size;->getWidth()I

    move-result v9

    iget-object v10, p0, LP5/u0;->M:Landroid/util/Size;
    ...
    invoke-virtual {p0, v4, v8, v5}, LP5/o0;->r(Landroid/hardware/camera2/CaptureRequest;Lcom/xiaomi/engine/BufferFormat;I)Lcom/xiaomi/engine/PreProcessData;
    ...
    iget-object v5, p0, LP5/i0;->c:Landroid/os/Handler;
...
.method public final w()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-object v8, v2, LP5/g;->u4:Ljava/lang/Boolean;

    if-nez v8, :cond_2

    sget-object v8, Ld6/h;->b3:Ld6/J;

    invoke-virtual {v8}, Ld6/J;->b()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v2, v9}, LP5/g;->B0(Ljava/lang/String;)Z
    ...
    invoke-static {v9, v8, v4}, Ld6/K;->g(Landroid/hardware/camera2/CameraCharacteristics;Ld6/J;I)Ljava/lang/Object;
    ...
    iput-object v8, v2, LP5/g;->u4:Ljava/lang/Boolean;
    ...
    invoke-virtual {v8}, L炤炨炪烩炪炮烩炣炢炱炮炤炢烩炤炨炪炪炨炩烩炄炨炪炪炨炩;->R6()Z
    ...
    iget-object v8, p0, LP5/u0;->J:Landroid/view/Surface;

    invoke-virtual {v3, v7}, LP5/G0;->n(I)Landroid/view/Surface;
    ...
    invoke-static {v8, v9}, LA/w3;->i(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v13, p0, LP5/u0;->L:Landroid/util/Size;

    invoke-virtual {p0, v8, v13, v10, v9}, LP5/o0;->o(ILandroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v8

    iput-object v8, p0, LP5/o0;->A:Lcom/xiaomi/engine/BufferFormat;

    goto :goto_5

    :cond_8
    iget-object v8, p0, LP5/u0;->L:Landroid/util/Size;

    invoke-virtual {p0, v8, v10, v9}, LP5/o0;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {v3, v9}, LP5/G0;->n(I)Landroid/view/Surface;
    ...
    :cond_9
    iget-boolean v10, p0, LP5/i0;->m:Z
    ...
    iget-boolean v10, v10, LP5/H;->Z:Z
    ...
    invoke-static {v1, v12, v3}, LP5/K;->i(Landroid/hardware/camera2/CaptureRequest$Builder;ILP5/H;)V

    invoke-virtual {v0, v1, v12}, LP5/Z;->D1(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget v3, v3, LP5/H;->X2:I

    if-eq v3, v12, :cond_d

    if-eq v3, v11, :cond_c

    iget-boolean v9, p0, LP5/u0;->C:Z
    ...
    invoke-static {v3, v9, v10, v11}, LA/B2;->e(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v9, v2, LP5/g;->n4:Ljava/lang/Boolean;

    if-nez v9, :cond_11

    sget-object v9, Ld6/h;->Y2:Ld6/J;

    invoke-virtual {v9}, Ld6/J;->b()Ljava/lang/String;

    move-result-object v10

    invoke-virtual {v2, v10}, LP5/g;->B0(Ljava/lang/String;)Z

    move-result v10

    if-eqz v10, :cond_10

    iget-object v10, v2, LP5/g;->d:Landroid/hardware/camera2/CameraCharacteristics;

    invoke-static {v10, v9, v4}, Ld6/K;->g(Landroid/hardware/camera2/CameraCharacteristics;Ld6/J;I)Ljava/lang/Object;
    ...
    iput-object v4, v2, LP5/g;->n4:Ljava/lang/Boolean;
    ...
    :cond_11
    :goto_8
    iget-object v4, v2, LP5/g;->n4:Ljava/lang/Boolean;
    ...
    :cond_14
    iget-object v4, p0, LP5/u0;->B:LP5/a1;

    if-eqz v4, :cond_16

    iget-object v4, v4, LP5/a1;->g:LP5/a1$a;

    iget-boolean v4, v4, LP5/a1$a;->a:Z
    ...
    iget-object v4, p0, LP5/o0;->v:Landroid/graphics/Rect;

    invoke-static {v4, v3}, LCh/j;->g(Landroid/graphics/Rect;F)Landroid/graphics/Rect;

    move-result-object v3

    const-string v4, "sr set mtkCrop = "

    invoke-static {v3, v4}, LA/B2;->f(Landroid/graphics/Rect;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v3, p0, LP5/i0;->l:Ljava/lang/String;

    sget-object v3, Ld6/s;->q3:Ld6/J;
    ...
    invoke-static {v1, v3, v0}, Ld6/K;->d(Landroid/hardware/camera2/CaptureRequest$Builder;Ld6/J;Ljava/lang/Object;)V
    ...
    invoke-static {v1, v2, p0}, LP5/K;->m0(Landroid/hardware/camera2/CaptureRequest$Builder;LP5/g;Ljava/lang/String;)V
...
.method public final x()V
    ...
    :try_start_0
    iget-object v3, v1, LP5/Z;->D:LP5/G0;

    const/16 v4, 0xf

    invoke-virtual {v3, v4}, LP5/G0;->n(I)Landroid/view/Surface;

    move-result-object v3

    iput-object v3, v0, LP5/u0;->K:Landroid/view/Surface;
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0

    :catch_0
    iget-object v3, v0, LP5/u0;->K:Landroid/view/Surface;

    const/4 v4, 0x1

    if-nez v3, :cond_0

    iput-boolean v4, v0, LP5/u0;->H:Z
    ...
    invoke-static {v8, v7}, LA/w3;->i(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v9, v1, LP5/Z;->D:LP5/G0;

    invoke-virtual {v9, v7, v8}, LP5/G0;->k(IZ)Landroid/view/Surface;

    move-result-object v8

    iput-object v8, v0, LP5/u0;->J:Landroid/view/Surface;
    ...
    iget-object v8, v6, LP5/H;->M:Landroid/util/Size;

    goto :goto_3

    :cond_6
    iget-object v8, v6, LP5/H;->O:Landroid/util/Size;

    goto :goto_3

    :cond_7
    iget-object v8, v6, LP5/H;->N:Landroid/util/Size;
    ...
    :cond_9
    iget-object v8, v6, LP5/H;->L:Landroid/util/Size;
    ...
    invoke-static {v13, v8}, LA/w3;->j(Ljava/lang/String;Landroid/util/Size;)Ljava/lang/String;
    ...
    :goto_4
    iput-object v8, v0, LP5/u0;->M:Landroid/util/Size;

    iget-object v8, v0, LP5/u0;->J:Landroid/view/Surface;

    invoke-static {v8}, LXb/E;->d(Landroid/view/Surface;)Landroid/util/Size;

    move-result-object v8

    iput-object v8, v0, LP5/u0;->L:Landroid/util/Size;
    ...
    iget-object v12, v0, LP5/u0;->M:Landroid/util/Size;
    ...
    iget-object v12, v0, LP5/u0;->L:Landroid/util/Size;
    ...
    iget-object v8, v6, LP5/H;->j:Landroid/util/Size;
    ...
    iget-object v13, v0, LP5/u0;->L:Landroid/util/Size;
    ...
    :goto_6
    iget-object v14, v0, LP5/u0;->L:Landroid/util/Size;
    ...
    invoke-static {v14, v8}, LA/w3;->j(Ljava/lang/String;Landroid/util/Size;)Ljava/lang/String;
    ...
    iget v13, v6, LP5/H;->X2:I

    if-eq v13, v10, :cond_13

    if-eq v13, v9, :cond_12

    invoke-static {v12}, LP5/M;->m(Landroid/hardware/camera2/CaptureResult;)Ljava/lang/Integer;

    move-result-object v3

    iget v14, v6, LP5/H;->h0:I
    ...
    :cond_f
    iget-boolean v14, v6, LP5/H;->e3:Z
    ...
    :goto_7
    iput-boolean v14, v0, LP5/u0;->C:Z
    ...
    invoke-static {v13, v11, v14, v15, v4}, LA/l2;->b(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v12}, Lr9/a;->b(Landroid/hardware/camera2/CaptureResult;)Landroid/os/Parcelable;

    move-result-object v3

    iget-wide v14, v6, LP5/H;->s0:J

    const-string v4, "default exposureTime: "

    invoke-static {v14, v15, v4}, LV1/A;->c(JLjava/lang/String;)Ljava/lang/String;
    ...
    sget-object v9, Ld6/I;->r1:Ld6/J;

    const v10, 0xbabe

    invoke-static {v4, v9, v10}, Ld6/K;->j(Landroid/hardware/camera2/CaptureResult;Ld6/J;I)Ljava/lang/Object;
    ...
    :goto_a
    iget-object v13, v0, LP5/o0;->w:Landroid/hardware/camera2/CaptureResult;

    sget-object v2, Ld6/I;->q1:Ld6/J;

    invoke-static {v13, v2, v10}, Ld6/K;->j(Landroid/hardware/camera2/CaptureResult;Ld6/J;I)Ljava/lang/Object;
    ...
    invoke-static {v14, v15, v2}, LV1/A;->c(JLjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, v0, LP5/u0;->L:Landroid/util/Size;

    iget-object v4, v0, LP5/u0;->M:Landroid/util/Size;
    ...
    iput-object v1, v0, LP5/u0;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;

    const-string v1, "featureType "

    const-string v2, ", initFeatureSetting: "

    invoke-static {v11, v1, v2}, LMf/f;->g(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, v0, LP5/u0;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
...
.method public final y()Z
    ...
    invoke-static {v0}, LP5/M;->l(Landroid/hardware/camera2/CaptureResult;)Z
    ...
    :cond_1
    iget-object p0, p0, LP5/u0;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
