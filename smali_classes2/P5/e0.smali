...
# direct methods
.method public constructor <init>(LP5/Z;ZLandroid/view/Surface;LP5/a1;)V
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0, p4}, LP5/a0;-><init>(LP5/Z;Lv9/a;LP5/a1;)V

    iput-object p3, p0, LP5/e0;->Z:Landroid/view/Surface;

    iput-boolean p2, p0, LP5/e0;->b0:Z

    return-void
.end method

.method public static R(LP5/e0;ZI)V
    .locals 5
    ...
    invoke-virtual {v2, v1}, LP5/G;->i(Z)V
    ...
    invoke-interface {p2, p1, v2, v3, v1}, LP5/a$i;->onPictureTakenFinished(ZJI)V
    ...
    invoke-static {p2, v2, v4}, LA/W;->h(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final S()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-static {v1, v5, v2}, Ld6/K;->e(Landroid/hardware/camera2/CaptureRequest$Builder;Ld6/J;Ljava/lang/Object;)V

    iget-object v2, v0, LP5/Z;->D:LP5/G0;

    iget-object v5, v2, LP5/G0;->a:Landroid/media/ImageReader;
    ...
    iget-boolean v5, p0, LP5/e0;->b0:Z

    invoke-static {v5}, Ljava/lang/Byte;->valueOf(B)Ljava/lang/Byte;

    move-result-object v6

    invoke-static {v1, v2, v6}, Ld6/K;->e(Landroid/hardware/camera2/CaptureRequest$Builder;Ld6/J;Ljava/lang/Object;)V
    ...
    invoke-static {v2}, LP5/h;->C1(LP5/g;)Z
    ...
    :cond_1
    iget-object v6, p0, LP5/i0;->g:LP5/a$i;

    iget-object v7, p0, LP5/e0;->a0:Ljava/lang/String;
    ...
    instance-of v7, v6, Lv3/u$b;

    if-eqz v7, :cond_2

    check-cast v6, Lv3/u$b;

    invoke-virtual {v6}, Lv3/u$b;->a()Ljava/lang/String;
    ...
    iput-object v6, p0, LP5/e0;->a0:Ljava/lang/String;

    invoke-static {v6}, Lcom/xiaomi/camera/mivi/util/LogPrefixUtil;->getPrefix(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    iput-object v6, p0, LP5/a0;->R:Ljava/lang/String;

    iget-object v6, p0, LP5/e0;->a0:Ljava/lang/String;

    invoke-static {v1, v2, v6}, LP5/K;->m0(Landroid/hardware/camera2/CaptureRequest$Builder;LP5/g;Ljava/lang/String;)V
    ...
    invoke-static {v6, v7, v9}, LA/W;->h(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, p0, v3}, Ld6/K;->d(Landroid/hardware/camera2/CaptureRequest$Builder;Ld6/J;Ljava/lang/Object;)V

    invoke-static {v2}, LP5/h;->l2(LP5/g;)Z
    ...
    invoke-static {v0, v2, p0, v1}, LP5/K;->c0(ILP5/g;LP5/H;Landroid/hardware/camera2/CaptureRequest$Builder;)V
...
.method public final m()V
    ...
    :try_start_0
    new-instance v4, LP5/d0;

    invoke-direct {v4, p0}, LP5/d0;-><init>(LP5/e0;)V

    invoke-virtual {p0}, LP5/e0;->S()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v5

    iget-object v6, p0, LP5/e0;->Z:Landroid/view/Surface;
    ...
    :cond_0
    :goto_0
    iget-object v6, v2, LP5/Z;->v:Lx9/b;

    invoke-virtual {v6}, Lx9/b;->c()Ljava/lang/String;
    ...
    invoke-virtual {v1, v6}, LL3/l;->c(Ljava/lang/String;)J
    ...
    iget-object v5, p0, LP5/e0;->a0:Ljava/lang/String;
