...
.method public final J()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-object v5, v3, LP5/G0;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v6, v5}, LP5/H;->e(Landroid/util/Size;)V
    ...
    iget-boolean v5, v2, LP5/H;->R2:Z

    if-nez v5, :cond_1

    iget-object v2, v3, LP5/G0;->w:Landroid/media/ImageReader;
    ...
    :cond_1
    iget v2, v2, LP5/H;->S2:I

    if-ne v2, v4, :cond_2

    iget-object v2, v3, LP5/G0;->b:Landroid/media/ImageReader;
    ...
    :cond_2
    iget-object v2, v3, LP5/G0;->a:Landroid/media/ImageReader;
    ...
    :goto_1
    sget-object v6, Ld6/s;->A3:Ld6/J;

    invoke-static {v2}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v2

    invoke-static {v1, v6, v2}, Ld6/K;->e(Landroid/hardware/camera2/CaptureRequest$Builder;Ld6/J;Ljava/lang/Object;)V

    iget-object v2, v3, LP5/G0;->g:Landroid/media/ImageReader;
    ...
    iget v2, v0, LP5/Z;->I:I

    and-int/2addr v2, v4

    if-eqz v2, :cond_5

    iget-object v2, v3, LP5/G0;->l:Landroid/media/ImageReader;
    ...
    :cond_5
    iget-object v2, v3, LP5/G0;->e:Landroid/media/ImageReader;
    ...
    iget-object v2, p0, LP5/g;->z5:Ljava/lang/Boolean;

    if-nez v2, :cond_9

    sget-object v2, Ld6/h;->V3:Ld6/J;
    ...
    iget-object v8, p0, LP5/g;->d:Landroid/hardware/camera2/CameraCharacteristics;

    invoke-static {v8, v2, v6}, Ld6/K;->g(Landroid/hardware/camera2/CameraCharacteristics;Ld6/J;I)Ljava/lang/Object;
    ...
    iput-object v2, p0, LP5/g;->z5:Ljava/lang/Boolean;
    ...
    :cond_9
    :goto_4
    iget-object p0, p0, LP5/g;->z5:Ljava/lang/Boolean;
    ...
    invoke-static {p0}, LXb/E;->a(Landroid/view/Surface;)Ljava/lang/String;
    ...
    invoke-static {v1, p0, v2}, LP5/K;->i(Landroid/hardware/camera2/CaptureRequest$Builder;ILP5/H;)V
...
.method public final k()V
    ...
    iget-object v1, v0, LP5/H;->h:Landroid/util/Size;

    iput-object v1, p0, LP5/i0;->o:Landroid/util/Size;
...
.method public final m()V
    ...
    :try_start_0
    invoke-virtual {p0}, LP5/Q0;->J()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iput-object v4, p0, LP5/J0;->B:LP9/o;

    invoke-virtual {p0}, LP5/J0;->A()V

    iget-object v4, p0, LP5/i0;->b:LP5/Z;

    iget-object v4, v4, LP5/Z;->E:LP5/g;

    invoke-static {v4}, LP5/h;->t2(LP5/g;)Z
    ...
    invoke-static {v3, v5, v4}, LP5/K;->m0(Landroid/hardware/camera2/CaptureRequest$Builder;LP5/g;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v5}, LL3/l;->c(Ljava/lang/String;)J
    ...
    invoke-virtual {v1, v5}, LL3/l;->m(Ljava/lang/String;)V

    iget-object v1, p0, LP5/J0;->G:Ljava/lang/String;

    iget-object v5, p0, LP5/J0;->P:LP5/J0$a;
    ...
    invoke-static {v0, v1}, LA/h3;->a(II)V
    :try_end_0
