...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LP5/G0;->i:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, LP5/G0;->j:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, LP5/G0;->k:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public static j(LP5/H;I)Landroid/util/Size;
    .locals 2
    ...
    iget-object p0, p0, LP5/H;->p:Landroid/util/Size;
    ...
    iget-object p0, p0, LP5/H;->q:Landroid/util/Size;
    ...
    iget-object p0, p0, LP5/H;->r:Landroid/util/Size;
    ...
    iget-object p0, p0, LP5/H;->u:Landroid/util/Size;
    ...
    iget-object p0, p0, LP5/H;->v:Landroid/util/Size;
...
.method public static l(I)I
    ...
    invoke-static {v2, p0}, LA/w3;->i(Ljava/lang/String;I)Ljava/lang/String;
...
.method public final a()V
    ...
    invoke-virtual {p0}, LP5/G0;->e()V

    iget-object v0, p0, LP5/G0;->f:Landroid/media/ImageReader;
    ...
    iput-object v1, p0, LP5/G0;->f:Landroid/media/ImageReader;

    :cond_0
    invoke-virtual {p0}, LP5/G0;->f()V

    iget-object v0, p0, LP5/G0;->o:Landroid/media/ImageReader;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, LP5/G0;->o:Landroid/media/ImageReader;

    :cond_1
    invoke-virtual {p0}, LP5/G0;->c()V

    invoke-virtual {p0}, LP5/G0;->g()V

    iget-object v0, p0, LP5/G0;->q:Landroid/media/ImageReader;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, LP5/G0;->q:Landroid/media/ImageReader;

    :cond_2
    iget-object v0, p0, LP5/G0;->g:Landroid/media/ImageReader;

    if-eqz v0, :cond_3

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, LP5/G0;->g:Landroid/media/ImageReader;

    :cond_3
    invoke-virtual {p0}, LP5/G0;->b()V

    invoke-virtual {p0}, LP5/G0;->d()V

    iget-object v0, p0, LP5/G0;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, p0, LP5/G0;->j:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :goto_2
    iget-object v1, p0, LP5/G0;->k:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final b()V
    ...
    iget-object v0, p0, LP5/G0;->d:Landroid/media/ImageReader;

    if-eqz v0, :cond_1

    iget-boolean v1, p0, LP5/G0;->x:Z
    ...
    invoke-static {v0}, LP5/G0;->s(Landroid/media/ImageReader;)V

    const/4 v0, 0x0

    iput-object v0, p0, LP5/G0;->d:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, LP5/G0;->d:Landroid/media/ImageReader;

    invoke-static {p0}, LP5/G0;->r(Landroid/media/ImageReader;)V
...
.method public final c()V
    ...
    iget-object v0, p0, LP5/G0;->p:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, LP5/G0;->p:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, LP5/G0;->p:Landroid/media/ImageReader;
...
.method public final d()V
    ...
    iget-object v0, p0, LP5/G0;->c:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, LP5/G0;->c:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, LP5/G0;->c:Landroid/media/ImageReader;
...
.method public final e()V
    ...
    iget-object v0, p0, LP5/G0;->a:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, LP5/G0;->a:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, LP5/G0;->a:Landroid/media/ImageReader;
...
.method public final f()V
    ...
    iget-object v0, p0, LP5/G0;->l:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, LP5/G0;->l:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, LP5/G0;->l:Landroid/media/ImageReader;
...
.method public final g()V
    ...
    iget-object v0, p0, LP5/G0;->e:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, LP5/G0;->e:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, LP5/G0;->e:Landroid/media/ImageReader;
...
.method public final h(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {p0, p1}, LP5/G0;->n(I)Landroid/view/Surface;
...
.method public final k(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {p0, v1}, LP5/G0;->n(I)Landroid/view/Surface;
    ...
    :cond_0
    invoke-virtual {p0, v3}, LP5/G0;->n(I)Landroid/view/Surface;
    ...
    :cond_1
    invoke-virtual {p0, p2}, LP5/G0;->n(I)Landroid/view/Surface;
    ...
    :cond_3
    invoke-virtual {p0, v2}, LP5/G0;->n(I)Landroid/view/Surface;
...
.method public final m()Landroid/util/SparseArray;
    ...
    iget-object p0, p0, LP5/G0;->v:Landroid/util/SparseArray;
...
.method public final n(I)Landroid/view/Surface;
    ...
    iget-object p0, p0, LY5/e;->e:Landroid/media/ImageReader;
...
.method public final u(Landroid/util/Size;LP5/Z$g;Landroid/os/Handler;)V
    .locals 5
    ...
    iput-object p1, p0, LP5/G0;->p:Landroid/media/ImageReader;
    ...
    :goto_0
    iget-object p1, p0, LP5/G0;->p:Landroid/media/ImageReader;
    ...
    invoke-static {p0}, LP5/G0;->t(Landroid/media/ImageReader;)V

    return-void
.end method

.method public final v(LP5/H;LP5/Z$a;Landroid/os/Handler;)V
    .locals 3

    invoke-virtual {p0}, LP5/G0;->e()V

    iget-object v0, p1, LP5/H;->i:Landroid/util/Size;
...
.method public final w(LP5/H;Landroid/media/ImageReader$OnImageAvailableListener;Landroid/os/Handler;)V
    .locals 4
    ...
    iput-object v0, p0, LP5/G0;->f:Landroid/media/ImageReader;

    :cond_0
    iget-object v0, p1, LP5/H;->h:Landroid/util/Size;
    ...
    iget v2, p1, LP5/H;->U:I

    iget p1, p1, LP5/H;->X:I

    invoke-static {v1, v0, v2, p1}, Landroid/media/ImageReader;->newInstance(IIII)Landroid/media/ImageReader;

    move-result-object p1

    iput-object p1, p0, LP5/G0;->f:Landroid/media/ImageReader;
