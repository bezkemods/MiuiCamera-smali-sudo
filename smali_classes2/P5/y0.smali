...
# direct methods
.method public constructor <init>(LP5/Z;Landroid/hardware/camera2/CaptureResult;ZLv9/d;Lv9/a;)V
    .locals 0
    .param p1    # LP5/Z;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {p0, p1, p5}, LP5/o0;-><init>(LP5/Z;Lv9/a;)V

    const/4 p1, -0x1

    iput p1, p0, LP5/y0;->G:I

    iput p1, p0, LP5/y0;->H:I

    iput-object p2, p0, LP5/o0;->w:Landroid/hardware/camera2/CaptureResult;

    iput-boolean p3, p0, LP5/y0;->C:Z
    ...
    iput-object p4, p0, LP5/y0;->D:Lv9/d;

    invoke-virtual {p4}, Lv9/d;->d()I
...
.method public final k()V
    ...
    iput-object v2, p0, LP5/i0;->o:Landroid/util/Size;

    iget-boolean v2, p0, LP5/y0;->C:Z
    ...
    iget-boolean v3, v2, LP5/H;->L0:Z

    const/16 v4, 0x8

    if-eqz v3, :cond_2

    iput v4, p0, LP5/y0;->B:I
    ...
    :cond_6
    iget-object v4, v1, LP5/Z;->F:LP5/G;

    iget-object v4, v4, LP5/G;->a:LP5/H;

    iget-boolean v4, v4, LP5/H;->r1:Z
    ...
    iget-boolean v1, v1, LP5/H;->q1:Z

    if-eqz v1, :cond_8

    iget-boolean v1, p0, LP5/y0;->C:Z
    ...
    iget-boolean v10, v4, LP5/H;->q1:Z
    ...
    invoke-static {v1, v8}, LA/O;->b(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    :cond_b
    iget-boolean v1, v4, LP5/H;->d1:Z

    if-eqz v1, :cond_c

    invoke-static {v6, v12, v2}, LP5/h;->A0(IILP5/g;)Z
    ...
    :cond_c
    invoke-static {v6, v11, v2}, LP5/h;->A0(IILP5/g;)Z
    ...
    :goto_2
    iput-boolean v8, p0, LP5/i0;->m:Z

    iput-boolean v8, p0, LP5/i0;->p:Z

    iget v1, p0, LP5/y0;->B:I

    invoke-virtual {p0, v1}, LP5/i0;->d(I)I
    ...
    iget-object v1, p0, LP5/o0;->w:Landroid/hardware/camera2/CaptureResult;

    invoke-virtual {v0, v1}, LP5/Z;->n2(Landroid/hardware/camera2/CaptureResult;)Z

    move-result v0

    iput-boolean v0, p0, LP5/y0;->F:Z
...
.method public final m()V
    ...
    :try_start_0
    new-instance v4, LP5/x0;

    invoke-direct {v4, p0}, LP5/x0;-><init>(LP5/y0;)V

    invoke-virtual {p0}, LP5/y0;->x()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v5

    invoke-virtual {p0, v5}, LP5/y0;->w(Landroid/hardware/camera2/CaptureRequest$Builder;)V

    iget-object v6, v1, LP5/Z;->E:LP5/g;

    invoke-static {v6}, LP5/h;->P2(LP5/g;)Z
    ...
    iget-object v7, p0, LP5/o0;->A:Lcom/xiaomi/engine/BufferFormat;
    ...
    :cond_2
    invoke-virtual {p0, v5, v7, v6}, LP5/o0;->r(Landroid/hardware/camera2/CaptureRequest;Lcom/xiaomi/engine/BufferFormat;I)Lcom/xiaomi/engine/PreProcessData;

    move-result-object v6

    if-eqz v6, :cond_3

    invoke-virtual {p0, v6}, LP5/o0;->u(Lcom/xiaomi/engine/PreProcessData;)V
    ...
    invoke-static {p0, v2}, LA/h3;->a(II)V
...
.method public final w(Landroid/hardware/camera2/CaptureRequest$Builder;)V
    ...
    :cond_0
    iget-object v0, v3, LP5/Z;->E:LP5/g;
    ...
    iget-object v6, p0, LP5/o0;->v:Landroid/graphics/Rect;

    if-eqz v0, :cond_1

    iget-object v0, v3, LP5/Z;->F:LP5/G;

    iget-object v0, v0, LP5/G;->a:LP5/H;

    iget v0, v0, LP5/H;->b0:F

    invoke-static {v6, v0}, LCh/j;->g(Landroid/graphics/Rect;F)Landroid/graphics/Rect;

    move-result-object v5

    const-string v0, "isZoomRatioSupported: uw set crop = "

    invoke-static {v5, v0}, LA/B2;->f(Landroid/graphics/Rect;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v2, v5, v1}, Ld6/K;->b(Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;Z)V
    ...
    invoke-static {v6, v0}, LA/B2;->f(Landroid/graphics/Rect;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v2, v6, v1}, Ld6/K;->b(Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;Z)V
    ...
    sget-object v3, Ld6/I;->l1:Ld6/J;

    const v5, 0xbabe

    invoke-static {v0, v3, v5}, Ld6/K;->j(Landroid/hardware/camera2/CaptureResult;Ld6/J;I)Ljava/lang/Object;
    ...
    invoke-static {v0, v3}, LA/B2;->f(Landroid/graphics/Rect;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, v3, LP5/Z;->E:LP5/g;

    invoke-static {p0, p1, v1}, LP5/K;->w0(LP5/g;Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
...
.method public final x()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-virtual {v1, v2, v5}, Lx9/b;->a(Lx9/c;LP5/Z0;)Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-virtual {v5, v2}, LP5/G0;->n(I)Landroid/view/Surface;
    ...
    :cond_1
    :goto_0
    invoke-virtual {v5, v8}, LP5/G0;->n(I)Landroid/view/Surface;
    ...
    invoke-virtual {p0, v9}, LP5/o0;->p(Landroid/util/Size;)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v10

    iput-object v10, p0, LP5/o0;->A:Lcom/xiaomi/engine/BufferFormat;
    ...
    :cond_3
    invoke-virtual {v5}, LP5/G0;->m()Landroid/util/SparseArray;
    ...
    invoke-virtual {v5, v10}, LP5/G0;->n(I)Landroid/view/Surface;
    ...
    invoke-virtual {v5, v6}, LP5/G0;->n(I)Landroid/view/Surface;
    ...
    invoke-static {v9}, LXb/E;->d(Landroid/view/Surface;)Landroid/util/Size;
    ...
    iput-object v2, p0, LP5/o0;->u:Landroid/util/Size;
    ...
    :cond_7
    iget-object v2, p0, LP5/o0;->u:Landroid/util/Size;

    invoke-virtual {p0, v2}, LP5/o0;->p(Landroid/util/Size;)Lcom/xiaomi/engine/BufferFormat;
    ...
    iput v2, p0, LP5/i0;->t:I

    iget-boolean v9, p0, LP5/y0;->F:Z
    ...
    invoke-virtual {v5, v2, v9}, LP5/G0;->h(IZ)Landroid/view/Surface;

    move-result-object v2

    invoke-virtual {v0}, LP5/Z;->d2()Landroid/util/Size;
    ...
    invoke-virtual {v5, v2, v9}, LP5/G0;->k(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v5, v4}, LP5/G0;->n(I)Landroid/view/Surface;
    ...
    :goto_5
    iget-boolean v11, p0, LP5/y0;->E:Z
    ...
    iget-object v10, p0, LP5/y0;->D:Lv9/d;

    invoke-virtual {v10}, Lv9/d;->d()I
    ...
    sget-object v11, Lv9/d;->b:Lv9/d;

    invoke-virtual {v11}, Lv9/d;->d()I
    ...
    invoke-virtual {p0, v9, v10, v2}, LP5/o0;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {v2}, LP5/H;->c()Z

    move-result v2

    invoke-virtual {v0, v2}, LP5/Z;->e2(Z)I

    move-result v2

    iput v2, p0, LP5/y0;->G:I
    ...
    invoke-virtual {v0, v2}, LP5/Z;->f2(Z)I

    move-result v2

    iput v2, p0, LP5/y0;->H:I
    ...
    invoke-virtual {v2}, Le0/q;->R()Z

    move-result v2

    if-nez v2, :cond_10

    iget-object v2, v5, LP5/G0;->n:Landroid/view/Surface;
    ...
    iget-object v5, v0, LP5/Z;->E:LP5/g;
    ...
    invoke-static {v5}, LP5/h;->G2(LP5/g;)Z
    ...
    invoke-static {v1, v6, v9}, Ld6/K;->d(Landroid/hardware/camera2/CaptureRequest$Builder;Ld6/J;Ljava/lang/Object;)V
    ...
    iget-byte v2, v2, LP5/H;->i3:B

    sget-object v6, Ld6/s;->M3:Ld6/J;

    invoke-static {v2}, Ljava/lang/Byte;->valueOf(B)Ljava/lang/Byte;

    move-result-object v2

    invoke-static {v1, v6, v2}, Ld6/K;->d(Landroid/hardware/camera2/CaptureRequest$Builder;Ld6/J;Ljava/lang/Object;)V
    ...
    iget-boolean v2, v2, LP5/H;->R0:Z

    if-eqz v2, :cond_17

    iget-object v2, p0, LP5/o0;->w:Landroid/hardware/camera2/CaptureResult;

    invoke-static {v2}, LP5/M;->m(Landroid/hardware/camera2/CaptureResult;)Ljava/lang/Integer;

    move-result-object v2

    const-string v6, "apply specshot mode capture request: "

    invoke-static {v6, v2}, LA/W;->e(Ljava/lang/String;Ljava/lang/Integer;)Ljava/lang/String;
    ...
    invoke-static {v1, v7, v2}, LP5/K;->i(Landroid/hardware/camera2/CaptureRequest$Builder;ILP5/H;)V

    iget-object v2, v0, LP5/Z;->F:LP5/G;

    iget-object v2, v2, LP5/G;->a:LP5/H;

    iget-boolean v6, v2, LP5/H;->e2:Z

    iget-boolean v2, v2, LP5/H;->c3:Z

    iget-object v7, v0, LP5/Z;->F:LP5/G;

    iget-object v7, v7, LP5/G;->a:LP5/H;

    iget-boolean v7, v7, LP5/H;->e3:Z

    invoke-virtual {v0}, LP5/Z;->x()I
    ...
    iget-boolean v10, v10, LP5/H;->L0:Z
    ...
    iget-boolean v6, v6, LP5/H;->l3:Z

    if-eqz v6, :cond_18

    const-string v6, "isHQQuickShot Do not apply hwmfnr. numOfHQQuickShots:"

    invoke-static {v6, v9}, LA/w3;->i(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {v5}, LP5/h;->t2(LP5/g;)Z
    ...
    invoke-static {v1, v5, p0}, LP5/K;->m0(Landroid/hardware/camera2/CaptureRequest$Builder;LP5/g;Ljava/lang/String;)V
    ...
    iget v2, v2, LP5/H;->Y2:I

    invoke-static {v2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v2

    invoke-static {v1, p0, v2}, Ld6/K;->d(Landroid/hardware/camera2/CaptureRequest$Builder;Ld6/J;Ljava/lang/Object;)V
    ...
    invoke-virtual {v5, p0}, LP5/g;->B0(Ljava/lang/String;)Z
