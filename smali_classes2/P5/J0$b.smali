...
.method public constructor <init>(LP5/J0;)V
    ...
    iput-object p1, p0, LP5/J0$b;->a:LP5/J0;
...
.method public final onDataReady(J)V
    ...
    iget-object v0, p0, LP5/J0$b;->a:LP5/J0;
    ...
    invoke-static {v0, p1, p2}, LP5/J0;->x(LP5/J0;J)V

    iget-object p1, p0, LP5/J0$b;->a:LP5/J0;
    ...
    iget-object p2, p2, LP5/Z;->V:Ljava/util/concurrent/ConcurrentLinkedDeque;

    iget-object v0, p1, LP5/J0;->B:LP9/o;

    iget-wide v0, v0, LP9/o;->e:J

    invoke-virtual {p1, p2, v0, v1}, LP5/J0;->H(Ljava/util/concurrent/ConcurrentLinkedDeque;J)V

    iget-object p1, p0, LP5/J0$b;->a:LP5/J0;

    iget-object p2, p1, LP5/i0;->b:LP5/Z;

    iget-object p2, p2, LP5/Z;->W:Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    iget-object v0, v0, LP5/Z;->W:Ljava/util/concurrent/ConcurrentLinkedDeque;
...
.method public final onImageReceived(LP9/o;[BLjava/lang/String;)V
    ...
    iput-wide v1, v0, LP5/J0;->I:J

    iget-object v0, p0, LP5/J0$b;->a:LP5/J0;

    iget-object v1, v0, LP5/i0;->a:Ljava/lang/String;

    iget-wide v2, v0, LP5/J0;->I:J
    ...
    iget-object v1, v1, LP5/i0;->r:Lv9/a;

    new-instance v2, LP5/K0;

    invoke-direct {v2, p0, p2, p3}, LP5/K0;-><init>(LP5/J0$b;[BLjava/lang/String;)V
    ...
    invoke-virtual {v1, v2, p2, v0}, Lv9/a;->a(Ljava/lang/Runnable;Ljava/lang/Runnable;Lio/reactivex/Scheduler;)V

    goto :goto_1

    :cond_2
    invoke-static {v0, p2, p3}, LP5/J0;->w(LP5/J0;[BLjava/lang/String;)V

    :goto_1
    iget-object p2, p0, LP5/J0$b;->a:LP5/J0;

    iget p3, p2, LP5/J0;->L:I

    const/4 v0, 0x1

    add-int/2addr p3, v0

    iput p3, p2, LP5/J0;->L:I
    ...
    :goto_2
    iget-object p1, p2, LP5/i0;->b:LP5/Z;

    iget-object p2, p1, LP5/Z;->D:LP5/G0;

    iget-object p2, p2, LP5/G0;->a:Landroid/media/ImageReader;
    ...
    iget-object p2, p2, LP5/G0;->e:Landroid/media/ImageReader;
    ...
    iget-object p2, p2, LP5/G0;->d:Landroid/media/ImageReader;
    ...
    iget-object p2, p2, LP5/G0;->p:Landroid/media/ImageReader;
    ...
    iget-object p2, p2, LP5/G0;->l:Landroid/media/ImageReader;
    ...
    :cond_8
    iget-object p1, p1, LP5/Z;->D:LP5/G0;

    iget-object p2, p1, LP5/G0;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_9
    iget-object p1, p1, LP5/G0;->j:Ljava/util/concurrent/ConcurrentHashMap;
