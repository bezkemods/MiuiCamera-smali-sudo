...
.method public constructor <init>(LP5/Z;ILandroid/view/Surface;)V
    .locals 1
    ...
    iput-boolean p1, p0, LP5/s0;->C:Z

    iput p2, p0, LP5/s0;->F:I

    sget-object p1, Lv9/d;->b:Lv9/d;

    iput-object p1, p0, LP5/s0;->H:Lv9/d;

    iput-object p3, p0, LP5/s0;->I:Landroid/view/Surface;

    return-void
.end method

.method public static w(LP5/s0;ZI)V
    .locals 5
...
.method public final m()V
    ...
    iget v0, p0, LP5/s0;->G:I

    iget v1, p0, LP5/s0;->F:I
    ...
    iget-object v3, v2, LP5/Z;->E:LP5/g;

    invoke-static {v3}, LP5/h;->r2(LP5/g;)Z
    ...
    invoke-virtual {v0, v4}, LL3/l;->c(Ljava/lang/String;)J
    ...
    invoke-virtual {v2}, LP5/Z;->j0()V

    :cond_2
    :try_start_0
    new-instance v0, LP5/r0;

    invoke-direct {v0, p0}, LP5/r0;-><init>(LP5/s0;)V

    invoke-virtual {p0}, LP5/s0;->x()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v4

    iget-object v5, p0, LP5/s0;->I:Landroid/view/Surface;
    ...
    iget-object v11, p0, LP5/i0;->c:Landroid/os/Handler;
    ...
    iget v10, p0, LP5/s0;->G:I

    add-int/2addr v10, v6

    iput v10, p0, LP5/s0;->G:I

    iput v9, p0, LP5/s0;->D:I

    if-ne v10, v1, :cond_5

    iput v9, p0, LP5/s0;->E:I
...
.method public final x()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    :cond_1
    invoke-virtual {v4}, LP5/G0;->m()Landroid/util/SparseArray;
    ...
    invoke-virtual {v4, v11}, LP5/G0;->n(I)Landroid/view/Surface;
    ...
    invoke-virtual {v4, v6}, LP5/G0;->n(I)Landroid/view/Surface;
    ...
    invoke-virtual {v4, v2, v10}, LP5/G0;->k(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {v4, v9}, LP5/G0;->n(I)Landroid/view/Surface;
    ...
    invoke-virtual {p0, v10, v5, v2}, LP5/o0;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-static {p0}, LP5/h;->r2(LP5/g;)Z
    ...
    iput-boolean v9, v2, LP5/H;->z1:Z

    :cond_9
    invoke-static {v7, p0, v2, v1}, LP5/K;->N(ILP5/g;LP5/H;Landroid/hardware/camera2/CaptureRequest$Builder;)V
    ...
    iget-object v6, p0, LP5/g;->f:Ljava/util/HashSet;

    invoke-virtual {v4, v1, v5, v6, v2}, Lcom/android/camera2/compat/MiCameraCompatBaseImpl;->applyBeautyParameter(Landroid/hardware/camera2/CaptureRequest$Builder;Ljava/util/Map;Ljava/util/HashSet;Lcom/android/camera/fragment/beauty/p;)V
    ...
    invoke-static {p0, v1, v9}, LP5/K;->w0(LP5/g;Landroid/hardware/camera2/CaptureRequest$Builder;Z)V

    invoke-static {p0, v1, v9}, LP5/K;->p0(LP5/g;Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
