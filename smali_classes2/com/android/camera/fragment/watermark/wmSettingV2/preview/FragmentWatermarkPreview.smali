...
.method public static synthetic Cb(Lcom/android/camera/fragment/watermark/wmSettingV2/preview/FragmentWatermarkPreview;Landroid/graphics/Bitmap;)V
    .locals 5
...
.method public static synthetic Db(Lcom/android/camera/fragment/watermark/wmSettingV2/preview/FragmentWatermarkPreview;)V
    .locals 3

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    :try_start_0
    invoke-virtual {p0}, Lcom/android/camera/fragment/watermark/wmSettingV2/preview/FragmentWatermarkPreview;->wc()V
    :try_end_0
    ...
    const-string v2, "updateWmPreview: error "
...
.method public static synthetic Fb(Lcom/android/camera/fragment/watermark/wmSettingV2/preview/FragmentWatermarkPreview;)V
    .locals 3
...
.method public static Zb(Lcom/android/camera/fragment/watermark/wmSettingV2/preview/FragmentWatermarkPreview;ZZ)V
    .locals 5

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const-string v0, "updateWmPreview\uff1aisBeautyShowing > "
    ...
    invoke-virtual {p1, p2}, LH2/g;->g(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v0, "updateWmPreview: error "
...
.method public static synthetic ac(Lcom/android/camera/fragment/watermark/wmSettingV2/preview/FragmentWatermarkPreview;IZ)V
    .locals 3
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/watermark/wmSettingV2/preview/FragmentWatermarkPreview;->sc(Z)V
...
.method public final Qa(Z)V
    ...
    const-string v1, "updateWatermarkVisibility: isNeedVisible->"
    ...
    invoke-direct {v1, v3}, LA/n1;-><init>(I)V
...
.method public final X3()V
    ...
    const-string v2, "updateWatermarkContent: "
...
.method public final Z6()V
    ...
    :cond_0
    invoke-virtual {p0, v1}, Lcom/android/camera/fragment/watermark/wmSettingV2/preview/FragmentWatermarkPreview;->sc(Z)V
...
.method public final jc()V
    ...
    invoke-virtual {v0, v1, p0}, LH2/g;->e(Ljava/lang/String;LF2/a;)V

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, LH2/g;->b(Z)Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/fragment/watermark/wmSettingV2/preview/FragmentWatermarkPreview;->sc(Z)V
...
.method public final notifyAfterFrameAvailable(I)V
    ...
    const-string v3, "startLocationAddressUpdate: start, hasPermission is "

    const-string v4, ", isWatermarkEnable is "
    ...
    iget-object v2, p1, LH2/g;->c:Lio/reactivex/disposables/Disposable;
    ...
    invoke-static {v4, v5, v2, v3}, Lio/reactivex/Observable;->timer(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Observable;
    ...
    invoke-static {v4, v5, v2, v6}, Lio/reactivex/Observable;->interval(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Observable;

    move-result-object v2

    invoke-virtual {v3, v2}, Lio/reactivex/Observable;->concatWith(Lio/reactivex/ObservableSource;)Lio/reactivex/Observable;

    move-result-object v2

    new-instance v3, LH2/a;

    invoke-direct {v3, p1, v1}, LH2/a;-><init>(LH2/g;Z)V
    ...
    invoke-direct {v2, p1, v0}, LH2/b;-><init>(Ljava/lang/Object;I)V
    ...
    iput-object v0, p1, LH2/g;->c:Lio/reactivex/disposables/Disposable;
...
.method public final sc(Z)V
    ...
    iget-object v2, p1, Lcom/xiaomi/cam/watermark/b;->f:Ln9/I;
    ...
    invoke-static {v5, v0}, LA/O;->b(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {v2, v4}, Lb3/e;->d(IZ)Ljava/lang/String;
    ...
    invoke-virtual {p1, v0, v2, v4}, Lcom/xiaomi/cam/watermark/b;->P(Landroid/content/Context;ILjava/lang/String;)V

    goto :goto_1

    :cond_4
    invoke-virtual {p1, v1}, Lcom/xiaomi/cam/watermark/b;->h(Z)V
    ...
    invoke-direct {v0, p0, p1}, LM2/d;-><init>(Lcom/android/camera/fragment/watermark/wmSettingV2/preview/FragmentWatermarkPreview;Lcom/xiaomi/cam/watermark/b;)V

    new-instance p1, LA3/x0;

    const/4 v1, 0x4

    invoke-direct {p1, p0, v1}, LA3/x0;-><init>(Ljava/lang/Object;I)V

    invoke-static {v0, p1}, Lb3/b;->a(Ljava/util/concurrent/Callable;Ljava/util/function/Consumer;)V
