...
.method public final onClick(Landroid/view/View;)V
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/recyclerview/SingleChoiceRecyclerView$SingleChoiceRecyclerViewAdapter;->c:LW2/c$b;

    if-eqz p0, :cond_f

    iget-object p0, p0, LW2/c$b;->a:LW2/c;
    ...
    iget-object v2, v0, LZ2/b;->c:Ljava/lang/Object;

    check-cast v2, Ljava/lang/String;

    iget-object v3, p0, LW2/c;->l:Ljava/util/ArrayList;
    ...
    iget-object v3, v0, LZ2/b;->b:Ljava/io/Serializable;
    ...
    invoke-virtual {p0, p1}, LW2/c;->g(I)V
    ...
    iget-object v3, p0, LW2/c;->f:Landroid/content/Context;
    ...
    invoke-static {v3, p0, v4}, LA/b4;->c(Landroid/content/Context;IZ)V
    ...
    invoke-direct {v0, p0, p1}, LW2/b;-><init>(Ljava/lang/Object;I)V

    sget-boolean p0, LW2/h;->a:Z
    ...
    :cond_8
    :goto_3
    invoke-virtual {v0, v1}, LW2/b;->a(Z)V
    ...
    invoke-direct {v2, v0, v4}, LW2/g;-><init>(Ljava/lang/Object;I)V

    new-instance v4, LI2/s;

    invoke-direct {v4, v0}, LI2/s;-><init>(LW2/b;)V
    ...
    invoke-direct {v0, v3, v5}, Lmiuix/appcompat/app/AlertDialog$a;-><init>(Landroid/content/Context;I)V

    invoke-virtual {v0, p1}, Lmiuix/appcompat/app/AlertDialog$a;->o(Ljava/lang/CharSequence;)V

    invoke-virtual {v0, p0}, Lmiuix/appcompat/app/AlertDialog$a;->I(Ljava/lang/CharSequence;)V

    invoke-virtual {v0, v1}, Lmiuix/appcompat/app/AlertDialog$a;->d(Z)V

    const p0, 0x7f141111

    invoke-virtual {v0, p0, v2}, Lmiuix/appcompat/app/AlertDialog$a;->B(ILandroid/content/DialogInterface$OnClickListener;)V

    const p0, 0x7f141110

    invoke-virtual {v0, p0, v4}, Lmiuix/appcompat/app/AlertDialog$a;->s(ILandroid/content/DialogInterface$OnClickListener;)V

    const/4 p0, 0x0

    invoke-virtual {v0, p0}, Lmiuix/appcompat/app/AlertDialog$a;->w(Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    iget-object p0, p0, LW2/c;->g:Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/menu/DialogFontMenuViewModel;
