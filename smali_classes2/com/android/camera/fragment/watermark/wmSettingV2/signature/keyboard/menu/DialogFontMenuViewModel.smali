...
.method public static final a(Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/menu/DialogFontMenuViewModel;Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/textstyle/MarketTextStyle;Ljava/lang/String;Ljava/lang/String;Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/menu/DialogFontMenuViewModel$a$a;)Ljava/lang/Object;
    ...
    invoke-static {p4}, LAe/b;->m(Laf/e;)Laf/e;

    move-result-object p4

    invoke-direct {p0, v0, p4}, LEg/k;-><init>(ILaf/e;)V

    invoke-virtual {p0}, LEg/k;->s()V

    new-instance p4, LW2/d;

    invoke-direct {p4, p1, p0}, LW2/d;-><init>(Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/textstyle/MarketTextStyle;LEg/k;)V
    ...
    iget-object p1, p1, LZ2/b;->c:Ljava/lang/Object;
    ...
    invoke-static {p3, p1, v1, v2}, LCg/p;->h0(Ljava/lang/CharSequence;[Ljava/lang/String;II)Ljava/util/List;

    move-result-object p1

    invoke-static {p1}, LXe/u;->c0(Ljava/util/List;)Ljava/lang/Object;
    ...
    invoke-static {p3, v2, p1}, LCg/m;->N(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p4, p2}, LW2/d;->a(Ljava/lang/String;)V
    ...
    invoke-interface {p1, p2}, LV2/a;->b(Ljava/lang/String;)Lz8/c;

    move-result-object p1

    new-instance v2, LV2/d;

    invoke-direct {v2, p3, v1}, LV2/d;-><init>(Ljava/lang/String;I)V

    iget-object p1, p1, Lz8/c;->a:Lio/reactivex/Observable;

    new-instance v3, LTc/e;

    invoke-direct {v3, v2, v0}, LTc/e;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v2, v0}, LV2/f;-><init>(LV2/e;)V

    new-instance v0, LV2/g;

    invoke-direct {v0, p4, p2, v1}, LV2/g;-><init>(Ljava/lang/Object;Ljava/io/Serializable;I)V

    new-instance v1, LV2/h;

    invoke-direct {v1, p3, p4, p2}, LV2/h;-><init>(Ljava/lang/String;LW2/d;Ljava/lang/String;)V

    new-instance p2, LFc/g;

    const/16 p3, 0x8

    invoke-direct {p2, v0, p3}, LFc/g;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p1, v2, p2, v1}, Lio/reactivex/Observable;->subscribe(Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Action;)Lio/reactivex/disposables/Disposable;
...
.method public final b(Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/textstyle/TextStyle;)V
    ...
    invoke-virtual {v4}, Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/textstyle/MarketTextStyle;->h()Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p0}, Landroidx/lifecycle/ViewModelKt;->getViewModelScope(Landroidx/lifecycle/ViewModel;)LEg/F;
    ...
    invoke-direct/range {v1 .. v7}, Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/menu/DialogFontMenuViewModel$a;-><init>(Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/textstyle/TextStyle;Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/menu/DialogFontMenuViewModel;Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/textstyle/MarketTextStyle;Ljava/lang/String;Ljava/lang/String;Laf/e;)V

    const/4 p0, 0x3

    const/4 p1, 0x0

    invoke-static {v0, p1, v8, p0}, LEg/f;->b(LEg/F;Laf/f;Llf/p;I)LEg/C0;
