...
.method public final Z6()V
    ...
    invoke-interface {v4}, Lq3/a;->b()Landroid/location/Location;

    move-result-object v4

    if-nez v4, :cond_2

    const-string v6, "updateLocationData->currentLocation is null!"
    ...
    const-string v4, "getNormalLocationAddress->location is null!"

    new-array v7, v0, [Ljava/lang/Object;

    invoke-static {v2, v4, v7}, Lcom/android/camera/log/Log;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    iget-object v4, v4, LH2/g;->a:Ljava/lang/String;
    ...
    const-string v4, "updateLocationData->latlng:$locationLatlng, address:$locationAddress"
    ...
    iget-object v7, v4, LF2/g;->f:Lcom/xiaomi/cam/watermark/b;
    ...
    iget-object v8, v8, Luc/v;->c:Lxc/a;

    iget-object v8, v8, Lxc/a;->k:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/WatermarkTopAdapter;->c:Landroid/content/Context;

    invoke-virtual {v7, v8, v6, v2}, Lcom/xiaomi/cam/watermark/b;->Q(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_3

    :cond_5
    invoke-virtual {v7, v0}, Lcom/xiaomi/cam/watermark/b;->h(Z)V

    :goto_3
    invoke-virtual {v7}, Lcom/xiaomi/cam/watermark/b;->y()Z

    move-result v8

    if-eqz v8, :cond_9

    iget-object v8, v7, Lcom/xiaomi/cam/watermark/b;->f:Ln9/I;
    ...
    invoke-direct {v9, v1, v7, v6, v2}, LF2/d;-><init>(ZLcom/xiaomi/cam/watermark/b;Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v8, v9}, Ljava/util/LinkedHashMap;->forEach(Ljava/util/function/BiConsumer;)V
    ...
    :cond_7
    invoke-static {v8, v0}, Lb3/e;->d(IZ)Ljava/lang/String;
    ...
    invoke-virtual {v7, v10, v8, v9}, Lcom/xiaomi/cam/watermark/b;->P(Landroid/content/Context;ILjava/lang/String;)V
    ...
    invoke-direct {v8, p0, v7}, LF2/e;-><init>(Lcom/android/camera/fragment/watermark/wmSettingV1/WatermarkTopAdapter;Lcom/xiaomi/cam/watermark/b;)V

    new-instance v7, LF2/f;

    const/4 v9, 0x0

    invoke-direct {v7, v9, p0, v4}, LF2/f;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    invoke-static {v8, v7}, Lb3/b;->a(Ljava/util/concurrent/Callable;Ljava/util/function/Consumer;)V
...
.method public final e()V
    ...
    invoke-virtual {v0, v1}, LH2/g;->g(Ljava/lang/String;)V
