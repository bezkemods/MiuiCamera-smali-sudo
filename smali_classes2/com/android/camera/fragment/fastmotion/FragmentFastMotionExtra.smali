...
.method public final Eg(Lcom/android/camera/data/data/c;ILcom/android/camera/fragment/fastmotion/FragmentFastMotion;)V
    .locals 0
...
.method public final onManuallyDataChanged(Lcom/android/camera/data/data/c;Ljava/lang/String;Ljava/lang/String;ZII)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/camera/fragment/fastmotion/FragmentFastMotionExtra;->Cf(Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v15, LA/r;

    invoke-direct {v15, v3}, LA/r;-><init>(I)V

    invoke-virtual {v8, v15}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    iget-object v3, v7, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->b:Landroid/view/View;

    invoke-virtual {v3, v13}, Landroid/view/View;->setVisibility(I)V

    iget-object v3, v7, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->m:Lcom/android/camera/fragment/fastmotion/FragmentFastMotion$a;
    ...
    invoke-virtual {v7}, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->yh()V

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    invoke-static {v8, v1, v4, v6}, LA/P;->f(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    iput-object v8, v7, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->a:Ljava/lang/String;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/fragment/fastmotion/FragmentFastMotionExtra;->Yf()Ljava/lang/String;

    move-result-object v7

    iget-object v8, v0, Lcom/android/camera/fragment/fastmotion/FragmentFastMotionExtra;->b:Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;
    ...
    invoke-direct {v9, v3}, LA/r;-><init>(I)V

    invoke-virtual {v15, v9}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    iget-object v3, v8, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->b:Landroid/view/View;

    invoke-virtual {v3, v13}, Landroid/view/View;->setVisibility(I)V

    iget-object v3, v8, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->m:Lcom/android/camera/fragment/fastmotion/FragmentFastMotion$a;

    invoke-virtual {v3, v14}, Landroid/os/Handler;->removeMessages(I)V

    invoke-virtual {v3, v14, v11, v12}, Landroid/os/Handler;->sendEmptyMessageDelayed(IJ)Z

    invoke-virtual {v8}, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->yh()V

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    invoke-static {v9, v1, v6, v7}, LA/P;->f(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v9

    iput-object v9, v8, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->a:Ljava/lang/String;

    if-eqz v4, :cond_7

    iget-object v1, v8, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->d:Lcom/android/camera/ui/FastmotionIndicatorView;

    invoke-virtual {v1, v13}, Landroid/view/View;->setVisibility(I)V

    iget-object v15, v8, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->d:Lcom/android/camera/ui/FastmotionIndicatorView;
    ...
    invoke-virtual/range {v15 .. v20}, Lcom/android/camera/ui/FastmotionIndicatorView;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZZ)V

    iget-object v1, v8, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->e:Landroid/widget/TextView;

    invoke-virtual {v1, v10}, Landroid/view/View;->setVisibility(I)V

    iget-object v1, v8, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->f:Landroid/widget/TextView;
    ...
    invoke-static {v1, v6}, Landroidx/concurrent/futures/a;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, v8, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->a:Ljava/lang/String;
    ...
    invoke-virtual {v1, v3}, Lb0/A0;->getComponentValue(I)Ljava/lang/String;
    ...
    invoke-virtual {v1, v3}, Lb0/A0;->reset(I)V
    ...
    iget-object v9, v0, Lcom/android/camera/fragment/fastmotion/FragmentFastMotionExtra;->c:Lcom/android/camera/ui/CombineSlideView;

    const/4 v15, 0x6

    invoke-virtual {v9, v15, v5}, Lcom/android/camera/ui/CombineSlideView;->h(IZ)V
    ...
    invoke-direct {v5, v3}, LA/r;-><init>(I)V

    invoke-virtual {v4, v5}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    iget-object v3, v0, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->b:Landroid/view/View;

    invoke-virtual {v3, v13}, Landroid/view/View;->setVisibility(I)V

    iget-object v3, v0, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->m:Lcom/android/camera/fragment/fastmotion/FragmentFastMotion$a;

    invoke-virtual {v3, v14}, Landroid/os/Handler;->removeMessages(I)V

    invoke-virtual {v3, v14, v11, v12}, Landroid/os/Handler;->sendEmptyMessageDelayed(IJ)Z

    invoke-virtual {v0}, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->yh()V

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    invoke-static {v4, v2, v1, v6}, LA/P;->f(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v2, v1}, Landroidx/concurrent/futures/a;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v4, v3}, LA/r;-><init>(I)V
    ...
    iput-object v3, v0, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->a:Ljava/lang/String;
    ...
    invoke-static {v1, v5}, Landroidx/concurrent/futures/a;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_e
    invoke-virtual {v0, v5}, Lcom/android/camera/fragment/fastmotion/FragmentFastMotionExtra;->Cf(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v7, v3}, LA/r;-><init>(I)V
    ...
    invoke-static {v6, v1, v2, v5}, LA/P;->f(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v15, v0, Lcom/android/camera/fragment/fastmotion/FragmentFastMotion;->d:Lcom/android/camera/ui/FastmotionIndicatorView;
...
.method public final updateView(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-interface {p2, v0, p1, v1, p0}, Lcom/android/camera2/compat/theme/common/MiThemeOperationSeekbarInterface;->getExtraHorizontalSeekbarAdapter(Landroid/content/Context;Lcom/android/camera/data/data/c;ILi2/h;)Lcom/android/camera/ui/J;
    ...
    invoke-interface {p2, p0}, Lcom/android/camera/ui/J;->mapValueToPosition(Ljava/lang/String;)F

    move-result p0

    new-array p1, v2, [Ls5/a;

    invoke-virtual {v0, p2, p0, p1}, Lcom/android/camera/ui/CombineSlideView;->b(Lcom/android/camera/ui/J;F[Ls5/a;)V
    ...
    invoke-interface {p2, v0, v1, v1}, Lcom/android/camera/ui/J;->initDataList(Ls5/d;Ljava/util/List;Ljava/lang/String;)V
    ...
    invoke-interface {p2, p1}, Lcom/android/camera/ui/J;->mapValueToPosition(Ljava/lang/String;)F
    ...
    invoke-direct {p0, v2}, LA/M;-><init>(I)V

    iput-object p0, v1, Ls5/a$a;->n:Ls5/a$b;
    ...
    invoke-virtual {v0, p2, p1, p0}, Lcom/android/camera/ui/CombineSlideView;->b(Lcom/android/camera/ui/J;F[Ls5/a;)V
