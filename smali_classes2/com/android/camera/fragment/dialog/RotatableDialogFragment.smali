...
# virtual methods
.method public final Ma(Landroidx/fragment/app/FragmentManager;)V
    .locals 0
    ...
    invoke-static {p1, p0}, LXb/u;->c(Landroidx/fragment/app/FragmentManager;Ljava/lang/String;)Z

    return-void
.end method

.method public final hb(IIIII)V
    .locals 2
...
.method public final onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    iput-object v1, v2, LXb/m;->a:Landroid/content/DialogInterface$OnClickListener;

    const/4 v1, 0x0

    iput-object v1, v2, LXb/m;->b:LV5/e;
    ...
    invoke-virtual {v6, v1}, Lmiuix/appcompat/app/AlertDialog$a;->H(I)V

    :cond_0
    if-eq v4, v3, :cond_1

    invoke-virtual {v6, v4}, Lmiuix/appcompat/app/AlertDialog$a;->n(I)V
    ...
    invoke-virtual {v6, v1}, Lmiuix/appcompat/app/AlertDialog$a;->K(Landroid/view/View;)V

    :cond_2
    if-eq v5, v3, :cond_3

    invoke-virtual {v6, v5, v2}, Lmiuix/appcompat/app/AlertDialog$a;->B(ILandroid/content/DialogInterface$OnClickListener;)V

    :cond_3
    if-eq v0, v3, :cond_4

    invoke-virtual {v6, v0, v2}, Lmiuix/appcompat/app/AlertDialog$a;->s(ILandroid/content/DialogInterface$OnClickListener;)V

    :cond_4
    const/4 v0, 0x1

    invoke-virtual {v6, v0}, Lmiuix/appcompat/app/AlertDialog$a;->d(Z)V

    invoke-virtual {v6, v2}, Lmiuix/appcompat/app/AlertDialog$a;->w(Landroid/content/DialogInterface$OnCancelListener;)V

    new-instance v0, LX1/j;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    invoke-virtual {v6, v0}, Lmiuix/appcompat/app/AlertDialog$a;->z(Landroid/content/DialogInterface$OnKeyListener;)V
    ...
    new-instance v3, LXb/l;

    invoke-direct {v3, v2}, LXb/l;-><init>(LXb/m;)V
    ...
    invoke-direct {v1, p0, v0, p1}, LX1/i;-><init>(Lcom/android/camera/fragment/dialog/RotatableDialogFragment;Lmiuix/appcompat/app/AlertDialog;I)V
