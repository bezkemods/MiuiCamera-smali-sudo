...
.field private mWideSelfEngine:LJ5/d;
...
.method public static synthetic C9(Lcom/android/camera/module/WideSelfieModule;)V
    .locals 0
...
.method public static bridge synthetic H9(Lcom/android/camera/module/WideSelfieModule;)[B
    .locals 0
...
.method public static synthetic K8(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    .locals 0
...
.method public static bridge synthetic K9(Lcom/android/camera/module/WideSelfieModule;)LJ5/d;
    .locals 0

    iget-object p0, p0, Lcom/android/camera/module/WideSelfieModule;->mWideSelfEngine:LJ5/d;
...
.method private checkData([BII)Z
    ...
    invoke-static {v1, p1, v2, p2, v3}, Landroidx/concurrent/futures/a;->h(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
...
.method public static bridge synthetic fa(Lcom/android/camera/module/WideSelfieModule;[B)V
    .locals 0
...
.method private initPreviewLayout()V
    ...
    invoke-virtual {v0, v1, p0}, LA/J2;->g(II)V
    ...
    invoke-interface {p0}, LV3/w1;->initPreviewLayout()V
...
.method private isStitching()Z
    ...
    iget-object p0, p0, LJ5/d;->f:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private static synthetic lambda$onPreviewUpdate$0(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-interface {v0, p0, p1, p2}, LV3/w1;->Bh(Landroid/graphics/Bitmap;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method private synthetic lambda$startSaveTask$3()V
    ...
    invoke-static {v1, v2, v0}, LA/b4;->b(Landroid/content/Context;ILjava/lang/String;)V
...
.method private static synthetic lambda$startSaveTask$4(LV3/e1;)V
    .locals 2
...
.method public static bridge synthetic na(Lcom/android/camera/module/WideSelfieModule;)V
    .locals 1
...
.method private onSaveFinish()V
    ...
    invoke-virtual {v1, v2}, LP5/G;->I(I)V
...
.method private setupCaptureParams()V
    ...
    invoke-virtual {v0, v2}, LP5/G;->I(I)V
    ...
    invoke-virtual {v0, v2}, LP5/G;->e0(F)V
    ...
    invoke-virtual {v0, v2}, LP5/a;->C0(I)V
    ...
    invoke-virtual {v3, v4}, LP5/G;->n(I)V
...
.method private startSaveTask([BIII)V
    ...
    iget-object v7, v0, Lcom/android/camera/module/BaseModule;->mCallback:Lcom/android/camera/module/K;
    ...
    invoke-direct {v5, v0}, LA/w1;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct/range {v6 .. v19}, Lcom/android/camera/module/WideSelfieModule$b;-><init>(Lcom/android/camera/module/K;Ljava/lang/String;[BIIIZIIILcom/android/camera/fragment/beauty/p;Ljava/lang/String;LA/w1;)V
...
.method private startWideSelfieShooting()V
    ...
    invoke-static {v3, v6, v5}, LAg/c;->u(III)I
    ...
    const-string v7, "startWideSelfieShooting mJpegRotation = "
    ...
    invoke-interface {v7, v0}, LV3/O0;->le(Lcom/android/camera/module/J;)V

    iget-object v8, v0, Lcom/android/camera/module/WideSelfieModule;->mWideSelfEngine:LJ5/d;

    iget v9, v0, Lcom/android/camera/module/WideSelfieModule;->mJpegRotation:I

    iput v9, v8, LJ5/d;->c:I
    ...
    iget v9, v8, LJ5/d;->g:I

    iget v10, v8, LJ5/d;->h:I

    const/16 v12, 0x802

    iget v13, v8, LJ5/d;->c:I
    ...
    :goto_3
    iput-boolean v10, v8, LJ5/d;->x:Z

    iget-object v10, v8, LJ5/d;->a:Landroid/content/Context;

    invoke-static {v10}, LJ5/b;->a(Landroid/content/Context;)LJ5/b;

    move-result-object v10

    iget v12, v8, LJ5/d;->c:I

    rem-int/lit16 v12, v12, 0xb4

    if-ne v12, v5, :cond_4

    iget v12, v8, LJ5/d;->h:I

    iget v13, v8, LJ5/d;->n:I

    mul-int/2addr v12, v13

    iget v10, v10, LJ5/b;->a:I

    div-int/2addr v12, v10

    iget v10, v8, LJ5/d;->m:I
    ...
    iget v14, v8, LJ5/d;->l:I

    iget v15, v8, LJ5/d;->m:I

    add-int/2addr v15, v13

    invoke-direct {v10, v1, v13, v14, v15}, Landroid/graphics/Rect;-><init>(IIII)V

    iput-object v10, v8, LJ5/d;->o:Landroid/graphics/Rect;

    goto :goto_4

    :cond_4
    iget v12, v8, LJ5/d;->g:I

    iget v13, v10, LJ5/b;->g:I

    add-int/lit8 v14, v13, -0x2

    mul-int/2addr v14, v12

    iget v10, v10, LJ5/b;->b:I

    div-int v12, v14, v10

    iget-boolean v10, v8, LJ5/d;->x:Z

    if-eqz v10, :cond_5

    iget v10, v8, LJ5/d;->l:I
    ...
    :cond_5
    iget v10, v8, LJ5/d;->n:I

    iget v13, v8, LJ5/d;->m:I
    ...
    iput-object v13, v8, LJ5/d;->o:Landroid/graphics/Rect;
    ...
    iget v5, v8, LJ5/d;->l:I

    goto :goto_5

    :cond_6
    iget v5, v8, LJ5/d;->m:I
    ...
    iget-object v4, v8, LJ5/d;->k:Landroid/util/SizeF;
    ...
    invoke-static {v12, v4, v14, v15, v2}, LA/l2;->b(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v2, v5, v4, v10, v12}, Landroidx/concurrent/futures/a;->h(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    iget-object v4, v8, LJ5/d;->y:LJ5/d$c;
    ...
    iget-object v2, v8, LJ5/d;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-interface {v2}, Ls3/j;->N0()Ljava/lang/Object;
    ...
    invoke-virtual {v4, v3}, LP5/G;->d(Z)V
    ...
    invoke-virtual {v4}, L炤炨炪烩炪炮烩炣炢炱炮炤炢烩炤炨炪炪炨炩烩炄炨炪炪炨炩;->G1()Z
    ...
    invoke-virtual {v4, v3}, LP5/G;->i(Z)V
    ...
    iput-object v4, v5, LP5/H;->a:Landroid/location/Location;
    ...
    invoke-virtual {v4, v3}, LP5/G;->I(I)V
    ...
    invoke-virtual {v3, v4}, LP5/G;->D(Z)V
    ...
    iget-boolean v4, v3, LP5/H;->o1:Z

    if-eqz v4, :cond_9

    iput-boolean v1, v3, LP5/H;->o1:Z
    ...
    invoke-virtual {v1, v3}, LP5/G;->W(I)V
    ...
    invoke-virtual {v1, v6, v3, v4}, LP5/a;->f(ILP5/a$i;Ll4/j;)V

    monitor-exit v2
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-interface {v7}, LV3/O0;->onStart()V
...
.method private stopWideSelfieShooting(ZZLjava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/android/camera/module/WideSelfieModule;->mWideSelfEngine:LJ5/d;
    ...
    iget-boolean v1, v0, LJ5/d;->t:Z

    const/4 v4, 0x1

    if-nez v1, :cond_1

    const-string p1, "stopCapture failed, can\'t stop"
    ...
    :cond_1
    iget-object v0, v0, LJ5/d;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    const-string p1, "stopCapture failed, error state"
    ...
    invoke-static {p1}, LJ5/a;->a(Landroid/content/Context;)LJ5/a;

    move-result-object p1

    iget-object p2, p1, LJ5/a;->a:Landroid/os/Vibrator;

    iget-object p1, p1, LJ5/a;->b:Landroid/os/VibrationEffect;
...
.method private updateHorizontalHintText(LV3/w1;I)V
    .locals 4
    ...
    invoke-interface {p1, v1}, LV3/w1;->od(I)V
...
.method private updatePictureAndPreviewSize()V
    ...
    invoke-virtual {v0}, L炤炨炪烩炪炮烩炣炢炱炮炤炢烩炤炨炪炪炨炩烩炄炨炪炪炨炩;->m1()I
    ...
    invoke-virtual {v1, v2, v3}, LP5/g;->c0(ILjava/lang/Class;)Ljava/util/List;
    ...
    invoke-static {v2, v3, v7}, Lcom/android/camera/data/data/h;->I(IILP5/g;)F
...
.method private updateThumbBackgroudLayout(LV3/w1;ZIILandroid/graphics/Point;)V
    .locals 6
    ...
    invoke-interface {p1, p0, v5, v5}, LV3/w1;->S5(IZZ)V
    ...
    invoke-interface {p1, p0, v5, v4}, LV3/w1;->S5(IZZ)V
    ...
    invoke-interface {p1, p0, v4, v5}, LV3/w1;->S5(IZZ)V
    ...
    invoke-interface {p1, p0, v4, v4}, LV3/w1;->S5(IZZ)V
...
.method private updateVerticalHintText(LV3/w1;I)V
    .locals 2
    ...
    invoke-static {v0}, LJ5/a;->a(Landroid/content/Context;)LJ5/a;

    move-result-object v0

    iget-object v1, v0, LJ5/a;->a:Landroid/os/Vibrator;

    iget-object v0, v0, LJ5/a;->b:Landroid/os/VibrationEffect;
    ...
    :cond_1
    invoke-interface {p1, p2}, LV3/w1;->od(I)V

    :cond_2
    return-void
.end method

.method public static synthetic v9(LV3/e1;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera/module/WideSelfieModule;->lambda$startSaveTask$4(LV3/e1;)V
...
.method public closeCamera()V
    ...
    invoke-virtual {v1, v4}, LP5/a;->l1(Z)V

    iget-object p0, p0, Lcom/android/camera/module/BaseModule;->mCameraManager:Ls3/j;

    invoke-interface {p0, v3}, Ls3/j;->R0(LP5/a;)V
...
.method public handleMessage(ILandroid/os/Message;)Z
    ...
    invoke-virtual {p1, p2, v0}, LA/J2;->g(II)V

    iget-object p1, p0, Lcom/android/camera/module/WideSelfieModule;->mWideSelfEngine:LJ5/d;
    ...
    :cond_2
    iput p2, p1, LJ5/d;->i:I

    iput v0, p1, LJ5/d;->j:I

    iput v1, p1, LJ5/d;->g:I

    iput p0, p1, LJ5/d;->h:I

    iget-object p0, p1, LJ5/d;->a:Landroid/content/Context;
    ...
    invoke-static {p0}, LJ5/d;->a(Landroid/hardware/camera2/CameraCharacteristics;)Landroid/util/SizeF;

    move-result-object p0

    iput-object p0, p1, LJ5/d;->k:Landroid/util/SizeF;
    :try_end_0
    ...
    invoke-direct {p2, v1}, LV1/v;-><init>(I)V
...
.method public onActive()V
    ...
    invoke-static {v0}, LJ5/b;->a(Landroid/content/Context;)LJ5/b;
    ...
    iget v0, v0, LJ5/b;->c:I

    invoke-static {}, Lcom/xiaomi/camera/basic/Global;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-static {v2}, LJ5/b;->a(Landroid/content/Context;)LJ5/b;

    move-result-object v2

    iget v2, v2, LJ5/b;->a:I
    ...
    invoke-direct {v0, v1, v2, p0}, LJ5/d;-><init>(Landroid/content/Context;ILcom/android/camera/module/WideSelfieModule;)V

    iput-object v0, p0, Lcom/android/camera/module/WideSelfieModule;->mWideSelfEngine:LJ5/d;
    ...
    iget-boolean v0, p0, LJ5/d;->u:Z

    if-nez v0, :cond_0

    iget-object v0, p0, LJ5/d;->A:LJ5/d$b;

    iget-object v1, p0, LJ5/d;->w:LJ5/c;

    iget-object v2, p0, LJ5/d;->q:Landroid/hardware/Sensor;

    const/16 v3, 0x2710

    iget-object v4, p0, LJ5/d;->p:Landroid/hardware/SensorManager;
...
.method public onInactive()V
    ...
    iget-boolean v2, v0, LJ5/d;->u:Z

    const/4 v3, 0x0

    if-eqz v2, :cond_0

    iget-object v2, v0, LJ5/d;->A:LJ5/d$b;

    iget-object v4, v0, LJ5/d;->p:Landroid/hardware/SensorManager;

    invoke-virtual {v4, v2}, Landroid/hardware/SensorManager;->unregisterListener(Landroid/hardware/SensorEventListener;)V

    iput-boolean v3, v0, LJ5/d;->u:Z
    ...
    iget-object v0, p0, LJ5/d;->z:LJ5/d$a;
    ...
    iget-object v0, p0, LJ5/d;->v:Landroid/os/HandlerThread;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Landroid/os/HandlerThread;->quit()Z

    iput-object v1, p0, LJ5/d;->v:Landroid/os/HandlerThread;
...
.method public onMove(ZIILandroid/graphics/Point;Landroid/graphics/Point;Z)V
    ...
    invoke-static {p0}, LJ5/a;->a(Landroid/content/Context;)LJ5/a;

    move-result-object p0

    iget-object p0, p0, LJ5/a;->a:Landroid/os/Vibrator;
    ...
    invoke-direct {p0, v6, p4}, Lcom/android/camera/module/WideSelfieModule;->updateVerticalHintText(LV3/w1;I)V
    ...
    invoke-static {p4}, LJ5/a;->a(Landroid/content/Context;)LJ5/a;

    move-result-object p4

    iget-object p4, p4, LJ5/a;->a:Landroid/os/Vibrator;
    ...
    invoke-interface {v6, p0}, LV3/w1;->od(I)V
    ...
    iget-object p6, p4, LJ5/a;->a:Landroid/os/Vibrator;

    iget-object p4, p4, LJ5/a;->b:Landroid/os/VibrationEffect;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/camera/module/WideSelfieModule;->updateThumbBackgroudLayout(LV3/w1;ZIILandroid/graphics/Point;)V

    iput p2, p0, Lcom/android/camera/module/WideSelfieModule;->mLastMoveDirection:I

    invoke-direct {p0, v6, p2}, Lcom/android/camera/module/WideSelfieModule;->updateHorizontalHintText(LV3/w1;I)V
    ...
    invoke-static {p2, p6}, LA/O;->b(Ljava/lang/String;Z)Ljava/lang/String;
...
.method public onOrientationChanged(III)V
    ...
    invoke-static {p2, v1, v2, p1, v3}, Landroidx/concurrent/futures/a;->h(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
...
.method public onPreviewUpdate(Z[BIILandroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-static {p3, p1}, LA/w3;->i(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, LXb/e;->h(ILandroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-direct {p2, p1, p5, p6, p3}, Lcom/android/camera/module/h0;-><init>(Ljava/lang/Object;Ljava/lang/Object;Landroid/os/Parcelable;I)V
...
.method public onRenderRequested()V
    ...
    invoke-interface {p0}, LV3/w1;->requestRender()V
