...
.method public final e(I)I
    ...
    invoke-static {p1, p0, v0, v1}, LA/B2;->e(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final i(Lcom/android/camera/litegallery/a;)V
    ...
    invoke-direct {p1, v0}, LHe/d;-><init>(I)V
...
.method public final j(Lcom/android/camera/litegallery/a;Z)V
    ...
    invoke-direct {v0, p1, p2, v1}, LA3/K;-><init>(Ljava/lang/Object;ZI)V
...
.method public final n(Lcom/android/camera/litegallery/a;Landroidx/fragment/app/FragmentActivity;)V
    ...
    sget v0, Lm3/x;->gallery_delete_dialog_title:I

    invoke-virtual {p2, v0}, Landroid/app/Activity;->getString(I)Ljava/lang/String;

    move-result-object v2

    sget v0, Lm3/x;->gallery_delete_dialog_msg:I

    invoke-virtual {p2, v0}, Landroid/app/Activity;->getString(I)Ljava/lang/String;

    move-result-object v3

    sget v0, Lm3/x;->gallery_delete_dialog_confirm:I
    ...
    invoke-direct {v5, v0, p0, p1}, LA/A1;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    sget p1, Lm3/x;->dialog_button_cancel:I
    ...
    invoke-direct {v9, p1}, LF1/j;-><init>(I)V
...
.method public onStart()V
    ...
    iput-object v6, p0, Lcom/android/camera/litegallery/GalleryContainerManager;->g:Landroid/os/HandlerThread;
    ...
    iput-object v6, p0, Lcom/android/camera/litegallery/GalleryContainerManager;->h:Landroid/os/Handler;
    ...
    invoke-static {v9, v6}, LA/w3;->i(Ljava/lang/String;I)Ljava/lang/String;
    ...
    new-instance v5, LA/i3;

    const-string v6, "LiteGalleryLoader"

    invoke-direct {v5, v6, v0}, LA/i3;-><init>(Ljava/lang/String;I)V

    invoke-static {v8, v5}, Ljava/util/concurrent/Executors;->newFixedThreadPool(ILjava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ExecutorService;

    move-result-object v5

    iput-object v5, p0, Lcom/android/camera/litegallery/GalleryContainerManager;->k:Ljava/util/concurrent/ExecutorService;

    sget-object v5, Lm3/k;->a:Ljava/lang/String;
    ...
    invoke-direct {v6, v8}, LHc/b;-><init>(I)V
    ...
    iput-object v6, v5, Lm3/n;->f:Ljava/util/LinkedList;

    new-instance v6, LA/i3;

    const-string v8, "GalleryThumbnailLoader"

    invoke-direct {v6, v8, v0}, LA/i3;-><init>(Ljava/lang/String;I)V

    invoke-static {v6}, Lio/reactivex/plugins/RxJavaPlugins;->createSingleScheduler(Ljava/util/concurrent/ThreadFactory;)Lio/reactivex/Scheduler;

    move-result-object v6

    iput-object v6, v5, Lm3/n;->c:Lio/reactivex/Scheduler;

    new-instance v6, Lcom/google/android/material/search/d;

    invoke-direct {v6, v5}, Lcom/google/android/material/search/d;-><init>(Ljava/lang/Object;)V

    sget-object v8, Lio/reactivex/BackpressureStrategy;->LATEST:Lio/reactivex/BackpressureStrategy;

    invoke-static {v6, v8}, Lio/reactivex/Flowable;->create(Lio/reactivex/FlowableOnSubscribe;Lio/reactivex/BackpressureStrategy;)Lio/reactivex/Flowable;

    move-result-object v6

    sget-object v8, Lcom/xiaomi/camera/rx/CameraSchedulers;->sMainThreadScheduler:Lio/reactivex/Scheduler;

    invoke-virtual {v6, v8}, Lio/reactivex/Flowable;->observeOn(Lio/reactivex/Scheduler;)Lio/reactivex/Flowable;

    move-result-object v6

    new-instance v9, LE2/e;

    const/4 v10, 0x6

    invoke-direct {v9, v5, v10}, LE2/e;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v6, v9}, Lio/reactivex/Flowable;->doOnNext(Lio/reactivex/functions/Consumer;)Lio/reactivex/Flowable;

    move-result-object v6

    invoke-virtual {v6}, Lio/reactivex/Flowable;->onBackpressureLatest()Lio/reactivex/Flowable;

    move-result-object v6

    iget-object v9, v5, Lm3/n;->c:Lio/reactivex/Scheduler;

    invoke-virtual {v6, v9, v4, v1}, Lio/reactivex/Flowable;->observeOn(Lio/reactivex/Scheduler;ZI)Lio/reactivex/Flowable;

    move-result-object v6

    new-instance v9, LA/A2;

    invoke-direct {v9, v5, v2}, LA/A2;-><init>(Ljava/lang/Object;I)V
    ...
    new-instance v9, LTc/f;

    invoke-direct {v9, v5, v3}, LTc/f;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v6, v9}, Lio/reactivex/Flowable;->doOnNext(Lio/reactivex/functions/Consumer;)Lio/reactivex/Flowable;

    move-result-object v6

    new-instance v9, LFc/g;

    invoke-direct {v9, v5, v0}, LFc/g;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v6, v9}, Lio/reactivex/Flowable;->subscribe(Lio/reactivex/functions/Consumer;)Lio/reactivex/disposables/Disposable;

    move-result-object v0

    iput-object v0, v5, Lm3/n;->b:Lio/reactivex/disposables/Disposable;

    new-instance v0, LFc/b;

    const/16 v6, 0x9

    invoke-direct {v0, v5, v6}, LFc/b;-><init>(Ljava/lang/Object;I)V

    sget-object v6, Lio/reactivex/BackpressureStrategy;->MISSING:Lio/reactivex/BackpressureStrategy;

    invoke-static {v0, v6}, Lio/reactivex/Flowable;->create(Lio/reactivex/FlowableOnSubscribe;Lio/reactivex/BackpressureStrategy;)Lio/reactivex/Flowable;
    ...
    iget-object v6, v5, Lm3/n;->c:Lio/reactivex/Scheduler;

    invoke-virtual {v0, v6}, Lio/reactivex/Flowable;->observeOn(Lio/reactivex/Scheduler;)Lio/reactivex/Flowable;

    move-result-object v0

    new-instance v6, LA3/Q;

    invoke-direct {v6, v5, v2}, LA3/Q;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v6, v5, v3}, LE2/q;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v3, v5, v2}, LA3/n2;-><init>(Ljava/lang/Object;I)V
    ...
    iput-object v0, v5, Lm3/n;->e:Lio/reactivex/disposables/Disposable;

    iput-object v5, p0, Lcom/android/camera/litegallery/GalleryContainerManager;->o:Lm3/n;
    ...
    invoke-direct {v5, v2, v3}, Lm3/p;-><init>(J)V

    invoke-static {v5, v0}, Ljava/util/concurrent/CompletableFuture;->supplyAsync(Ljava/util/function/Supplier;Ljava/util/concurrent/Executor;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-direct {v2, p0, v1}, Ll4/w;-><init>(Ljava/lang/Object;I)V
...
.method public onStop()V
    ...
    invoke-static {v0, v3, v2, v4}, LA/N;->j(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v0, p0, Lcom/android/camera/litegallery/GalleryContainerManager;->o:Lm3/n;

    if-eqz v0, :cond_9

    iget-object v1, v0, Lm3/n;->a:Lio/reactivex/FlowableEmitter;
    ...
    :cond_4
    iput-object v3, v0, Lm3/n;->a:Lio/reactivex/FlowableEmitter;

    iget-object v1, v0, Lm3/n;->b:Lio/reactivex/disposables/Disposable;
    ...
    :cond_5
    iput-object v3, v0, Lm3/n;->b:Lio/reactivex/disposables/Disposable;

    iget-object v1, v0, Lm3/n;->d:Lio/reactivex/FlowableEmitter;
    ...
    :cond_6
    iput-object v3, v0, Lm3/n;->d:Lio/reactivex/FlowableEmitter;

    iget-object v1, v0, Lm3/n;->e:Lio/reactivex/disposables/Disposable;
    ...
    :cond_7
    iput-object v3, v0, Lm3/n;->e:Lio/reactivex/disposables/Disposable;

    iget-object v1, v0, Lm3/n;->c:Lio/reactivex/Scheduler;
    ...
    :cond_8
    iput-object v3, v0, Lm3/n;->c:Lio/reactivex/Scheduler;

    iget-object v0, v0, Lm3/n;->f:Ljava/util/LinkedList;

    invoke-virtual {v0}, Ljava/util/LinkedList;->clear()V

    :cond_9
    iput-object v3, p0, Lcom/android/camera/litegallery/GalleryContainerManager;->o:Lm3/n;
