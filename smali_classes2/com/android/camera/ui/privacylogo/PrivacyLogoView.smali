...
.method private getPrivacyLogoResId()I
    ...
    invoke-static {p0}, LXb/I;->c(Landroid/content/Context;)Z
    ...
    :cond_0
    sget p0, LSb/d;->ic_privacy_logo:I

    return p0

    :cond_1
    :goto_0
    sget p0, LSb/d;->ic_privacy_logo_night:I
    ...
    :cond_3
    sget p0, LSb/d;->ic_privacy_logo_global:I

    return p0

    :cond_4
    :goto_1
    sget p0, LSb/d;->ic_privacy_logo_global_night:I
