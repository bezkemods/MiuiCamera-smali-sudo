...
.method private static initFilterComponent(ILjava/util/ArrayList;)V
    ...
    invoke-virtual {v1, p1, p0, v0}, Lf0/L;->k(Ljava/util/ArrayList;II)V

    const/4 p0, 0x0

    invoke-virtual {v1, v0, p0}, Lf0/L;->l(IZ)V
...
.method private static is75mmLensSupported()Z
    ...
    invoke-static {}, LP5/h;->h()Ljava/util/HashMap;
...
.method private static synthetic lambda$setWidgetCameraMasterFilter$0(ILjava/util/concurrent/atomic/AtomicBoolean;LV3/B;)V
    ...
    invoke-interface {p2, p0}, LV3/B;->J8(I)V
...
.method private static mutexByCclockWidget(I)V
    ...
    invoke-virtual {v0, p0}, Lb0/f0;->getPersistValue(I)Ljava/lang/String;
    ...
    invoke-virtual {v1, p0}, Lf0/T;->isSwitchOn(I)Z

    move-result v2

    if-eqz v2, :cond_3

    invoke-virtual {v1, p0}, Lf0/T;->h(I)V
    ...
    invoke-static {p0, v2}, Lcom/android/camera/data/data/v;->v0(IZ)V

    invoke-virtual {v0, p0}, Lcom/android/camera/data/data/c;->reset(I)V

    :cond_4
    invoke-static {p0, v2}, Lcom/android/camera/data/data/v;->u0(IZ)V
...
.method private static mutexByCvLensWidget(Ljava/lang/String;)V
    ...
    invoke-static {p0, v0}, Lcom/android/camera/data/data/j;->j0(IZ)V
...
.method private static mutexByMasterFilterWidget(I)V
    ...
    invoke-virtual {v0, p0}, Lf0/T;->h(I)V
    ...
    invoke-static {p0, v0}, Lcom/android/camera/data/data/v;->v0(IZ)V
    ...
    invoke-virtual {p0, v0}, Lb0/F;->p(I)Z
    ...
    invoke-virtual {p0, v0, v1}, Lb0/F;->setComponentValue(ILjava/lang/String;)V

    const/4 v1, 0x1

    invoke-virtual {p0, v0, v1}, Lb0/F;->t(IZ)V
...
.method public static setCameraWidget(Landroid/content/pm/PackageManager;Landroid/content/Context;)V
    ...
    instance-of v0, v0, L폵폹폻편폻폿편폲폳폠폿폵폳편폮폿폷폹폻폿편폕폹폻폻폹폸폐폺폿폦;
...
.method private static setWidgetCameraCcLock(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, v1}, Lb0/i;->l(Z)V
    ...
    invoke-virtual {v0, v1}, Lc0/c;->n(Z)V

    const/16 v0, 0xa2

    invoke-static {v0, v1}, Lcom/android/camera/data/data/j;->A0(IZ)V
...
.method private static setWidgetCameraCvType(Landroid/content/Intent;)V
    ...
    iput-boolean v1, v0, Lb0/w;->c:Z

    const/16 v1, 0xab

    const-string v2, "0"

    invoke-virtual {v0, v1, v2}, Lb0/w;->setComponentValue(ILjava/lang/String;)V
...
.method private static setWidgetCameraFilter(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-virtual {v3, v0}, Lcom/android/camera/effect/EffectController;->o(I)Ljava/util/ArrayList;

    move-result-object v3

    invoke-static {v3, p0}, Lcom/android/camera2/compat/theme/custom/cv/widget/MiuiWidgetUtil;->checkNameResId(Ljava/util/ArrayList;I)I

    move-result p0

    if-eqz p0, :cond_4

    invoke-static {v0, v3}, Lcom/android/camera2/compat/theme/custom/cv/widget/MiuiWidgetUtil;->initFilterComponent(ILjava/util/ArrayList;)V
    ...
    invoke-direct {v4, p0, v1}, Lc1/f;-><init>(II)V
    ...
    invoke-static {v0, v1, v3, p0}, LG4/a;->e(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
...
.method private static setWidgetCameraLens(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    :goto_1
    invoke-static {p0}, Lcom/android/camera/data/data/v;->p0(Ljava/lang/String;)V
    ...
    invoke-static {v1, v2, v3, p0}, LG4/a;->e(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
...
.method private static setWidgetCameraMasterFilter(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-direct {v2, p0, v1}, LA3/F1;-><init>(ILjava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    invoke-direct {v0, v2, v1, p1}, LL0/l;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method private static setWidgetProStyleMode(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, v1, v2}, Lb0/V;->setComponentValue(ILjava/lang/String;)V
...
.method private static updateDefaultWidget(Landroid/content/Context;Landroid/content/pm/PackageManager;)V
    ...
    instance-of v1, v1, L폵폹폻편폻폿편폲폳폠폿폵폳편폮폿폷폹폻폿편폕폹폻폻폹폸폐폺폿폦;
    ...
    invoke-virtual {v0}, L炤炨炪烩炪炮烩炣炢炱炮炤炢烩炤炨炪炪炨炩烩炄炨炪炪炨炩;->Q4()Z
