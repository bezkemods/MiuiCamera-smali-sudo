...
.method public constructor <init>(Lf6/g;ILW0/z;Landroid/content/Context;)V
    .locals 0
    ...
    iput-object p3, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:LW0/z;
...
.method private updateVertexData(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lcom/android/camera/effect/renders/n;->mGLCanvas:Lf6/g;
    ...
    invoke-virtual {v0, v1, v2}, LP0/g;->g(FF)V
    ...
    iget-object p0, p0, Lcom/android/camera/effect/renders/n;->mGLCanvas:Lf6/g;

    check-cast p0, Lf6/a;

    iget-object p0, p0, Lf6/a;->c:LP0/g;
...
.method public draw(LQ0/b;)Z
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:LW0/z;
    ...
    sget-object v1, Lp9/b;->a:Landroid/content/Context;
    ...
    iget-object v0, p1, LQ0/c;->c:Lf6/b;

    iget-object p1, p1, LQ0/n;->b:Landroid/graphics/Rect;

    sget-object v1, Lp9/b;->a:Landroid/content/Context;

    invoke-virtual {p0, v0, p1, v1}, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->drawTexture(Lf6/b;Landroid/graphics/Rect;Landroid/content/Context;)V
...
.method public drawTexture(ILandroid/graphics/Rect;Landroid/content/Context;)V
    ...
    .line 17
    iget-object p0, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:LW0/z;

    invoke-virtual {p0, p1, p2, v0, p3}, LW0/z;->b(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)V

    :cond_1
    return-void
.end method

.method public drawTexture(Lf6/b;Landroid/graphics/Rect;Landroid/content/Context;)V
    .locals 1
    ...
    invoke-virtual {p1, v0}, Lf6/b;->f(Lf6/g;)Z
    ...
    .line 4
    invoke-virtual {p0, p1, v0}, Lcom/android/camera/effect/renders/r;->bindTexture(Lf6/b;I)Z
    ...
    .line 9
    iget-object p2, p0, Lcom/android/camera2/compat/theme/custom/cv/filter/CvStyleFilterRender;->mFilter:LW0/z;
    ...
    invoke-virtual {p2, p1, v0, p0, p3}, LW0/z;->b(ILjava/nio/FloatBuffer;Ljava/nio/FloatBuffer;Landroid/content/Context;)V
...
.method public initFilter(Landroid/content/Context;)V
    ...
    iget-boolean v1, v0, LW0/z;->h:Z

    if-nez v1, :cond_0

    invoke-virtual {v0, p1}, LW0/z;->a(Landroid/content/Context;)V
