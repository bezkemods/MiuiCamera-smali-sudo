...
.method public static synthetic B(LV3/B;)V
    .locals 0
...
.method public static synthetic G(LV3/B;LV3/e1;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;->lambda$reInitAlertAction$6(LV3/B;LV3/e1;)V
...
.method public static synthetic Z(Lcom/android/camera/fragment/top/FragmentTopAlert;)Z
    .locals 0
...
.method private static synthetic lambda$reInitAlertAction$6(LV3/B;LV3/e1;)V
    .locals 1

    const/4 v0, 0x1

    invoke-interface {p1, p0, v0}, LV3/e1;->showTips(LV3/B;Z)V
...
.method public static synthetic n(LX3/f;)V
    .locals 0
...
.method private reInitAlertAction(Z)V
    ...
    invoke-interface {p0}, LV3/B;->jg()V

    invoke-interface {p0}, LV3/B;->di()V

    invoke-interface {p0}, LV3/B;->C7()V

    invoke-interface {p0}, LV3/B;->f2()V

    invoke-interface {p0}, LV3/B;->Kf()V

    invoke-interface {p0}, LV3/B;->a6()V

    invoke-interface {p0, v1}, LV3/B;->Ah(Z)V

    invoke-interface {p0}, LV3/B;->qc()V

    invoke-interface {p0}, LV3/B;->J0()V

    new-array p1, v0, [Z

    invoke-interface {p0, p1}, LV3/B;->Fd([Z)V

    invoke-interface {p0}, LV3/B;->p8()V

    invoke-interface {p0}, LV3/B;->x9()V

    invoke-interface {p0}, LV3/B;->q3()V
    ...
    invoke-virtual {p1}, Lf0/d0;->G()Z

    move-result p1

    invoke-interface {p0, p1}, LV3/B;->s4(Z)V

    invoke-interface {p0}, LV3/B;->vh()V

    invoke-interface {p0}, LV3/B;->Da()V

    invoke-interface {p0}, LV3/B;->gb()V

    invoke-interface {p0}, LV3/B;->t5()V

    invoke-interface {p0}, LV3/B;->id()V

    invoke-interface {p0}, LV3/B;->N7()V

    invoke-interface {p0}, LV3/B;->O0()V

    invoke-interface {p0}, LV3/B;->w8()V
...
.method public alertAiDetectTipHint(IIJ)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/android/camera2/compat/theme/custom/mm/top/m;-><init>(Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;IIJ)V
...
.method public alertSmartCompositionTip(II)V
    ...
    invoke-direct {v0, p1, p2}, Lcom/android/camera2/compat/theme/custom/mm/top/n;-><init>(II)V
...
.method public bridge synthetic getVideoTag()LV3/e0;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;->getVideoTag()Lcom/android/camera/ui/B0;
...
.method public initLandscapeTopTipLayout(Landroid/view/View;II)V
    ...
    invoke-direct {v0, p1, p2, p3}, Lcom/android/camera2/compat/theme/custom/mm/top/o;-><init>(Landroid/view/View;II)V
...
.method public updateLyingDirectHint(ZZ)V
    ...
    invoke-interface {v0, p1}, LV3/e1;->setIsShowTopLyingDirectHint(Z)V
    ...
    invoke-interface {v0}, LV3/e1;->isShowTopLyingDirectHint()Z
