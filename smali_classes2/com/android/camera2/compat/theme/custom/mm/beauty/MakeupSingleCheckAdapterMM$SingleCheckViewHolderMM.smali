...
.method public onItemClick(Landroid/view/View;)V
    ...
    iget-boolean v0, v0, Lcom/android/camera/data/data/w;->g:Z
...
.method public setDataToView(Lcom/android/camera/data/data/w;I)V
    .locals 9

    invoke-super {p0, p1, p2}, Lcom/android/camera/fragment/beauty/MakeupSingleCheckAdapter$SingleCheckViewHolder;->setDataToView(Lcom/android/camera/data/data/w;I)V
    ...
    invoke-interface/range {v1 .. v7}, Lcom/android/camera2/compat/theme/common/MiThemeOperationPopUpNewStyleInterface;->setDataView(Landroid/content/Context;Lcom/android/camera/data/data/w;ILcom/android/camera/fragment/beauty/MakeupSingleCheckAdapter$SingleCheckViewHolder;ZZ)V

    iget-boolean p2, p1, Lcom/android/camera/data/data/w;->g:Z
    ...
    iget-object p2, p2, Lf0/d0;->h:LS5/b;

    iget-object v0, p1, Lcom/android/camera/data/data/w;->c:Ljava/lang/String;

    invoke-static {v0, p2}, Lcom/android/camera/data/data/h;->v(Ljava/lang/String;LS5/b;)I
    ...
    invoke-interface {p2, p1, p0}, LV3/r0;->c7(Ljava/lang/String;LA/z3;)V
