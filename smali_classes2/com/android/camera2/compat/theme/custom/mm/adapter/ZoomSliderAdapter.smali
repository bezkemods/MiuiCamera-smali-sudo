...
.field private mStopPointValueListener:Li2/i;
...
.method public constructor <init>(Landroid/content/Context;ILi2/i;Landroid/util/Range;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p3, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/ZoomSliderAdapter;->mStopPointValueListener:Li2/i;
...
.method private final getSupportedZoomInnerValues()V
    ...
    sget-object v2, LWb/g;->b:[Ljava/lang/Float;

    invoke-static {v1, v0, v2}, Lcom/android/camera/data/data/h;->R(ZZ[Ljava/lang/Float;)Ljava/util/ArrayList;
...
.method private final initValue()V
    ...
    invoke-virtual {v4}, Lw7/b;->c()Ljava/util/List;

    move-result-object v4

    invoke-static {v1, v2, v0, v3, v4}, Lcom/android/camera/data/data/h;->a0(Ljava/util/List;IFFLjava/util/List;)V
...
.method public mapPositionToValue(F)Ljava/lang/String;
    ...
    invoke-static {p1, p0, v1, v0}, LA/c0;->d(FFFF)F
