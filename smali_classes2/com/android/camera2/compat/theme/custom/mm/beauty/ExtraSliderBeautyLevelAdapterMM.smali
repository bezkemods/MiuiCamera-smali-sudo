...
.field private mManuallyListener:Li2/i;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Li2/i;)V
    .locals 0

    invoke-direct {p0}, Lcom/android/camera/fragment/manually/adapter/b;-><init>()V

    iput-object p3, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/ExtraSliderBeautyLevelAdapterMM;->mManuallyListener:Li2/i;
...
.method public draw(Lcom/android/camera/ui/c$a$a;ILandroid/graphics/Canvas;ZIFI)V
    ...
    iget-object p5, p0, Lcom/android/camera/ui/c$a;->mNormalPaint:Landroid/graphics/Paint;

    invoke-virtual {p5, p7}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p5, p0, Lcom/android/camera/ui/c$a;->mStopPointPaint:Landroid/graphics/Paint;
    ...
    iget-object p5, p0, Lcom/android/camera/ui/c$a;->mSelectTextPaint:Landroid/graphics/Paint;

    iget p6, p0, Lcom/android/camera/ui/c$a;->mSelectTextColor:I

    invoke-virtual {p5, p6}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p5, p0, Lcom/android/camera/ui/c$a;->mPointPaint:Landroid/graphics/Paint;
    ...
    iget-object p6, p0, Lcom/android/camera/ui/c$a;->mCurrentValue:Ljava/lang/String;

    invoke-virtual {p0, p3, p5, p6}, Lcom/android/camera/ui/c$a;->drawText(Landroid/graphics/Canvas;ZLjava/lang/String;)V
    ...
    iget p6, p1, Lcom/android/camera/ui/c$a$a;->i:F
    ...
    iget p1, p1, Lcom/android/camera/ui/c$a$a;->h:F
    ...
    :cond_5
    invoke-virtual {p0, p2, p3, p4, p5}, Lcom/android/camera/ui/c$a;->drawLine(ILandroid/graphics/Canvas;ZF)V
...
.method public drawPoint(Landroid/graphics/Canvas;)V
    ...
    iget v0, p0, Lcom/android/camera/ui/c$a;->mCurrentLineHalfHeight:F

    iget v1, p0, Lcom/android/camera/ui/c$a;->mPointLineGap:F

    add-float/2addr v0, v1

    iget v1, p0, Lcom/android/camera/ui/c$a;->mPointRadius:F
    ...
    iget-object v1, p0, Lcom/android/camera/ui/c$a;->mStrokePaint:Landroid/graphics/Paint;
...
.method public getDefaultPositionRange()Landroid/util/Range;
    ...
    iget-object v0, p0, Lcom/android/camera/ui/c$a;->mDefaultValue:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/camera/ui/c$a;->mDefaultValue:Ljava/lang/String;
    ...
    iget v1, p0, Lcom/android/camera/ui/c$a;->mSampleInterval:I
    ...
    iget v2, p0, Lcom/android/camera/ui/c$a;->mSampleInterval:I
...
.method public initDataList(Ls5/d;Ljava/util/List;Ljava/lang/String;)V
    ...
    invoke-super {p0, p1, p2, p3}, Lcom/android/camera/ui/c$a;->initDataList(Ls5/d;Ljava/util/List;Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/ui/c$a;->needVirtual()Z
    ...
    iget p2, p0, Lcom/android/camera/ui/c$a;->mRealInterval:I
    ...
    iget p2, p0, Lcom/android/camera/ui/c$a;->mSampleInterval:I
...
.method public initStyle(Landroid/content/Context;)V
    ...
    invoke-super {p0, p1}, Lcom/android/camera/ui/c$a;->initStyle(Landroid/content/Context;)V
...
.method public isFlagPosition(I)Z
    ...
    :cond_1
    iget v0, p0, Lcom/android/camera/ui/c$a;->mRealInterval:I
    ...
    iget-object p0, p0, Lcom/android/camera/ui/c$a;->mDefaultValue:Ljava/lang/String;
...
.method public onCustomWheelScroll(Ljava/lang/String;Z)V
    ...
    iget-object v2, p0, Lcom/android/camera/ui/c$a;->mCurrentValue:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/camera/ui/c$a;->mCurrentValue:Ljava/lang/String;
    ...
    .line 8
    iget-object v1, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/ExtraSliderBeautyLevelAdapterMM;->mManuallyListener:Li2/i;
    ...
    .line 9
    invoke-interface {v1, p1, v0, v2}, Li2/i;->onZoomItemSlideOn(IZI)V

    .line 10
    iget-object p1, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/ExtraSliderBeautyLevelAdapterMM;->mManuallyListener:Li2/i;

    const/4 v0, 0x3

    invoke-interface {p1, p2, v0}, Li2/i;->onManuallyDataChanged(Ljava/lang/String;I)V
...
.method public onPositionSelect(Landroid/view/View;FII)V
    ...
    .line 6
    iget-object v0, p0, Lcom/android/camera2/compat/theme/custom/mm/beauty/ExtraSliderBeautyLevelAdapterMM;->mManuallyListener:Li2/i;

    if-eqz v0, :cond_0

    .line 7
    invoke-interface {v0, p1, p3, p4}, Li2/i;->onZoomItemSlideOn(IZI)V
    ...
    invoke-interface {p1, p2, p3}, Li2/i;->onManuallyDataChanged(Ljava/lang/String;I)V
...
.method public updateColor(Z)V
    ...
    iget-object p0, p0, Lcom/android/camera/ui/c$a;->mStrokePaint:Landroid/graphics/Paint;
...
.method public updateDefaultValue(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/android/camera/ui/c$a;->mDefaultValue:Ljava/lang/String;
