...
.method public final Z()Landroid/util/Range;
    ...
    invoke-static {p0}, LP5/h;->W(LP5/g;)F
...
.method public final h7(FFI)Z
    ...
    invoke-static {v1}, Lcom/android/camera/data/data/j;->R(I)Z
    ...
    iget v1, v1, Lb0/Y;->a:I

    const/4 v4, 0x3

    if-gt v1, v4, :cond_2

    invoke-super {p0, p1, p2, p3}, LN5/I;->h7(FFI)Z
    ...
    const-string p3, "ultra_wide"

    invoke-virtual {p0, p3}, Lb0/Y;->j(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v5}, Lb0/Y;->j(Ljava/lang/String;)Z

    move-result v6

    const-string v7, "ultra_tele"

    invoke-virtual {p0, v7}, Lb0/Y;->j(Ljava/lang/String;)Z
    ...
    invoke-static {p0, v2}, LM5/g;->U7(Lcom/android/camera/module/J;Z)V
