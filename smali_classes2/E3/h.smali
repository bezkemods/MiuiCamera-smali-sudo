...
.method public constructor <init>(II)V
    ...
    .line 5
    iput-boolean p1, p0, LE3/h;->b:Z

    .line 6
    iput p2, p0, LE3/h;->c:I
...
.method public final apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p1, v1, v0}, LE3/l;-><init>(ILcom/android/camera/module/J;)V
    :try_end_1
    ...
    invoke-interface {v4}, Lcom/android/camera/module/K;->B()LA/J2;

    move-result-object v4

    if-eqz v4, :cond_4

    iget-object v5, v4, LA/J2;->y:LA/S2;

    if-eqz v5, :cond_4

    iget-boolean v5, v4, LA/J2;->z:Z

    if-eqz v5, :cond_3

    iput-object v3, v4, LA/J2;->A:Landroid/graphics/Rect;
    ...
    iput-object v5, v4, LA/J2;->A:Landroid/graphics/Rect;
    ...
    invoke-interface {v1, v8, v2}, Lcom/android/camera/module/K;->notifyDataChanged(II)V
    ...
    invoke-static {v3, v1, v0}, Lcom/android/camera/data/data/h;->I(IILP5/g;)F

    invoke-interface {v2}, LV3/o0;->Fg()V
