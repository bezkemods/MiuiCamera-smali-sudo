...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lj6/b;->a:Z

    const-string v2, "camera_dump_parameters"

    invoke-static {v2, v1}, LWb/f;->c(Ljava/lang/String;Z)Z

    move-result v1

    sput-boolean v1, Lj6/b;->b:Z
    ...
    invoke-static {v0, v3, v4}, LWb/f;->f(Ljava/lang/String;J)J

    move-result-wide v3

    sput-wide v3, Lj6/b;->n:J
    ...
    sput-object v0, Lj6/b;->o:Ljava/lang/String;
    ...
    sput-boolean v0, Lj6/b;->q:Z

    const-string v0, "ro.boot.product.theme_customize"

    const-string v4, ""

    invoke-static {v0, v4}, LWb/f;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lj6/b;->r:Ljava/lang/String;
    ...
    sput-object v0, Lj6/b;->s:Ljava/lang/String;
    ...
    sput-boolean v0, Lj6/b;->y:Z

    const-string v0, "camera.support.mimoji.version"

    const/4 v4, -0x1

    invoke-static {v0, v4}, LWb/f;->e(Ljava/lang/String;I)I
    ...
    const-string v7, "true;360;SineEaseInInterpolator"

    invoke-static {v6, v7}, LWb/f;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    sput-object v6, Lj6/b;->S:Ljava/lang/String;

    const-string v6, "camera.debug.mivi3.output.jpeg"

    invoke-static {v6, v2}, LWb/f;->c(Ljava/lang/String;Z)Z

    move-result v6

    sput-boolean v6, Lj6/b;->T:Z
    ...
    sput-boolean v6, Lj6/b;->U:Z

    const-string v6, "vendor.debug.camera.liveshot.version"

    invoke-static {v6, v2}, LWb/f;->e(Ljava/lang/String;I)I
    ...
    invoke-static {v6, v1}, LWb/f;->c(Ljava/lang/String;Z)Z

    move-result v6

    sput-boolean v6, Lj6/b;->W:Z

    const-string v6, "camera.debug.zoom_vibrate"

    invoke-static {v6, v3}, LWb/f;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    sput-object v3, Lj6/b;->X:Ljava/lang/String;
    ...
    sput-boolean v3, Lj6/b;->Y:Z

    const-string v3, "camera.debug.setting.upload.minimum.latency"

    const-wide/16 v6, 0x0

    invoke-static {v3, v6, v7}, LWb/f;->f(Ljava/lang/String;J)J

    move-result-wide v6

    sput-wide v6, Lj6/b;->Z:J
    ...
    sput-object v3, Lj6/b;->a0:Ljava/util/List;
    ...
    sput-object v3, Lj6/b;->b0:Ljava/util/List;
...
.method public static a()Z
    ...
    sget-object v0, Lw7/c;->h:Ljava/lang/String;
...
.method public static e(Landroid/content/Context;)V
    ...
    sput-object v0, Lj6/b;->c0:Ljava/lang/String;
    ...
    :cond_1
    sget-object v0, Lj6/b;->d0:Ljava/lang/String;

    sget-object v1, Lj6/b;->c0:Ljava/lang/String;
    ...
    :cond_2
    sget-object v0, Lj6/b;->c0:Ljava/lang/String;
