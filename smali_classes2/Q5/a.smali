...
.method public constructor <init>(LP5/Z;Lv9/a;LP5/a1;)V
    ...
    iput-object p3, p0, LQ5/a;->B:LP5/a1;

    iget p1, p3, LP5/a1;->a:I

    iput p1, p0, LQ5/a;->J:I

    iget p1, p3, LP5/a1;->d:I
...
.method public final B()LQ5/a$c;
    ...
    invoke-virtual {v1, v2, v0}, Lx9/b;->a(Lx9/c;LP5/Z0;)Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v0

    invoke-virtual {p0}, LQ5/a;->E()LQ5/a$d;
    ...
    iget-object v3, v1, LQ5/a$d;->a:Ljava/util/ArrayList;
    ...
    iget-object v2, v1, LQ5/a$d;->a:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, LQ5/a$c;->a:Landroid/hardware/camera2/CaptureRequest$Builder;

    iget-boolean v0, v1, LQ5/a$d;->c:Z

    iput-boolean v0, p0, LQ5/a$c;->c:Z

    iget-boolean v0, v1, LQ5/a$d;->b:Z

    iput-boolean v0, p0, LQ5/a$c;->b:Z

    return-object p0
.end method

.method public final C(LQ5/a$c;)V
    .locals 2
    ...
    iput-object v1, p0, LP5/i0;->l:Ljava/lang/String;
    ...
    invoke-static {p1, v0, p0}, LP5/K;->m0(Landroid/hardware/camera2/CaptureRequest$Builder;LP5/g;Ljava/lang/String;)V

    :cond_0
    return-void
.end method

.method public abstract D()LQ5/a$b;
.end method

.method public abstract E()LQ5/a$d;
.end method

.method public abstract F()Z
.end method

.method public G(LP9/o;)V
    .locals 1
...
.method public abstract H(LQ5/a$c;)V
.end method
...
.method public final k()V
    ...
    invoke-static {v0, v3}, LA/w3;->i(Ljava/lang/String;I)Ljava/lang/String;
...
.method public final m()V
    ...
    iget-object v3, p0, LQ5/a;->B:LP5/a1;

    iget v4, v3, LP5/a1;->f:I
    ...
    :cond_0
    :try_start_0
    new-instance v4, LQ5/a$a;

    invoke-virtual {p0}, LQ5/a;->D()LQ5/a$b;

    move-result-object v7

    invoke-direct {v4}, Landroid/hardware/camera2/CameraCaptureSession$CaptureCallback;-><init>()V

    iput-object p0, v4, LQ5/a$a;->a:LQ5/a;

    iput-object v7, v4, LQ5/a$a;->b:LQ5/a$b;

    invoke-virtual {p0}, LQ5/a;->B()LQ5/a$c;

    move-result-object v7

    invoke-virtual {p0, v7}, LQ5/a;->y(LQ5/a$c;)V

    iget-object v8, v7, LQ5/a$c;->a:Landroid/hardware/camera2/CaptureRequest$Builder;

    const/4 v9, 0x3

    invoke-virtual {v0, v8, v9}, LP5/Z;->D1(Landroid/hardware/camera2/CaptureRequest$Builder;I)V

    invoke-virtual {p0, v7}, LQ5/a;->H(LQ5/a$c;)V

    invoke-virtual {p0, v7}, LQ5/a;->C(LQ5/a$c;)V

    iget v8, v3, LP5/a1;->f:I
    :try_end_0
    ...
    iget-object v2, v3, LP5/a1;->g:LP5/a1$a;
    ...
    :goto_0
    iget-object v6, v3, LP5/a1;->g:LP5/a1$a;

    iget v6, v6, LP5/a1$a;->c:I

    if-ge v2, v6, :cond_1

    iget-object v6, v7, LQ5/a$c;->a:Landroid/hardware/camera2/CaptureRequest$Builder;

    invoke-virtual {p0, v6, v2}, LQ5/a;->x(Landroid/hardware/camera2/CaptureRequest$Builder;I)V

    sget-object v8, Landroid/hardware/camera2/CaptureRequest;->CONTROL_ENABLE_ZSL:Landroid/hardware/camera2/CaptureRequest$Key;

    iget-object v13, p0, LQ5/a;->B:LP5/a1;

    iget-boolean v13, v13, LP5/a1;->c:Z

    invoke-static {v13}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v13

    invoke-static {v6, v8, v13, v5}, Ld6/K;->b(Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;Z)V
    ...
    :cond_2
    invoke-virtual {p0, v7}, LQ5/a;->z(LQ5/a$c;)V
    ...
    iput-object v1, p0, LP5/o0;->x:Ljava/lang/String;
    ...
    iget-object v2, v7, LQ5/a$c;->a:Landroid/hardware/camera2/CaptureRequest$Builder;

    invoke-virtual {p0, v2, v5}, LQ5/a;->x(Landroid/hardware/camera2/CaptureRequest$Builder;I)V
    ...
    iget-boolean v6, v6, LP5/a1;->c:Z

    invoke-static {v6}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v6

    invoke-static {v2, v3, v6, v5}, Ld6/K;->b(Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;Z)V
    ...
    :goto_2
    invoke-virtual {p0, v10}, LQ5/a;->w(Z)V
    :try_end_1
    ...
    :catch_1
    invoke-virtual {p0, v5}, LQ5/a;->w(Z)V
...
.method public w(Z)V
    ...
    invoke-static {p1, p0}, LA/h3;->a(II)V
...
.method public abstract y(LQ5/a$c;)V
.end method

.method public final z(LQ5/a$c;)V
    .locals 6
    ...
    :cond_0
    iget-object v1, p0, LP5/o0;->A:Lcom/xiaomi/engine/BufferFormat;

    if-nez v1, :cond_1

    new-instance v1, Lcom/xiaomi/engine/BufferFormat;

    iget-object v3, p0, LP5/o0;->u:Landroid/util/Size;

    invoke-virtual {v3}, Landroid/util/Size;->getWidth()I

    move-result v3

    iget-object v4, p0, LP5/o0;->u:Landroid/util/Size;
    ...
    invoke-virtual {p0, p1, v1, v0}, LP5/o0;->r(Landroid/hardware/camera2/CaptureRequest;Lcom/xiaomi/engine/BufferFormat;I)Lcom/xiaomi/engine/PreProcessData;

    move-result-object p1

    if-eqz p1, :cond_2

    invoke-virtual {p0, p1}, LP5/o0;->u(Lcom/xiaomi/engine/PreProcessData;)V
    ...
    invoke-virtual {p0, p1}, LL3/l;->m(Ljava/lang/String;)V
