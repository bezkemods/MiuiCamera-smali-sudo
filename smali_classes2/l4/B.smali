...
.method public synthetic constructor <init>(Landroid/app/Application;[BZLandroid/net/Uri;Ljava/lang/String;Landroid/location/Location;IIIJIZ)V
    ...
    iput-object p1, p0, Ll4/B;->a:Landroid/app/Application;

    iput-object p2, p0, Ll4/B;->b:[B

    iput-boolean p3, p0, Ll4/B;->c:Z

    iput-object p4, p0, Ll4/B;->d:Landroid/net/Uri;

    iput-object p5, p0, Ll4/B;->e:Ljava/lang/String;

    iput-object p6, p0, Ll4/B;->f:Landroid/location/Location;

    iput p7, p0, Ll4/B;->g:I

    iput p8, p0, Ll4/B;->h:I

    iput p9, p0, Ll4/B;->i:I

    iput-wide p10, p0, Ll4/B;->j:J

    iput p12, p0, Ll4/B;->k:I

    iput-boolean p13, p0, Ll4/B;->l:Z
...
.method public final invoke()Ljava/lang/Object;
    ...
    iget-object v9, v1, Ll4/B;->d:Landroid/net/Uri;

    new-instance v0, Ljava/lang/StringBuilder;

    const-string v3, "updateImage:  orientation > "

    invoke-direct {v0, v3}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget v3, v1, Ll4/B;->g:I
    ...
    iget-object v14, v1, Ll4/B;->a:Landroid/app/Application;
    ...
    :cond_3
    :goto_3
    iget-boolean v5, v1, Ll4/B;->c:Z

    iget-object v6, v1, Ll4/B;->e:Ljava/lang/String;
    ...
    :cond_5
    :goto_5
    invoke-static {v6, v5}, Ll4/C;->e(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    :cond_6
    invoke-static {v6}, Landroidx/constraintlayout/core/a;->g(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    const-string v2, "updateImage uri-> "
    ...
    iget-object v2, v1, Ll4/B;->b:[B

    iget v8, v1, Ll4/B;->k:I
    ...
    :try_start_3
    sget-object v0, Ll4/p;->a:Ljava/io/File;
    ...
    invoke-static {v13}, LN9/f;->m(Ljava/lang/String;)Z
    ...
    const-string v1, "tryLock %s failed, %s times"
    ...
    sget-object v3, Ll4/p;->a:Ljava/io/File;

    invoke-direct {v0, v3, v7}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    invoke-static {v0, v2}, LXb/t;->p(Ljava/io/File;[B)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_3

    if-eqz v1, :cond_e

    invoke-static {v13}, LN9/f;->n(Ljava/lang/String;)V
    ...
    :goto_13
    :try_start_b
    invoke-static {v0, v15}, Ll4/C;->b(Ljava/lang/Exception;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Ll4/C;->s(Ljava/lang/Exception;)Z

    move-result v0

    if-eqz v0, :cond_13

    sget-object v0, Ll4/C;->r:Lcom/xiaomi/camera/utils/lifecycle/FreshLiveData;
    ...
    const-string v7, "updateImage  writeFile cost %s ms, fileLen: %d"
    ...
    invoke-static {v4, v0}, LMf/f;->e(Ljava/io/File;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v7, v3, Ll4/B;->f:Landroid/location/Location;
    ...
    invoke-static/range {v3 .. v8}, Ll4/C;->z(Landroid/app/Application;Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[BI)I
    ...
    const-string v3, "updateImage ret->%s, updateAfter cost %s ms"
    ...
    invoke-static/range {v13 .. v24}, Ll4/C;->y(IJJJLandroid/content/Context;Landroid/location/Location;Ljava/lang/String;ZZ)V
