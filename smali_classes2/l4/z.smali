...
.method public synthetic constructor <init>(IJJJLandroid/content/Context;Landroid/location/Location;Ljava/lang/String;ZZ)V
    ...
    iput p1, p0, Ll4/z;->a:I

    iput-object p8, p0, Ll4/z;->b:Landroid/content/Context;

    iput-object p10, p0, Ll4/z;->c:Ljava/lang/String;

    iput-wide p2, p0, Ll4/z;->d:J

    iput-boolean p11, p0, Ll4/z;->e:Z

    iput-wide p4, p0, Ll4/z;->f:J

    iput-object p9, p0, Ll4/z;->g:Landroid/location/Location;

    iput-boolean p12, p0, Ll4/z;->h:Z

    iput-wide p6, p0, Ll4/z;->i:J
...
.method public final run()V
    ...
    iget v1, v0, Ll4/z;->a:I

    iget-object v11, v0, Ll4/z;->b:Landroid/content/Context;

    iget-object v12, v0, Ll4/z;->c:Ljava/lang/String;

    iget-wide v13, v0, Ll4/z;->d:J

    iget-boolean v15, v0, Ll4/z;->e:Z

    iget-wide v9, v0, Ll4/z;->f:J

    iget-object v7, v0, Ll4/z;->g:Landroid/location/Location;

    iget-boolean v8, v0, Ll4/z;->h:Z
    ...
    invoke-static/range {v2 .. v10}, Ll4/C;->k(Landroid/content/Context;Ljava/lang/String;JZJLandroid/location/Location;Z)Landroid/content/Intent;
    ...
    invoke-static/range {v2 .. v9}, Ll4/C;->v(Landroid/content/Context;Ljava/lang/String;ZJZJ)V
    ...
    :goto_1
    sget-object v1, Ll4/C;->p:[Ljava/lang/String;
