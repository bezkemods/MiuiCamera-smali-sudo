...
.method public static a()Ljava/util/ArrayList;
    ...
    invoke-static {v6}, Lcom/android/camera/data/data/o;->f(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    invoke-static {v6, v5}, Lcom/android/camera/data/data/o;->v0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v7, v5}, Lcom/android/camera/data/data/o;->v0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v5, v4}, Lcom/android/camera/data/data/o;->v0(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static b(Ljava/lang/String;Ll5/v;)V
    .locals 8
    ...
    :pswitch_0
    invoke-virtual {p1, v1}, Ll5/v;->p(I)Ll5/s;

    move-result-object p0

    invoke-virtual {p0, v5}, Ll5/s;->l(F)V

    invoke-virtual {p1, v4}, Ll5/v;->p(I)Ll5/s;

    move-result-object p0

    invoke-virtual {p0, v5}, Ll5/s;->l(F)V

    invoke-virtual {p1, v0}, Ll5/v;->p(I)Ll5/s;
    ...
    invoke-virtual {p0, v3}, Ll5/s;->j(I)V

    invoke-virtual {p1, v2}, Ll5/v;->p(I)Ll5/s;
    ...
    invoke-virtual {p0, v2}, Ll5/s;->j(I)V
    ...
    iput v2, p0, Ll5/s;->t:I

    iget v0, p0, Ll5/s;->r:I

    iput v0, p0, Ll5/s;->s:I
...
.method public static c(Landroid/content/Context;Ljava/lang/String;Ll5/v;)V
    .locals 6
    ...
    :pswitch_0
    invoke-virtual {p2, p0, v3}, Ll5/v;->o(Landroid/content/Context;I)V

    const p1, 0x7f080200

    invoke-virtual {p2, p0, p1}, Ll5/v;->o(Landroid/content/Context;I)V
    ...
    invoke-virtual {p2, v0}, Ll5/v;->p(I)Ll5/s;

    move-result-object p0

    invoke-virtual {p0, v2}, Ll5/s;->j(I)V

    invoke-virtual {p0}, Ll5/s;->b()V

    invoke-virtual {p2, v1}, Ll5/v;->p(I)Ll5/s;
    ...
    invoke-virtual {p2, v2}, Ll5/v;->p(I)Ll5/s;
