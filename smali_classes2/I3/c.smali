...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LI3/c;->a:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, LI3/c;->b:Landroid/util/SparseArray;
...
.method public final a(I)V
    ...
    iget-object v0, p0, LI3/c;->b:Landroid/util/SparseArray;

    invoke-virtual {v0, p1}, Landroid/util/SparseArray;->remove(I)V

    iget-object v0, p0, LI3/c;->a:Landroid/util/SparseArray;
    ...
    iget-object v2, v1, Lne/e;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :try_start_1
    invoke-virtual {v1, v0, v2, v3}, Lne/e;->b(Lie/a;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    :try_start_2
    invoke-virtual {v1, v2, v3}, Lne/e;->d(Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    ...
    iget-object v0, v1, Lne/e;->h:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicInteger;->decrementAndGet()I

    invoke-virtual {v1}, Lne/e;->h()V

    iget-object p0, p0, LI3/c;->a:Landroid/util/SparseArray;
...
.method public final cancelDownloadSync(I)Z
    ...
    invoke-virtual {p0, p1}, LI3/c;->a(I)V
...
.method public final startDownload(ILjava/util/List;Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;)V
    ...
    iget-object v1, p0, LI3/c;->b:Landroid/util/SparseArray;
    ...
    invoke-direct {v1, v2, v3, p2}, Lie/a$a;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const/16 p2, 0x96

    iput p2, v1, Lie/a$a;->h:I

    iput-boolean v0, v1, Lie/a$a;->j:Z

    invoke-virtual {v1}, Lie/a$a;->a()Lie/a;

    move-result-object p2

    new-instance v0, LI3/c$a;

    invoke-direct {v0, p0, p3, p1}, LI3/c$a;-><init>(LI3/c;Lcom/iqiyi/android/qigsaw/core/splitdownload/DownloadCallback;I)V

    invoke-virtual {p2, v0}, Lie/a;->i(Lte/a;)V
