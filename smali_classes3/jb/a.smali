...
.field public final e:Ljb/a$d;

.field public final f:Ljb/a$a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ljb/a;->c:Ljava/lang/Object;

    new-instance v0, Ljb/a$a;

    invoke-direct {v0, p0}, Ljb/a$a;-><init>(Ljb/a;)V

    iput-object v0, p0, Ljb/a;->f:Ljb/a$a;
    ...
    iput-object v0, p0, Ljb/a;->d:Landroid/os/HandlerThread;
    ...
    invoke-direct {v1, p0, v0}, Ljb/a$d;-><init>(Ljb/a;Landroid/os/Looper;)V

    iput-object v1, p0, Ljb/a;->e:Ljb/a$d;

    return-void
.end method

.method public static a(Ljb/a;Lv9/b$a;IZ)V
    .locals 17
    ...
    invoke-direct {v12, v1, v0, v2}, Ljb/b;-><init>(Ljb/a;Lv9/b$a;I)V

    const/4 v13, 0x1

    if-nez v2, :cond_0

    iget-object v3, v0, Lv9/b$a;->d:Landroid/media/Image;
    ...
    iget-object v3, v0, Lv9/b$a;->e:Landroid/media/Image;
    ...
    iget-object v5, v0, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v4, v5, v2}, LA/M;->g(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {v4, v3, v6, v13}, Lr9/e;->k(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    iget-object v3, v1, Ljb/a;->c:Ljava/lang/Object;
    ...
    iput-wide v6, v1, Ljb/a;->a:J

    iput-boolean v13, v1, Ljb/a;->b:Z
    ...
    iget-object v7, v0, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v4, v1, Ljb/a;->c:Ljava/lang/Object;
    ...
    :try_start_2
    iget-boolean v0, v1, Ljb/a;->b:Z

    if-eqz v0, :cond_1

    iget-object v0, v1, Ljb/a;->c:Ljava/lang/Object;
    ...
    invoke-static {v2, v1, v3}, LK2/j;->g(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
# virtual methods
.method public final b(Lv9/b;Lcom/xiaomi/engine/TaskSession;)V
    .locals 32
    ...
    iget-object v4, v4, Ljb/a;->f:Ljb/a$a;

    iget-object v6, v1, Lv9/b;->f:Ljava/util/ArrayList;
    ...
    iget-object v2, v0, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v0, v2, v7}, Lv9/b$a;->d(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V

    iget-object v2, v1, Lv9/b;->p:LP9/r$c;
    ...
    iget-object v8, v5, Lv9/b$a;->d:Landroid/media/Image;

    iget-object v9, v5, Lv9/b$a;->e:Landroid/media/Image;

    iget-object v5, v5, Lv9/b$a;->g:Landroid/media/Image;

    if-eqz v8, :cond_0

    invoke-virtual {v8}, Landroid/media/Image;->close()V

    invoke-virtual {v2, v8}, LP9/r$c;->b(Landroid/media/Image;)V
    ...
    invoke-virtual {v2, v9}, LP9/r$c;->b(Landroid/media/Image;)V
    ...
    invoke-virtual {v2, v5}, LP9/r$c;->b(Landroid/media/Image;)V
    ...
    invoke-virtual {v0}, Lv9/b$a;->c()Z

    move-result v2

    if-eqz v2, :cond_4

    iput-object v0, v1, Lv9/b;->i:Lv9/b$a;

    invoke-virtual {v4, v1, v3}, Ljb/a$a;->a(Lv9/b;Z)V

    :cond_4
    return-void

    :cond_5
    iget v0, v1, Lv9/b;->a:I
    ...
    iget v15, v1, Lv9/b;->b:I

    iget-boolean v5, v1, Lv9/b;->l:Z

    iget-object v12, v1, Lv9/b;->o:Lv9/d;

    iget-boolean v14, v1, Lv9/b;->m:Z
    ...
    invoke-direct/range {v14 .. v19}, Lv9/b$a;-><init>(IZLv9/d;ZZ)V

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5, v11}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-static {v6, v5}, LA/m2;->i(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v2, v5, v11, v12}, LA/N;->j(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v7, v14, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v7, v14, Lv9/b$a;->d:Landroid/media/Image;
    ...
    iget-object v7, v7, Lv9/b$a;->d:Landroid/media/Image;
    ...
    :cond_8
    invoke-static {v10, v14}, LA/w3;->i(Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v9, v5, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    :goto_3
    invoke-virtual {v0, v7, v3, v3}, Lv9/b$a;->e(Landroid/media/Image;IZ)V
    ...
    iget-object v7, v1, Lv9/b;->p:LP9/r$c;
    ...
    check-cast v11, Lv9/b$a;

    if-eq v11, v5, :cond_b

    iget-object v12, v11, Lv9/b$a;->d:Landroid/media/Image;

    invoke-virtual {v12}, Landroid/media/Image;->close()V

    invoke-virtual {v7, v12}, LP9/r$c;->b(Landroid/media/Image;)V

    iget-object v12, v11, Lv9/b$a;->e:Landroid/media/Image;
    ...
    :cond_c
    iget-object v11, v11, Lv9/b$a;->g:Landroid/media/Image;

    if-eqz v11, :cond_b

    invoke-virtual {v11}, Landroid/media/Image;->close()V

    invoke-virtual {v7, v11}, LP9/r$c;->b(Landroid/media/Image;)V
    ...
    iget-object v6, v5, Lv9/b$a;->d:Landroid/media/Image;

    invoke-virtual {v6}, Landroid/media/Image;->close()V

    invoke-virtual {v7, v6}, LP9/r$c;->b(Landroid/media/Image;)V

    const/4 v6, 0x1

    invoke-virtual {v0, v9, v6}, Lv9/b$a;->d(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V

    iget-boolean v6, v1, Lv9/b;->l:Z

    if-eqz v6, :cond_e

    iget-object v6, v5, Lv9/b$a;->g:Landroid/media/Image;

    iget-boolean v7, v5, Lv9/b$a;->l:Z

    invoke-virtual {v0, v6, v13, v7}, Lv9/b$a;->e(Landroid/media/Image;IZ)V

    :cond_e
    iget-object v5, v5, Lv9/b$a;->e:Landroid/media/Image;

    const/4 v6, 0x1

    if-eqz v5, :cond_f

    invoke-virtual {v0, v5, v6, v3}, Lv9/b$a;->e(Landroid/media/Image;IZ)V
    ...
    invoke-virtual {v4, v1, v6}, Ljb/a$a;->a(Lv9/b;Z)V
    ...
    iget-object v0, v1, Lv9/b;->n:Landroid/util/Size;
    ...
    invoke-static {v9, v0, v14, v15}, LA/B2;->e(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget v0, v1, Lv9/b;->b:I

    iget-boolean v12, v1, Lv9/b;->l:Z

    iget-object v15, v1, Lv9/b;->o:Lv9/d;

    iget-boolean v13, v1, Lv9/b;->m:Z
    ...
    invoke-direct/range {v17 .. v22}, Lv9/b$a;-><init>(IZLv9/d;ZZ)V

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0, v11}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-static {v6, v0}, LA/m2;->i(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v0, v3, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v19, Ld6/I;->n1:Ld6/J;

    invoke-virtual/range {v19 .. v19}, Ld6/J;->a()Ljava/lang/Object;
    ...
    invoke-static {v0, v4}, LA/S;->h(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v4, v3, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v3, v3, Lv9/b$a;->d:Landroid/media/Image;
    ...
    iget-object v0, v0, Lv9/b$a;->d:Landroid/media/Image;
    ...
    :cond_1c
    invoke-static {v10, v0}, LA/w3;->i(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {v9, v0}, LA/w3;->i(Ljava/lang/String;I)Ljava/lang/String;
    ...
    check-cast v8, Lv9/b$a;

    iget-object v12, v8, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v0, v1, Lv9/b;->o:Lv9/d;
    ...
    check-cast v13, Lv9/b$a;

    iget-object v0, v13, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v23, Ld6/I;->n1:Ld6/J;

    invoke-virtual/range {v23 .. v23}, Ld6/J;->a()Ljava/lang/Object;
    ...
    invoke-static {v0, v3}, LA/S;->h(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v3, v13, Lv9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v3, v13, Lv9/b$a;->e:Landroid/media/Image;
    ...
    iget-object v0, v0, Lv9/b$a;->e:Landroid/media/Image;
    ...
    :cond_20
    invoke-static {v9, v2}, LA/w3;->i(Ljava/lang/String;I)Ljava/lang/String;
    ...
    :goto_15
    invoke-virtual {v5, v0, v9, v4}, Lv9/b$a;->e(Landroid/media/Image;IZ)V
    ...
    :goto_16
    invoke-virtual {v5, v12, v9}, Lv9/b$a;->d(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V

    iget-boolean v0, v1, Lv9/b;->l:Z

    if-eqz v0, :cond_23

    iget-object v0, v8, Lv9/b$a;->g:Landroid/media/Image;

    iget-boolean v4, v8, Lv9/b$a;->l:Z
    ...
    :goto_18
    invoke-virtual {v5, v0, v2, v2}, Lv9/b$a;->e(Landroid/media/Image;IZ)V
    ...
    iget-object v0, v1, Lv9/b;->p:LP9/r$c;
    ...
    :cond_26
    iget-object v9, v4, Lv9/b$a;->d:Landroid/media/Image;

    invoke-virtual {v9}, Landroid/media/Image;->close()V

    invoke-virtual {v0, v9}, LP9/r$c;->b(Landroid/media/Image;)V

    iget-object v9, v4, Lv9/b$a;->e:Landroid/media/Image;
    ...
    :cond_27
    iget-object v4, v4, Lv9/b$a;->g:Landroid/media/Image;

    if-eqz v4, :cond_25

    invoke-virtual {v4}, Landroid/media/Image;->close()V

    invoke-virtual {v0, v4}, LP9/r$c;->b(Landroid/media/Image;)V
    ...
    iget-object v2, v8, Lv9/b$a;->d:Landroid/media/Image;

    invoke-virtual {v2}, Landroid/media/Image;->close()V

    invoke-virtual {v0, v2}, LP9/r$c;->b(Landroid/media/Image;)V

    iget-object v2, v8, Lv9/b$a;->e:Landroid/media/Image;

    if-eqz v2, :cond_29

    iget-object v4, v1, Lv9/b;->o:Lv9/d;

    invoke-virtual {v4}, Lv9/d;->d()I
    ...
    invoke-virtual {v5, v2, v6, v4}, Lv9/b$a;->e(Landroid/media/Image;IZ)V

    :goto_1a
    invoke-virtual {v5}, Lv9/b$a;->c()Z
    ...
    check-cast v2, Lv9/b$a;

    iput-boolean v4, v2, Lv9/b$a;->i:Z
    ...
    iput-object v3, v1, Lv9/b;->g:Ljava/util/ArrayList;

    iget-boolean v0, v1, Lv9/b;->k:Z
    ...
    invoke-virtual {v3, v1, v0}, Ljb/a$a;->a(Lv9/b;Z)V
    ...
    iput-object v5, v1, Lv9/b;->i:Lv9/b$a;
