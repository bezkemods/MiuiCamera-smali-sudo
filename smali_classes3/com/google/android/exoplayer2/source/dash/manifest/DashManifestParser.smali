...
.method public parseAudioChannelConfiguration(Lorg/xmlpull/v1/XmlPullParser;)I
    ...
    invoke-static {p1, p0, v0}, Lcom/google/android/exoplayer2/source/dash/manifest/DashManifestParser;->parseInt(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)I
...
.method public parseBaseUrl(Lorg/xmlpull/v1/XmlPullParser;Ljava/util/List;Z)Ljava/util/List;
    ...
    :cond_2
    const-string/jumbo v2, "serviceLocation"
...
.method public parseContentProtection(Lorg/xmlpull/v1/XmlPullParser;)Landroid/util/Pair;
    ...
    invoke-static {p0, v4, v1}, Lcom/google/android/exoplayer2/extractor/mp4/PsshAtomUtil;->buildPsshAtom(Ljava/util/UUID;[Ljava/util/UUID;[B)[B
    ...
    invoke-static {p0}, Lcom/google/android/exoplayer2/extractor/mp4/PsshAtomUtil;->parseUuid([B)Ljava/util/UUID;

    move-result-object v3

    if-nez v3, :cond_8

    const-string p0, "MpdParser"

    const-string v5, "Skipping malformed cenc:pssh data"

    invoke-static {p0, v5}, Lcom/google/android/exoplayer2/util/Log;->w(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v6, p0}, Ljava/util/UUID;->equals(Ljava/lang/Object;)Z
    ...
    invoke-direct {v1, p0, v4, p1, v3}, Lcom/google/android/exoplayer2/drm/DrmInitData$SchemeData;-><init>(Ljava/util/UUID;Ljava/lang/String;Ljava/lang/String;[B)V
...
.method public parseMediaPresentationDescription(Lorg/xmlpull/v1/XmlPullParser;Landroid/net/Uri;)Lcom/google/android/exoplayer2/source/dash/manifest/DashManifest;
    ...
    :goto_4
    invoke-direct {v5, v6, v7, v0, v8}, Lcom/google/android/exoplayer2/source/dash/manifest/BaseUrl;-><init>(Ljava/lang/String;Ljava/lang/String;II)V

    filled-new-array {v5}, [Lcom/google/android/exoplayer2/source/dash/manifest/BaseUrl;
...
.method public parseRoleFlagsFromDashRoleScheme(Ljava/lang/String;)I
    ...
    :sswitch_0
    const-string/jumbo v5, "supplementary"
    ...
    :sswitch_a
    const-string v5, "enhanced-audio-intelligibility"
