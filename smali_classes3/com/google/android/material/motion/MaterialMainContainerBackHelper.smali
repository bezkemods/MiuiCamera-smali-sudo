...
.method private createCornerAnimator(Lcom/google/android/material/internal/ClippableRoundedCornerLayout;)Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v0, p1, v1}, LV1/q;-><init>(Ljava/lang/Object;I)V
...
.method private getRoundedCornerRadius(Landroid/view/WindowInsets;I)I
    ...
    invoke-static {p1, p2}, Landroidx/core/view/e;->b(Landroid/view/WindowInsets;I)Landroid/view/RoundedCorner;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-static {p0}, Lcom/google/android/exoplayer2/analytics/K;->a(Landroid/view/RoundedCorner;)I
