...
.field private final myProcessDetails$delegate:LWe/f;

.field private final myProcessName$delegate:LWe/f;

.field private final myUuid$delegate:LWe/f;
...
.method public constructor <init>(Landroid/content/Context;Lcom/google/firebase/sessions/UuidGenerator;)V
    ...
    iput-object p1, p0, Lcom/google/firebase/sessions/ProcessDataManagerImpl;->myProcessName$delegate:LWe/f;
    ...
    invoke-direct {p1, p2}, Lcom/google/firebase/sessions/c;-><init>(Lcom/google/firebase/sessions/UuidGenerator;)V

    invoke-static {p1}, LAg/a;->w(Llf/a;)LWe/n;

    move-result-object p1

    iput-object p1, p0, Lcom/google/firebase/sessions/ProcessDataManagerImpl;->myUuid$delegate:LWe/f;

    new-instance p1, Lcom/google/firebase/sessions/d;

    invoke-direct {p1, p0}, Lcom/google/firebase/sessions/d;-><init>(Lcom/google/firebase/sessions/ProcessDataManagerImpl;)V

    invoke-static {p1}, LAg/a;->w(Llf/a;)LWe/n;

    move-result-object p1

    iput-object p1, p0, Lcom/google/firebase/sessions/ProcessDataManagerImpl;->myProcessDetails$delegate:LWe/f;
...
.method private final getMyProcessDetails()Lcom/google/firebase/sessions/ProcessDetails;
    ...
    iget-object p0, p0, Lcom/google/firebase/sessions/ProcessDataManagerImpl;->myProcessDetails$delegate:LWe/f;
...
.method public getMyProcessName()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/google/firebase/sessions/ProcessDataManagerImpl;->myProcessName$delegate:LWe/f;
...
.method public getMyUuid()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/google/firebase/sessions/ProcessDataManagerImpl;->myUuid$delegate:LWe/f;
...
.method public updateProcessDataMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p1}, LXe/G;->Q(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, LXe/F;->I(LWe/j;)Ljava/util/Map;
