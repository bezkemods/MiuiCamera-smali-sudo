...
.method public constructor <init>(Ljava/lang/reflect/Type;Lio/reactivex/Scheduler;ZZZZZZ)V
    ...
    iput-object p1, p0, Lwj/f;->a:Ljava/lang/reflect/Type;

    iput-object p2, p0, Lwj/f;->b:Lio/reactivex/Scheduler;

    iput-boolean p3, p0, Lwj/f;->c:Z

    iput-boolean p4, p0, Lwj/f;->d:Z

    iput-boolean p5, p0, Lwj/f;->e:Z

    iput-boolean p6, p0, Lwj/f;->f:Z

    iput-boolean p7, p0, Lwj/f;->g:Z

    iput-boolean p8, p0, Lwj/f;->h:Z
...
.method public final a(Lvj/m;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1}, Lwj/b;-><init>(Lvj/m;)V

    iget-boolean p1, p0, Lwj/f;->c:Z

    if-eqz p1, :cond_0

    new-instance p1, Lwj/e;

    invoke-direct {p1, v0}, Lwj/e;-><init>(Lio/reactivex/Observable;)V
    ...
    :cond_0
    iget-boolean p1, p0, Lwj/f;->d:Z

    if-eqz p1, :cond_1

    new-instance p1, Lwj/a;

    invoke-direct {p1, v0}, Lwj/a;-><init>(Lio/reactivex/Observable;)V

    goto :goto_0

    :cond_1
    :goto_1
    iget-object p1, p0, Lwj/f;->b:Lio/reactivex/Scheduler;
